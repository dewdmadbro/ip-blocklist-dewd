...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-1279627-2D56A8)
...
**Last Updated:** 2026-07-28 09:14:27 UTC
...
- **Total Input IPs:** 1,279,627
- **Countries Processed:** 50
- **Combined Unique IPs:** 1,125,791
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 135,484 | 133,670 | 237,519 | 18.56% | `aggregated-us-only.txt` |
| China | CN | 7,801 | 7,800 | 173,637 | 13.57% | `aggregated-cn-only.txt` |
| India | IN | 13,176 | 13,145 | 77,425 | 6.05% | `aggregated-in-only.txt` |
| Germany | DE | 29,225 | 29,158 | 46,510 | 3.63% | `aggregated-de-only.txt` |
| Russia | RU | 13,278 | 13,041 | 27,838 | 2.18% | `aggregated-ru-only.txt` |
| United Kingdom | GB | 35,497 | 35,342 | 32,396 | 2.53% | `aggregated-gb-only.txt` |
| Thailand | TH | 1,984 | 1,984 | 15,443 | 1.21% | `aggregated-th-only.txt` |
| Vietnam | VN | 2,193 | 2,193 | 40,081 | 3.13% | `aggregated-vn-only.txt` |
| South Korea | KR | 3,949 | 3,939 | 15,959 | 1.25% | `aggregated-kr-only.txt` |
| Brazil | BR | 13,023 | 12,978 | 69,754 | 5.45% | `aggregated-br-only.txt` |
| Taiwan | TW | 2,388 | 2,388 | 14,029 | 1.10% | `aggregated-tw-only.txt` |
| Canada | CA | 16,948 | 16,824 | 25,464 | 1.99% | `aggregated-ca-only.txt` |
| Singapore | SG | 9,453 | 9,443 | 35,180 | 2.75% | `aggregated-sg-only.txt` |
| Italy | IT | 9,769 | 9,745 | 15,529 | 1.21% | `aggregated-it-only.txt` |
| Netherlands | NL | 18,880 | 18,759 | 51,413 | 4.02% | `aggregated-nl-only.txt` |
| Indonesia | ID | 6,505 | 6,481 | 28,832 | 2.25% | `aggregated-id-only.txt` |
| France | FR | 33,610 | 33,583 | 23,764 | 1.86% | `aggregated-fr-only.txt` |
| Venezuela | VE | 957 | 957 | 7,791 | 0.61% | `aggregated-ve-only.txt` |
| Australia | AU | 12,139 | 12,065 | 17,041 | 1.33% | `aggregated-au-only.txt` |
| Turkey | TR | 3,450 | 3,428 | 13,764 | 1.08% | `aggregated-tr-only.txt` |
| Ukraine | UA | 5,551 | 5,495 | 10,444 | 0.82% | `aggregated-ua-only.txt` |
| Iran | IR | 2,048 | 2,047 | 5,415 | 0.42% | `aggregated-ir-only.txt` |
| Poland | PL | 8,204 | 8,171 | 8,372 | 0.65% | `aggregated-pl-only.txt` |
| Mexico | MX | 4,471 | 4,467 | 15,994 | 1.25% | `aggregated-mx-only.txt` |
| Spain | ES | 11,172 | 11,153 | 9,445 | 0.74% | `aggregated-es-only.txt` |
| Argentina | AR | 3,474 | 3,472 | 12,052 | 0.94% | `aggregated-ar-only.txt` |
| Egypt | EG | 728 | 728 | 3,780 | 0.30% | `aggregated-eg-only.txt` |
| Pakistan | PK | 1,355 | 1,353 | 17,780 | 1.39% | `aggregated-pk-only.txt` |
| Malaysia | MY | 2,570 | 2,570 | 5,855 | 0.46% | `aggregated-my-only.txt` |
| Bulgaria | BG | 2,376 | 2,365 | 3,076 | 0.24% | `aggregated-bg-only.txt` |
| Czechia | CZ | 3,621 | 3,620 | 1,939 | 0.15% | `aggregated-cz-only.txt` |
| Colombia | CO | 2,215 | 2,215 | 6,769 | 0.53% | `aggregated-co-only.txt` |
| United Arab Emirates | AE | 3,842 | 3,842 | 4,399 | 0.34% | `aggregated-ae-only.txt` |
| Romania | RO | 3,995 | 3,986 | 2,572 | 0.20% | `aggregated-ro-only.txt` |
| Kazakhstan | KZ | 1,312 | 1,311 | 2,732 | 0.21% | `aggregated-kz-only.txt` |
| Morocco | MA | 494 | 494 | 4,230 | 0.33% | `aggregated-ma-only.txt` |
| Saudi Arabia | SA | 1,682 | 1,682 | 4,342 | 0.34% | `aggregated-sa-only.txt` |
| South Africa | ZA | 4,021 | 4,007 | 8,710 | 0.68% | `aggregated-za-only.txt` |
| Bangladesh | BD | 2,627 | 2,625 | 8,036 | 0.63% | `aggregated-bd-only.txt` |
| Chile | CL | 1,975 | 1,973 | 3,722 | 0.29% | `aggregated-cl-only.txt` |
| Nigeria | NG | 1,091 | 1,091 | 1,805 | 0.14% | `aggregated-ng-only.txt` |
| Kenya | KE | 873 | 873 | 2,995 | 0.23% | `aggregated-ke-only.txt` |
| Algeria | DZ | 219 | 219 | 2,220 | 0.17% | `aggregated-dz-only.txt` |
| Serbia | RS | 992 | 990 | 1,312 | 0.10% | `aggregated-rs-only.txt` |
| Peru | PE | 1,120 | 1,119 | 2,087 | 0.16% | `aggregated-pe-only.txt` |
| Sri Lanka | LK | 248 | 248 | 962 | 0.08% | `aggregated-lk-only.txt` |
| Iraq | IQ | 683 | 683 | 2,839 | 0.22% | `aggregated-iq-only.txt` |
| Ethiopia | ET | 97 | 97 | 1,182 | 0.09% | `aggregated-et-only.txt` |
| Ghana | GH | 342 | 342 | 595 | 0.05% | `aggregated-gh-only.txt` |
| Belarus | BY | 417 | 417 | 761 | 0.06% | `aggregated-by-only.txt` |
...
- **`aggregated.txt`** - 1,279,627 total aggregated IPs from all sources
- **`aggregated-ae-only.txt`** - 4,399 IPs from AE
- **`aggregated-ar-only.txt`** - 12,052 IPs from AR
- **`aggregated-au-only.txt`** - 17,041 IPs from AU
- **`aggregated-bd-only.txt`** - 8,036 IPs from BD
- **`aggregated-bg-only.txt`** - 3,076 IPs from BG
- **`aggregated-br-only.txt`** - 69,754 IPs from BR
- **`aggregated-by-only.txt`** - 761 IPs from BY
- **`aggregated-ca-only.txt`** - 25,464 IPs from CA
- **`aggregated-cl-only.txt`** - 3,722 IPs from CL
- **`aggregated-cn-only.txt`** - 173,637 IPs from CN
- **`aggregated-co-only.txt`** - 6,769 IPs from CO
- **`aggregated-cz-only.txt`** - 1,939 IPs from CZ
- **`aggregated-de-only.txt`** - 46,510 IPs from DE
- **`aggregated-dz-only.txt`** - 2,220 IPs from DZ
- **`aggregated-eg-only.txt`** - 3,780 IPs from EG
- **`aggregated-es-only.txt`** - 9,445 IPs from ES
- **`aggregated-et-only.txt`** - 1,182 IPs from ET
- **`aggregated-fr-only.txt`** - 23,764 IPs from FR
- **`aggregated-gb-only.txt`** - 32,396 IPs from GB
- **`aggregated-gh-only.txt`** - 595 IPs from GH
- **`aggregated-id-only.txt`** - 28,832 IPs from ID
- **`aggregated-in-only.txt`** - 77,425 IPs from IN
- **`aggregated-iq-only.txt`** - 2,839 IPs from IQ
- **`aggregated-ir-only.txt`** - 5,415 IPs from IR
- **`aggregated-it-only.txt`** - 15,529 IPs from IT
- **`aggregated-ke-only.txt`** - 2,995 IPs from KE
- **`aggregated-kr-only.txt`** - 15,959 IPs from KR
- **`aggregated-kz-only.txt`** - 2,732 IPs from KZ
- **`aggregated-lk-only.txt`** - 962 IPs from LK
- **`aggregated-ma-only.txt`** - 4,230 IPs from MA
- **`aggregated-mx-only.txt`** - 15,994 IPs from MX
- **`aggregated-my-only.txt`** - 5,855 IPs from MY
- **`aggregated-ng-only.txt`** - 1,805 IPs from NG
- **`aggregated-nl-only.txt`** - 51,413 IPs from NL
- **`aggregated-pe-only.txt`** - 2,087 IPs from PE
- **`aggregated-pk-only.txt`** - 17,780 IPs from PK
- **`aggregated-pl-only.txt`** - 8,372 IPs from PL
- **`aggregated-ro-only.txt`** - 2,572 IPs from RO
- **`aggregated-rs-only.txt`** - 1,312 IPs from RS
- **`aggregated-ru-only.txt`** - 27,838 IPs from RU
- **`aggregated-sa-only.txt`** - 4,342 IPs from SA
- **`aggregated-sg-only.txt`** - 35,180 IPs from SG
- **`aggregated-th-only.txt`** - 15,443 IPs from TH
- **`aggregated-tr-only.txt`** - 13,764 IPs from TR
- **`aggregated-tw-only.txt`** - 14,029 IPs from TW
- **`aggregated-ua-only.txt`** - 10,444 IPs from UA
- **`aggregated-us-only.txt`** - 237,519 IPs from US
- **`aggregated-ve-only.txt`** - 7,791 IPs from VE
- **`aggregated-vn-only.txt`** - 40,081 IPs from VN
- **`aggregated-za-only.txt`** - 8,710 IPs from ZA
- **`aggregated-multi-50countries-combined.txt`** - 1,125,791 unique IPs (deduplicated across all countries)
