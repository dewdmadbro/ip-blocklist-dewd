...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-1313482-2D56A8)
...
**Last Updated:** 2026-08-05 20:04:19 UTC
...
- **Total Input IPs:** 1,313,482
- **Countries Processed:** 50
- **Combined Unique IPs:** 1,156,323
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 134,012 | 132,160 | 242,466 | 18.46% | `aggregated-us-only.txt` |
| China | CN | 7,796 | 7,795 | 181,487 | 13.82% | `aggregated-cn-only.txt` |
| India | IN | 13,207 | 13,176 | 78,328 | 5.96% | `aggregated-in-only.txt` |
| Germany | DE | 29,310 | 29,243 | 45,493 | 3.46% | `aggregated-de-only.txt` |
| Russia | RU | 13,276 | 13,041 | 29,308 | 2.23% | `aggregated-ru-only.txt` |
| United Kingdom | GB | 35,276 | 35,129 | 32,693 | 2.49% | `aggregated-gb-only.txt` |
| Thailand | TH | 1,988 | 1,988 | 15,199 | 1.16% | `aggregated-th-only.txt` |
| Vietnam | VN | 2,198 | 2,198 | 40,423 | 3.08% | `aggregated-vn-only.txt` |
| South Korea | KR | 3,919 | 3,909 | 16,260 | 1.24% | `aggregated-kr-only.txt` |
| Brazil | BR | 13,022 | 12,974 | 74,887 | 5.70% | `aggregated-br-only.txt` |
| Taiwan | TW | 2,402 | 2,402 | 14,406 | 1.10% | `aggregated-tw-only.txt` |
| Canada | CA | 17,066 | 16,942 | 25,855 | 1.97% | `aggregated-ca-only.txt` |
| Singapore | SG | 9,488 | 9,478 | 35,787 | 2.72% | `aggregated-sg-only.txt` |
| Italy | IT | 9,749 | 9,725 | 15,685 | 1.19% | `aggregated-it-only.txt` |
| Netherlands | NL | 18,927 | 18,806 | 51,504 | 3.92% | `aggregated-nl-only.txt` |
| Indonesia | ID | 6,554 | 6,527 | 29,104 | 2.22% | `aggregated-id-only.txt` |
| France | FR | 33,667 | 33,640 | 24,270 | 1.85% | `aggregated-fr-only.txt` |
| Venezuela | VE | 959 | 959 | 7,644 | 0.58% | `aggregated-ve-only.txt` |
| Australia | AU | 12,122 | 12,050 | 17,222 | 1.31% | `aggregated-au-only.txt` |
| Turkey | TR | 3,458 | 3,440 | 13,763 | 1.05% | `aggregated-tr-only.txt` |
| Ukraine | UA | 5,577 | 5,521 | 13,937 | 1.06% | `aggregated-ua-only.txt` |
| Iran | IR | 2,049 | 2,048 | 5,367 | 0.41% | `aggregated-ir-only.txt` |
| Poland | PL | 8,199 | 8,166 | 9,509 | 0.72% | `aggregated-pl-only.txt` |
| Mexico | MX | 4,479 | 4,475 | 16,398 | 1.25% | `aggregated-mx-only.txt` |
| Spain | ES | 11,287 | 11,268 | 9,724 | 0.74% | `aggregated-es-only.txt` |
| Argentina | AR | 3,455 | 3,453 | 12,880 | 0.98% | `aggregated-ar-only.txt` |
| Egypt | EG | 730 | 730 | 3,843 | 0.29% | `aggregated-eg-only.txt` |
| Pakistan | PK | 1,358 | 1,356 | 18,418 | 1.40% | `aggregated-pk-only.txt` |
| Malaysia | MY | 2,581 | 2,581 | 6,062 | 0.46% | `aggregated-my-only.txt` |
| Bulgaria | BG | 2,367 | 2,356 | 3,099 | 0.24% | `aggregated-bg-only.txt` |
| Czechia | CZ | 3,612 | 3,611 | 1,942 | 0.15% | `aggregated-cz-only.txt` |
| Colombia | CO | 2,222 | 2,222 | 6,786 | 0.52% | `aggregated-co-only.txt` |
| United Arab Emirates | AE | 3,828 | 3,828 | 4,557 | 0.35% | `aggregated-ae-only.txt` |
| Romania | RO | 4,008 | 3,999 | 2,584 | 0.20% | `aggregated-ro-only.txt` |
| Kazakhstan | KZ | 1,317 | 1,316 | 2,845 | 0.22% | `aggregated-kz-only.txt` |
| Morocco | MA | 494 | 494 | 4,574 | 0.35% | `aggregated-ma-only.txt` |
| Saudi Arabia | SA | 1,687 | 1,687 | 4,447 | 0.34% | `aggregated-sa-only.txt` |
| South Africa | ZA | 4,019 | 4,005 | 8,914 | 0.68% | `aggregated-za-only.txt` |
| Bangladesh | BD | 2,625 | 2,623 | 7,760 | 0.59% | `aggregated-bd-only.txt` |
| Chile | CL | 1,984 | 1,982 | 3,936 | 0.30% | `aggregated-cl-only.txt` |
| Nigeria | NG | 1,095 | 1,095 | 1,752 | 0.13% | `aggregated-ng-only.txt` |
| Kenya | KE | 874 | 874 | 3,077 | 0.23% | `aggregated-ke-only.txt` |
| Algeria | DZ | 219 | 219 | 2,229 | 0.17% | `aggregated-dz-only.txt` |
| Serbia | RS | 999 | 997 | 1,341 | 0.10% | `aggregated-rs-only.txt` |
| Peru | PE | 1,123 | 1,122 | 2,149 | 0.16% | `aggregated-pe-only.txt` |
| Sri Lanka | LK | 249 | 249 | 967 | 0.07% | `aggregated-lk-only.txt` |
| Iraq | IQ | 682 | 682 | 2,855 | 0.22% | `aggregated-iq-only.txt` |
| Ethiopia | ET | 97 | 97 | 1,179 | 0.09% | `aggregated-et-only.txt` |
| Ghana | GH | 347 | 347 | 618 | 0.05% | `aggregated-gh-only.txt` |
...
- **`aggregated.txt`** - 1,313,482 total aggregated IPs from all sources
- **`aggregated-ae-only.txt`** - 4,557 IPs from AE
- **`aggregated-ar-only.txt`** - 12,880 IPs from AR
- **`aggregated-au-only.txt`** - 17,222 IPs from AU
- **`aggregated-bd-only.txt`** - 7,760 IPs from BD
- **`aggregated-bg-only.txt`** - 3,099 IPs from BG
- **`aggregated-br-only.txt`** - 74,887 IPs from BR
- **`aggregated-by-only.txt`** - 790 IPs from BY
- **`aggregated-ca-only.txt`** - 25,855 IPs from CA
- **`aggregated-cl-only.txt`** - 3,936 IPs from CL
- **`aggregated-cn-only.txt`** - 181,487 IPs from CN
- **`aggregated-co-only.txt`** - 6,786 IPs from CO
- **`aggregated-cz-only.txt`** - 1,942 IPs from CZ
- **`aggregated-de-only.txt`** - 45,493 IPs from DE
- **`aggregated-dz-only.txt`** - 2,229 IPs from DZ
- **`aggregated-eg-only.txt`** - 3,843 IPs from EG
- **`aggregated-es-only.txt`** - 9,724 IPs from ES
- **`aggregated-et-only.txt`** - 1,179 IPs from ET
- **`aggregated-fr-only.txt`** - 24,270 IPs from FR
- **`aggregated-gb-only.txt`** - 32,693 IPs from GB
- **`aggregated-gh-only.txt`** - 618 IPs from GH
- **`aggregated-id-only.txt`** - 29,104 IPs from ID
- **`aggregated-in-only.txt`** - 78,328 IPs from IN
- **`aggregated-iq-only.txt`** - 2,855 IPs from IQ
- **`aggregated-ir-only.txt`** - 5,367 IPs from IR
- **`aggregated-it-only.txt`** - 15,685 IPs from IT
- **`aggregated-ke-only.txt`** - 3,077 IPs from KE
- **`aggregated-kr-only.txt`** - 16,260 IPs from KR
- **`aggregated-kz-only.txt`** - 2,845 IPs from KZ
- **`aggregated-lk-only.txt`** - 967 IPs from LK
- **`aggregated-ma-only.txt`** - 4,574 IPs from MA
- **`aggregated-mx-only.txt`** - 16,398 IPs from MX
- **`aggregated-my-only.txt`** - 6,062 IPs from MY
- **`aggregated-ng-only.txt`** - 1,752 IPs from NG
- **`aggregated-nl-only.txt`** - 51,504 IPs from NL
- **`aggregated-pe-only.txt`** - 2,149 IPs from PE
- **`aggregated-pk-only.txt`** - 18,418 IPs from PK
- **`aggregated-pl-only.txt`** - 9,509 IPs from PL
- **`aggregated-ro-only.txt`** - 2,584 IPs from RO
- **`aggregated-rs-only.txt`** - 1,341 IPs from RS
- **`aggregated-ru-only.txt`** - 29,308 IPs from RU
- **`aggregated-sa-only.txt`** - 4,447 IPs from SA
- **`aggregated-sg-only.txt`** - 35,787 IPs from SG
- **`aggregated-th-only.txt`** - 15,199 IPs from TH
- **`aggregated-tr-only.txt`** - 13,763 IPs from TR
- **`aggregated-tw-only.txt`** - 14,406 IPs from TW
- **`aggregated-ua-only.txt`** - 13,937 IPs from UA
- **`aggregated-us-only.txt`** - 242,466 IPs from US
- **`aggregated-ve-only.txt`** - 7,644 IPs from VE
- **`aggregated-vn-only.txt`** - 40,423 IPs from VN
- **`aggregated-za-only.txt`** - 8,914 IPs from ZA
- **`aggregated-multi-50countries-combined.txt`** - 1,156,323 unique IPs (deduplicated across all countries)
