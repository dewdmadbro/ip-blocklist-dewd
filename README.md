...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-1273257-2D56A8)
...
- **`aggregated.txt`** - 1,273,257 total aggregated IPs from all sources
- **`aggregated-ae-only.txt`** - 4,373 IPs from AE
- **`aggregated-ar-only.txt`** - 12,007 IPs from AR
- **`aggregated-au-only.txt`** - 17,002 IPs from AU
- **`aggregated-bd-only.txt`** - 8,001 IPs from BD
- **`aggregated-bg-only.txt`** - 3,068 IPs from BG
- **`aggregated-br-only.txt`** - 68,264 IPs from BR
- **`aggregated-by-only.txt`** - 753 IPs from BY
- **`aggregated-ca-only.txt`** - 26,432 IPs from CA
- **`aggregated-cl-only.txt`** - 3,693 IPs from CL
- **`aggregated-cn-only.txt`** - 172,747 IPs from CN
- **`aggregated-co-only.txt`** - 6,722 IPs from CO
- **`aggregated-cz-only.txt`** - 1,942 IPs from CZ
- **`aggregated-de-only.txt`** - 46,415 IPs from DE
- **`aggregated-dz-only.txt`** - 2,186 IPs from DZ
- **`aggregated-eg-only.txt`** - 3,684 IPs from EG
- **`aggregated-es-only.txt`** - 9,418 IPs from ES
- **`aggregated-et-only.txt`** - 1,187 IPs from ET
- **`aggregated-fr-only.txt`** - 23,728 IPs from FR
- **`aggregated-gb-only.txt`** - 32,398 IPs from GB
- **`aggregated-gh-only.txt`** - 589 IPs from GH
- **`aggregated-id-only.txt`** - 28,629 IPs from ID
- **`aggregated-in-only.txt`** - 76,742 IPs from IN
- **`aggregated-iq-only.txt`** - 2,878 IPs from IQ
- **`aggregated-ir-only.txt`** - 5,355 IPs from IR
- **`aggregated-it-only.txt`** - 15,490 IPs from IT
- **`aggregated-ke-only.txt`** - 2,972 IPs from KE
- **`aggregated-kr-only.txt`** - 15,954 IPs from KR
- **`aggregated-kz-only.txt`** - 2,700 IPs from KZ
- **`aggregated-lk-only.txt`** - 956 IPs from LK
- **`aggregated-ma-only.txt`** - 4,219 IPs from MA
- **`aggregated-mx-only.txt`** - 15,774 IPs from MX
...
- **`aggregated-pk-only.txt`** - 17,634 IPs from PK
- **`aggregated-pl-only.txt`** - 8,333 IPs from PL
- **`aggregated-ro-only.txt`** - 2,560 IPs from RO
- **`aggregated-rs-only.txt`** - 1,303 IPs from RS
- **`aggregated-ru-only.txt`** - 27,532 IPs from RU
- **`aggregated-sa-only.txt`** - 4,347 IPs from SA
- **`aggregated-sg-only.txt`** - 35,162 IPs from SG
- **`aggregated-th-only.txt`** - 15,370 IPs from TH
- **`aggregated-tr-only.txt`** - 13,774 IPs from TR
- **`aggregated-tw-only.txt`** - 13,970 IPs from TW
- **`aggregated-ua-only.txt`** - 10,032 IPs from UA
- **`aggregated-us-only.txt`** - 236,297 IPs from US
- **`aggregated-ve-only.txt`** - 7,786 IPs from VE
- **`aggregated-vn-only.txt`** - 39,961 IPs from VN
- **`aggregated-za-only.txt`** - 8,646 IPs from ZA
- **`aggregated-multi-50countries-combined.txt`** - 1,120,038 unique IPs (deduplicated across all countries)
