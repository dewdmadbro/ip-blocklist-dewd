...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-1239363-2D56A8)
...
**Last Updated:** 2026-07-16 14:31:34 UTC
...
- **Total Input IPs:** 1,239,363
- **Countries Processed:** 50
- **Combined Unique IPs:** 1,090,712
- **Combined Output File:** `aggregated-multi-50countries-combined.txt`
- **Overall Filter Rate:** 88.01%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 141,446 | 139,632 | 232,315 | 18.74% | `aggregated-us-only.txt` |
| China | CN | 7,708 | 7,707 | 166,821 | 13.46% | `aggregated-cn-only.txt` |
| India | IN | 13,129 | 13,098 | 74,656 | 6.02% | `aggregated-in-only.txt` |
| Germany | DE | 29,072 | 29,000 | 46,328 | 3.74% | `aggregated-de-only.txt` |
| Russia | RU | 13,251 | 13,011 | 26,918 | 2.17% | `aggregated-ru-only.txt` |
| United Kingdom | GB | 35,500 | 35,331 | 32,619 | 2.63% | `aggregated-gb-only.txt` |
| Thailand | TH | 1,969 | 1,969 | 14,640 | 1.18% | `aggregated-th-only.txt` |
| Vietnam | VN | 2,176 | 2,176 | 39,533 | 3.19% | `aggregated-vn-only.txt` |
| South Korea | KR | 3,887 | 3,877 | 15,739 | 1.27% | `aggregated-kr-only.txt` |
| Brazil | BR | 12,905 | 12,852 | 61,679 | 4.98% | `aggregated-br-only.txt` |
| Taiwan | TW | 2,369 | 2,369 | 13,769 | 1.11% | `aggregated-tw-only.txt` |
| Canada | CA | 16,872 | 16,752 | 25,428 | 2.05% | `aggregated-ca-only.txt` |
| Singapore | SG | 9,454 | 9,444 | 36,054 | 2.91% | `aggregated-sg-only.txt` |
| Italy | IT | 9,737 | 9,692 | 15,245 | 1.23% | `aggregated-it-only.txt` |
| Netherlands | NL | 18,713 | 18,604 | 51,502 | 4.16% | `aggregated-nl-only.txt` |
| Indonesia | ID | 6,477 | 6,451 | 27,786 | 2.24% | `aggregated-id-only.txt` |
| France | FR | 32,897 | 32,870 | 22,972 | 1.85% | `aggregated-fr-only.txt` |
| Venezuela | VE | 957 | 957 | 7,665 | 0.62% | `aggregated-ve-only.txt` |
| Australia | AU | 12,038 | 11,968 | 17,190 | 1.39% | `aggregated-au-only.txt` |
| Turkey | TR | 3,431 | 3,405 | 13,480 | 1.09% | `aggregated-tr-only.txt` |
| Ukraine | UA | 5,412 | 5,357 | 9,057 | 0.73% | `aggregated-ua-only.txt` |
| Iran | IR | 2,053 | 2,052 | 4,948 | 0.40% | `aggregated-ir-only.txt` |
| Poland | PL | 8,148 | 8,118 | 8,116 | 0.65% | `aggregated-pl-only.txt` |
| Mexico | MX | 4,422 | 4,418 | 14,836 | 1.20% | `aggregated-mx-only.txt` |
| Spain | ES | 11,002 | 10,982 | 9,095 | 0.73% | `aggregated-es-only.txt` |
| Argentina | AR | 3,428 | 3,426 | 11,667 | 0.94% | `aggregated-ar-only.txt` |
| Egypt | EG | 734 | 734 | 3,471 | 0.28% | `aggregated-eg-only.txt` |
| Pakistan | PK | 1,348 | 1,346 | 16,957 | 1.37% | `aggregated-pk-only.txt` |
| Malaysia | MY | 2,524 | 2,524 | 5,743 | 0.46% | `aggregated-my-only.txt` |
| Bulgaria | BG | 2,373 | 2,362 | 3,014 | 0.24% | `aggregated-bg-only.txt` |
| Czechia | CZ | 3,595 | 3,594 | 1,920 | 0.15% | `aggregated-cz-only.txt` |
| Colombia | CO | 2,210 | 2,210 | 6,404 | 0.52% | `aggregated-co-only.txt` |
| United Arab Emirates | AE | 3,798 | 3,798 | 4,249 | 0.34% | `aggregated-ae-only.txt` |
| Romania | RO | 4,015 | 4,007 | 2,526 | 0.20% | `aggregated-ro-only.txt` |
| Kazakhstan | KZ | 1,306 | 1,305 | 2,626 | 0.21% | `aggregated-kz-only.txt` |
| Morocco | MA | 495 | 495 | 4,167 | 0.34% | `aggregated-ma-only.txt` |
| Saudi Arabia | SA | 1,646 | 1,646 | 4,234 | 0.34% | `aggregated-sa-only.txt` |
| South Africa | ZA | 3,985 | 3,971 | 8,378 | 0.68% | `aggregated-za-only.txt` |
| Bangladesh | BD | 2,627 | 2,625 | 7,163 | 0.58% | `aggregated-bd-only.txt` |
| Chile | CL | 1,915 | 1,913 | 3,553 | 0.29% | `aggregated-cl-only.txt` |
| Nigeria | NG | 1,087 | 1,087 | 1,616 | 0.13% | `aggregated-ng-only.txt` |
| Kenya | KE | 872 | 872 | 3,051 | 0.25% | `aggregated-ke-only.txt` |
| Algeria | DZ | 219 | 219 | 2,082 | 0.17% | `aggregated-dz-only.txt` |
| Serbia | RS | 987 | 985 | 1,262 | 0.10% | `aggregated-rs-only.txt` |
| Peru | PE | 1,175 | 1,174 | 2,003 | 0.16% | `aggregated-pe-only.txt` |
| Sri Lanka | LK | 250 | 250 | 914 | 0.07% | `aggregated-lk-only.txt` |
| Iraq | IQ | 683 | 683 | 2,860 | 0.23% | `aggregated-iq-only.txt` |
| Ethiopia | ET | 97 | 97 | 1,166 | 0.09% | `aggregated-et-only.txt` |
| Ghana | GH | 343 | 343 | 563 | 0.05% | `aggregated-gh-only.txt` |
| Belarus | BY | 417 | 417 | 732 | 0.06% | `aggregated-by-only.txt` |
...
- **`aggregated.txt`** - 1,239,363 total aggregated IPs from all sources
- **`aggregated-ae-only.txt`** - 4,249 IPs from AE
- **`aggregated-ar-only.txt`** - 11,667 IPs from AR
- **`aggregated-au-only.txt`** - 17,190 IPs from AU
- **`aggregated-bd-only.txt`** - 7,163 IPs from BD
- **`aggregated-bg-only.txt`** - 3,014 IPs from BG
- **`aggregated-br-only.txt`** - 61,679 IPs from BR
- **`aggregated-by-only.txt`** - 732 IPs from BY
- **`aggregated-ca-only.txt`** - 25,428 IPs from CA
- **`aggregated-cl-only.txt`** - 3,553 IPs from CL
- **`aggregated-cn-only.txt`** - 166,821 IPs from CN
- **`aggregated-co-only.txt`** - 6,404 IPs from CO
- **`aggregated-cz-only.txt`** - 1,920 IPs from CZ
- **`aggregated-de-only.txt`** - 46,328 IPs from DE
- **`aggregated-dz-only.txt`** - 2,082 IPs from DZ
- **`aggregated-eg-only.txt`** - 3,471 IPs from EG
- **`aggregated-es-only.txt`** - 9,095 IPs from ES
- **`aggregated-et-only.txt`** - 1,166 IPs from ET
- **`aggregated-fr-only.txt`** - 22,972 IPs from FR
- **`aggregated-gb-only.txt`** - 32,619 IPs from GB
- **`aggregated-gh-only.txt`** - 563 IPs from GH
- **`aggregated-id-only.txt`** - 27,786 IPs from ID
- **`aggregated-in-only.txt`** - 74,656 IPs from IN
- **`aggregated-iq-only.txt`** - 2,860 IPs from IQ
- **`aggregated-ir-only.txt`** - 4,948 IPs from IR
- **`aggregated-it-only.txt`** - 15,245 IPs from IT
- **`aggregated-ke-only.txt`** - 3,051 IPs from KE
- **`aggregated-kr-only.txt`** - 15,739 IPs from KR
- **`aggregated-kz-only.txt`** - 2,626 IPs from KZ
- **`aggregated-lk-only.txt`** - 914 IPs from LK
- **`aggregated-ma-only.txt`** - 4,167 IPs from MA
- **`aggregated-mx-only.txt`** - 14,836 IPs from MX
- **`aggregated-my-only.txt`** - 5,743 IPs from MY
- **`aggregated-ng-only.txt`** - 1,616 IPs from NG
- **`aggregated-nl-only.txt`** - 51,502 IPs from NL
- **`aggregated-pe-only.txt`** - 2,003 IPs from PE
- **`aggregated-pk-only.txt`** - 16,957 IPs from PK
- **`aggregated-pl-only.txt`** - 8,116 IPs from PL
- **`aggregated-ro-only.txt`** - 2,526 IPs from RO
- **`aggregated-rs-only.txt`** - 1,262 IPs from RS
- **`aggregated-ru-only.txt`** - 26,918 IPs from RU
- **`aggregated-sa-only.txt`** - 4,234 IPs from SA
- **`aggregated-sg-only.txt`** - 36,054 IPs from SG
- **`aggregated-th-only.txt`** - 14,640 IPs from TH
- **`aggregated-tr-only.txt`** - 13,480 IPs from TR
- **`aggregated-tw-only.txt`** - 13,769 IPs from TW
- **`aggregated-ua-only.txt`** - 9,057 IPs from UA
- **`aggregated-us-only.txt`** - 232,315 IPs from US
- **`aggregated-ve-only.txt`** - 7,665 IPs from VE
- **`aggregated-vn-only.txt`** - 39,533 IPs from VN
- **`aggregated-za-only.txt`** - 8,378 IPs from ZA
- **`aggregated-multi-50countries-combined.txt`** - 1,090,712 unique IPs (deduplicated across all countries)
