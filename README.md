...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-1148195-2D56A8)
...
**Last Updated:** 2026-06-26 20:18:25 UTC
...
- **Total Input IPs:** 1,148,195
- **Countries Processed:** 50
- **Combined Unique IPs:** 1,013,782
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 157,756 | 155,950 | 220,995 | 19.25% | `aggregated-us-only.txt` |
| China | CN | 7,904 | 7,903 | 151,423 | 13.19% | `aggregated-cn-only.txt` |
| India | IN | 12,970 | 12,938 | 72,357 | 6.30% | `aggregated-in-only.txt` |
| Germany | DE | 28,842 | 28,762 | 44,013 | 3.83% | `aggregated-de-only.txt` |
| Russia | RU | 13,176 | 12,937 | 25,995 | 2.26% | `aggregated-ru-only.txt` |
| United Kingdom | GB | 35,639 | 35,460 | 31,541 | 2.75% | `aggregated-gb-only.txt` |
| Thailand | TH | 1,954 | 1,954 | 13,895 | 1.21% | `aggregated-th-only.txt` |
| Vietnam | VN | 2,164 | 2,164 | 35,931 | 3.13% | `aggregated-vn-only.txt` |
| South Korea | KR | 3,964 | 3,954 | 14,973 | 1.30% | `aggregated-kr-only.txt` |
| Brazil | BR | 13,475 | 13,440 | 49,103 | 4.28% | `aggregated-br-only.txt` |
| Taiwan | TW | 2,417 | 2,417 | 13,595 | 1.18% | `aggregated-tw-only.txt` |
| Canada | CA | 17,019 | 16,891 | 24,447 | 2.13% | `aggregated-ca-only.txt` |
| Singapore | SG | 9,303 | 9,293 | 35,648 | 3.10% | `aggregated-sg-only.txt` |
| Italy | IT | 9,635 | 9,611 | 14,768 | 1.29% | `aggregated-it-only.txt` |
| Netherlands | NL | 18,841 | 18,711 | 51,063 | 4.45% | `aggregated-nl-only.txt` |
| Indonesia | ID | 6,422 | 6,401 | 26,896 | 2.34% | `aggregated-id-only.txt` |
| France | FR | 32,646 | 32,619 | 21,217 | 1.85% | `aggregated-fr-only.txt` |
| Venezuela | VE | 941 | 941 | 6,795 | 0.59% | `aggregated-ve-only.txt` |
| Australia | AU | 12,040 | 11,957 | 16,745 | 1.46% | `aggregated-au-only.txt` |
| Turkey | TR | 3,403 | 3,379 | 13,147 | 1.15% | `aggregated-tr-only.txt` |
| Ukraine | UA | 5,552 | 5,497 | 8,341 | 0.73% | `aggregated-ua-only.txt` |
| Iran | IR | 2,046 | 2,045 | 4,558 | 0.40% | `aggregated-ir-only.txt` |
| Poland | PL | 8,097 | 8,063 | 7,754 | 0.68% | `aggregated-pl-only.txt` |
| Mexico | MX | 4,379 | 4,375 | 12,017 | 1.05% | `aggregated-mx-only.txt` |
| Spain | ES | 11,030 | 11,008 | 8,324 | 0.72% | `aggregated-es-only.txt` |
| Argentina | AR | 3,459 | 3,457 | 9,632 | 0.84% | `aggregated-ar-only.txt` |
| Egypt | EG | 737 | 737 | 3,094 | 0.27% | `aggregated-eg-only.txt` |
| Pakistan | PK | 1,364 | 1,362 | 15,055 | 1.31% | `aggregated-pk-only.txt` |
| Malaysia | MY | 2,530 | 2,530 | 5,552 | 0.48% | `aggregated-my-only.txt` |
| Bulgaria | BG | 2,335 | 2,324 | 2,883 | 0.25% | `aggregated-bg-only.txt` |
| Czechia | CZ | 3,623 | 3,622 | 1,737 | 0.15% | `aggregated-cz-only.txt` |
| Colombia | CO | 2,199 | 2,199 | 4,918 | 0.43% | `aggregated-co-only.txt` |
| United Arab Emirates | AE | 3,314 | 3,314 | 3,774 | 0.33% | `aggregated-ae-only.txt` |
| Romania | RO | 4,016 | 4,006 | 2,238 | 0.19% | `aggregated-ro-only.txt` |
| Kazakhstan | KZ | 1,307 | 1,306 | 2,457 | 0.21% | `aggregated-kz-only.txt` |
| Morocco | MA | 478 | 478 | 3,768 | 0.33% | `aggregated-ma-only.txt` |
| Saudi Arabia | SA | 1,634 | 1,634 | 4,117 | 0.36% | `aggregated-sa-only.txt` |
| South Africa | ZA | 3,972 | 3,958 | 6,851 | 0.60% | `aggregated-za-only.txt` |
| Bangladesh | BD | 2,623 | 2,621 | 5,793 | 0.50% | `aggregated-bd-only.txt` |
| Chile | CL | 1,898 | 1,897 | 2,701 | 0.24% | `aggregated-cl-only.txt` |
| Nigeria | NG | 1,080 | 1,080 | 1,246 | 0.11% | `aggregated-ng-only.txt` |
| Kenya | KE | 866 | 866 | 2,693 | 0.23% | `aggregated-ke-only.txt` |
| Algeria | DZ | 220 | 220 | 1,792 | 0.16% | `aggregated-dz-only.txt` |
...
| Iraq | IQ | 683 | 683 | 2,154 | 0.19% | `aggregated-iq-only.txt` |
| Ethiopia | ET | 99 | 99 | 966 | 0.08% | `aggregated-et-only.txt` |
| Ghana | GH | 340 | 340 | 522 | 0.05% | `aggregated-gh-only.txt` |
...
- **`aggregated.txt`** - 1,148,195 total aggregated IPs from all sources
- **`aggregated-ae-only.txt`** - 3,774 IPs from AE
- **`aggregated-ar-only.txt`** - 9,632 IPs from AR
- **`aggregated-au-only.txt`** - 16,745 IPs from AU
- **`aggregated-bd-only.txt`** - 5,793 IPs from BD
- **`aggregated-bg-only.txt`** - 2,883 IPs from BG
- **`aggregated-br-only.txt`** - 49,103 IPs from BR
- **`aggregated-by-only.txt`** - 678 IPs from BY
- **`aggregated-ca-only.txt`** - 24,447 IPs from CA
- **`aggregated-cl-only.txt`** - 2,701 IPs from CL
- **`aggregated-cn-only.txt`** - 151,423 IPs from CN
- **`aggregated-co-only.txt`** - 4,918 IPs from CO
- **`aggregated-cz-only.txt`** - 1,737 IPs from CZ
- **`aggregated-de-only.txt`** - 44,013 IPs from DE
- **`aggregated-dz-only.txt`** - 1,792 IPs from DZ
- **`aggregated-eg-only.txt`** - 3,094 IPs from EG
- **`aggregated-es-only.txt`** - 8,324 IPs from ES
- **`aggregated-et-only.txt`** - 966 IPs from ET
- **`aggregated-fr-only.txt`** - 21,217 IPs from FR
- **`aggregated-gb-only.txt`** - 31,541 IPs from GB
- **`aggregated-gh-only.txt`** - 522 IPs from GH
- **`aggregated-id-only.txt`** - 26,896 IPs from ID
- **`aggregated-in-only.txt`** - 72,357 IPs from IN
- **`aggregated-iq-only.txt`** - 2,154 IPs from IQ
- **`aggregated-ir-only.txt`** - 4,558 IPs from IR
- **`aggregated-it-only.txt`** - 14,768 IPs from IT
- **`aggregated-ke-only.txt`** - 2,693 IPs from KE
- **`aggregated-kr-only.txt`** - 14,973 IPs from KR
- **`aggregated-kz-only.txt`** - 2,457 IPs from KZ
- **`aggregated-lk-only.txt`** - 830 IPs from LK
- **`aggregated-ma-only.txt`** - 3,768 IPs from MA
- **`aggregated-mx-only.txt`** - 12,017 IPs from MX
- **`aggregated-my-only.txt`** - 5,552 IPs from MY
- **`aggregated-ng-only.txt`** - 1,246 IPs from NG
- **`aggregated-nl-only.txt`** - 51,063 IPs from NL
- **`aggregated-pe-only.txt`** - 1,677 IPs from PE
- **`aggregated-pk-only.txt`** - 15,055 IPs from PK
- **`aggregated-pl-only.txt`** - 7,754 IPs from PL
- **`aggregated-ro-only.txt`** - 2,238 IPs from RO
- **`aggregated-rs-only.txt`** - 1,113 IPs from RS
- **`aggregated-ru-only.txt`** - 25,995 IPs from RU
- **`aggregated-sa-only.txt`** - 4,117 IPs from SA
- **`aggregated-sg-only.txt`** - 35,648 IPs from SG
- **`aggregated-th-only.txt`** - 13,895 IPs from TH
- **`aggregated-tr-only.txt`** - 13,147 IPs from TR
- **`aggregated-tw-only.txt`** - 13,595 IPs from TW
- **`aggregated-ua-only.txt`** - 8,341 IPs from UA
- **`aggregated-us-only.txt`** - 220,995 IPs from US
- **`aggregated-ve-only.txt`** - 6,795 IPs from VE
- **`aggregated-vn-only.txt`** - 35,931 IPs from VN
- **`aggregated-za-only.txt`** - 6,851 IPs from ZA
- **`aggregated-multi-50countries-combined.txt`** - 1,013,782 unique IPs (deduplicated across all countries)
