...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-1049914-2D56A8)
...
**Last Updated:** 2026-05-15 04:21:17 UTC
...
- **Total Input IPs:** 1,049,914
- **Countries Processed:** 50
- **Combined Unique IPs:** 929,842
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 167,975 | 166,467 | 200,623 | 19.11% | `aggregated-us-only.txt` |
| China | CN | 7,573 | 7,572 | 135,254 | 12.88% | `aggregated-cn-only.txt` |
| India | IN | 12,849 | 12,821 | 65,382 | 6.23% | `aggregated-in-only.txt` |
| Germany | DE | 28,807 | 28,725 | 38,991 | 3.71% | `aggregated-de-only.txt` |
| Russia | RU | 13,075 | 12,845 | 24,995 | 2.38% | `aggregated-ru-only.txt` |
| United Kingdom | GB | 34,028 | 33,858 | 29,485 | 2.81% | `aggregated-gb-only.txt` |
| Thailand | TH | 1,943 | 1,942 | 13,557 | 1.29% | `aggregated-th-only.txt` |
| Vietnam | VN | 2,134 | 2,134 | 35,248 | 3.36% | `aggregated-vn-only.txt` |
| South Korea | KR | 3,984 | 3,974 | 14,213 | 1.35% | `aggregated-kr-only.txt` |
| Brazil | BR | 12,903 | 12,767 | 43,134 | 4.11% | `aggregated-br-only.txt` |
| Taiwan | TW | 2,418 | 2,418 | 12,963 | 1.23% | `aggregated-tw-only.txt` |
| Canada | CA | 17,039 | 16,905 | 22,421 | 2.14% | `aggregated-ca-only.txt` |
| Singapore | SG | 9,243 | 9,233 | 31,663 | 3.02% | `aggregated-sg-only.txt` |
| Italy | IT | 9,559 | 9,535 | 14,038 | 1.34% | `aggregated-it-only.txt` |
| Netherlands | NL | 18,372 | 18,250 | 50,708 | 4.83% | `aggregated-nl-only.txt` |
| Indonesia | ID | 6,412 | 6,393 | 25,254 | 2.41% | `aggregated-id-only.txt` |
| France | FR | 32,099 | 32,073 | 19,839 | 1.89% | `aggregated-fr-only.txt` |
| Venezuela | VE | 928 | 928 | 6,482 | 0.62% | `aggregated-ve-only.txt` |
| Australia | AU | 12,110 | 12,041 | 15,657 | 1.49% | `aggregated-au-only.txt` |
| Turkey | TR | 3,410 | 3,386 | 12,295 | 1.17% | `aggregated-tr-only.txt` |
| Ukraine | UA | 5,547 | 5,492 | 8,000 | 0.76% | `aggregated-ua-only.txt` |
| Iran | IR | 2,013 | 2,012 | 3,936 | 0.37% | `aggregated-ir-only.txt` |
| Poland | PL | 8,019 | 7,988 | 7,435 | 0.71% | `aggregated-pl-only.txt` |
| Mexico | MX | 4,378 | 4,374 | 10,416 | 0.99% | `aggregated-mx-only.txt` |
| Spain | ES | 10,946 | 10,915 | 7,475 | 0.71% | `aggregated-es-only.txt` |
| Argentina | AR | 3,471 | 3,469 | 8,916 | 0.85% | `aggregated-ar-only.txt` |
| Egypt | EG | 730 | 730 | 2,729 | 0.26% | `aggregated-eg-only.txt` |
| Pakistan | PK | 1,320 | 1,320 | 13,365 | 1.27% | `aggregated-pk-only.txt` |
| Malaysia | MY | 2,480 | 2,480 | 5,196 | 0.49% | `aggregated-my-only.txt` |
| Bulgaria | BG | 2,287 | 2,277 | 2,783 | 0.27% | `aggregated-bg-only.txt` |
| Czechia | CZ | 3,600 | 3,600 | 1,660 | 0.16% | `aggregated-cz-only.txt` |
| Colombia | CO | 2,222 | 2,222 | 4,440 | 0.42% | `aggregated-co-only.txt` |
| United Arab Emirates | AE | 3,232 | 3,232 | 3,375 | 0.32% | `aggregated-ae-only.txt` |
| Romania | RO | 3,917 | 3,908 | 2,071 | 0.20% | `aggregated-ro-only.txt` |
| Kazakhstan | KZ | 1,255 | 1,254 | 2,274 | 0.22% | `aggregated-kz-only.txt` |
| Morocco | MA | 478 | 478 | 3,396 | 0.32% | `aggregated-ma-only.txt` |
| Saudi Arabia | SA | 1,630 | 1,630 | 3,758 | 0.36% | `aggregated-sa-only.txt` |
| South Africa | ZA | 3,962 | 3,949 | 6,689 | 0.64% | `aggregated-za-only.txt` |
| Bangladesh | BD | 2,615 | 2,612 | 5,204 | 0.50% | `aggregated-bd-only.txt` |
| Chile | CL | 1,885 | 1,885 | 2,351 | 0.22% | `aggregated-cl-only.txt` |
...
| Peru | PE | 1,103 | 1,102 | 1,492 | 0.14% | `aggregated-pe-only.txt` |
| Sri Lanka | LK | 249 | 249 | 626 | 0.06% | `aggregated-lk-only.txt` |
| Iraq | IQ | 680 | 680 | 1,894 | 0.18% | `aggregated-iq-only.txt` |
| Ethiopia | ET | 98 | 98 | 900 | 0.09% | `aggregated-et-only.txt` |
| Ghana | GH | 342 | 342 | 498 | 0.05% | `aggregated-gh-only.txt` |
...
- **`aggregated.txt`** - 1,049,914 total aggregated IPs from all sources
- **`aggregated-ae-only.txt`** - 3,375 IPs from AE
- **`aggregated-ar-only.txt`** - 8,916 IPs from AR
- **`aggregated-au-only.txt`** - 15,657 IPs from AU
- **`aggregated-bd-only.txt`** - 5,204 IPs from BD
- **`aggregated-bg-only.txt`** - 2,783 IPs from BG
- **`aggregated-br-only.txt`** - 43,134 IPs from BR
- **`aggregated-by-only.txt`** - 678 IPs from BY
- **`aggregated-ca-only.txt`** - 22,421 IPs from CA
- **`aggregated-cl-only.txt`** - 2,351 IPs from CL
- **`aggregated-cn-only.txt`** - 135,254 IPs from CN
- **`aggregated-co-only.txt`** - 4,440 IPs from CO
- **`aggregated-cz-only.txt`** - 1,660 IPs from CZ
- **`aggregated-de-only.txt`** - 38,991 IPs from DE
- **`aggregated-dz-only.txt`** - 1,565 IPs from DZ
- **`aggregated-eg-only.txt`** - 2,729 IPs from EG
- **`aggregated-es-only.txt`** - 7,475 IPs from ES
- **`aggregated-et-only.txt`** - 900 IPs from ET
- **`aggregated-fr-only.txt`** - 19,839 IPs from FR
- **`aggregated-gb-only.txt`** - 29,485 IPs from GB
- **`aggregated-gh-only.txt`** - 498 IPs from GH
- **`aggregated-id-only.txt`** - 25,254 IPs from ID
- **`aggregated-in-only.txt`** - 65,382 IPs from IN
- **`aggregated-iq-only.txt`** - 1,894 IPs from IQ
- **`aggregated-ir-only.txt`** - 3,936 IPs from IR
- **`aggregated-it-only.txt`** - 14,038 IPs from IT
...
- **`aggregated-lk-only.txt`** - 626 IPs from LK
- **`aggregated-ma-only.txt`** - 3,396 IPs from MA
- **`aggregated-mx-only.txt`** - 10,416 IPs from MX
- **`aggregated-my-only.txt`** - 5,196 IPs from MY
- **`aggregated-ng-only.txt`** - 1,127 IPs from NG
- **`aggregated-nl-only.txt`** - 50,708 IPs from NL
- **`aggregated-pe-only.txt`** - 1,492 IPs from PE
- **`aggregated-pk-only.txt`** - 13,365 IPs from PK
- **`aggregated-pl-only.txt`** - 7,435 IPs from PL
- **`aggregated-ro-only.txt`** - 2,071 IPs from RO
- **`aggregated-rs-only.txt`** - 1,005 IPs from RS
- **`aggregated-ru-only.txt`** - 24,995 IPs from RU
- **`aggregated-sa-only.txt`** - 3,758 IPs from SA
- **`aggregated-sg-only.txt`** - 31,663 IPs from SG
- **`aggregated-th-only.txt`** - 13,557 IPs from TH
- **`aggregated-tr-only.txt`** - 12,295 IPs from TR
- **`aggregated-tw-only.txt`** - 12,963 IPs from TW
- **`aggregated-ua-only.txt`** - 8,000 IPs from UA
- **`aggregated-us-only.txt`** - 200,623 IPs from US
- **`aggregated-ve-only.txt`** - 6,482 IPs from VE
- **`aggregated-vn-only.txt`** - 35,248 IPs from VN
- **`aggregated-za-only.txt`** - 6,689 IPs from ZA
- **`aggregated-multi-50countries-combined.txt`** - 929,842 unique IPs (deduplicated across all countries)
