...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-1148686-2D56A8)
...
**Last Updated:** 2026-06-27 09:12:26 UTC
...
- **Total Input IPs:** 1,148,686
- **Countries Processed:** 50
- **Combined Unique IPs:** 1,014,199
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 157,756 | 155,950 | 220,662 | 19.21% | `aggregated-us-only.txt` |
| China | CN | 7,904 | 7,903 | 152,034 | 13.24% | `aggregated-cn-only.txt` |
| India | IN | 12,970 | 12,938 | 72,265 | 6.29% | `aggregated-in-only.txt` |
| Germany | DE | 28,842 | 28,762 | 43,858 | 3.82% | `aggregated-de-only.txt` |
| Russia | RU | 13,176 | 12,937 | 26,007 | 2.26% | `aggregated-ru-only.txt` |
| United Kingdom | GB | 35,639 | 35,460 | 31,529 | 2.74% | `aggregated-gb-only.txt` |
| Thailand | TH | 1,954 | 1,954 | 13,896 | 1.21% | `aggregated-th-only.txt` |
| Vietnam | VN | 2,164 | 2,164 | 35,963 | 3.13% | `aggregated-vn-only.txt` |
| South Korea | KR | 3,964 | 3,954 | 14,988 | 1.30% | `aggregated-kr-only.txt` |
| Brazil | BR | 13,475 | 13,440 | 49,182 | 4.28% | `aggregated-br-only.txt` |
| Taiwan | TW | 2,417 | 2,417 | 13,589 | 1.18% | `aggregated-tw-only.txt` |
| Canada | CA | 17,019 | 16,891 | 24,594 | 2.14% | `aggregated-ca-only.txt` |
| Singapore | SG | 9,303 | 9,293 | 35,670 | 3.11% | `aggregated-sg-only.txt` |
| Italy | IT | 9,635 | 9,611 | 14,763 | 1.29% | `aggregated-it-only.txt` |
| Netherlands | NL | 18,841 | 18,711 | 51,047 | 4.44% | `aggregated-nl-only.txt` |
| Indonesia | ID | 6,422 | 6,401 | 26,899 | 2.34% | `aggregated-id-only.txt` |
| France | FR | 32,646 | 32,619 | 21,248 | 1.85% | `aggregated-fr-only.txt` |
| Venezuela | VE | 941 | 941 | 6,794 | 0.59% | `aggregated-ve-only.txt` |
| Australia | AU | 12,040 | 11,957 | 16,750 | 1.46% | `aggregated-au-only.txt` |
| Turkey | TR | 3,403 | 3,379 | 13,153 | 1.15% | `aggregated-tr-only.txt` |
...
| Mexico | MX | 4,379 | 4,375 | 12,046 | 1.05% | `aggregated-mx-only.txt` |
| Spain | ES | 11,030 | 11,008 | 8,352 | 0.73% | `aggregated-es-only.txt` |
| Argentina | AR | 3,459 | 3,457 | 9,641 | 0.84% | `aggregated-ar-only.txt` |
| Egypt | EG | 737 | 737 | 3,097 | 0.27% | `aggregated-eg-only.txt` |
| Pakistan | PK | 1,364 | 1,362 | 15,072 | 1.31% | `aggregated-pk-only.txt` |
| Malaysia | MY | 2,530 | 2,530 | 5,547 | 0.48% | `aggregated-my-only.txt` |
| Bulgaria | BG | 2,335 | 2,324 | 2,885 | 0.25% | `aggregated-bg-only.txt` |
| Czechia | CZ | 3,623 | 3,622 | 1,738 | 0.15% | `aggregated-cz-only.txt` |
| Colombia | CO | 2,199 | 2,199 | 4,932 | 0.43% | `aggregated-co-only.txt` |
| United Arab Emirates | AE | 3,314 | 3,314 | 3,781 | 0.33% | `aggregated-ae-only.txt` |
| Romania | RO | 4,016 | 4,006 | 2,244 | 0.20% | `aggregated-ro-only.txt` |
| Kazakhstan | KZ | 1,307 | 1,306 | 2,463 | 0.21% | `aggregated-kz-only.txt` |
| Morocco | MA | 478 | 478 | 3,769 | 0.33% | `aggregated-ma-only.txt` |
| Saudi Arabia | SA | 1,634 | 1,634 | 4,115 | 0.36% | `aggregated-sa-only.txt` |
| South Africa | ZA | 3,972 | 3,958 | 6,842 | 0.60% | `aggregated-za-only.txt` |
| Bangladesh | BD | 2,623 | 2,621 | 5,794 | 0.50% | `aggregated-bd-only.txt` |
| Chile | CL | 1,898 | 1,897 | 2,702 | 0.24% | `aggregated-cl-only.txt` |
| Nigeria | NG | 1,080 | 1,080 | 1,240 | 0.11% | `aggregated-ng-only.txt` |
| Kenya | KE | 866 | 866 | 2,690 | 0.23% | `aggregated-ke-only.txt` |
| Algeria | DZ | 220 | 220 | 1,788 | 0.16% | `aggregated-dz-only.txt` |
...
| Iraq | IQ | 683 | 683 | 2,165 | 0.19% | `aggregated-iq-only.txt` |
...
- **`aggregated.txt`** - 1,148,686 total aggregated IPs from all sources
- **`aggregated-ae-only.txt`** - 3,781 IPs from AE
- **`aggregated-ar-only.txt`** - 9,641 IPs from AR
- **`aggregated-au-only.txt`** - 16,750 IPs from AU
- **`aggregated-bd-only.txt`** - 5,794 IPs from BD
- **`aggregated-bg-only.txt`** - 2,885 IPs from BG
- **`aggregated-br-only.txt`** - 49,182 IPs from BR
- **`aggregated-by-only.txt`** - 677 IPs from BY
- **`aggregated-ca-only.txt`** - 24,594 IPs from CA
- **`aggregated-cl-only.txt`** - 2,702 IPs from CL
- **`aggregated-cn-only.txt`** - 152,034 IPs from CN
- **`aggregated-co-only.txt`** - 4,932 IPs from CO
- **`aggregated-cz-only.txt`** - 1,738 IPs from CZ
- **`aggregated-de-only.txt`** - 43,858 IPs from DE
- **`aggregated-dz-only.txt`** - 1,788 IPs from DZ
- **`aggregated-eg-only.txt`** - 3,097 IPs from EG
- **`aggregated-es-only.txt`** - 8,352 IPs from ES
- **`aggregated-et-only.txt`** - 962 IPs from ET
- **`aggregated-fr-only.txt`** - 21,248 IPs from FR
- **`aggregated-gb-only.txt`** - 31,529 IPs from GB
- **`aggregated-gh-only.txt`** - 527 IPs from GH
- **`aggregated-id-only.txt`** - 26,899 IPs from ID
- **`aggregated-in-only.txt`** - 72,265 IPs from IN
- **`aggregated-iq-only.txt`** - 2,165 IPs from IQ
- **`aggregated-ir-only.txt`** - 4,558 IPs from IR
- **`aggregated-it-only.txt`** - 14,763 IPs from IT
- **`aggregated-ke-only.txt`** - 2,690 IPs from KE
- **`aggregated-kr-only.txt`** - 14,988 IPs from KR
- **`aggregated-kz-only.txt`** - 2,463 IPs from KZ
- **`aggregated-lk-only.txt`** - 819 IPs from LK
- **`aggregated-ma-only.txt`** - 3,769 IPs from MA
- **`aggregated-mx-only.txt`** - 12,046 IPs from MX
- **`aggregated-my-only.txt`** - 5,547 IPs from MY
- **`aggregated-ng-only.txt`** - 1,240 IPs from NG
- **`aggregated-nl-only.txt`** - 51,047 IPs from NL
- **`aggregated-pe-only.txt`** - 1,675 IPs from PE
- **`aggregated-pk-only.txt`** - 15,072 IPs from PK
- **`aggregated-pl-only.txt`** - 7,754 IPs from PL
- **`aggregated-ro-only.txt`** - 2,244 IPs from RO
- **`aggregated-rs-only.txt`** - 1,112 IPs from RS
- **`aggregated-ru-only.txt`** - 26,007 IPs from RU
- **`aggregated-sa-only.txt`** - 4,115 IPs from SA
- **`aggregated-sg-only.txt`** - 35,670 IPs from SG
- **`aggregated-th-only.txt`** - 13,896 IPs from TH
- **`aggregated-tr-only.txt`** - 13,153 IPs from TR
- **`aggregated-tw-only.txt`** - 13,589 IPs from TW
- **`aggregated-ua-only.txt`** - 8,321 IPs from UA
- **`aggregated-us-only.txt`** - 220,662 IPs from US
- **`aggregated-ve-only.txt`** - 6,794 IPs from VE
- **`aggregated-vn-only.txt`** - 35,963 IPs from VN
- **`aggregated-za-only.txt`** - 6,842 IPs from ZA
- **`aggregated-multi-50countries-combined.txt`** - 1,014,199 unique IPs (deduplicated across all countries)
