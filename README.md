...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-1134605-2D56A8)
...
**Last Updated:** 2026-06-21 20:11:40 UTC
...
- **Total Input IPs:** 1,134,605
- **Countries Processed:** 50
- **Combined Unique IPs:** 1,001,925
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 157,756 | 155,950 | 219,770 | 19.37% | `aggregated-us-only.txt` |
| China | CN | 7,904 | 7,903 | 144,874 | 12.77% | `aggregated-cn-only.txt` |
| India | IN | 12,970 | 12,938 | 71,741 | 6.32% | `aggregated-in-only.txt` |
| Germany | DE | 28,842 | 28,762 | 43,961 | 3.87% | `aggregated-de-only.txt` |
| Russia | RU | 13,176 | 12,937 | 25,913 | 2.28% | `aggregated-ru-only.txt` |
| United Kingdom | GB | 35,639 | 35,460 | 31,520 | 2.78% | `aggregated-gb-only.txt` |
| Thailand | TH | 1,954 | 1,954 | 13,901 | 1.23% | `aggregated-th-only.txt` |
| Vietnam | VN | 2,164 | 2,164 | 35,609 | 3.14% | `aggregated-vn-only.txt` |
| South Korea | KR | 3,964 | 3,954 | 14,855 | 1.31% | `aggregated-kr-only.txt` |
| Brazil | BR | 13,475 | 13,440 | 48,480 | 4.27% | `aggregated-br-only.txt` |
| Taiwan | TW | 2,417 | 2,417 | 13,555 | 1.19% | `aggregated-tw-only.txt` |
| Canada | CA | 17,019 | 16,891 | 24,523 | 2.16% | `aggregated-ca-only.txt` |
| Singapore | SG | 9,303 | 9,293 | 35,360 | 3.12% | `aggregated-sg-only.txt` |
| Italy | IT | 9,635 | 9,611 | 14,693 | 1.29% | `aggregated-it-only.txt` |
| Netherlands | NL | 18,841 | 18,711 | 51,104 | 4.50% | `aggregated-nl-only.txt` |
| Indonesia | ID | 6,422 | 6,401 | 26,713 | 2.35% | `aggregated-id-only.txt` |
| France | FR | 32,646 | 32,619 | 20,967 | 1.85% | `aggregated-fr-only.txt` |
| Venezuela | VE | 941 | 941 | 6,767 | 0.60% | `aggregated-ve-only.txt` |
| Australia | AU | 12,040 | 11,957 | 16,761 | 1.48% | `aggregated-au-only.txt` |
| Turkey | TR | 3,403 | 3,379 | 13,074 | 1.15% | `aggregated-tr-only.txt` |
| Ukraine | UA | 5,552 | 5,497 | 8,297 | 0.73% | `aggregated-ua-only.txt` |
| Iran | IR | 2,046 | 2,045 | 4,559 | 0.40% | `aggregated-ir-only.txt` |
| Poland | PL | 8,097 | 8,063 | 7,622 | 0.67% | `aggregated-pl-only.txt` |
| Mexico | MX | 4,379 | 4,375 | 11,834 | 1.04% | `aggregated-mx-only.txt` |
| Spain | ES | 11,030 | 11,008 | 8,228 | 0.73% | `aggregated-es-only.txt` |
| Argentina | AR | 3,459 | 3,457 | 9,541 | 0.84% | `aggregated-ar-only.txt` |
| Egypt | EG | 737 | 737 | 3,080 | 0.27% | `aggregated-eg-only.txt` |
| Pakistan | PK | 1,364 | 1,362 | 14,867 | 1.31% | `aggregated-pk-only.txt` |
| Malaysia | MY | 2,530 | 2,530 | 5,488 | 0.48% | `aggregated-my-only.txt` |
...
| Romania | RO | 4,016 | 4,006 | 2,209 | 0.19% | `aggregated-ro-only.txt` |
| Kazakhstan | KZ | 1,307 | 1,306 | 2,469 | 0.22% | `aggregated-kz-only.txt` |
| Morocco | MA | 478 | 478 | 3,689 | 0.33% | `aggregated-ma-only.txt` |
| Saudi Arabia | SA | 1,634 | 1,634 | 4,069 | 0.36% | `aggregated-sa-only.txt` |
| South Africa | ZA | 3,972 | 3,958 | 6,832 | 0.60% | `aggregated-za-only.txt` |
| Bangladesh | BD | 2,623 | 2,621 | 5,659 | 0.50% | `aggregated-bd-only.txt` |
| Chile | CL | 1,898 | 1,897 | 2,665 | 0.23% | `aggregated-cl-only.txt` |
| Nigeria | NG | 1,080 | 1,080 | 1,244 | 0.11% | `aggregated-ng-only.txt` |
| Kenya | KE | 866 | 866 | 2,668 | 0.24% | `aggregated-ke-only.txt` |
| Algeria | DZ | 220 | 220 | 1,782 | 0.16% | `aggregated-dz-only.txt` |
| Serbia | RS | 960 | 958 | 1,102 | 0.10% | `aggregated-rs-only.txt` |
| Peru | PE | 1,105 | 1,104 | 1,644 | 0.14% | `aggregated-pe-only.txt` |
| Sri Lanka | LK | 250 | 250 | 806 | 0.07% | `aggregated-lk-only.txt` |
| Iraq | IQ | 683 | 683 | 2,105 | 0.19% | `aggregated-iq-only.txt` |
...
- **`aggregated.txt`** - 1,134,605 total aggregated IPs from all sources
- **`aggregated-ae-only.txt`** - 3,735 IPs from AE
- **`aggregated-ar-only.txt`** - 9,541 IPs from AR
- **`aggregated-au-only.txt`** - 16,761 IPs from AU
- **`aggregated-bd-only.txt`** - 5,659 IPs from BD
- **`aggregated-bg-only.txt`** - 2,867 IPs from BG
- **`aggregated-br-only.txt`** - 48,480 IPs from BR
- **`aggregated-by-only.txt`** - 667 IPs from BY
- **`aggregated-ca-only.txt`** - 24,523 IPs from CA
- **`aggregated-cl-only.txt`** - 2,665 IPs from CL
- **`aggregated-cn-only.txt`** - 144,874 IPs from CN
- **`aggregated-co-only.txt`** - 4,839 IPs from CO
- **`aggregated-cz-only.txt`** - 1,742 IPs from CZ
- **`aggregated-de-only.txt`** - 43,961 IPs from DE
- **`aggregated-dz-only.txt`** - 1,782 IPs from DZ
- **`aggregated-eg-only.txt`** - 3,080 IPs from EG
- **`aggregated-es-only.txt`** - 8,228 IPs from ES
- **`aggregated-et-only.txt`** - 951 IPs from ET
- **`aggregated-fr-only.txt`** - 20,967 IPs from FR
- **`aggregated-gb-only.txt`** - 31,520 IPs from GB
- **`aggregated-gh-only.txt`** - 524 IPs from GH
- **`aggregated-id-only.txt`** - 26,713 IPs from ID
- **`aggregated-in-only.txt`** - 71,741 IPs from IN
- **`aggregated-iq-only.txt`** - 2,105 IPs from IQ
- **`aggregated-ir-only.txt`** - 4,559 IPs from IR
- **`aggregated-it-only.txt`** - 14,693 IPs from IT
- **`aggregated-ke-only.txt`** - 2,668 IPs from KE
- **`aggregated-kr-only.txt`** - 14,855 IPs from KR
- **`aggregated-kz-only.txt`** - 2,469 IPs from KZ
- **`aggregated-lk-only.txt`** - 806 IPs from LK
- **`aggregated-ma-only.txt`** - 3,689 IPs from MA
- **`aggregated-mx-only.txt`** - 11,834 IPs from MX
- **`aggregated-my-only.txt`** - 5,488 IPs from MY
- **`aggregated-ng-only.txt`** - 1,244 IPs from NG
- **`aggregated-nl-only.txt`** - 51,104 IPs from NL
- **`aggregated-pe-only.txt`** - 1,644 IPs from PE
- **`aggregated-pk-only.txt`** - 14,867 IPs from PK
- **`aggregated-pl-only.txt`** - 7,622 IPs from PL
...
- **`aggregated-sa-only.txt`** - 4,069 IPs from SA
- **`aggregated-sg-only.txt`** - 35,360 IPs from SG
- **`aggregated-th-only.txt`** - 13,901 IPs from TH
- **`aggregated-tr-only.txt`** - 13,074 IPs from TR
- **`aggregated-tw-only.txt`** - 13,555 IPs from TW
- **`aggregated-ua-only.txt`** - 8,297 IPs from UA
- **`aggregated-us-only.txt`** - 219,770 IPs from US
- **`aggregated-ve-only.txt`** - 6,767 IPs from VE
- **`aggregated-vn-only.txt`** - 35,609 IPs from VN
- **`aggregated-za-only.txt`** - 6,832 IPs from ZA
- **`aggregated-multi-50countries-combined.txt`** - 1,001,925 unique IPs (deduplicated across all countries)
