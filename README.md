...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-2037356-2D56A8)
...
- **`aggregated.txt`** - 2,037,356 total aggregated IPs from all sources
- **`aggregated-ae-only.txt`** - 8,185 IPs from AE
- **`aggregated-ar-only.txt`** - 35,029 IPs from AR
- **`aggregated-au-only.txt`** - 20,773 IPs from AU
- **`aggregated-bd-only.txt`** - 17,844 IPs from BD
- **`aggregated-bg-only.txt`** - 4,350 IPs from BG
- **`aggregated-br-only.txt`** - 125,964 IPs from BR
- **`aggregated-by-only.txt`** - 2,242 IPs from BY
- **`aggregated-ca-only.txt`** - 35,353 IPs from CA
- **`aggregated-cl-only.txt`** - 12,265 IPs from CL
- **`aggregated-cn-only.txt`** - 262,817 IPs from CN
- **`aggregated-co-only.txt`** - 14,722 IPs from CO
- **`aggregated-cz-only.txt`** - 3,104 IPs from CZ
- **`aggregated-de-only.txt`** - 58,011 IPs from DE
- **`aggregated-dz-only.txt`** - 4,902 IPs from DZ
- **`aggregated-eg-only.txt`** - 6,907 IPs from EG
- **`aggregated-es-only.txt`** - 18,299 IPs from ES
- **`aggregated-et-only.txt`** - 2,634 IPs from ET
- **`aggregated-fr-only.txt`** - 36,367 IPs from FR
- **`aggregated-gb-only.txt`** - 46,938 IPs from GB
- **`aggregated-gh-only.txt`** - 944 IPs from GH
- **`aggregated-id-only.txt`** - 41,885 IPs from ID
- **`aggregated-in-only.txt`** - 100,668 IPs from IN
- **`aggregated-iq-only.txt`** - 7,924 IPs from IQ
- **`aggregated-ir-only.txt`** - 7,356 IPs from IR
- **`aggregated-it-only.txt`** - 23,160 IPs from IT
- **`aggregated-ke-only.txt`** - 5,577 IPs from KE
- **`aggregated-kr-only.txt`** - 22,700 IPs from KR
- **`aggregated-kz-only.txt`** - 6,794 IPs from KZ
- **`aggregated-lk-only.txt`** - 1,324 IPs from LK
- **`aggregated-ma-only.txt`** - 10,673 IPs from MA
- **`aggregated-mx-only.txt`** - 29,062 IPs from MX
- **`aggregated-my-only.txt`** - 9,384 IPs from MY
- **`aggregated-ng-only.txt`** - 3,368 IPs from NG
- **`aggregated-nl-only.txt`** - 58,548 IPs from NL
- **`aggregated-pe-only.txt`** - 4,101 IPs from PE
- **`aggregated-pk-only.txt`** - 29,797 IPs from PK
- **`aggregated-pl-only.txt`** - 12,275 IPs from PL
- **`aggregated-ro-only.txt`** - 4,201 IPs from RO
- **`aggregated-rs-only.txt`** - 2,422 IPs from RS
- **`aggregated-ru-only.txt`** - 46,881 IPs from RU
- **`aggregated-sa-only.txt`** - 9,841 IPs from SA
- **`aggregated-sg-only.txt`** - 49,511 IPs from SG
- **`aggregated-th-only.txt`** - 20,280 IPs from TH
- **`aggregated-tr-only.txt`** - 24,063 IPs from TR
- **`aggregated-tw-only.txt`** - 21,438 IPs from TW
- **`aggregated-ua-only.txt`** - 26,047 IPs from UA
- **`aggregated-us-only.txt`** - 388,137 IPs from US
- **`aggregated-ve-only.txt`** - 13,593 IPs from VE
- **`aggregated-vn-only.txt`** - 49,948 IPs from VN
- **`aggregated-za-only.txt`** - 15,751 IPs from ZA
- **`aggregated-multi-50countries-combined.txt`** - 1,764,359 unique IPs (deduplicated across all countries)
