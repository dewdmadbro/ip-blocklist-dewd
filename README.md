...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-974157-2D56A8)
...
- **`aggregated.txt`** - 974,157 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 15,710 IPs from AU
- **`aggregated-ca-only.txt`** - 22,068 IPs from CA
- **`aggregated-de-only.txt`** - 39,931 IPs from DE
- **`aggregated-es-only.txt`** - 6,806 IPs from ES
- **`aggregated-fr-only.txt`** - 19,195 IPs from FR
- **`aggregated-gb-only.txt`** - 28,341 IPs from GB
- **`aggregated-it-only.txt`** - 14,029 IPs from IT
- **`aggregated-jp-only.txt`** - 13,302 IPs from JP
- **`aggregated-kr-only.txt`** - 13,820 IPs from KR
- **`aggregated-mx-only.txt`** - 11,774 IPs from MX
- **`aggregated-nl-only.txt`** - 48,738 IPs from NL
- **`aggregated-sg-only.txt`** - 35,655 IPs from SG
- **`aggregated-us-only.txt`** - 162,742 IPs from US
- **`aggregated-multi-14countries-combined.txt`** - 432,111 unique IPs (deduplicated across all countries)
