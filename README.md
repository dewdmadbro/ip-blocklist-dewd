...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-1855978-2D56A8)
...
- **`aggregated.txt`** - 1,855,978 total aggregated IPs from all sources
- **`aggregated-ae-only.txt`** - 7,016 IPs from AE
- **`aggregated-ar-only.txt`** - 29,322 IPs from AR
- **`aggregated-au-only.txt`** - 19,741 IPs from AU
- **`aggregated-bd-only.txt`** - 13,431 IPs from BD
- **`aggregated-bg-only.txt`** - 4,011 IPs from BG
- **`aggregated-br-only.txt`** - 114,051 IPs from BR
- **`aggregated-by-only.txt`** - 1,740 IPs from BY
- **`aggregated-ca-only.txt`** - 34,314 IPs from CA
- **`aggregated-cl-only.txt`** - 9,838 IPs from CL
- **`aggregated-cn-only.txt`** - 249,770 IPs from CN
- **`aggregated-co-only.txt`** - 12,471 IPs from CO
- **`aggregated-cz-only.txt`** - 2,790 IPs from CZ
- **`aggregated-de-only.txt`** - 53,023 IPs from DE
- **`aggregated-dz-only.txt`** - 3,965 IPs from DZ
- **`aggregated-eg-only.txt`** - 5,973 IPs from EG
- **`aggregated-es-only.txt`** - 15,907 IPs from ES
- **`aggregated-et-only.txt`** - 2,088 IPs from ET
- **`aggregated-fr-only.txt`** - 33,502 IPs from FR
- **`aggregated-gb-only.txt`** - 43,138 IPs from GB
- **`aggregated-gh-only.txt`** - 877 IPs from GH
- **`aggregated-id-only.txt`** - 38,992 IPs from ID
- **`aggregated-in-only.txt`** - 95,110 IPs from IN
- **`aggregated-iq-only.txt`** - 5,598 IPs from IQ
- **`aggregated-ir-only.txt`** - 6,777 IPs from IR
- **`aggregated-it-only.txt`** - 21,153 IPs from IT
- **`aggregated-ke-only.txt`** - 4,832 IPs from KE
- **`aggregated-kr-only.txt`** - 20,635 IPs from KR
- **`aggregated-kz-only.txt`** - 5,254 IPs from KZ
- **`aggregated-lk-only.txt`** - 1,235 IPs from LK
- **`aggregated-ma-only.txt`** - 8,615 IPs from MA
- **`aggregated-mx-only.txt`** - 25,539 IPs from MX
- **`aggregated-my-only.txt`** - 8,361 IPs from MY
- **`aggregated-ng-only.txt`** - 2,788 IPs from NG
- **`aggregated-nl-only.txt`** - 56,279 IPs from NL
- **`aggregated-pe-only.txt`** - 3,335 IPs from PE
- **`aggregated-pk-only.txt`** - 25,727 IPs from PK
- **`aggregated-pl-only.txt`** - 10,999 IPs from PL
- **`aggregated-ro-only.txt`** - 3,456 IPs from RO
- **`aggregated-rs-only.txt`** - 2,090 IPs from RS
- **`aggregated-ru-only.txt`** - 41,674 IPs from RU
- **`aggregated-sa-only.txt`** - 8,447 IPs from SA
- **`aggregated-sg-only.txt`** - 46,109 IPs from SG
- **`aggregated-th-only.txt`** - 18,495 IPs from TH
- **`aggregated-tr-only.txt`** - 22,057 IPs from TR
- **`aggregated-tw-only.txt`** - 19,866 IPs from TW
- **`aggregated-ua-only.txt`** - 23,191 IPs from UA
- **`aggregated-us-only.txt`** - 358,123 IPs from US
- **`aggregated-ve-only.txt`** - 11,582 IPs from VE
- **`aggregated-vn-only.txt`** - 46,091 IPs from VN
- **`aggregated-za-only.txt`** - 13,497 IPs from ZA
- **`aggregated-multi-50countries-combined.txt`** - 1,612,875 unique IPs (deduplicated across all countries)
