...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-1294801-2D56A8)
...
**Last Updated:** 2026-08-04 03:48:41 UTC
...
- **Total Input IPs:** 1,294,801
- **Countries Processed:** 50
- **Combined Unique IPs:** 1,139,247
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 134,012 | 132,160 | 240,909 | 18.61% | `aggregated-us-only.txt` |
| China | CN | 7,796 | 7,795 | 177,532 | 13.71% | `aggregated-cn-only.txt` |
| India | IN | 13,207 | 13,176 | 77,838 | 6.01% | `aggregated-in-only.txt` |
| Germany | DE | 29,310 | 29,243 | 45,403 | 3.51% | `aggregated-de-only.txt` |
| Russia | RU | 13,276 | 13,041 | 28,515 | 2.20% | `aggregated-ru-only.txt` |
| United Kingdom | GB | 35,276 | 35,129 | 32,352 | 2.50% | `aggregated-gb-only.txt` |
| Thailand | TH | 1,988 | 1,988 | 15,160 | 1.17% | `aggregated-th-only.txt` |
| Vietnam | VN | 2,198 | 2,198 | 40,513 | 3.13% | `aggregated-vn-only.txt` |
| South Korea | KR | 3,919 | 3,909 | 16,198 | 1.25% | `aggregated-kr-only.txt` |
| Brazil | BR | 13,022 | 12,974 | 72,585 | 5.61% | `aggregated-br-only.txt` |
| Taiwan | TW | 2,402 | 2,402 | 14,344 | 1.11% | `aggregated-tw-only.txt` |
| Canada | CA | 17,066 | 16,942 | 25,821 | 1.99% | `aggregated-ca-only.txt` |
| Singapore | SG | 9,488 | 9,478 | 35,493 | 2.74% | `aggregated-sg-only.txt` |
| Italy | IT | 9,749 | 9,725 | 15,618 | 1.21% | `aggregated-it-only.txt` |
| Netherlands | NL | 18,927 | 18,806 | 51,374 | 3.97% | `aggregated-nl-only.txt` |
| Indonesia | ID | 6,554 | 6,527 | 28,998 | 2.24% | `aggregated-id-only.txt` |
| France | FR | 33,667 | 33,640 | 24,014 | 1.85% | `aggregated-fr-only.txt` |
| Venezuela | VE | 959 | 959 | 7,558 | 0.58% | `aggregated-ve-only.txt` |
| Australia | AU | 12,122 | 12,050 | 17,196 | 1.33% | `aggregated-au-only.txt` |
| Turkey | TR | 3,458 | 3,440 | 13,698 | 1.06% | `aggregated-tr-only.txt` |
| Ukraine | UA | 5,577 | 5,521 | 11,898 | 0.92% | `aggregated-ua-only.txt` |
| Iran | IR | 2,049 | 2,048 | 5,335 | 0.41% | `aggregated-ir-only.txt` |
| Poland | PL | 8,199 | 8,166 | 8,830 | 0.68% | `aggregated-pl-only.txt` |
| Mexico | MX | 4,479 | 4,475 | 16,095 | 1.24% | `aggregated-mx-only.txt` |
| Spain | ES | 11,287 | 11,268 | 9,654 | 0.75% | `aggregated-es-only.txt` |
| Argentina | AR | 3,455 | 3,453 | 11,820 | 0.91% | `aggregated-ar-only.txt` |
| Egypt | EG | 730 | 730 | 3,800 | 0.29% | `aggregated-eg-only.txt` |
| Pakistan | PK | 1,358 | 1,356 | 18,155 | 1.40% | `aggregated-pk-only.txt` |
| Malaysia | MY | 2,581 | 2,581 | 5,941 | 0.46% | `aggregated-my-only.txt` |
| Bulgaria | BG | 2,367 | 2,356 | 3,100 | 0.24% | `aggregated-bg-only.txt` |
| Czechia | CZ | 3,612 | 3,611 | 1,934 | 0.15% | `aggregated-cz-only.txt` |
| Colombia | CO | 2,222 | 2,222 | 6,583 | 0.51% | `aggregated-co-only.txt` |
| United Arab Emirates | AE | 3,828 | 3,828 | 4,475 | 0.35% | `aggregated-ae-only.txt` |
| Romania | RO | 4,008 | 3,999 | 2,585 | 0.20% | `aggregated-ro-only.txt` |
| Kazakhstan | KZ | 1,317 | 1,316 | 2,797 | 0.22% | `aggregated-kz-only.txt` |
| Morocco | MA | 494 | 494 | 4,246 | 0.33% | `aggregated-ma-only.txt` |
| Saudi Arabia | SA | 1,687 | 1,687 | 4,334 | 0.33% | `aggregated-sa-only.txt` |
| South Africa | ZA | 4,019 | 4,005 | 8,653 | 0.67% | `aggregated-za-only.txt` |
| Bangladesh | BD | 2,625 | 2,623 | 7,455 | 0.58% | `aggregated-bd-only.txt` |
| Chile | CL | 1,984 | 1,982 | 3,803 | 0.29% | `aggregated-cl-only.txt` |
| Nigeria | NG | 1,095 | 1,095 | 1,753 | 0.14% | `aggregated-ng-only.txt` |
| Kenya | KE | 874 | 874 | 3,000 | 0.23% | `aggregated-ke-only.txt` |
| Algeria | DZ | 219 | 219 | 2,200 | 0.17% | `aggregated-dz-only.txt` |
| Serbia | RS | 999 | 997 | 1,328 | 0.10% | `aggregated-rs-only.txt` |
| Peru | PE | 1,123 | 1,122 | 2,108 | 0.16% | `aggregated-pe-only.txt` |
| Sri Lanka | LK | 249 | 249 | 976 | 0.08% | `aggregated-lk-only.txt` |
| Iraq | IQ | 682 | 682 | 2,720 | 0.21% | `aggregated-iq-only.txt` |
...
- **`aggregated.txt`** - 1,294,801 total aggregated IPs from all sources
- **`aggregated-ae-only.txt`** - 4,475 IPs from AE
- **`aggregated-ar-only.txt`** - 11,820 IPs from AR
- **`aggregated-au-only.txt`** - 17,196 IPs from AU
- **`aggregated-bd-only.txt`** - 7,455 IPs from BD
- **`aggregated-bg-only.txt`** - 3,100 IPs from BG
- **`aggregated-br-only.txt`** - 72,585 IPs from BR
- **`aggregated-by-only.txt`** - 782 IPs from BY
- **`aggregated-ca-only.txt`** - 25,821 IPs from CA
- **`aggregated-cl-only.txt`** - 3,803 IPs from CL
- **`aggregated-cn-only.txt`** - 177,532 IPs from CN
- **`aggregated-co-only.txt`** - 6,583 IPs from CO
- **`aggregated-cz-only.txt`** - 1,934 IPs from CZ
- **`aggregated-de-only.txt`** - 45,403 IPs from DE
- **`aggregated-dz-only.txt`** - 2,200 IPs from DZ
- **`aggregated-eg-only.txt`** - 3,800 IPs from EG
- **`aggregated-es-only.txt`** - 9,654 IPs from ES
- **`aggregated-et-only.txt`** - 1,156 IPs from ET
- **`aggregated-fr-only.txt`** - 24,014 IPs from FR
- **`aggregated-gb-only.txt`** - 32,352 IPs from GB
- **`aggregated-gh-only.txt`** - 612 IPs from GH
- **`aggregated-id-only.txt`** - 28,998 IPs from ID
- **`aggregated-in-only.txt`** - 77,838 IPs from IN
- **`aggregated-iq-only.txt`** - 2,720 IPs from IQ
- **`aggregated-ir-only.txt`** - 5,335 IPs from IR
- **`aggregated-it-only.txt`** - 15,618 IPs from IT
- **`aggregated-ke-only.txt`** - 3,000 IPs from KE
- **`aggregated-kr-only.txt`** - 16,198 IPs from KR
- **`aggregated-kz-only.txt`** - 2,797 IPs from KZ
- **`aggregated-lk-only.txt`** - 976 IPs from LK
- **`aggregated-ma-only.txt`** - 4,246 IPs from MA
- **`aggregated-mx-only.txt`** - 16,095 IPs from MX
- **`aggregated-my-only.txt`** - 5,941 IPs from MY
- **`aggregated-ng-only.txt`** - 1,753 IPs from NG
- **`aggregated-nl-only.txt`** - 51,374 IPs from NL
- **`aggregated-pe-only.txt`** - 2,108 IPs from PE
- **`aggregated-pk-only.txt`** - 18,155 IPs from PK
- **`aggregated-pl-only.txt`** - 8,830 IPs from PL
- **`aggregated-ro-only.txt`** - 2,585 IPs from RO
- **`aggregated-rs-only.txt`** - 1,328 IPs from RS
- **`aggregated-ru-only.txt`** - 28,515 IPs from RU
- **`aggregated-sa-only.txt`** - 4,334 IPs from SA
- **`aggregated-sg-only.txt`** - 35,493 IPs from SG
- **`aggregated-th-only.txt`** - 15,160 IPs from TH
- **`aggregated-tr-only.txt`** - 13,698 IPs from TR
- **`aggregated-tw-only.txt`** - 14,344 IPs from TW
- **`aggregated-ua-only.txt`** - 11,898 IPs from UA
- **`aggregated-us-only.txt`** - 240,909 IPs from US
- **`aggregated-ve-only.txt`** - 7,558 IPs from VE
- **`aggregated-vn-only.txt`** - 40,513 IPs from VN
- **`aggregated-za-only.txt`** - 8,653 IPs from ZA
- **`aggregated-multi-50countries-combined.txt`** - 1,139,247 unique IPs (deduplicated across all countries)
