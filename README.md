...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-1687527-2D56A8)
...
**Last Updated:** 2026-09-12 04:49:50 UTC
...
- **Total Input IPs:** 1,687,527
- **Countries Processed:** 50
- **Combined Unique IPs:** 1,480,585
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 130,282 | 128,440 | 324,612 | 19.24% | `aggregated-us-only.txt` |
| China | CN | 7,830 | 7,829 | 237,552 | 14.08% | `aggregated-cn-only.txt` |
| India | IN | 13,289 | 13,260 | 89,530 | 5.31% | `aggregated-in-only.txt` |
| Germany | DE | 29,980 | 29,865 | 49,614 | 2.94% | `aggregated-de-only.txt` |
| Russia | RU | 13,215 | 12,981 | 37,657 | 2.23% | `aggregated-ru-only.txt` |
| United Kingdom | GB | 35,923 | 35,760 | 39,690 | 2.35% | `aggregated-gb-only.txt` |
| Thailand | TH | 2,062 | 2,062 | 17,315 | 1.03% | `aggregated-th-only.txt` |
| Vietnam | VN | 2,222 | 2,222 | 42,812 | 2.54% | `aggregated-vn-only.txt` |
| South Korea | KR | 3,943 | 3,932 | 18,914 | 1.12% | `aggregated-kr-only.txt` |
| Brazil | BR | 12,586 | 12,544 | 103,865 | 6.15% | `aggregated-br-only.txt` |
| Taiwan | TW | 2,411 | 2,411 | 18,283 | 1.08% | `aggregated-tw-only.txt` |
| Canada | CA | 17,185 | 17,069 | 30,222 | 1.79% | `aggregated-ca-only.txt` |
| Singapore | SG | 9,598 | 9,588 | 43,625 | 2.59% | `aggregated-sg-only.txt` |
| Italy | IT | 9,808 | 9,786 | 19,368 | 1.15% | `aggregated-it-only.txt` |
| Netherlands | NL | 19,163 | 19,049 | 54,746 | 3.24% | `aggregated-nl-only.txt` |
| Indonesia | ID | 6,616 | 6,595 | 35,720 | 2.12% | `aggregated-id-only.txt` |
| France | FR | 33,424 | 33,396 | 30,855 | 1.83% | `aggregated-fr-only.txt` |
| Venezuela | VE | 979 | 979 | 10,156 | 0.60% | `aggregated-ve-only.txt` |
| Australia | AU | 12,309 | 12,242 | 18,583 | 1.10% | `aggregated-au-only.txt` |
| Turkey | TR | 3,540 | 3,520 | 20,869 | 1.24% | `aggregated-tr-only.txt` |
| Ukraine | UA | 5,554 | 5,509 | 20,857 | 1.24% | `aggregated-ua-only.txt` |
| Iran | IR | 2,069 | 2,068 | 6,296 | 0.37% | `aggregated-ir-only.txt` |
| Poland | PL | 8,247 | 8,218 | 10,490 | 0.62% | `aggregated-pl-only.txt` |
| Mexico | MX | 4,317 | 4,313 | 22,991 | 1.36% | `aggregated-mx-only.txt` |
| Spain | ES | 11,404 | 11,370 | 14,157 | 0.84% | `aggregated-es-only.txt` |
| Argentina | AR | 3,498 | 3,496 | 25,210 | 1.49% | `aggregated-ar-only.txt` |
| Egypt | EG | 740 | 740 | 5,273 | 0.31% | `aggregated-eg-only.txt` |
| Pakistan | PK | 1,378 | 1,377 | 23,534 | 1.39% | `aggregated-pk-only.txt` |
| Malaysia | MY | 2,615 | 2,615 | 7,702 | 0.46% | `aggregated-my-only.txt` |
| Bulgaria | BG | 2,365 | 2,351 | 3,727 | 0.22% | `aggregated-bg-only.txt` |
| Czechia | CZ | 3,696 | 3,695 | 2,521 | 0.15% | `aggregated-cz-only.txt` |
| Colombia | CO | 2,250 | 2,250 | 10,754 | 0.64% | `aggregated-co-only.txt` |
| United Arab Emirates | AE | 3,788 | 3,788 | 6,299 | 0.37% | `aggregated-ae-only.txt` |
| Romania | RO | 4,057 | 4,048 | 3,173 | 0.19% | `aggregated-ro-only.txt` |
| Kazakhstan | KZ | 1,288 | 1,287 | 3,894 | 0.23% | `aggregated-kz-only.txt` |
| Morocco | MA | 489 | 489 | 7,189 | 0.43% | `aggregated-ma-only.txt` |
| Saudi Arabia | SA | 1,723 | 1,723 | 7,493 | 0.44% | `aggregated-sa-only.txt` |
| South Africa | ZA | 4,070 | 4,056 | 11,955 | 0.71% | `aggregated-za-only.txt` |
| Bangladesh | BD | 2,713 | 2,711 | 11,059 | 0.66% | `aggregated-bd-only.txt` |
| Chile | CL | 2,001 | 1,999 | 8,189 | 0.49% | `aggregated-cl-only.txt` |
| Nigeria | NG | 1,126 | 1,126 | 2,291 | 0.14% | `aggregated-ng-only.txt` |
| Kenya | KE | 883 | 883 | 4,146 | 0.25% | `aggregated-ke-only.txt` |
| Algeria | DZ | 220 | 220 | 3,266 | 0.19% | `aggregated-dz-only.txt` |
| Serbia | RS | 1,004 | 1,004 | 1,747 | 0.10% | `aggregated-rs-only.txt` |
| Peru | PE | 1,123 | 1,122 | 2,886 | 0.17% | `aggregated-pe-only.txt` |
| Sri Lanka | LK | 252 | 252 | 1,142 | 0.07% | `aggregated-lk-only.txt` |
| Iraq | IQ | 675 | 675 | 4,363 | 0.26% | `aggregated-iq-only.txt` |
| Ethiopia | ET | 100 | 100 | 1,767 | 0.10% | `aggregated-et-only.txt` |
| Ghana | GH | 354 | 354 | 813 | 0.05% | `aggregated-gh-only.txt` |
| Belarus | BY | 424 | 424 | 1,413 | 0.08% | `aggregated-by-only.txt` |
...
- **`aggregated.txt`** - 1,687,527 total aggregated IPs from all sources
- **`aggregated-ae-only.txt`** - 6,299 IPs from AE
- **`aggregated-ar-only.txt`** - 25,210 IPs from AR
- **`aggregated-au-only.txt`** - 18,583 IPs from AU
- **`aggregated-bd-only.txt`** - 11,059 IPs from BD
- **`aggregated-bg-only.txt`** - 3,727 IPs from BG
- **`aggregated-br-only.txt`** - 103,865 IPs from BR
- **`aggregated-by-only.txt`** - 1,413 IPs from BY
- **`aggregated-ca-only.txt`** - 30,222 IPs from CA
- **`aggregated-cl-only.txt`** - 8,189 IPs from CL
- **`aggregated-cn-only.txt`** - 237,552 IPs from CN
- **`aggregated-co-only.txt`** - 10,754 IPs from CO
- **`aggregated-cz-only.txt`** - 2,521 IPs from CZ
- **`aggregated-de-only.txt`** - 49,614 IPs from DE
- **`aggregated-dz-only.txt`** - 3,266 IPs from DZ
- **`aggregated-eg-only.txt`** - 5,273 IPs from EG
- **`aggregated-es-only.txt`** - 14,157 IPs from ES
- **`aggregated-et-only.txt`** - 1,767 IPs from ET
- **`aggregated-fr-only.txt`** - 30,855 IPs from FR
- **`aggregated-gb-only.txt`** - 39,690 IPs from GB
- **`aggregated-gh-only.txt`** - 813 IPs from GH
- **`aggregated-id-only.txt`** - 35,720 IPs from ID
- **`aggregated-in-only.txt`** - 89,530 IPs from IN
- **`aggregated-iq-only.txt`** - 4,363 IPs from IQ
- **`aggregated-ir-only.txt`** - 6,296 IPs from IR
- **`aggregated-it-only.txt`** - 19,368 IPs from IT
- **`aggregated-ke-only.txt`** - 4,146 IPs from KE
- **`aggregated-kr-only.txt`** - 18,914 IPs from KR
- **`aggregated-kz-only.txt`** - 3,894 IPs from KZ
- **`aggregated-lk-only.txt`** - 1,142 IPs from LK
- **`aggregated-ma-only.txt`** - 7,189 IPs from MA
- **`aggregated-mx-only.txt`** - 22,991 IPs from MX
- **`aggregated-my-only.txt`** - 7,702 IPs from MY
- **`aggregated-ng-only.txt`** - 2,291 IPs from NG
- **`aggregated-nl-only.txt`** - 54,746 IPs from NL
- **`aggregated-pe-only.txt`** - 2,886 IPs from PE
- **`aggregated-pk-only.txt`** - 23,534 IPs from PK
- **`aggregated-pl-only.txt`** - 10,490 IPs from PL
- **`aggregated-ro-only.txt`** - 3,173 IPs from RO
- **`aggregated-rs-only.txt`** - 1,747 IPs from RS
- **`aggregated-ru-only.txt`** - 37,657 IPs from RU
- **`aggregated-sa-only.txt`** - 7,493 IPs from SA
- **`aggregated-sg-only.txt`** - 43,625 IPs from SG
- **`aggregated-th-only.txt`** - 17,315 IPs from TH
- **`aggregated-tr-only.txt`** - 20,869 IPs from TR
- **`aggregated-tw-only.txt`** - 18,283 IPs from TW
- **`aggregated-ua-only.txt`** - 20,857 IPs from UA
- **`aggregated-us-only.txt`** - 324,612 IPs from US
- **`aggregated-ve-only.txt`** - 10,156 IPs from VE
- **`aggregated-vn-only.txt`** - 42,812 IPs from VN
- **`aggregated-za-only.txt`** - 11,955 IPs from ZA
- **`aggregated-multi-50countries-combined.txt`** - 1,480,585 unique IPs (deduplicated across all countries)
