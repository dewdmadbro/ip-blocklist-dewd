...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-1530489-2D56A8)
...
**Last Updated:** 2026-09-07 21:41:35 UTC
...
"South Korea" : 1.2
"Australia" : 1.2
"Other/Unfiltered" : 24.9
```

## Overall Summary

- **Total Input IPs:** 1,530,489
- **Countries Processed:** 50
- **Combined Unique IPs:** 1,348,572
- **Combined Output File:** `aggregated-multi-50countries-combined.txt`
- **Overall Filter Rate:** 88.11%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 130,282 | 128,440 | 289,712 | 18.93% | `aggregated-us-only.txt` |
| China | CN | 7,830 | 7,829 | 226,487 | 14.80% | `aggregated-cn-only.txt` |
| India | IN | 13,289 | 13,260 | 84,365 | 5.51% | `aggregated-in-only.txt` |
| Germany | DE | 29,980 | 29,865 | 46,907 | 3.06% | `aggregated-de-only.txt` |
| Russia | RU | 13,215 | 12,981 | 33,323 | 2.18% | `aggregated-ru-only.txt` |
| United Kingdom | GB | 35,923 | 35,760 | 36,060 | 2.36% | `aggregated-gb-only.txt` |
| Thailand | TH | 2,062 | 2,062 | 16,211 | 1.06% | `aggregated-th-only.txt` |
| Vietnam | VN | 2,222 | 2,222 | 39,768 | 2.60% | `aggregated-vn-only.txt` |
| South Korea | KR | 3,943 | 3,932 | 17,928 | 1.17% | `aggregated-kr-only.txt` |
| Brazil | BR | 12,586 | 12,544 | 94,125 | 6.15% | `aggregated-br-only.txt` |
| Taiwan | TW | 2,411 | 2,411 | 16,871 | 1.10% | `aggregated-tw-only.txt` |
| Canada | CA | 17,185 | 17,069 | 27,909 | 1.82% | `aggregated-ca-only.txt` |
| Singapore | SG | 9,598 | 9,588 | 40,805 | 2.67% | `aggregated-sg-only.txt` |
| Italy | IT | 9,808 | 9,786 | 17,559 | 1.15% | `aggregated-it-only.txt` |
| Netherlands | NL | 19,163 | 19,049 | 53,197 | 3.48% | `aggregated-nl-only.txt` |
| Indonesia | ID | 6,616 | 6,595 | 32,971 | 2.15% | `aggregated-id-only.txt` |
| France | FR | 33,424 | 33,396 | 28,267 | 1.85% | `aggregated-fr-only.txt` |
| Venezuela | VE | 979 | 979 | 8,813 | 0.58% | `aggregated-ve-only.txt` |
| Australia | AU | 12,309 | 12,242 | 17,744 | 1.16% | `aggregated-au-only.txt` |
| Turkey | TR | 3,540 | 3,520 | 17,125 | 1.12% | `aggregated-tr-only.txt` |
| Ukraine | UA | 5,554 | 5,509 | 18,479 | 1.21% | `aggregated-ua-only.txt` |
| Iran | IR | 2,069 | 2,068 | 5,837 | 0.38% | `aggregated-ir-only.txt` |
| Poland | PL | 8,247 | 8,218 | 9,070 | 0.59% | `aggregated-pl-only.txt` |
| Mexico | MX | 4,317 | 4,313 | 20,326 | 1.33% | `aggregated-mx-only.txt` |
| Spain | ES | 11,404 | 11,370 | 12,372 | 0.81% | `aggregated-es-only.txt` |
| Argentina | AR | 3,498 | 3,496 | 20,486 | 1.34% | `aggregated-ar-only.txt` |
| Egypt | EG | 740 | 740 | 4,196 | 0.27% | `aggregated-eg-only.txt` |
| Pakistan | PK | 1,378 | 1,377 | 21,032 | 1.37% | `aggregated-pk-only.txt` |
| Malaysia | MY | 2,615 | 2,615 | 7,053 | 0.46% | `aggregated-my-only.txt` |
| Bulgaria | BG | 2,365 | 2,351 | 3,435 | 0.22% | `aggregated-bg-only.txt` |
| Czechia | CZ | 3,696 | 3,695 | 2,218 | 0.14% | `aggregated-cz-only.txt` |
| Colombia | CO | 2,250 | 2,250 | 9,015 | 0.59% | `aggregated-co-only.txt` |
| United Arab Emirates | AE | 3,788 | 3,788 | 5,408 | 0.35% | `aggregated-ae-only.txt` |
| Romania | RO | 4,057 | 4,048 | 2,887 | 0.19% | `aggregated-ro-only.txt` |
| Kazakhstan | KZ | 1,288 | 1,287 | 3,314 | 0.22% | `aggregated-kz-only.txt` |
| Morocco | MA | 489 | 489 | 5,614 | 0.37% | `aggregated-ma-only.txt` |
| Saudi Arabia | SA | 1,723 | 1,723 | 6,349 | 0.41% | `aggregated-sa-only.txt` |
| South Africa | ZA | 4,070 | 4,056 | 10,125 | 0.66% | `aggregated-za-only.txt` |
| Bangladesh | BD | 2,713 | 2,711 | 9,237 | 0.60% | `aggregated-bd-only.txt` |
| Chile | CL | 2,001 | 1,999 | 6,312 | 0.41% | `aggregated-cl-only.txt` |
| Nigeria | NG | 1,126 | 1,126 | 1,863 | 0.12% | `aggregated-ng-only.txt` |
| Kenya | KE | 883 | 883 | 3,576 | 0.23% | `aggregated-ke-only.txt` |
| Algeria | DZ | 220 | 220 | 2,474 | 0.16% | `aggregated-dz-only.txt` |
| Serbia | RS | 1,004 | 1,004 | 1,474 | 0.10% | `aggregated-rs-only.txt` |
| Peru | PE | 1,123 | 1,122 | 2,537 | 0.17% | `aggregated-pe-only.txt` |
| Sri Lanka | LK | 252 | 252 | 1,036 | 0.07% | `aggregated-lk-only.txt` |
| Iraq | IQ | 675 | 675 | 3,443 | 0.22% | `aggregated-iq-only.txt` |
| Ethiopia | ET | 100 | 100 | 1,409 | 0.09% | `aggregated-et-only.txt` |
| Ghana | GH | 354 | 354 | 731 | 0.05% | `aggregated-gh-only.txt` |
| Belarus | BY | 424 | 424 | 1,117 | 0.07% | `aggregated-by-only.txt` |
...
- **`aggregated.txt`** - 1,530,489 total aggregated IPs from all sources
- **`aggregated-ae-only.txt`** - 5,408 IPs from AE
- **`aggregated-ar-only.txt`** - 20,486 IPs from AR
- **`aggregated-au-only.txt`** - 17,744 IPs from AU
- **`aggregated-bd-only.txt`** - 9,237 IPs from BD
- **`aggregated-bg-only.txt`** - 3,435 IPs from BG
- **`aggregated-br-only.txt`** - 94,125 IPs from BR
- **`aggregated-by-only.txt`** - 1,117 IPs from BY
- **`aggregated-ca-only.txt`** - 27,909 IPs from CA
- **`aggregated-cl-only.txt`** - 6,312 IPs from CL
- **`aggregated-cn-only.txt`** - 226,487 IPs from CN
- **`aggregated-co-only.txt`** - 9,015 IPs from CO
- **`aggregated-cz-only.txt`** - 2,218 IPs from CZ
- **`aggregated-de-only.txt`** - 46,907 IPs from DE
- **`aggregated-dz-only.txt`** - 2,474 IPs from DZ
- **`aggregated-eg-only.txt`** - 4,196 IPs from EG
- **`aggregated-es-only.txt`** - 12,372 IPs from ES
- **`aggregated-et-only.txt`** - 1,409 IPs from ET
- **`aggregated-fr-only.txt`** - 28,267 IPs from FR
- **`aggregated-gb-only.txt`** - 36,060 IPs from GB
- **`aggregated-gh-only.txt`** - 731 IPs from GH
- **`aggregated-id-only.txt`** - 32,971 IPs from ID
- **`aggregated-in-only.txt`** - 84,365 IPs from IN
- **`aggregated-iq-only.txt`** - 3,443 IPs from IQ
- **`aggregated-ir-only.txt`** - 5,837 IPs from IR
- **`aggregated-it-only.txt`** - 17,559 IPs from IT
- **`aggregated-ke-only.txt`** - 3,576 IPs from KE
- **`aggregated-kr-only.txt`** - 17,928 IPs from KR
- **`aggregated-kz-only.txt`** - 3,314 IPs from KZ
- **`aggregated-lk-only.txt`** - 1,036 IPs from LK
- **`aggregated-ma-only.txt`** - 5,614 IPs from MA
- **`aggregated-mx-only.txt`** - 20,326 IPs from MX
- **`aggregated-my-only.txt`** - 7,053 IPs from MY
- **`aggregated-ng-only.txt`** - 1,863 IPs from NG
- **`aggregated-nl-only.txt`** - 53,197 IPs from NL
- **`aggregated-pe-only.txt`** - 2,537 IPs from PE
- **`aggregated-pk-only.txt`** - 21,032 IPs from PK
- **`aggregated-pl-only.txt`** - 9,070 IPs from PL
- **`aggregated-ro-only.txt`** - 2,887 IPs from RO
- **`aggregated-rs-only.txt`** - 1,474 IPs from RS
- **`aggregated-ru-only.txt`** - 33,323 IPs from RU
- **`aggregated-sa-only.txt`** - 6,349 IPs from SA
- **`aggregated-sg-only.txt`** - 40,805 IPs from SG
- **`aggregated-th-only.txt`** - 16,211 IPs from TH
- **`aggregated-tr-only.txt`** - 17,125 IPs from TR
- **`aggregated-tw-only.txt`** - 16,871 IPs from TW
- **`aggregated-ua-only.txt`** - 18,479 IPs from UA
- **`aggregated-us-only.txt`** - 289,712 IPs from US
- **`aggregated-ve-only.txt`** - 8,813 IPs from VE
- **`aggregated-vn-only.txt`** - 39,768 IPs from VN
- **`aggregated-za-only.txt`** - 10,125 IPs from ZA
- **`aggregated-multi-50countries-combined.txt`** - 1,348,572 unique IPs (deduplicated across all countries)
