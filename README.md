...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-1075192-2D56A8)
...
**Last Updated:** 2026-05-30 19:48:22 UTC
...
- **Total Input IPs:** 1,075,192
- **Countries Processed:** 50
- **Combined Unique IPs:** 949,235
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 166,410 | 164,906 | 207,395 | 19.29% | `aggregated-us-only.txt` |
| China | CN | 7,573 | 7,572 | 134,078 | 12.47% | `aggregated-cn-only.txt` |
| India | IN | 12,851 | 12,823 | 66,688 | 6.20% | `aggregated-in-only.txt` |
| Germany | DE | 28,870 | 28,778 | 41,691 | 3.88% | `aggregated-de-only.txt` |
| Russia | RU | 13,094 | 12,866 | 25,106 | 2.34% | `aggregated-ru-only.txt` |
| United Kingdom | GB | 34,140 | 33,965 | 30,641 | 2.85% | `aggregated-gb-only.txt` |
| Thailand | TH | 1,933 | 1,932 | 13,681 | 1.27% | `aggregated-th-only.txt` |
| Vietnam | VN | 2,156 | 2,156 | 35,870 | 3.34% | `aggregated-vn-only.txt` |
| South Korea | KR | 3,959 | 3,949 | 13,931 | 1.30% | `aggregated-kr-only.txt` |
| Brazil | BR | 13,582 | 13,546 | 45,305 | 4.21% | `aggregated-br-only.txt` |
| Taiwan | TW | 2,393 | 2,393 | 13,046 | 1.21% | `aggregated-tw-only.txt` |
| Canada | CA | 17,069 | 16,942 | 23,961 | 2.23% | `aggregated-ca-only.txt` |
| Singapore | SG | 9,272 | 9,262 | 32,522 | 3.02% | `aggregated-sg-only.txt` |
| Italy | IT | 9,551 | 9,527 | 14,027 | 1.30% | `aggregated-it-only.txt` |
| Netherlands | NL | 18,621 | 18,497 | 51,093 | 4.75% | `aggregated-nl-only.txt` |
| Indonesia | ID | 6,405 | 6,384 | 25,569 | 2.38% | `aggregated-id-only.txt` |
| France | FR | 32,173 | 32,147 | 19,617 | 1.82% | `aggregated-fr-only.txt` |
| Venezuela | VE | 935 | 935 | 6,776 | 0.63% | `aggregated-ve-only.txt` |
| Australia | AU | 12,081 | 12,011 | 16,095 | 1.50% | `aggregated-au-only.txt` |
| Turkey | TR | 3,406 | 3,381 | 12,672 | 1.18% | `aggregated-tr-only.txt` |
| Ukraine | UA | 5,566 | 5,512 | 8,152 | 0.76% | `aggregated-ua-only.txt` |
| Iran | IR | 2,019 | 2,018 | 3,925 | 0.37% | `aggregated-ir-only.txt` |
| Poland | PL | 8,024 | 7,993 | 7,375 | 0.69% | `aggregated-pl-only.txt` |
| Mexico | MX | 4,408 | 4,404 | 11,062 | 1.03% | `aggregated-mx-only.txt` |
| Spain | ES | 11,164 | 11,133 | 7,770 | 0.72% | `aggregated-es-only.txt` |
| Argentina | AR | 3,493 | 3,491 | 9,269 | 0.86% | `aggregated-ar-only.txt` |
| Egypt | EG | 718 | 718 | 2,793 | 0.26% | `aggregated-eg-only.txt` |
| Pakistan | PK | 1,321 | 1,321 | 13,621 | 1.27% | `aggregated-pk-only.txt` |
| Malaysia | MY | 2,497 | 2,497 | 5,254 | 0.49% | `aggregated-my-only.txt` |
| Bulgaria | BG | 2,282 | 2,272 | 2,751 | 0.26% | `aggregated-bg-only.txt` |
| Czechia | CZ | 3,587 | 3,586 | 1,723 | 0.16% | `aggregated-cz-only.txt` |
| Colombia | CO | 2,219 | 2,219 | 4,480 | 0.42% | `aggregated-co-only.txt` |
| United Arab Emirates | AE | 3,270 | 3,270 | 3,437 | 0.32% | `aggregated-ae-only.txt` |
| Romania | RO | 3,943 | 3,934 | 2,084 | 0.19% | `aggregated-ro-only.txt` |
| Kazakhstan | KZ | 1,260 | 1,259 | 2,416 | 0.22% | `aggregated-kz-only.txt` |
| Morocco | MA | 476 | 476 | 3,618 | 0.34% | `aggregated-ma-only.txt` |
| Saudi Arabia | SA | 1,629 | 1,629 | 3,796 | 0.35% | `aggregated-sa-only.txt` |
| South Africa | ZA | 3,976 | 3,963 | 6,477 | 0.60% | `aggregated-za-only.txt` |
| Bangladesh | BD | 2,621 | 2,616 | 5,180 | 0.48% | `aggregated-bd-only.txt` |
| Chile | CL | 1,901 | 1,901 | 2,290 | 0.21% | `aggregated-cl-only.txt` |
| Nigeria | NG | 1,075 | 1,075 | 1,180 | 0.11% | `aggregated-ng-only.txt` |
| Kenya | KE | 854 | 854 | 2,106 | 0.20% | `aggregated-ke-only.txt` |
| Algeria | DZ | 217 | 217 | 1,622 | 0.15% | `aggregated-dz-only.txt` |
| Serbia | RS | 947 | 945 | 1,034 | 0.10% | `aggregated-rs-only.txt` |
| Peru | PE | 1,098 | 1,097 | 1,507 | 0.14% | `aggregated-pe-only.txt` |
| Sri Lanka | LK | 247 | 247 | 629 | 0.06% | `aggregated-lk-only.txt` |
| Iraq | IQ | 681 | 681 | 1,873 | 0.17% | `aggregated-iq-only.txt` |
| Ethiopia | ET | 98 | 98 | 893 | 0.08% | `aggregated-et-only.txt` |
| Ghana | GH | 344 | 344 | 494 | 0.05% | `aggregated-gh-only.txt` |
...
- **`aggregated.txt`** - 1,075,192 total aggregated IPs from all sources
- **`aggregated-ae-only.txt`** - 3,437 IPs from AE
- **`aggregated-ar-only.txt`** - 9,269 IPs from AR
- **`aggregated-au-only.txt`** - 16,095 IPs from AU
- **`aggregated-bd-only.txt`** - 5,180 IPs from BD
- **`aggregated-bg-only.txt`** - 2,751 IPs from BG
- **`aggregated-br-only.txt`** - 45,305 IPs from BR
- **`aggregated-by-only.txt`** - 660 IPs from BY
- **`aggregated-ca-only.txt`** - 23,961 IPs from CA
- **`aggregated-cl-only.txt`** - 2,290 IPs from CL
- **`aggregated-cn-only.txt`** - 134,078 IPs from CN
- **`aggregated-co-only.txt`** - 4,480 IPs from CO
- **`aggregated-cz-only.txt`** - 1,723 IPs from CZ
- **`aggregated-de-only.txt`** - 41,691 IPs from DE
- **`aggregated-dz-only.txt`** - 1,622 IPs from DZ
- **`aggregated-eg-only.txt`** - 2,793 IPs from EG
- **`aggregated-es-only.txt`** - 7,770 IPs from ES
- **`aggregated-et-only.txt`** - 893 IPs from ET
- **`aggregated-fr-only.txt`** - 19,617 IPs from FR
- **`aggregated-gb-only.txt`** - 30,641 IPs from GB
- **`aggregated-gh-only.txt`** - 494 IPs from GH
- **`aggregated-id-only.txt`** - 25,569 IPs from ID
- **`aggregated-in-only.txt`** - 66,688 IPs from IN
- **`aggregated-iq-only.txt`** - 1,873 IPs from IQ
- **`aggregated-ir-only.txt`** - 3,925 IPs from IR
- **`aggregated-it-only.txt`** - 14,027 IPs from IT
- **`aggregated-ke-only.txt`** - 2,106 IPs from KE
- **`aggregated-kr-only.txt`** - 13,931 IPs from KR
- **`aggregated-kz-only.txt`** - 2,416 IPs from KZ
- **`aggregated-lk-only.txt`** - 629 IPs from LK
- **`aggregated-ma-only.txt`** - 3,618 IPs from MA
- **`aggregated-mx-only.txt`** - 11,062 IPs from MX
- **`aggregated-my-only.txt`** - 5,254 IPs from MY
- **`aggregated-ng-only.txt`** - 1,180 IPs from NG
- **`aggregated-nl-only.txt`** - 51,093 IPs from NL
- **`aggregated-pe-only.txt`** - 1,507 IPs from PE
- **`aggregated-pk-only.txt`** - 13,621 IPs from PK
- **`aggregated-pl-only.txt`** - 7,375 IPs from PL
- **`aggregated-ro-only.txt`** - 2,084 IPs from RO
- **`aggregated-rs-only.txt`** - 1,034 IPs from RS
- **`aggregated-ru-only.txt`** - 25,106 IPs from RU
- **`aggregated-sa-only.txt`** - 3,796 IPs from SA
- **`aggregated-sg-only.txt`** - 32,522 IPs from SG
- **`aggregated-th-only.txt`** - 13,681 IPs from TH
- **`aggregated-tr-only.txt`** - 12,672 IPs from TR
- **`aggregated-tw-only.txt`** - 13,046 IPs from TW
- **`aggregated-ua-only.txt`** - 8,152 IPs from UA
- **`aggregated-us-only.txt`** - 207,395 IPs from US
- **`aggregated-ve-only.txt`** - 6,776 IPs from VE
- **`aggregated-vn-only.txt`** - 35,870 IPs from VN
- **`aggregated-za-only.txt`** - 6,477 IPs from ZA
- **`aggregated-multi-50countries-combined.txt`** - 949,235 unique IPs (deduplicated across all countries)
