...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-1079287-2D56A8)
...
**Last Updated:** 2026-06-06 19:53:24 UTC
...
- **Total Input IPs:** 1,079,287
- **Countries Processed:** 50
- **Combined Unique IPs:** 953,034
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 165,171 | 163,351 | 211,546 | 19.60% | `aggregated-us-only.txt` |
| China | CN | 7,502 | 7,501 | 133,791 | 12.40% | `aggregated-cn-only.txt` |
| India | IN | 12,894 | 12,865 | 67,769 | 6.28% | `aggregated-in-only.txt` |
| Germany | DE | 28,948 | 28,868 | 41,877 | 3.88% | `aggregated-de-only.txt` |
| Russia | RU | 13,123 | 12,894 | 25,237 | 2.34% | `aggregated-ru-only.txt` |
| United Kingdom | GB | 34,022 | 33,847 | 30,665 | 2.84% | `aggregated-gb-only.txt` |
| Thailand | TH | 1,927 | 1,926 | 13,693 | 1.27% | `aggregated-th-only.txt` |
| Vietnam | VN | 2,159 | 2,159 | 34,475 | 3.19% | `aggregated-vn-only.txt` |
| South Korea | KR | 3,938 | 3,928 | 13,980 | 1.30% | `aggregated-kr-only.txt` |
| Brazil | BR | 13,593 | 13,559 | 44,370 | 4.11% | `aggregated-br-only.txt` |
| Taiwan | TW | 2,399 | 2,399 | 13,155 | 1.22% | `aggregated-tw-only.txt` |
| Canada | CA | 17,038 | 16,909 | 23,913 | 2.22% | `aggregated-ca-only.txt` |
| Singapore | SG | 9,341 | 9,331 | 33,192 | 3.08% | `aggregated-sg-only.txt` |
| Italy | IT | 9,565 | 9,541 | 14,253 | 1.32% | `aggregated-it-only.txt` |
| Netherlands | NL | 18,603 | 18,479 | 51,015 | 4.73% | `aggregated-nl-only.txt` |
| Indonesia | ID | 6,408 | 6,389 | 25,559 | 2.37% | `aggregated-id-only.txt` |
| France | FR | 32,238 | 32,212 | 19,844 | 1.84% | `aggregated-fr-only.txt` |
| Venezuela | VE | 931 | 931 | 6,619 | 0.61% | `aggregated-ve-only.txt` |
| Australia | AU | 12,034 | 11,967 | 16,159 | 1.50% | `aggregated-au-only.txt` |
| Turkey | TR | 3,399 | 3,374 | 12,692 | 1.18% | `aggregated-tr-only.txt` |
| Ukraine | UA | 5,573 | 5,519 | 8,108 | 0.75% | `aggregated-ua-only.txt` |
| Iran | IR | 2,018 | 2,017 | 4,097 | 0.38% | `aggregated-ir-only.txt` |
| Poland | PL | 8,039 | 8,008 | 7,443 | 0.69% | `aggregated-pl-only.txt` |
| Mexico | MX | 4,395 | 4,391 | 10,821 | 1.00% | `aggregated-mx-only.txt` |
| Spain | ES | 11,295 | 11,270 | 7,832 | 0.73% | `aggregated-es-only.txt` |
| Argentina | AR | 3,494 | 3,492 | 9,136 | 0.85% | `aggregated-ar-only.txt` |
| Egypt | EG | 718 | 718 | 2,796 | 0.26% | `aggregated-eg-only.txt` |
| Pakistan | PK | 1,338 | 1,336 | 13,814 | 1.28% | `aggregated-pk-only.txt` |
| Malaysia | MY | 2,508 | 2,508 | 5,300 | 0.49% | `aggregated-my-only.txt` |
| Bulgaria | BG | 2,292 | 2,282 | 2,776 | 0.26% | `aggregated-bg-only.txt` |
| Czechia | CZ | 3,588 | 3,587 | 1,723 | 0.16% | `aggregated-cz-only.txt` |
| Colombia | CO | 2,210 | 2,210 | 4,348 | 0.40% | `aggregated-co-only.txt` |
| United Arab Emirates | AE | 3,284 | 3,284 | 3,416 | 0.32% | `aggregated-ae-only.txt` |
| Romania | RO | 3,946 | 3,937 | 2,103 | 0.19% | `aggregated-ro-only.txt` |
| Kazakhstan | KZ | 1,263 | 1,262 | 2,405 | 0.22% | `aggregated-kz-only.txt` |
| Morocco | MA | 475 | 475 | 3,460 | 0.32% | `aggregated-ma-only.txt` |
| Saudi Arabia | SA | 1,629 | 1,629 | 3,844 | 0.36% | `aggregated-sa-only.txt` |
| South Africa | ZA | 3,967 | 3,953 | 6,478 | 0.60% | `aggregated-za-only.txt` |
| Bangladesh | BD | 2,621 | 2,616 | 5,146 | 0.48% | `aggregated-bd-only.txt` |
| Chile | CL | 1,901 | 1,901 | 2,189 | 0.20% | `aggregated-cl-only.txt` |
| Nigeria | NG | 1,077 | 1,077 | 1,154 | 0.11% | `aggregated-ng-only.txt` |
| Kenya | KE | 857 | 857 | 2,126 | 0.20% | `aggregated-ke-only.txt` |
| Algeria | DZ | 218 | 218 | 1,655 | 0.15% | `aggregated-dz-only.txt` |
| Serbia | RS | 949 | 947 | 1,028 | 0.10% | `aggregated-rs-only.txt` |
| Peru | PE | 1,092 | 1,091 | 1,519 | 0.14% | `aggregated-pe-only.txt` |
| Sri Lanka | LK | 247 | 247 | 632 | 0.06% | `aggregated-lk-only.txt` |
| Iraq | IQ | 684 | 684 | 1,843 | 0.17% | `aggregated-iq-only.txt` |
| Ethiopia | ET | 99 | 99 | 895 | 0.08% | `aggregated-et-only.txt` |
| Ghana | GH | 341 | 341 | 498 | 0.05% | `aggregated-gh-only.txt` |
| Belarus | BY | 418 | 418 | 645 | 0.06% | `aggregated-by-only.txt` |
...
- **`aggregated.txt`** - 1,079,287 total aggregated IPs from all sources
- **`aggregated-ae-only.txt`** - 3,416 IPs from AE
- **`aggregated-ar-only.txt`** - 9,136 IPs from AR
- **`aggregated-au-only.txt`** - 16,159 IPs from AU
- **`aggregated-bd-only.txt`** - 5,146 IPs from BD
- **`aggregated-bg-only.txt`** - 2,776 IPs from BG
- **`aggregated-br-only.txt`** - 44,370 IPs from BR
- **`aggregated-by-only.txt`** - 645 IPs from BY
- **`aggregated-ca-only.txt`** - 23,913 IPs from CA
- **`aggregated-cl-only.txt`** - 2,189 IPs from CL
- **`aggregated-cn-only.txt`** - 133,791 IPs from CN
- **`aggregated-co-only.txt`** - 4,348 IPs from CO
- **`aggregated-cz-only.txt`** - 1,723 IPs from CZ
- **`aggregated-de-only.txt`** - 41,877 IPs from DE
- **`aggregated-dz-only.txt`** - 1,655 IPs from DZ
- **`aggregated-eg-only.txt`** - 2,796 IPs from EG
- **`aggregated-es-only.txt`** - 7,832 IPs from ES
- **`aggregated-et-only.txt`** - 895 IPs from ET
- **`aggregated-fr-only.txt`** - 19,844 IPs from FR
- **`aggregated-gb-only.txt`** - 30,665 IPs from GB
- **`aggregated-gh-only.txt`** - 498 IPs from GH
- **`aggregated-id-only.txt`** - 25,559 IPs from ID
- **`aggregated-in-only.txt`** - 67,769 IPs from IN
- **`aggregated-iq-only.txt`** - 1,843 IPs from IQ
- **`aggregated-ir-only.txt`** - 4,097 IPs from IR
- **`aggregated-it-only.txt`** - 14,253 IPs from IT
- **`aggregated-ke-only.txt`** - 2,126 IPs from KE
- **`aggregated-kr-only.txt`** - 13,980 IPs from KR
- **`aggregated-kz-only.txt`** - 2,405 IPs from KZ
- **`aggregated-lk-only.txt`** - 632 IPs from LK
- **`aggregated-ma-only.txt`** - 3,460 IPs from MA
- **`aggregated-mx-only.txt`** - 10,821 IPs from MX
- **`aggregated-my-only.txt`** - 5,300 IPs from MY
- **`aggregated-ng-only.txt`** - 1,154 IPs from NG
- **`aggregated-nl-only.txt`** - 51,015 IPs from NL
- **`aggregated-pe-only.txt`** - 1,519 IPs from PE
- **`aggregated-pk-only.txt`** - 13,814 IPs from PK
- **`aggregated-pl-only.txt`** - 7,443 IPs from PL
- **`aggregated-ro-only.txt`** - 2,103 IPs from RO
- **`aggregated-rs-only.txt`** - 1,028 IPs from RS
- **`aggregated-ru-only.txt`** - 25,237 IPs from RU
- **`aggregated-sa-only.txt`** - 3,844 IPs from SA
- **`aggregated-sg-only.txt`** - 33,192 IPs from SG
- **`aggregated-th-only.txt`** - 13,693 IPs from TH
- **`aggregated-tr-only.txt`** - 12,692 IPs from TR
- **`aggregated-tw-only.txt`** - 13,155 IPs from TW
- **`aggregated-ua-only.txt`** - 8,108 IPs from UA
- **`aggregated-us-only.txt`** - 211,546 IPs from US
- **`aggregated-ve-only.txt`** - 6,619 IPs from VE
- **`aggregated-vn-only.txt`** - 34,475 IPs from VN
- **`aggregated-za-only.txt`** - 6,478 IPs from ZA
- **`aggregated-multi-50countries-combined.txt`** - 953,034 unique IPs (deduplicated across all countries)
