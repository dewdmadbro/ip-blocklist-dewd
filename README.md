...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-1093594-2D56A8)
...
**Last Updated:** 2026-06-09 20:27:43 UTC
...
- **Total Input IPs:** 1,093,594
- **Countries Processed:** 50
- **Combined Unique IPs:** 965,252
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 164,583 | 162,769 | 214,152 | 19.58% | `aggregated-us-only.txt` |
| China | CN | 7,731 | 7,730 | 135,097 | 12.35% | `aggregated-cn-only.txt` |
| India | IN | 12,952 | 12,923 | 69,058 | 6.31% | `aggregated-in-only.txt` |
| Germany | DE | 29,036 | 28,962 | 43,038 | 3.94% | `aggregated-de-only.txt` |
| Russia | RU | 13,140 | 12,911 | 25,400 | 2.32% | `aggregated-ru-only.txt` |
| United Kingdom | GB | 34,200 | 34,027 | 31,096 | 2.84% | `aggregated-gb-only.txt` |
| Thailand | TH | 1,943 | 1,943 | 13,798 | 1.26% | `aggregated-th-only.txt` |
| Vietnam | VN | 2,161 | 2,161 | 34,716 | 3.17% | `aggregated-vn-only.txt` |
| South Korea | KR | 3,940 | 3,930 | 14,148 | 1.29% | `aggregated-kr-only.txt` |
| Brazil | BR | 13,459 | 13,423 | 45,547 | 4.16% | `aggregated-br-only.txt` |
| Taiwan | TW | 2,411 | 2,411 | 13,289 | 1.22% | `aggregated-tw-only.txt` |
| Canada | CA | 17,078 | 16,950 | 23,746 | 2.17% | `aggregated-ca-only.txt` |
| Singapore | SG | 9,235 | 9,225 | 33,502 | 3.06% | `aggregated-sg-only.txt` |
| Italy | IT | 9,642 | 9,615 | 14,396 | 1.32% | `aggregated-it-only.txt` |
| Netherlands | NL | 18,672 | 18,556 | 51,113 | 4.67% | `aggregated-nl-only.txt` |
| Indonesia | ID | 6,418 | 6,399 | 25,804 | 2.36% | `aggregated-id-only.txt` |
| France | FR | 32,361 | 32,335 | 20,188 | 1.85% | `aggregated-fr-only.txt` |
| Venezuela | VE | 932 | 932 | 6,688 | 0.61% | `aggregated-ve-only.txt` |
| Australia | AU | 11,518 | 11,439 | 16,347 | 1.49% | `aggregated-au-only.txt` |
| Turkey | TR | 3,402 | 3,378 | 12,778 | 1.17% | `aggregated-tr-only.txt` |
| Ukraine | UA | 5,554 | 5,500 | 8,134 | 0.74% | `aggregated-ua-only.txt` |
| Iran | IR | 2,019 | 2,018 | 4,167 | 0.38% | `aggregated-ir-only.txt` |
| Poland | PL | 8,080 | 8,049 | 7,438 | 0.68% | `aggregated-pl-only.txt` |
| Mexico | MX | 4,401 | 4,397 | 11,031 | 1.01% | `aggregated-mx-only.txt` |
| Spain | ES | 11,327 | 11,296 | 7,904 | 0.72% | `aggregated-es-only.txt` |
| Argentina | AR | 3,505 | 3,503 | 9,255 | 0.85% | `aggregated-ar-only.txt` |
| Egypt | EG | 721 | 721 | 2,853 | 0.26% | `aggregated-eg-only.txt` |
| Pakistan | PK | 1,343 | 1,341 | 14,086 | 1.29% | `aggregated-pk-only.txt` |
| Malaysia | MY | 2,516 | 2,516 | 5,380 | 0.49% | `aggregated-my-only.txt` |
| Bulgaria | BG | 2,318 | 2,308 | 2,812 | 0.26% | `aggregated-bg-only.txt` |
| Czechia | CZ | 3,617 | 3,616 | 1,750 | 0.16% | `aggregated-cz-only.txt` |
| Colombia | CO | 2,217 | 2,217 | 4,438 | 0.41% | `aggregated-co-only.txt` |
...
| Kazakhstan | KZ | 1,271 | 1,270 | 2,421 | 0.22% | `aggregated-kz-only.txt` |
| Morocco | MA | 476 | 476 | 3,543 | 0.32% | `aggregated-ma-only.txt` |
| Saudi Arabia | SA | 1,627 | 1,627 | 3,948 | 0.36% | `aggregated-sa-only.txt` |
| South Africa | ZA | 3,954 | 3,940 | 6,540 | 0.60% | `aggregated-za-only.txt` |
| Bangladesh | BD | 2,618 | 2,614 | 5,268 | 0.48% | `aggregated-bd-only.txt` |
| Chile | CL | 1,904 | 1,904 | 2,392 | 0.22% | `aggregated-cl-only.txt` |
| Nigeria | NG | 1,078 | 1,078 | 1,186 | 0.11% | `aggregated-ng-only.txt` |
| Kenya | KE | 855 | 855 | 2,161 | 0.20% | `aggregated-ke-only.txt` |
| Algeria | DZ | 219 | 219 | 1,682 | 0.15% | `aggregated-dz-only.txt` |
| Serbia | RS | 959 | 957 | 1,035 | 0.09% | `aggregated-rs-only.txt` |
| Peru | PE | 1,099 | 1,098 | 1,551 | 0.14% | `aggregated-pe-only.txt` |
| Sri Lanka | LK | 249 | 249 | 653 | 0.06% | `aggregated-lk-only.txt` |
| Iraq | IQ | 684 | 684 | 1,962 | 0.18% | `aggregated-iq-only.txt` |
...
- **`aggregated.txt`** - 1,093,594 total aggregated IPs from all sources
- **`aggregated-ae-only.txt`** - 3,551 IPs from AE
- **`aggregated-ar-only.txt`** - 9,255 IPs from AR
- **`aggregated-au-only.txt`** - 16,347 IPs from AU
- **`aggregated-bd-only.txt`** - 5,268 IPs from BD
- **`aggregated-bg-only.txt`** - 2,812 IPs from BG
- **`aggregated-br-only.txt`** - 45,547 IPs from BR
- **`aggregated-by-only.txt`** - 647 IPs from BY
- **`aggregated-ca-only.txt`** - 23,746 IPs from CA
- **`aggregated-cl-only.txt`** - 2,392 IPs from CL
- **`aggregated-cn-only.txt`** - 135,097 IPs from CN
- **`aggregated-co-only.txt`** - 4,438 IPs from CO
- **`aggregated-cz-only.txt`** - 1,750 IPs from CZ
- **`aggregated-de-only.txt`** - 43,038 IPs from DE
- **`aggregated-dz-only.txt`** - 1,682 IPs from DZ
- **`aggregated-eg-only.txt`** - 2,853 IPs from EG
- **`aggregated-es-only.txt`** - 7,904 IPs from ES
- **`aggregated-et-only.txt`** - 908 IPs from ET
- **`aggregated-fr-only.txt`** - 20,188 IPs from FR
- **`aggregated-gb-only.txt`** - 31,096 IPs from GB
- **`aggregated-gh-only.txt`** - 507 IPs from GH
- **`aggregated-id-only.txt`** - 25,804 IPs from ID
- **`aggregated-in-only.txt`** - 69,058 IPs from IN
- **`aggregated-iq-only.txt`** - 1,962 IPs from IQ
- **`aggregated-ir-only.txt`** - 4,167 IPs from IR
- **`aggregated-it-only.txt`** - 14,396 IPs from IT
- **`aggregated-ke-only.txt`** - 2,161 IPs from KE
- **`aggregated-kr-only.txt`** - 14,148 IPs from KR
- **`aggregated-kz-only.txt`** - 2,421 IPs from KZ
- **`aggregated-lk-only.txt`** - 653 IPs from LK
- **`aggregated-ma-only.txt`** - 3,543 IPs from MA
- **`aggregated-mx-only.txt`** - 11,031 IPs from MX
- **`aggregated-my-only.txt`** - 5,380 IPs from MY
- **`aggregated-ng-only.txt`** - 1,186 IPs from NG
- **`aggregated-nl-only.txt`** - 51,113 IPs from NL
- **`aggregated-pe-only.txt`** - 1,551 IPs from PE
- **`aggregated-pk-only.txt`** - 14,086 IPs from PK
- **`aggregated-pl-only.txt`** - 7,438 IPs from PL
- **`aggregated-ro-only.txt`** - 2,148 IPs from RO
- **`aggregated-rs-only.txt`** - 1,035 IPs from RS
- **`aggregated-ru-only.txt`** - 25,400 IPs from RU
- **`aggregated-sa-only.txt`** - 3,948 IPs from SA
- **`aggregated-sg-only.txt`** - 33,502 IPs from SG
- **`aggregated-th-only.txt`** - 13,798 IPs from TH
- **`aggregated-tr-only.txt`** - 12,778 IPs from TR
- **`aggregated-tw-only.txt`** - 13,289 IPs from TW
- **`aggregated-ua-only.txt`** - 8,134 IPs from UA
- **`aggregated-us-only.txt`** - 214,152 IPs from US
- **`aggregated-ve-only.txt`** - 6,688 IPs from VE
- **`aggregated-vn-only.txt`** - 34,716 IPs from VN
- **`aggregated-za-only.txt`** - 6,540 IPs from ZA
- **`aggregated-multi-50countries-combined.txt`** - 965,252 unique IPs (deduplicated across all countries)
