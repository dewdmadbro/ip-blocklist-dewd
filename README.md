...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-1351387-2D56A8)
...
**Last Updated:** 2026-08-15 13:08:05 UTC
...
- **Total Input IPs:** 1,351,387
- **Countries Processed:** 50
- **Combined Unique IPs:** 1,192,371
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 133,752 | 131,895 | 250,313 | 18.52% | `aggregated-us-only.txt` |
| China | CN | 7,864 | 7,863 | 199,170 | 14.74% | `aggregated-cn-only.txt` |
| India | IN | 13,195 | 13,165 | 79,949 | 5.92% | `aggregated-in-only.txt` |
| Germany | DE | 29,554 | 29,487 | 44,698 | 3.31% | `aggregated-de-only.txt` |
| Russia | RU | 13,366 | 13,132 | 30,108 | 2.23% | `aggregated-ru-only.txt` |
| United Kingdom | GB | 35,611 | 35,465 | 33,609 | 2.49% | `aggregated-gb-only.txt` |
| Thailand | TH | 1,995 | 1,995 | 15,349 | 1.14% | `aggregated-th-only.txt` |
| Vietnam | VN | 2,205 | 2,205 | 38,421 | 2.84% | `aggregated-vn-only.txt` |
| South Korea | KR | 3,940 | 3,930 | 16,612 | 1.23% | `aggregated-kr-only.txt` |
| Brazil | BR | 12,623 | 12,580 | 78,409 | 5.80% | `aggregated-br-only.txt` |
| Taiwan | TW | 2,393 | 2,393 | 15,224 | 1.13% | `aggregated-tw-only.txt` |
| Canada | CA | 17,090 | 16,967 | 26,975 | 2.00% | `aggregated-ca-only.txt` |
| Singapore | SG | 9,459 | 9,449 | 36,580 | 2.71% | `aggregated-sg-only.txt` |
| Italy | IT | 9,746 | 9,714 | 15,912 | 1.18% | `aggregated-it-only.txt` |
| Netherlands | NL | 18,940 | 18,817 | 51,518 | 3.81% | `aggregated-nl-only.txt` |
| Indonesia | ID | 6,564 | 6,535 | 29,420 | 2.18% | `aggregated-id-only.txt` |
| France | FR | 33,593 | 33,564 | 24,886 | 1.84% | `aggregated-fr-only.txt` |
| Venezuela | VE | 967 | 967 | 7,447 | 0.55% | `aggregated-ve-only.txt` |
| Australia | AU | 12,166 | 12,097 | 17,341 | 1.28% | `aggregated-au-only.txt` |
| Turkey | TR | 3,463 | 3,447 | 14,161 | 1.05% | `aggregated-tr-only.txt` |
| Ukraine | UA | 5,565 | 5,510 | 15,819 | 1.17% | `aggregated-ua-only.txt` |
| Iran | IR | 2,058 | 2,057 | 5,737 | 0.42% | `aggregated-ir-only.txt` |
| Poland | PL | 8,181 | 8,148 | 8,571 | 0.63% | `aggregated-pl-only.txt` |
| Mexico | MX | 4,348 | 4,344 | 16,553 | 1.22% | `aggregated-mx-only.txt` |
| Spain | ES | 11,222 | 11,204 | 10,147 | 0.75% | `aggregated-es-only.txt` |
| Argentina | AR | 3,476 | 3,474 | 13,787 | 1.02% | `aggregated-ar-only.txt` |
| Egypt | EG | 730 | 730 | 3,794 | 0.28% | `aggregated-eg-only.txt` |
| Pakistan | PK | 1,367 | 1,365 | 18,286 | 1.35% | `aggregated-pk-only.txt` |
| Malaysia | MY | 2,585 | 2,585 | 6,237 | 0.46% | `aggregated-my-only.txt` |
| Bulgaria | BG | 2,365 | 2,354 | 3,132 | 0.23% | `aggregated-bg-only.txt` |
| Czechia | CZ | 3,617 | 3,616 | 1,951 | 0.14% | `aggregated-cz-only.txt` |
| Colombia | CO | 2,234 | 2,234 | 6,797 | 0.50% | `aggregated-co-only.txt` |
| United Arab Emirates | AE | 3,831 | 3,831 | 4,650 | 0.34% | `aggregated-ae-only.txt` |
| Romania | RO | 4,009 | 4,000 | 2,607 | 0.19% | `aggregated-ro-only.txt` |
| Kazakhstan | KZ | 1,319 | 1,318 | 2,797 | 0.21% | `aggregated-kz-only.txt` |
| Morocco | MA | 494 | 494 | 4,781 | 0.35% | `aggregated-ma-only.txt` |
| Saudi Arabia | SA | 1,690 | 1,690 | 4,662 | 0.34% | `aggregated-sa-only.txt` |
| South Africa | ZA | 4,017 | 4,003 | 8,749 | 0.65% | `aggregated-za-only.txt` |
| Bangladesh | BD | 2,653 | 2,651 | 7,019 | 0.52% | `aggregated-bd-only.txt` |
| Chile | CL | 2,002 | 2,000 | 4,164 | 0.31% | `aggregated-cl-only.txt` |
| Nigeria | NG | 1,097 | 1,097 | 1,685 | 0.12% | `aggregated-ng-only.txt` |
| Kenya | KE | 875 | 875 | 2,926 | 0.22% | `aggregated-ke-only.txt` |
| Algeria | DZ | 220 | 220 | 2,116 | 0.16% | `aggregated-dz-only.txt` |
| Serbia | RS | 991 | 989 | 1,342 | 0.10% | `aggregated-rs-only.txt` |
| Peru | PE | 1,129 | 1,128 | 2,109 | 0.16% | `aggregated-pe-only.txt` |
| Sri Lanka | LK | 248 | 248 | 1,005 | 0.07% | `aggregated-lk-only.txt` |
| Iraq | IQ | 687 | 687 | 2,384 | 0.18% | `aggregated-iq-only.txt` |
...
- **`aggregated.txt`** - 1,351,387 total aggregated IPs from all sources
- **`aggregated-ae-only.txt`** - 4,650 IPs from AE
- **`aggregated-ar-only.txt`** - 13,787 IPs from AR
- **`aggregated-au-only.txt`** - 17,341 IPs from AU
- **`aggregated-bd-only.txt`** - 7,019 IPs from BD
- **`aggregated-bg-only.txt`** - 3,132 IPs from BG
- **`aggregated-br-only.txt`** - 78,409 IPs from BR
- **`aggregated-by-only.txt`** - 779 IPs from BY
- **`aggregated-ca-only.txt`** - 26,975 IPs from CA
- **`aggregated-cl-only.txt`** - 4,164 IPs from CL
- **`aggregated-cn-only.txt`** - 199,170 IPs from CN
- **`aggregated-co-only.txt`** - 6,797 IPs from CO
- **`aggregated-cz-only.txt`** - 1,951 IPs from CZ
- **`aggregated-de-only.txt`** - 44,698 IPs from DE
- **`aggregated-dz-only.txt`** - 2,116 IPs from DZ
- **`aggregated-eg-only.txt`** - 3,794 IPs from EG
- **`aggregated-es-only.txt`** - 10,147 IPs from ES
- **`aggregated-et-only.txt`** - 1,050 IPs from ET
- **`aggregated-fr-only.txt`** - 24,886 IPs from FR
- **`aggregated-gb-only.txt`** - 33,609 IPs from GB
- **`aggregated-gh-only.txt`** - 633 IPs from GH
- **`aggregated-id-only.txt`** - 29,420 IPs from ID
- **`aggregated-in-only.txt`** - 79,949 IPs from IN
- **`aggregated-iq-only.txt`** - 2,384 IPs from IQ
- **`aggregated-ir-only.txt`** - 5,737 IPs from IR
- **`aggregated-it-only.txt`** - 15,912 IPs from IT
- **`aggregated-ke-only.txt`** - 2,926 IPs from KE
- **`aggregated-kr-only.txt`** - 16,612 IPs from KR
- **`aggregated-kz-only.txt`** - 2,797 IPs from KZ
- **`aggregated-lk-only.txt`** - 1,005 IPs from LK
- **`aggregated-ma-only.txt`** - 4,781 IPs from MA
- **`aggregated-mx-only.txt`** - 16,553 IPs from MX
- **`aggregated-my-only.txt`** - 6,237 IPs from MY
- **`aggregated-ng-only.txt`** - 1,685 IPs from NG
- **`aggregated-nl-only.txt`** - 51,518 IPs from NL
- **`aggregated-pe-only.txt`** - 2,109 IPs from PE
- **`aggregated-pk-only.txt`** - 18,286 IPs from PK
- **`aggregated-pl-only.txt`** - 8,571 IPs from PL
- **`aggregated-ro-only.txt`** - 2,607 IPs from RO
- **`aggregated-rs-only.txt`** - 1,342 IPs from RS
- **`aggregated-ru-only.txt`** - 30,108 IPs from RU
- **`aggregated-sa-only.txt`** - 4,662 IPs from SA
- **`aggregated-sg-only.txt`** - 36,580 IPs from SG
- **`aggregated-th-only.txt`** - 15,349 IPs from TH
- **`aggregated-tr-only.txt`** - 14,161 IPs from TR
- **`aggregated-tw-only.txt`** - 15,224 IPs from TW
- **`aggregated-ua-only.txt`** - 15,819 IPs from UA
- **`aggregated-us-only.txt`** - 250,313 IPs from US
- **`aggregated-ve-only.txt`** - 7,447 IPs from VE
- **`aggregated-vn-only.txt`** - 38,421 IPs from VN
- **`aggregated-za-only.txt`** - 8,749 IPs from ZA
- **`aggregated-multi-50countries-combined.txt`** - 1,192,371 unique IPs (deduplicated across all countries)
