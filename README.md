...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-1078945-2D56A8)
...
**Last Updated:** 2026-05-22 20:18:53 UTC
...
- **Total Input IPs:** 1,078,945
- **Countries Processed:** 50
- **Combined Unique IPs:** 955,396
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 167,217 | 165,713 | 207,296 | 19.21% | `aggregated-us-only.txt` |
| China | CN | 7,572 | 7,571 | 138,289 | 12.82% | `aggregated-cn-only.txt` |
| India | IN | 12,832 | 12,801 | 66,730 | 6.18% | `aggregated-in-only.txt` |
| Germany | DE | 28,842 | 28,762 | 40,766 | 3.78% | `aggregated-de-only.txt` |
| Russia | RU | 13,087 | 12,857 | 25,409 | 2.35% | `aggregated-ru-only.txt` |
| United Kingdom | GB | 33,930 | 33,764 | 31,052 | 2.88% | `aggregated-gb-only.txt` |
| Thailand | TH | 1,936 | 1,935 | 13,696 | 1.27% | `aggregated-th-only.txt` |
| Vietnam | VN | 2,142 | 2,142 | 35,924 | 3.33% | `aggregated-vn-only.txt` |
| South Korea | KR | 3,976 | 3,966 | 14,524 | 1.35% | `aggregated-kr-only.txt` |
| Brazil | BR | 13,022 | 12,952 | 44,721 | 4.14% | `aggregated-br-only.txt` |
| Taiwan | TW | 2,417 | 2,417 | 13,190 | 1.22% | `aggregated-tw-only.txt` |
| Canada | CA | 17,079 | 16,951 | 24,500 | 2.27% | `aggregated-ca-only.txt` |
| Singapore | SG | 9,249 | 9,239 | 32,717 | 3.03% | `aggregated-sg-only.txt` |
| Italy | IT | 9,537 | 9,513 | 14,111 | 1.31% | `aggregated-it-only.txt` |
| Netherlands | NL | 18,516 | 18,392 | 51,343 | 4.76% | `aggregated-nl-only.txt` |
| Indonesia | ID | 6,418 | 6,397 | 25,549 | 2.37% | `aggregated-id-only.txt` |
| France | FR | 32,086 | 32,060 | 20,615 | 1.91% | `aggregated-fr-only.txt` |
| Venezuela | VE | 924 | 924 | 6,552 | 0.61% | `aggregated-ve-only.txt` |
| Australia | AU | 12,099 | 12,029 | 16,089 | 1.49% | `aggregated-au-only.txt` |
| Turkey | TR | 3,406 | 3,380 | 12,421 | 1.15% | `aggregated-tr-only.txt` |
| Ukraine | UA | 5,551 | 5,496 | 8,141 | 0.75% | `aggregated-ua-only.txt` |
| Iran | IR | 2,016 | 2,015 | 3,922 | 0.36% | `aggregated-ir-only.txt` |
| Poland | PL | 8,036 | 8,005 | 7,516 | 0.70% | `aggregated-pl-only.txt` |
| Mexico | MX | 4,410 | 4,406 | 10,712 | 0.99% | `aggregated-mx-only.txt` |
| Spain | ES | 11,163 | 11,132 | 7,774 | 0.72% | `aggregated-es-only.txt` |
| Argentina | AR | 3,467 | 3,465 | 9,027 | 0.84% | `aggregated-ar-only.txt` |
| Egypt | EG | 716 | 716 | 2,786 | 0.26% | `aggregated-eg-only.txt` |
| Pakistan | PK | 1,319 | 1,319 | 13,521 | 1.25% | `aggregated-pk-only.txt` |
| Malaysia | MY | 2,492 | 2,492 | 5,250 | 0.49% | `aggregated-my-only.txt` |
| Bulgaria | BG | 2,275 | 2,265 | 2,797 | 0.26% | `aggregated-bg-only.txt` |
| Czechia | CZ | 3,605 | 3,604 | 1,738 | 0.16% | `aggregated-cz-only.txt` |
| Colombia | CO | 2,207 | 2,207 | 4,506 | 0.42% | `aggregated-co-only.txt` |
| United Arab Emirates | AE | 3,233 | 3,233 | 3,455 | 0.32% | `aggregated-ae-only.txt` |
| Romania | RO | 3,924 | 3,915 | 2,096 | 0.19% | `aggregated-ro-only.txt` |
| Kazakhstan | KZ | 1,259 | 1,258 | 2,393 | 0.22% | `aggregated-kz-only.txt` |
| Morocco | MA | 475 | 475 | 3,475 | 0.32% | `aggregated-ma-only.txt` |
| Saudi Arabia | SA | 1,623 | 1,623 | 3,776 | 0.35% | `aggregated-sa-only.txt` |
| South Africa | ZA | 3,965 | 3,952 | 7,050 | 0.65% | `aggregated-za-only.txt` |
| Bangladesh | BD | 2,614 | 2,609 | 5,227 | 0.48% | `aggregated-bd-only.txt` |
| Chile | CL | 1,886 | 1,886 | 2,415 | 0.22% | `aggregated-cl-only.txt` |
| Nigeria | NG | 1,072 | 1,072 | 1,149 | 0.11% | `aggregated-ng-only.txt` |
| Kenya | KE | 855 | 855 | 2,433 | 0.23% | `aggregated-ke-only.txt` |
| Algeria | DZ | 217 | 217 | 1,606 | 0.15% | `aggregated-dz-only.txt` |
...
| Iraq | IQ | 682 | 682 | 1,876 | 0.17% | `aggregated-iq-only.txt` |
...
- **`aggregated.txt`** - 1,078,945 total aggregated IPs from all sources
- **`aggregated-ae-only.txt`** - 3,455 IPs from AE
- **`aggregated-ar-only.txt`** - 9,027 IPs from AR
...
- **`aggregated-ca-only.txt`** - 24,500 IPs from CA
- **`aggregated-cl-only.txt`** - 2,415 IPs from CL
- **`aggregated-cn-only.txt`** - 138,289 IPs from CN
- **`aggregated-co-only.txt`** - 4,506 IPs from CO
- **`aggregated-cz-only.txt`** - 1,738 IPs from CZ
- **`aggregated-de-only.txt`** - 40,766 IPs from DE
- **`aggregated-dz-only.txt`** - 1,606 IPs from DZ
- **`aggregated-eg-only.txt`** - 2,786 IPs from EG
- **`aggregated-es-only.txt`** - 7,774 IPs from ES
- **`aggregated-et-only.txt`** - 896 IPs from ET
- **`aggregated-fr-only.txt`** - 20,615 IPs from FR
- **`aggregated-gb-only.txt`** - 31,052 IPs from GB
- **`aggregated-gh-only.txt`** - 504 IPs from GH
- **`aggregated-id-only.txt`** - 25,549 IPs from ID
- **`aggregated-in-only.txt`** - 66,730 IPs from IN
- **`aggregated-iq-only.txt`** - 1,876 IPs from IQ
- **`aggregated-ir-only.txt`** - 3,922 IPs from IR
- **`aggregated-it-only.txt`** - 14,111 IPs from IT
- **`aggregated-ke-only.txt`** - 2,433 IPs from KE
- **`aggregated-kr-only.txt`** - 14,524 IPs from KR
- **`aggregated-kz-only.txt`** - 2,393 IPs from KZ
- **`aggregated-lk-only.txt`** - 647 IPs from LK
- **`aggregated-ma-only.txt`** - 3,475 IPs from MA
- **`aggregated-mx-only.txt`** - 10,712 IPs from MX
- **`aggregated-my-only.txt`** - 5,250 IPs from MY
- **`aggregated-ng-only.txt`** - 1,149 IPs from NG
- **`aggregated-nl-only.txt`** - 51,343 IPs from NL
- **`aggregated-pe-only.txt`** - 1,519 IPs from PE
- **`aggregated-pk-only.txt`** - 13,521 IPs from PK
- **`aggregated-pl-only.txt`** - 7,516 IPs from PL
- **`aggregated-ro-only.txt`** - 2,096 IPs from RO
- **`aggregated-rs-only.txt`** - 1,012 IPs from RS
- **`aggregated-ru-only.txt`** - 25,409 IPs from RU
- **`aggregated-sa-only.txt`** - 3,776 IPs from SA
- **`aggregated-sg-only.txt`** - 32,717 IPs from SG
- **`aggregated-th-only.txt`** - 13,696 IPs from TH
- **`aggregated-tr-only.txt`** - 12,421 IPs from TR
- **`aggregated-tw-only.txt`** - 13,190 IPs from TW
- **`aggregated-ua-only.txt`** - 8,141 IPs from UA
- **`aggregated-us-only.txt`** - 207,296 IPs from US
- **`aggregated-ve-only.txt`** - 6,552 IPs from VE
- **`aggregated-vn-only.txt`** - 35,924 IPs from VN
- **`aggregated-za-only.txt`** - 7,050 IPs from ZA
- **`aggregated-multi-50countries-combined.txt`** - 955,396 unique IPs (deduplicated across all countries)
