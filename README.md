...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-896733-2D56A8)
...
**Last Updated:** 2026-05-13 04:16:26 UTC
...
- **Total Input IPs:** 896,733
- **Countries Processed:** 50
- **Combined Unique IPs:** 785,561
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 167,975 | 166,467 | 212,109 | 23.65% | `aggregated-us-only.txt` |
| China | CN | 7,573 | 7,572 | 121,472 | 13.55% | `aggregated-cn-only.txt` |
| India | IN | 12,849 | 12,821 | 28,456 | 3.17% | `aggregated-in-only.txt` |
| Germany | DE | 28,807 | 28,725 | 40,061 | 4.47% | `aggregated-de-only.txt` |
| Russia | RU | 13,075 | 12,845 | 20,824 | 2.32% | `aggregated-ru-only.txt` |
| United Kingdom | GB | 34,028 | 33,858 | 34,055 | 3.80% | `aggregated-gb-only.txt` |
| Thailand | TH | 1,943 | 1,942 | 11,915 | 1.33% | `aggregated-th-only.txt` |
| Vietnam | VN | 2,134 | 2,134 | 23,757 | 2.65% | `aggregated-vn-only.txt` |
| South Korea | KR | 3,984 | 3,974 | 17,389 | 1.94% | `aggregated-kr-only.txt` |
| Brazil | BR | 12,903 | 12,767 | 29,468 | 3.29% | `aggregated-br-only.txt` |
| Taiwan | TW | 2,418 | 2,418 | 11,762 | 1.31% | `aggregated-tw-only.txt` |
| Canada | CA | 17,039 | 16,905 | 22,044 | 2.46% | `aggregated-ca-only.txt` |
| Singapore | SG | 9,243 | 9,233 | 15,426 | 1.72% | `aggregated-sg-only.txt` |
| Italy | IT | 9,559 | 9,535 | 16,672 | 1.86% | `aggregated-it-only.txt` |
| Netherlands | NL | 18,372 | 18,250 | 36,817 | 4.11% | `aggregated-nl-only.txt` |
| Indonesia | ID | 6,412 | 6,393 | 14,328 | 1.60% | `aggregated-id-only.txt` |
| France | FR | 32,099 | 32,073 | 15,781 | 1.76% | `aggregated-fr-only.txt` |
| Venezuela | VE | 928 | 928 | 2,895 | 0.32% | `aggregated-ve-only.txt` |
| Australia | AU | 12,110 | 12,041 | 12,503 | 1.39% | `aggregated-au-only.txt` |
| Turkey | TR | 3,410 | 3,386 | 9,641 | 1.08% | `aggregated-tr-only.txt` |
| Ukraine | UA | 5,547 | 5,492 | 6,915 | 0.77% | `aggregated-ua-only.txt` |
| Iran | IR | 2,013 | 2,012 | 2,596 | 0.29% | `aggregated-ir-only.txt` |
| Poland | PL | 8,019 | 7,988 | 5,979 | 0.67% | `aggregated-pl-only.txt` |
| Mexico | MX | 4,378 | 4,374 | 8,878 | 0.99% | `aggregated-mx-only.txt` |
| Spain | ES | 10,946 | 10,915 | 6,766 | 0.75% | `aggregated-es-only.txt` |
| Argentina | AR | 3,471 | 3,469 | 7,148 | 0.80% | `aggregated-ar-only.txt` |
| Egypt | EG | 730 | 730 | 2,364 | 0.26% | `aggregated-eg-only.txt` |
| Pakistan | PK | 1,320 | 1,320 | 7,858 | 0.88% | `aggregated-pk-only.txt` |
| Malaysia | MY | 2,480 | 2,480 | 3,849 | 0.43% | `aggregated-my-only.txt` |
| Bulgaria | BG | 2,287 | 2,277 | 2,070 | 0.23% | `aggregated-bg-only.txt` |
| Czechia | CZ | 3,600 | 3,600 | 2,367 | 0.26% | `aggregated-cz-only.txt` |
| Colombia | CO | 2,222 | 2,222 | 3,361 | 0.37% | `aggregated-co-only.txt` |
| United Arab Emirates | AE | 3,232 | 3,232 | 2,936 | 0.33% | `aggregated-ae-only.txt` |
| Romania | RO | 3,917 | 3,908 | 1,842 | 0.21% | `aggregated-ro-only.txt` |
| Kazakhstan | KZ | 1,255 | 1,254 | 2,308 | 0.26% | `aggregated-kz-only.txt` |
| Morocco | MA | 478 | 478 | 3,008 | 0.34% | `aggregated-ma-only.txt` |
| Saudi Arabia | SA | 1,630 | 1,630 | 3,407 | 0.38% | `aggregated-sa-only.txt` |
...
| Serbia | RS | 951 | 949 | 1,003 | 0.11% | `aggregated-rs-only.txt` |
| Peru | PE | 1,103 | 1,102 | 1,077 | 0.12% | `aggregated-pe-only.txt` |
| Sri Lanka | LK | 249 | 249 | 762 | 0.08% | `aggregated-lk-only.txt` |
| Iraq | IQ | 680 | 680 | 799 | 0.09% | `aggregated-iq-only.txt` |
| Ethiopia | ET | 98 | 98 | 829 | 0.09% | `aggregated-et-only.txt` |
| Ghana | GH | 342 | 342 | 430 | 0.05% | `aggregated-gh-only.txt` |
...
- **`aggregated.txt`** - 896,733 total aggregated IPs from all sources
- **`aggregated-ae-only.txt`** - 2,936 IPs from AE
- **`aggregated-ar-only.txt`** - 7,148 IPs from AR
- **`aggregated-au-only.txt`** - 12,503 IPs from AU
- **`aggregated-bd-only.txt`** - 1,565 IPs from BD
- **`aggregated-bg-only.txt`** - 2,070 IPs from BG
- **`aggregated-br-only.txt`** - 29,468 IPs from BR
- **`aggregated-by-only.txt`** - 361 IPs from BY
- **`aggregated-ca-only.txt`** - 22,044 IPs from CA
- **`aggregated-cl-only.txt`** - 1,886 IPs from CL
- **`aggregated-cn-only.txt`** - 121,472 IPs from CN
- **`aggregated-co-only.txt`** - 3,361 IPs from CO
- **`aggregated-cz-only.txt`** - 2,367 IPs from CZ
- **`aggregated-de-only.txt`** - 40,061 IPs from DE
- **`aggregated-dz-only.txt`** - 1,370 IPs from DZ
- **`aggregated-eg-only.txt`** - 2,364 IPs from EG
- **`aggregated-es-only.txt`** - 6,766 IPs from ES
- **`aggregated-et-only.txt`** - 829 IPs from ET
- **`aggregated-fr-only.txt`** - 15,781 IPs from FR
- **`aggregated-gb-only.txt`** - 34,055 IPs from GB
- **`aggregated-gh-only.txt`** - 430 IPs from GH
- **`aggregated-id-only.txt`** - 14,328 IPs from ID
- **`aggregated-in-only.txt`** - 28,456 IPs from IN
- **`aggregated-iq-only.txt`** - 799 IPs from IQ
- **`aggregated-ir-only.txt`** - 2,596 IPs from IR
- **`aggregated-it-only.txt`** - 16,672 IPs from IT
- **`aggregated-ke-only.txt`** - 1,570 IPs from KE
- **`aggregated-kr-only.txt`** - 17,389 IPs from KR
- **`aggregated-kz-only.txt`** - 2,308 IPs from KZ
- **`aggregated-lk-only.txt`** - 762 IPs from LK
- **`aggregated-ma-only.txt`** - 3,008 IPs from MA
- **`aggregated-mx-only.txt`** - 8,878 IPs from MX
- **`aggregated-my-only.txt`** - 3,849 IPs from MY
- **`aggregated-ng-only.txt`** - 547 IPs from NG
- **`aggregated-nl-only.txt`** - 36,817 IPs from NL
- **`aggregated-pe-only.txt`** - 1,077 IPs from PE
- **`aggregated-pk-only.txt`** - 7,858 IPs from PK
- **`aggregated-pl-only.txt`** - 5,979 IPs from PL
- **`aggregated-ro-only.txt`** - 1,842 IPs from RO
- **`aggregated-rs-only.txt`** - 1,003 IPs from RS
- **`aggregated-ru-only.txt`** - 20,824 IPs from RU
- **`aggregated-sa-only.txt`** - 3,407 IPs from SA
- **`aggregated-sg-only.txt`** - 15,426 IPs from SG
- **`aggregated-th-only.txt`** - 11,915 IPs from TH
- **`aggregated-tr-only.txt`** - 9,641 IPs from TR
- **`aggregated-tw-only.txt`** - 11,762 IPs from TW
- **`aggregated-ua-only.txt`** - 6,915 IPs from UA
- **`aggregated-us-only.txt`** - 212,109 IPs from US
- **`aggregated-ve-only.txt`** - 2,895 IPs from VE
- **`aggregated-vn-only.txt`** - 23,757 IPs from VN
- **`aggregated-za-only.txt`** - 2,335 IPs from ZA
- **`aggregated-multi-50countries-combined.txt`** - 785,561 unique IPs (deduplicated across all countries)
