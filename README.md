...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-1128278-2D56A8)
...
**Last Updated:** 2026-06-18 10:53:48 UTC
...
- **Total Input IPs:** 1,128,278
- **Countries Processed:** 50
- **Combined Unique IPs:** 996,283
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 162,102 | 160,287 | 218,903 | 19.40% | `aggregated-us-only.txt` |
| China | CN | 7,798 | 7,797 | 140,205 | 12.43% | `aggregated-cn-only.txt` |
| India | IN | 12,962 | 12,931 | 71,856 | 6.37% | `aggregated-in-only.txt` |
| Germany | DE | 28,808 | 28,728 | 44,126 | 3.91% | `aggregated-de-only.txt` |
| Russia | RU | 13,175 | 12,935 | 25,913 | 2.30% | `aggregated-ru-only.txt` |
| United Kingdom | GB | 35,600 | 35,425 | 31,526 | 2.79% | `aggregated-gb-only.txt` |
| Thailand | TH | 1,945 | 1,945 | 13,913 | 1.23% | `aggregated-th-only.txt` |
| Vietnam | VN | 2,161 | 2,161 | 35,488 | 3.15% | `aggregated-vn-only.txt` |
| South Korea | KR | 3,954 | 3,944 | 14,824 | 1.31% | `aggregated-kr-only.txt` |
| Brazil | BR | 13,481 | 13,446 | 48,422 | 4.29% | `aggregated-br-only.txt` |
| Taiwan | TW | 2,421 | 2,421 | 13,570 | 1.20% | `aggregated-tw-only.txt` |
| Canada | CA | 16,986 | 16,858 | 25,147 | 2.23% | `aggregated-ca-only.txt` |
| Singapore | SG | 9,327 | 9,317 | 35,371 | 3.13% | `aggregated-sg-only.txt` |
| Italy | IT | 9,615 | 9,591 | 14,701 | 1.30% | `aggregated-it-only.txt` |
| Netherlands | NL | 18,797 | 18,662 | 51,174 | 4.54% | `aggregated-nl-only.txt` |
| Indonesia | ID | 6,427 | 6,406 | 26,608 | 2.36% | `aggregated-id-only.txt` |
| France | FR | 32,688 | 32,662 | 20,887 | 1.85% | `aggregated-fr-only.txt` |
| Venezuela | VE | 940 | 940 | 6,741 | 0.60% | `aggregated-ve-only.txt` |
| Australia | AU | 12,043 | 11,960 | 16,787 | 1.49% | `aggregated-au-only.txt` |
| Turkey | TR | 3,433 | 3,409 | 13,079 | 1.16% | `aggregated-tr-only.txt` |
| Ukraine | UA | 5,549 | 5,494 | 8,235 | 0.73% | `aggregated-ua-only.txt` |
| Iran | IR | 2,032 | 2,031 | 4,541 | 0.40% | `aggregated-ir-only.txt` |
| Poland | PL | 8,080 | 8,050 | 7,577 | 0.67% | `aggregated-pl-only.txt` |
| Mexico | MX | 4,387 | 4,383 | 11,723 | 1.04% | `aggregated-mx-only.txt` |
| Spain | ES | 11,015 | 10,993 | 8,200 | 0.73% | `aggregated-es-only.txt` |
| Argentina | AR | 3,454 | 3,452 | 9,505 | 0.84% | `aggregated-ar-only.txt` |
| Egypt | EG | 731 | 731 | 3,082 | 0.27% | `aggregated-eg-only.txt` |
| Pakistan | PK | 1,343 | 1,341 | 14,818 | 1.31% | `aggregated-pk-only.txt` |
| Malaysia | MY | 2,523 | 2,523 | 5,476 | 0.49% | `aggregated-my-only.txt` |
| Bulgaria | BG | 2,326 | 2,315 | 2,857 | 0.25% | `aggregated-bg-only.txt` |
| Czechia | CZ | 3,655 | 3,654 | 1,745 | 0.15% | `aggregated-cz-only.txt` |
| Colombia | CO | 2,207 | 2,207 | 4,729 | 0.42% | `aggregated-co-only.txt` |
| United Arab Emirates | AE | 3,300 | 3,300 | 3,693 | 0.33% | `aggregated-ae-only.txt` |
| Romania | RO | 4,009 | 3,999 | 2,201 | 0.20% | `aggregated-ro-only.txt` |
| Kazakhstan | KZ | 1,308 | 1,307 | 2,476 | 0.22% | `aggregated-kz-only.txt` |
| Morocco | MA | 476 | 476 | 3,685 | 0.33% | `aggregated-ma-only.txt` |
| Saudi Arabia | SA | 1,632 | 1,632 | 4,063 | 0.36% | `aggregated-sa-only.txt` |
| South Africa | ZA | 3,966 | 3,952 | 6,802 | 0.60% | `aggregated-za-only.txt` |
| Bangladesh | BD | 2,628 | 2,626 | 5,550 | 0.49% | `aggregated-bd-only.txt` |
| Chile | CL | 1,910 | 1,909 | 2,655 | 0.24% | `aggregated-cl-only.txt` |
| Nigeria | NG | 1,077 | 1,077 | 1,270 | 0.11% | `aggregated-ng-only.txt` |
| Kenya | KE | 867 | 867 | 2,659 | 0.24% | `aggregated-ke-only.txt` |
| Algeria | DZ | 219 | 219 | 1,773 | 0.16% | `aggregated-dz-only.txt` |
| Serbia | RS | 959 | 957 | 1,080 | 0.10% | `aggregated-rs-only.txt` |
| Peru | PE | 1,103 | 1,102 | 1,630 | 0.14% | `aggregated-pe-only.txt` |
| Sri Lanka | LK | 249 | 249 | 799 | 0.07% | `aggregated-lk-only.txt` |
...
- **`aggregated.txt`** - 1,128,278 total aggregated IPs from all sources
- **`aggregated-ae-only.txt`** - 3,693 IPs from AE
- **`aggregated-ar-only.txt`** - 9,505 IPs from AR
- **`aggregated-au-only.txt`** - 16,787 IPs from AU
- **`aggregated-bd-only.txt`** - 5,550 IPs from BD
- **`aggregated-bg-only.txt`** - 2,857 IPs from BG
- **`aggregated-br-only.txt`** - 48,422 IPs from BR
- **`aggregated-by-only.txt`** - 670 IPs from BY
- **`aggregated-ca-only.txt`** - 25,147 IPs from CA
- **`aggregated-cl-only.txt`** - 2,655 IPs from CL
- **`aggregated-cn-only.txt`** - 140,205 IPs from CN
- **`aggregated-co-only.txt`** - 4,729 IPs from CO
- **`aggregated-cz-only.txt`** - 1,745 IPs from CZ
- **`aggregated-de-only.txt`** - 44,126 IPs from DE
- **`aggregated-dz-only.txt`** - 1,773 IPs from DZ
- **`aggregated-eg-only.txt`** - 3,082 IPs from EG
- **`aggregated-es-only.txt`** - 8,200 IPs from ES
- **`aggregated-et-only.txt`** - 957 IPs from ET
- **`aggregated-fr-only.txt`** - 20,887 IPs from FR
- **`aggregated-gb-only.txt`** - 31,526 IPs from GB
- **`aggregated-gh-only.txt`** - 520 IPs from GH
- **`aggregated-id-only.txt`** - 26,608 IPs from ID
- **`aggregated-in-only.txt`** - 71,856 IPs from IN
- **`aggregated-iq-only.txt`** - 2,071 IPs from IQ
- **`aggregated-ir-only.txt`** - 4,541 IPs from IR
- **`aggregated-it-only.txt`** - 14,701 IPs from IT
- **`aggregated-ke-only.txt`** - 2,659 IPs from KE
- **`aggregated-kr-only.txt`** - 14,824 IPs from KR
- **`aggregated-kz-only.txt`** - 2,476 IPs from KZ
- **`aggregated-lk-only.txt`** - 799 IPs from LK
- **`aggregated-ma-only.txt`** - 3,685 IPs from MA
- **`aggregated-mx-only.txt`** - 11,723 IPs from MX
- **`aggregated-my-only.txt`** - 5,476 IPs from MY
- **`aggregated-ng-only.txt`** - 1,270 IPs from NG
- **`aggregated-nl-only.txt`** - 51,174 IPs from NL
- **`aggregated-pe-only.txt`** - 1,630 IPs from PE
- **`aggregated-pk-only.txt`** - 14,818 IPs from PK
- **`aggregated-pl-only.txt`** - 7,577 IPs from PL
- **`aggregated-ro-only.txt`** - 2,201 IPs from RO
- **`aggregated-rs-only.txt`** - 1,080 IPs from RS
- **`aggregated-ru-only.txt`** - 25,913 IPs from RU
- **`aggregated-sa-only.txt`** - 4,063 IPs from SA
- **`aggregated-sg-only.txt`** - 35,371 IPs from SG
- **`aggregated-th-only.txt`** - 13,913 IPs from TH
- **`aggregated-tr-only.txt`** - 13,079 IPs from TR
- **`aggregated-tw-only.txt`** - 13,570 IPs from TW
- **`aggregated-ua-only.txt`** - 8,235 IPs from UA
- **`aggregated-us-only.txt`** - 218,903 IPs from US
- **`aggregated-ve-only.txt`** - 6,741 IPs from VE
- **`aggregated-vn-only.txt`** - 35,488 IPs from VN
- **`aggregated-za-only.txt`** - 6,802 IPs from ZA
- **`aggregated-multi-50countries-combined.txt`** - 996,283 unique IPs (deduplicated across all countries)
