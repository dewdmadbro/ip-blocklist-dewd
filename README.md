...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-1446805-2D56A8)
...
**Last Updated:** 2026-09-06 04:53:56 UTC
...
- **Total Input IPs:** 1,446,805
- **Countries Processed:** 50
- **Combined Unique IPs:** 1,276,185
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 130,282 | 128,440 | 274,145 | 18.95% | `aggregated-us-only.txt` |
| China | CN | 7,830 | 7,829 | 220,891 | 15.27% | `aggregated-cn-only.txt` |
| India | IN | 13,289 | 13,260 | 81,332 | 5.62% | `aggregated-in-only.txt` |
| Germany | DE | 29,980 | 29,865 | 45,131 | 3.12% | `aggregated-de-only.txt` |
| Russia | RU | 13,215 | 12,981 | 31,024 | 2.14% | `aggregated-ru-only.txt` |
| United Kingdom | GB | 35,923 | 35,760 | 34,394 | 2.38% | `aggregated-gb-only.txt` |
| Thailand | TH | 2,062 | 2,062 | 15,738 | 1.09% | `aggregated-th-only.txt` |
| Vietnam | VN | 2,222 | 2,222 | 38,532 | 2.66% | `aggregated-vn-only.txt` |
| South Korea | KR | 3,943 | 3,932 | 17,112 | 1.18% | `aggregated-kr-only.txt` |
| Brazil | BR | 12,586 | 12,544 | 85,795 | 5.93% | `aggregated-br-only.txt` |
| Taiwan | TW | 2,411 | 2,411 | 16,135 | 1.12% | `aggregated-tw-only.txt` |
| Canada | CA | 17,185 | 17,069 | 27,316 | 1.89% | `aggregated-ca-only.txt` |
| Singapore | SG | 9,598 | 9,588 | 38,705 | 2.68% | `aggregated-sg-only.txt` |
| Italy | IT | 9,808 | 9,786 | 16,564 | 1.14% | `aggregated-it-only.txt` |
| Netherlands | NL | 19,163 | 19,049 | 52,336 | 3.62% | `aggregated-nl-only.txt` |
| Indonesia | ID | 6,616 | 6,595 | 31,280 | 2.16% | `aggregated-id-only.txt` |
| France | FR | 33,424 | 33,396 | 26,835 | 1.85% | `aggregated-fr-only.txt` |
| Venezuela | VE | 979 | 979 | 7,805 | 0.54% | `aggregated-ve-only.txt` |
| Australia | AU | 12,309 | 12,242 | 17,785 | 1.23% | `aggregated-au-only.txt` |
| Turkey | TR | 3,540 | 3,520 | 15,721 | 1.09% | `aggregated-tr-only.txt` |
| Ukraine | UA | 5,554 | 5,509 | 16,725 | 1.16% | `aggregated-ua-only.txt` |
| Iran | IR | 2,069 | 2,068 | 5,522 | 0.38% | `aggregated-ir-only.txt` |
| Poland | PL | 8,247 | 8,218 | 8,692 | 0.60% | `aggregated-pl-only.txt` |
| Mexico | MX | 4,317 | 4,313 | 18,328 | 1.27% | `aggregated-mx-only.txt` |
| Spain | ES | 11,404 | 11,370 | 11,282 | 0.78% | `aggregated-es-only.txt` |
| Argentina | AR | 3,498 | 3,496 | 17,104 | 1.18% | `aggregated-ar-only.txt` |
| Egypt | EG | 740 | 740 | 3,836 | 0.27% | `aggregated-eg-only.txt` |
| Pakistan | PK | 1,378 | 1,377 | 19,619 | 1.36% | `aggregated-pk-only.txt` |
| Malaysia | MY | 2,615 | 2,615 | 6,643 | 0.46% | `aggregated-my-only.txt` |
| Bulgaria | BG | 2,365 | 2,351 | 3,298 | 0.23% | `aggregated-bg-only.txt` |
| Czechia | CZ | 3,696 | 3,695 | 2,069 | 0.14% | `aggregated-cz-only.txt` |
| Colombia | CO | 2,250 | 2,250 | 7,608 | 0.53% | `aggregated-co-only.txt` |
| United Arab Emirates | AE | 3,788 | 3,788 | 5,172 | 0.36% | `aggregated-ae-only.txt` |
| Romania | RO | 4,057 | 4,048 | 2,831 | 0.20% | `aggregated-ro-only.txt` |
| Kazakhstan | KZ | 1,288 | 1,287 | 2,994 | 0.21% | `aggregated-kz-only.txt` |
| Morocco | MA | 489 | 489 | 4,966 | 0.34% | `aggregated-ma-only.txt` |
| Saudi Arabia | SA | 1,723 | 1,723 | 5,408 | 0.37% | `aggregated-sa-only.txt` |
| South Africa | ZA | 4,070 | 4,056 | 9,398 | 0.65% | `aggregated-za-only.txt` |
| Bangladesh | BD | 2,713 | 2,711 | 7,731 | 0.53% | `aggregated-bd-only.txt` |
| Chile | CL | 2,001 | 1,999 | 4,976 | 0.34% | `aggregated-cl-only.txt` |
| Nigeria | NG | 1,126 | 1,126 | 1,650 | 0.11% | `aggregated-ng-only.txt` |
| Kenya | KE | 883 | 883 | 3,217 | 0.22% | `aggregated-ke-only.txt` |
| Algeria | DZ | 220 | 220 | 2,224 | 0.15% | `aggregated-dz-only.txt` |
| Serbia | RS | 1,004 | 1,004 | 1,407 | 0.10% | `aggregated-rs-only.txt` |
| Peru | PE | 1,123 | 1,122 | 2,246 | 0.16% | `aggregated-pe-only.txt` |
| Sri Lanka | LK | 252 | 252 | 985 | 0.07% | `aggregated-lk-only.txt` |
| Iraq | IQ | 675 | 675 | 2,902 | 0.20% | `aggregated-iq-only.txt` |
| Ethiopia | ET | 100 | 100 | 1,217 | 0.08% | `aggregated-et-only.txt` |
| Ghana | GH | 354 | 354 | 675 | 0.05% | `aggregated-gh-only.txt` |
| Belarus | BY | 424 | 424 | 884 | 0.06% | `aggregated-by-only.txt` |
...
- **`aggregated.txt`** - 1,446,805 total aggregated IPs from all sources
- **`aggregated-ae-only.txt`** - 5,172 IPs from AE
- **`aggregated-ar-only.txt`** - 17,104 IPs from AR
- **`aggregated-au-only.txt`** - 17,785 IPs from AU
- **`aggregated-bd-only.txt`** - 7,731 IPs from BD
- **`aggregated-bg-only.txt`** - 3,298 IPs from BG
- **`aggregated-br-only.txt`** - 85,795 IPs from BR
- **`aggregated-by-only.txt`** - 884 IPs from BY
- **`aggregated-ca-only.txt`** - 27,316 IPs from CA
- **`aggregated-cl-only.txt`** - 4,976 IPs from CL
- **`aggregated-cn-only.txt`** - 220,891 IPs from CN
- **`aggregated-co-only.txt`** - 7,608 IPs from CO
- **`aggregated-cz-only.txt`** - 2,069 IPs from CZ
- **`aggregated-de-only.txt`** - 45,131 IPs from DE
- **`aggregated-dz-only.txt`** - 2,224 IPs from DZ
- **`aggregated-eg-only.txt`** - 3,836 IPs from EG
- **`aggregated-es-only.txt`** - 11,282 IPs from ES
- **`aggregated-et-only.txt`** - 1,217 IPs from ET
- **`aggregated-fr-only.txt`** - 26,835 IPs from FR
- **`aggregated-gb-only.txt`** - 34,394 IPs from GB
- **`aggregated-gh-only.txt`** - 675 IPs from GH
- **`aggregated-id-only.txt`** - 31,280 IPs from ID
- **`aggregated-in-only.txt`** - 81,332 IPs from IN
- **`aggregated-iq-only.txt`** - 2,902 IPs from IQ
- **`aggregated-ir-only.txt`** - 5,522 IPs from IR
- **`aggregated-it-only.txt`** - 16,564 IPs from IT
- **`aggregated-ke-only.txt`** - 3,217 IPs from KE
- **`aggregated-kr-only.txt`** - 17,112 IPs from KR
- **`aggregated-kz-only.txt`** - 2,994 IPs from KZ
- **`aggregated-lk-only.txt`** - 985 IPs from LK
- **`aggregated-ma-only.txt`** - 4,966 IPs from MA
- **`aggregated-mx-only.txt`** - 18,328 IPs from MX
- **`aggregated-my-only.txt`** - 6,643 IPs from MY
- **`aggregated-ng-only.txt`** - 1,650 IPs from NG
- **`aggregated-nl-only.txt`** - 52,336 IPs from NL
- **`aggregated-pe-only.txt`** - 2,246 IPs from PE
- **`aggregated-pk-only.txt`** - 19,619 IPs from PK
- **`aggregated-pl-only.txt`** - 8,692 IPs from PL
- **`aggregated-ro-only.txt`** - 2,831 IPs from RO
- **`aggregated-rs-only.txt`** - 1,407 IPs from RS
- **`aggregated-ru-only.txt`** - 31,024 IPs from RU
- **`aggregated-sa-only.txt`** - 5,408 IPs from SA
- **`aggregated-sg-only.txt`** - 38,705 IPs from SG
- **`aggregated-th-only.txt`** - 15,738 IPs from TH
- **`aggregated-tr-only.txt`** - 15,721 IPs from TR
- **`aggregated-tw-only.txt`** - 16,135 IPs from TW
- **`aggregated-ua-only.txt`** - 16,725 IPs from UA
- **`aggregated-us-only.txt`** - 274,145 IPs from US
- **`aggregated-ve-only.txt`** - 7,805 IPs from VE
- **`aggregated-vn-only.txt`** - 38,532 IPs from VN
- **`aggregated-za-only.txt`** - 9,398 IPs from ZA
- **`aggregated-multi-50countries-combined.txt`** - 1,276,185 unique IPs (deduplicated across all countries)
