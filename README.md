...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-901057-2D56A8)
...
**Last Updated:** 2026-05-03 13:52:07 UTC
...
- **Total Input IPs:** 901,057
- **Countries Processed:** 50
- **Combined Unique IPs:** 798,738
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 169,198 | 167,680 | 145,817 | 16.18% | `aggregated-us-only.txt` |
| China | CN | 7,598 | 7,597 | 126,228 | 14.01% | `aggregated-cn-only.txt` |
| India | IN | 12,838 | 12,810 | 53,046 | 5.89% | `aggregated-in-only.txt` |
| Germany | DE | 28,972 | 28,867 | 34,637 | 3.84% | `aggregated-de-only.txt` |
| Russia | RU | 13,120 | 12,898 | 19,750 | 2.19% | `aggregated-ru-only.txt` |
| United Kingdom | GB | 33,411 | 33,252 | 26,320 | 2.92% | `aggregated-gb-only.txt` |
| Thailand | TH | 1,947 | 1,945 | 12,397 | 1.38% | `aggregated-th-only.txt` |
| Vietnam | VN | 2,128 | 2,128 | 26,639 | 2.96% | `aggregated-vn-only.txt` |
| South Korea | KR | 4,006 | 3,996 | 12,819 | 1.42% | `aggregated-kr-only.txt` |
| Brazil | BR | 12,782 | 12,630 | 41,319 | 4.59% | `aggregated-br-only.txt` |
| Taiwan | TW | 2,413 | 2,413 | 10,906 | 1.21% | `aggregated-tw-only.txt` |
| Canada | CA | 16,890 | 16,768 | 21,170 | 2.35% | `aggregated-ca-only.txt` |
| Singapore | SG | 9,268 | 9,258 | 27,534 | 3.06% | `aggregated-sg-only.txt` |
| Italy | IT | 9,580 | 9,556 | 13,291 | 1.48% | `aggregated-it-only.txt` |
| Netherlands | NL | 18,273 | 18,151 | 47,537 | 5.28% | `aggregated-nl-only.txt` |
| Indonesia | ID | 6,409 | 6,390 | 22,076 | 2.45% | `aggregated-id-only.txt` |
| France | FR | 32,393 | 32,367 | 17,622 | 1.96% | `aggregated-fr-only.txt` |
| Venezuela | VE | 900 | 900 | 4,261 | 0.47% | `aggregated-ve-only.txt` |
| Australia | AU | 11,396 | 11,317 | 14,940 | 1.66% | `aggregated-au-only.txt` |
| Turkey | TR | 3,399 | 3,371 | 12,836 | 1.42% | `aggregated-tr-only.txt` |
| Ukraine | UA | 5,540 | 5,481 | 7,599 | 0.84% | `aggregated-ua-only.txt` |
| Iran | IR | 2,012 | 2,011 | 3,266 | 0.36% | `aggregated-ir-only.txt` |
| Poland | PL | 8,011 | 7,976 | 5,188 | 0.58% | `aggregated-pl-only.txt` |
| Mexico | MX | 4,307 | 4,303 | 9,882 | 1.10% | `aggregated-mx-only.txt` |
| Spain | ES | 11,140 | 11,107 | 6,251 | 0.69% | `aggregated-es-only.txt` |
| Argentina | AR | 3,445 | 3,443 | 8,621 | 0.96% | `aggregated-ar-only.txt` |
| Egypt | EG | 716 | 716 | 2,814 | 0.31% | `aggregated-eg-only.txt` |
| Pakistan | PK | 1,320 | 1,320 | 12,234 | 1.36% | `aggregated-pk-only.txt` |
...
| Romania | RO | 3,916 | 3,907 | 1,612 | 0.18% | `aggregated-ro-only.txt` |
| Kazakhstan | KZ | 1,349 | 1,348 | 2,123 | 0.24% | `aggregated-kz-only.txt` |
| Morocco | MA | 478 | 478 | 3,577 | 0.40% | `aggregated-ma-only.txt` |
| Saudi Arabia | SA | 1,617 | 1,617 | 4,156 | 0.46% | `aggregated-sa-only.txt` |
| South Africa | ZA | 3,955 | 3,942 | 5,079 | 0.56% | `aggregated-za-only.txt` |
...
| Iraq | IQ | 681 | 681 | 1,578 | 0.18% | `aggregated-iq-only.txt` |
...
- **`aggregated.txt`** - 901,057 total aggregated IPs from all sources
...
- **`aggregated-br-only.txt`** - 41,319 IPs from BR
- **`aggregated-by-only.txt`** - 644 IPs from BY
- **`aggregated-ca-only.txt`** - 21,170 IPs from CA
- **`aggregated-cl-only.txt`** - 2,959 IPs from CL
- **`aggregated-cn-only.txt`** - 126,228 IPs from CN
- **`aggregated-co-only.txt`** - 4,155 IPs from CO
- **`aggregated-cz-only.txt`** - 1,398 IPs from CZ
- **`aggregated-de-only.txt`** - 34,637 IPs from DE
- **`aggregated-dz-only.txt`** - 1,539 IPs from DZ
- **`aggregated-eg-only.txt`** - 2,814 IPs from EG
- **`aggregated-es-only.txt`** - 6,251 IPs from ES
- **`aggregated-et-only.txt`** - 960 IPs from ET
- **`aggregated-fr-only.txt`** - 17,622 IPs from FR
- **`aggregated-gb-only.txt`** - 26,320 IPs from GB
- **`aggregated-gh-only.txt`** - 481 IPs from GH
- **`aggregated-id-only.txt`** - 22,076 IPs from ID
- **`aggregated-in-only.txt`** - 53,046 IPs from IN
- **`aggregated-iq-only.txt`** - 1,578 IPs from IQ
...
- **`aggregated-mx-only.txt`** - 9,882 IPs from MX
- **`aggregated-my-only.txt`** - 5,231 IPs from MY
- **`aggregated-ng-only.txt`** - 1,164 IPs from NG
- **`aggregated-nl-only.txt`** - 47,537 IPs from NL
- **`aggregated-pe-only.txt`** - 1,300 IPs from PE
- **`aggregated-pk-only.txt`** - 12,234 IPs from PK
- **`aggregated-pl-only.txt`** - 5,188 IPs from PL
- **`aggregated-ro-only.txt`** - 1,612 IPs from RO
- **`aggregated-rs-only.txt`** - 963 IPs from RS
- **`aggregated-ru-only.txt`** - 19,750 IPs from RU
- **`aggregated-sa-only.txt`** - 4,156 IPs from SA
- **`aggregated-sg-only.txt`** - 27,534 IPs from SG
- **`aggregated-th-only.txt`** - 12,397 IPs from TH
- **`aggregated-tr-only.txt`** - 12,836 IPs from TR
- **`aggregated-tw-only.txt`** - 10,906 IPs from TW
- **`aggregated-ua-only.txt`** - 7,599 IPs from UA
- **`aggregated-us-only.txt`** - 145,817 IPs from US
- **`aggregated-ve-only.txt`** - 4,261 IPs from VE
- **`aggregated-vn-only.txt`** - 26,639 IPs from VN
- **`aggregated-za-only.txt`** - 5,079 IPs from ZA
- **`aggregated-multi-50countries-combined.txt`** - 798,738 unique IPs (deduplicated across all countries)
