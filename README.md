...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-1078076-2D56A8)
...
**Last Updated:** 2026-05-22 15:31:14 UTC
...
- **Total Input IPs:** 1,078,076
- **Countries Processed:** 50
- **Combined Unique IPs:** 954,638
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 167,217 | 165,713 | 207,129 | 19.21% | `aggregated-us-only.txt` |
| China | CN | 7,572 | 7,571 | 138,182 | 12.82% | `aggregated-cn-only.txt` |
| India | IN | 12,832 | 12,801 | 66,703 | 6.19% | `aggregated-in-only.txt` |
| Germany | DE | 28,842 | 28,762 | 40,715 | 3.78% | `aggregated-de-only.txt` |
| Russia | RU | 13,087 | 12,857 | 25,394 | 2.36% | `aggregated-ru-only.txt` |
| United Kingdom | GB | 33,930 | 33,764 | 31,048 | 2.88% | `aggregated-gb-only.txt` |
| Thailand | TH | 1,936 | 1,935 | 13,694 | 1.27% | `aggregated-th-only.txt` |
| Vietnam | VN | 2,142 | 2,142 | 35,900 | 3.33% | `aggregated-vn-only.txt` |
| South Korea | KR | 3,976 | 3,966 | 14,515 | 1.35% | `aggregated-kr-only.txt` |
| Brazil | BR | 13,022 | 12,952 | 44,637 | 4.14% | `aggregated-br-only.txt` |
| Taiwan | TW | 2,417 | 2,417 | 13,183 | 1.22% | `aggregated-tw-only.txt` |
| Canada | CA | 17,079 | 16,951 | 24,488 | 2.27% | `aggregated-ca-only.txt` |
| Singapore | SG | 9,249 | 9,239 | 32,695 | 3.03% | `aggregated-sg-only.txt` |
| Italy | IT | 9,537 | 9,513 | 14,102 | 1.31% | `aggregated-it-only.txt` |
| Netherlands | NL | 18,516 | 18,392 | 51,327 | 4.76% | `aggregated-nl-only.txt` |
| Indonesia | ID | 6,418 | 6,397 | 25,542 | 2.37% | `aggregated-id-only.txt` |
| France | FR | 32,086 | 32,060 | 20,575 | 1.91% | `aggregated-fr-only.txt` |
| Venezuela | VE | 924 | 924 | 6,545 | 0.61% | `aggregated-ve-only.txt` |
| Australia | AU | 12,099 | 12,029 | 16,082 | 1.49% | `aggregated-au-only.txt` |
| Turkey | TR | 3,406 | 3,380 | 12,413 | 1.15% | `aggregated-tr-only.txt` |
| Ukraine | UA | 5,551 | 5,496 | 8,137 | 0.75% | `aggregated-ua-only.txt` |
...
| Spain | ES | 11,163 | 11,132 | 7,760 | 0.72% | `aggregated-es-only.txt` |
| Argentina | AR | 3,467 | 3,465 | 9,004 | 0.84% | `aggregated-ar-only.txt` |
| Egypt | EG | 716 | 716 | 2,784 | 0.26% | `aggregated-eg-only.txt` |
| Pakistan | PK | 1,319 | 1,319 | 13,528 | 1.25% | `aggregated-pk-only.txt` |
| Malaysia | MY | 2,492 | 2,492 | 5,243 | 0.49% | `aggregated-my-only.txt` |
| Bulgaria | BG | 2,275 | 2,265 | 2,775 | 0.26% | `aggregated-bg-only.txt` |
| Czechia | CZ | 3,605 | 3,604 | 1,732 | 0.16% | `aggregated-cz-only.txt` |
...
| Kazakhstan | KZ | 1,259 | 1,258 | 2,392 | 0.22% | `aggregated-kz-only.txt` |
| Morocco | MA | 475 | 475 | 3,470 | 0.32% | `aggregated-ma-only.txt` |
| Saudi Arabia | SA | 1,623 | 1,623 | 3,773 | 0.35% | `aggregated-sa-only.txt` |
| South Africa | ZA | 3,965 | 3,952 | 7,043 | 0.65% | `aggregated-za-only.txt` |
| Bangladesh | BD | 2,614 | 2,609 | 5,218 | 0.48% | `aggregated-bd-only.txt` |
| Chile | CL | 1,886 | 1,886 | 2,414 | 0.22% | `aggregated-cl-only.txt` |
| Nigeria | NG | 1,072 | 1,072 | 1,148 | 0.11% | `aggregated-ng-only.txt` |
...
| Peru | PE | 1,093 | 1,092 | 1,516 | 0.14% | `aggregated-pe-only.txt` |
| Sri Lanka | LK | 247 | 247 | 650 | 0.06% | `aggregated-lk-only.txt` |
| Iraq | IQ | 682 | 682 | 1,875 | 0.17% | `aggregated-iq-only.txt` |
| Ethiopia | ET | 98 | 98 | 894 | 0.08% | `aggregated-et-only.txt` |
| Ghana | GH | 341 | 341 | 505 | 0.05% | `aggregated-gh-only.txt` |
...
- **`aggregated.txt`** - 1,078,076 total aggregated IPs from all sources
- **`aggregated-ae-only.txt`** - 3,450 IPs from AE
- **`aggregated-ar-only.txt`** - 9,004 IPs from AR
- **`aggregated-au-only.txt`** - 16,082 IPs from AU
- **`aggregated-bd-only.txt`** - 5,218 IPs from BD
- **`aggregated-bg-only.txt`** - 2,775 IPs from BG
- **`aggregated-br-only.txt`** - 44,637 IPs from BR
- **`aggregated-by-only.txt`** - 682 IPs from BY
- **`aggregated-ca-only.txt`** - 24,488 IPs from CA
- **`aggregated-cl-only.txt`** - 2,414 IPs from CL
- **`aggregated-cn-only.txt`** - 138,182 IPs from CN
- **`aggregated-co-only.txt`** - 4,504 IPs from CO
- **`aggregated-cz-only.txt`** - 1,732 IPs from CZ
- **`aggregated-de-only.txt`** - 40,715 IPs from DE
- **`aggregated-dz-only.txt`** - 1,603 IPs from DZ
- **`aggregated-eg-only.txt`** - 2,784 IPs from EG
- **`aggregated-es-only.txt`** - 7,760 IPs from ES
- **`aggregated-et-only.txt`** - 894 IPs from ET
- **`aggregated-fr-only.txt`** - 20,575 IPs from FR
- **`aggregated-gb-only.txt`** - 31,048 IPs from GB
- **`aggregated-gh-only.txt`** - 505 IPs from GH
- **`aggregated-id-only.txt`** - 25,542 IPs from ID
- **`aggregated-in-only.txt`** - 66,703 IPs from IN
- **`aggregated-iq-only.txt`** - 1,875 IPs from IQ
- **`aggregated-ir-only.txt`** - 3,922 IPs from IR
- **`aggregated-it-only.txt`** - 14,102 IPs from IT
- **`aggregated-ke-only.txt`** - 2,431 IPs from KE
- **`aggregated-kr-only.txt`** - 14,515 IPs from KR
- **`aggregated-kz-only.txt`** - 2,392 IPs from KZ
- **`aggregated-lk-only.txt`** - 650 IPs from LK
- **`aggregated-ma-only.txt`** - 3,470 IPs from MA
- **`aggregated-mx-only.txt`** - 10,696 IPs from MX
- **`aggregated-my-only.txt`** - 5,243 IPs from MY
- **`aggregated-ng-only.txt`** - 1,148 IPs from NG
- **`aggregated-nl-only.txt`** - 51,327 IPs from NL
- **`aggregated-pe-only.txt`** - 1,516 IPs from PE
- **`aggregated-pk-only.txt`** - 13,528 IPs from PK
- **`aggregated-pl-only.txt`** - 7,513 IPs from PL
- **`aggregated-ro-only.txt`** - 2,096 IPs from RO
- **`aggregated-rs-only.txt`** - 1,011 IPs from RS
- **`aggregated-ru-only.txt`** - 25,394 IPs from RU
- **`aggregated-sa-only.txt`** - 3,773 IPs from SA
- **`aggregated-sg-only.txt`** - 32,695 IPs from SG
- **`aggregated-th-only.txt`** - 13,694 IPs from TH
- **`aggregated-tr-only.txt`** - 12,413 IPs from TR
- **`aggregated-tw-only.txt`** - 13,183 IPs from TW
- **`aggregated-ua-only.txt`** - 8,137 IPs from UA
- **`aggregated-us-only.txt`** - 207,129 IPs from US
- **`aggregated-ve-only.txt`** - 6,545 IPs from VE
- **`aggregated-vn-only.txt`** - 35,900 IPs from VN
- **`aggregated-za-only.txt`** - 7,043 IPs from ZA
- **`aggregated-multi-50countries-combined.txt`** - 954,638 unique IPs (deduplicated across all countries)
