...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-1254926-2D56A8)
...
**Last Updated:** 2026-07-22 14:33:32 UTC
...
- **Total Input IPs:** 1,254,926
- **Countries Processed:** 50
- **Combined Unique IPs:** 1,103,748
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 137,787 | 135,973 | 234,557 | 18.69% | `aggregated-us-only.txt` |
| China | CN | 7,716 | 7,715 | 170,569 | 13.59% | `aggregated-cn-only.txt` |
| India | IN | 13,160 | 13,130 | 75,864 | 6.05% | `aggregated-in-only.txt` |
| Germany | DE | 29,153 | 29,083 | 46,281 | 3.69% | `aggregated-de-only.txt` |
| Russia | RU | 13,272 | 13,034 | 27,339 | 2.18% | `aggregated-ru-only.txt` |
| United Kingdom | GB | 35,446 | 35,279 | 31,965 | 2.55% | `aggregated-gb-only.txt` |
| Thailand | TH | 1,979 | 1,979 | 14,788 | 1.18% | `aggregated-th-only.txt` |
| Vietnam | VN | 2,188 | 2,188 | 39,842 | 3.17% | `aggregated-vn-only.txt` |
| South Korea | KR | 3,909 | 3,899 | 15,922 | 1.27% | `aggregated-kr-only.txt` |
| Brazil | BR | 12,907 | 12,848 | 64,094 | 5.11% | `aggregated-br-only.txt` |
| Taiwan | TW | 2,387 | 2,387 | 13,892 | 1.11% | `aggregated-tw-only.txt` |
| Canada | CA | 16,857 | 16,741 | 25,115 | 2.00% | `aggregated-ca-only.txt` |
| Singapore | SG | 9,463 | 9,453 | 35,026 | 2.79% | `aggregated-sg-only.txt` |
| Italy | IT | 9,737 | 9,694 | 15,378 | 1.23% | `aggregated-it-only.txt` |
| Netherlands | NL | 18,776 | 18,667 | 51,384 | 4.09% | `aggregated-nl-only.txt` |
| Indonesia | ID | 6,499 | 6,473 | 28,328 | 2.26% | `aggregated-id-only.txt` |
| France | FR | 33,011 | 32,984 | 23,306 | 1.86% | `aggregated-fr-only.txt` |
| Venezuela | VE | 956 | 956 | 7,708 | 0.61% | `aggregated-ve-only.txt` |
| Australia | AU | 12,109 | 12,038 | 17,017 | 1.36% | `aggregated-au-only.txt` |
| Turkey | TR | 3,444 | 3,421 | 13,692 | 1.09% | `aggregated-tr-only.txt` |
| Ukraine | UA | 5,541 | 5,485 | 9,385 | 0.75% | `aggregated-ua-only.txt` |
| Iran | IR | 2,057 | 2,056 | 5,275 | 0.42% | `aggregated-ir-only.txt` |
| Poland | PL | 8,180 | 8,150 | 8,344 | 0.66% | `aggregated-pl-only.txt` |
| Mexico | MX | 4,452 | 4,448 | 15,251 | 1.22% | `aggregated-mx-only.txt` |
| Spain | ES | 11,055 | 11,035 | 9,240 | 0.74% | `aggregated-es-only.txt` |
| Argentina | AR | 3,452 | 3,450 | 11,810 | 0.94% | `aggregated-ar-only.txt` |
| Egypt | EG | 728 | 728 | 3,630 | 0.29% | `aggregated-eg-only.txt` |
| Pakistan | PK | 1,351 | 1,349 | 17,362 | 1.38% | `aggregated-pk-only.txt` |
| Malaysia | MY | 2,550 | 2,550 | 5,799 | 0.46% | `aggregated-my-only.txt` |
| Bulgaria | BG | 2,378 | 2,367 | 3,050 | 0.24% | `aggregated-bg-only.txt` |
| Czechia | CZ | 3,623 | 3,622 | 1,942 | 0.15% | `aggregated-cz-only.txt` |
| Colombia | CO | 2,217 | 2,217 | 6,523 | 0.52% | `aggregated-co-only.txt` |
| United Arab Emirates | AE | 3,826 | 3,826 | 4,312 | 0.34% | `aggregated-ae-only.txt` |
| Romania | RO | 3,987 | 3,979 | 2,528 | 0.20% | `aggregated-ro-only.txt` |
| Kazakhstan | KZ | 1,309 | 1,308 | 2,673 | 0.21% | `aggregated-kz-only.txt` |
| Morocco | MA | 493 | 493 | 4,178 | 0.33% | `aggregated-ma-only.txt` |
| Saudi Arabia | SA | 1,675 | 1,675 | 4,303 | 0.34% | `aggregated-sa-only.txt` |
| South Africa | ZA | 3,992 | 3,978 | 8,427 | 0.67% | `aggregated-za-only.txt` |
| Bangladesh | BD | 2,628 | 2,626 | 7,482 | 0.60% | `aggregated-bd-only.txt` |
| Chile | CL | 1,931 | 1,929 | 3,588 | 0.29% | `aggregated-cl-only.txt` |
| Nigeria | NG | 1,080 | 1,080 | 1,659 | 0.13% | `aggregated-ng-only.txt` |
| Kenya | KE | 873 | 873 | 3,110 | 0.25% | `aggregated-ke-only.txt` |
| Algeria | DZ | 219 | 219 | 2,130 | 0.17% | `aggregated-dz-only.txt` |
| Serbia | RS | 994 | 992 | 1,298 | 0.10% | `aggregated-rs-only.txt` |
| Peru | PE | 1,180 | 1,179 | 2,069 | 0.16% | `aggregated-pe-only.txt` |
...
- **`aggregated.txt`** - 1,254,926 total aggregated IPs from all sources
- **`aggregated-ae-only.txt`** - 4,312 IPs from AE
- **`aggregated-ar-only.txt`** - 11,810 IPs from AR
- **`aggregated-au-only.txt`** - 17,017 IPs from AU
- **`aggregated-bd-only.txt`** - 7,482 IPs from BD
- **`aggregated-bg-only.txt`** - 3,050 IPs from BG
- **`aggregated-br-only.txt`** - 64,094 IPs from BR
- **`aggregated-by-only.txt`** - 741 IPs from BY
- **`aggregated-ca-only.txt`** - 25,115 IPs from CA
- **`aggregated-cl-only.txt`** - 3,588 IPs from CL
- **`aggregated-cn-only.txt`** - 170,569 IPs from CN
- **`aggregated-co-only.txt`** - 6,523 IPs from CO
- **`aggregated-cz-only.txt`** - 1,942 IPs from CZ
- **`aggregated-de-only.txt`** - 46,281 IPs from DE
- **`aggregated-dz-only.txt`** - 2,130 IPs from DZ
- **`aggregated-eg-only.txt`** - 3,630 IPs from EG
- **`aggregated-es-only.txt`** - 9,240 IPs from ES
- **`aggregated-et-only.txt`** - 1,186 IPs from ET
- **`aggregated-fr-only.txt`** - 23,306 IPs from FR
- **`aggregated-gb-only.txt`** - 31,965 IPs from GB
- **`aggregated-gh-only.txt`** - 579 IPs from GH
- **`aggregated-id-only.txt`** - 28,328 IPs from ID
- **`aggregated-in-only.txt`** - 75,864 IPs from IN
- **`aggregated-iq-only.txt`** - 2,872 IPs from IQ
- **`aggregated-ir-only.txt`** - 5,275 IPs from IR
- **`aggregated-it-only.txt`** - 15,378 IPs from IT
- **`aggregated-ke-only.txt`** - 3,110 IPs from KE
- **`aggregated-kr-only.txt`** - 15,922 IPs from KR
- **`aggregated-kz-only.txt`** - 2,673 IPs from KZ
- **`aggregated-lk-only.txt`** - 935 IPs from LK
- **`aggregated-ma-only.txt`** - 4,178 IPs from MA
- **`aggregated-mx-only.txt`** - 15,251 IPs from MX
- **`aggregated-my-only.txt`** - 5,799 IPs from MY
- **`aggregated-ng-only.txt`** - 1,659 IPs from NG
- **`aggregated-nl-only.txt`** - 51,384 IPs from NL
- **`aggregated-pe-only.txt`** - 2,069 IPs from PE
- **`aggregated-pk-only.txt`** - 17,362 IPs from PK
- **`aggregated-pl-only.txt`** - 8,344 IPs from PL
- **`aggregated-ro-only.txt`** - 2,528 IPs from RO
- **`aggregated-rs-only.txt`** - 1,298 IPs from RS
- **`aggregated-ru-only.txt`** - 27,339 IPs from RU
- **`aggregated-sa-only.txt`** - 4,303 IPs from SA
- **`aggregated-sg-only.txt`** - 35,026 IPs from SG
- **`aggregated-th-only.txt`** - 14,788 IPs from TH
- **`aggregated-tr-only.txt`** - 13,692 IPs from TR
- **`aggregated-tw-only.txt`** - 13,892 IPs from TW
- **`aggregated-ua-only.txt`** - 9,385 IPs from UA
- **`aggregated-us-only.txt`** - 234,557 IPs from US
- **`aggregated-ve-only.txt`** - 7,708 IPs from VE
- **`aggregated-vn-only.txt`** - 39,842 IPs from VN
- **`aggregated-za-only.txt`** - 8,427 IPs from ZA
- **`aggregated-multi-50countries-combined.txt`** - 1,103,748 unique IPs (deduplicated across all countries)
