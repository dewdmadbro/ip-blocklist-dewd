...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-1062158-2D56A8)
...
**Last Updated:** 2026-05-18 10:48:04 UTC
...
- **Total Input IPs:** 1,062,158
- **Countries Processed:** 50
- **Combined Unique IPs:** 940,505
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 167,217 | 165,713 | 203,355 | 19.15% | `aggregated-us-only.txt` |
| China | CN | 7,572 | 7,571 | 136,429 | 12.84% | `aggregated-cn-only.txt` |
| India | IN | 12,832 | 12,801 | 65,919 | 6.21% | `aggregated-in-only.txt` |
| Germany | DE | 28,842 | 28,762 | 39,900 | 3.76% | `aggregated-de-only.txt` |
| Russia | RU | 13,087 | 12,857 | 25,120 | 2.36% | `aggregated-ru-only.txt` |
| United Kingdom | GB | 33,930 | 33,764 | 30,235 | 2.85% | `aggregated-gb-only.txt` |
| Thailand | TH | 1,936 | 1,935 | 13,614 | 1.28% | `aggregated-th-only.txt` |
| Vietnam | VN | 2,142 | 2,142 | 35,541 | 3.35% | `aggregated-vn-only.txt` |
| South Korea | KR | 3,976 | 3,966 | 14,327 | 1.35% | `aggregated-kr-only.txt` |
| Brazil | BR | 13,022 | 12,952 | 44,145 | 4.16% | `aggregated-br-only.txt` |
| Taiwan | TW | 2,417 | 2,417 | 13,021 | 1.23% | `aggregated-tw-only.txt` |
| Canada | CA | 17,079 | 16,951 | 22,802 | 2.15% | `aggregated-ca-only.txt` |
| Singapore | SG | 9,249 | 9,239 | 32,322 | 3.04% | `aggregated-sg-only.txt` |
| Italy | IT | 9,537 | 9,513 | 13,882 | 1.31% | `aggregated-it-only.txt` |
| Netherlands | NL | 18,516 | 18,392 | 50,964 | 4.80% | `aggregated-nl-only.txt` |
| Indonesia | ID | 6,418 | 6,397 | 25,326 | 2.38% | `aggregated-id-only.txt` |
| France | FR | 32,086 | 32,060 | 20,127 | 1.89% | `aggregated-fr-only.txt` |
| Venezuela | VE | 924 | 924 | 6,493 | 0.61% | `aggregated-ve-only.txt` |
| Australia | AU | 12,099 | 12,029 | 15,862 | 1.49% | `aggregated-au-only.txt` |
...
| Mexico | MX | 4,410 | 4,406 | 10,582 | 1.00% | `aggregated-mx-only.txt` |
| Spain | ES | 11,163 | 11,132 | 7,619 | 0.72% | `aggregated-es-only.txt` |
| Argentina | AR | 3,467 | 3,465 | 8,985 | 0.85% | `aggregated-ar-only.txt` |
| Egypt | EG | 716 | 716 | 2,732 | 0.26% | `aggregated-eg-only.txt` |
| Pakistan | PK | 1,319 | 1,319 | 13,410 | 1.26% | `aggregated-pk-only.txt` |
...
| Kazakhstan | KZ | 1,259 | 1,258 | 2,328 | 0.22% | `aggregated-kz-only.txt` |
| Morocco | MA | 475 | 475 | 3,437 | 0.32% | `aggregated-ma-only.txt` |
| Saudi Arabia | SA | 1,623 | 1,623 | 3,767 | 0.35% | `aggregated-sa-only.txt` |
| South Africa | ZA | 3,965 | 3,952 | 6,894 | 0.65% | `aggregated-za-only.txt` |
| Bangladesh | BD | 2,614 | 2,609 | 5,231 | 0.49% | `aggregated-bd-only.txt` |
| Chile | CL | 1,886 | 1,886 | 2,386 | 0.22% | `aggregated-cl-only.txt` |
...
- **`aggregated.txt`** - 1,062,158 total aggregated IPs from all sources
- **`aggregated-ae-only.txt`** - 3,398 IPs from AE
- **`aggregated-ar-only.txt`** - 8,985 IPs from AR
- **`aggregated-au-only.txt`** - 15,862 IPs from AU
- **`aggregated-bd-only.txt`** - 5,231 IPs from BD
- **`aggregated-bg-only.txt`** - 2,748 IPs from BG
- **`aggregated-br-only.txt`** - 44,145 IPs from BR
- **`aggregated-by-only.txt`** - 683 IPs from BY
- **`aggregated-ca-only.txt`** - 22,802 IPs from CA
- **`aggregated-cl-only.txt`** - 2,386 IPs from CL
- **`aggregated-cn-only.txt`** - 136,429 IPs from CN
- **`aggregated-co-only.txt`** - 4,493 IPs from CO
- **`aggregated-cz-only.txt`** - 1,683 IPs from CZ
- **`aggregated-de-only.txt`** - 39,900 IPs from DE
- **`aggregated-dz-only.txt`** - 1,574 IPs from DZ
- **`aggregated-eg-only.txt`** - 2,732 IPs from EG
- **`aggregated-es-only.txt`** - 7,619 IPs from ES
- **`aggregated-et-only.txt`** - 898 IPs from ET
- **`aggregated-fr-only.txt`** - 20,127 IPs from FR
- **`aggregated-gb-only.txt`** - 30,235 IPs from GB
- **`aggregated-gh-only.txt`** - 498 IPs from GH
- **`aggregated-id-only.txt`** - 25,326 IPs from ID
- **`aggregated-in-only.txt`** - 65,919 IPs from IN
- **`aggregated-iq-only.txt`** - 1,894 IPs from IQ
- **`aggregated-ir-only.txt`** - 3,941 IPs from IR
- **`aggregated-it-only.txt`** - 13,882 IPs from IT
- **`aggregated-ke-only.txt`** - 2,424 IPs from KE
- **`aggregated-kr-only.txt`** - 14,327 IPs from KR
- **`aggregated-kz-only.txt`** - 2,328 IPs from KZ
- **`aggregated-lk-only.txt`** - 627 IPs from LK
- **`aggregated-ma-only.txt`** - 3,437 IPs from MA
- **`aggregated-mx-only.txt`** - 10,582 IPs from MX
- **`aggregated-my-only.txt`** - 5,229 IPs from MY
- **`aggregated-ng-only.txt`** - 1,125 IPs from NG
- **`aggregated-nl-only.txt`** - 50,964 IPs from NL
- **`aggregated-pe-only.txt`** - 1,507 IPs from PE
- **`aggregated-pk-only.txt`** - 13,410 IPs from PK
- **`aggregated-pl-only.txt`** - 7,465 IPs from PL
- **`aggregated-ro-only.txt`** - 2,093 IPs from RO
- **`aggregated-rs-only.txt`** - 1,009 IPs from RS
- **`aggregated-ru-only.txt`** - 25,120 IPs from RU
- **`aggregated-sa-only.txt`** - 3,767 IPs from SA
- **`aggregated-sg-only.txt`** - 32,322 IPs from SG
- **`aggregated-th-only.txt`** - 13,614 IPs from TH
- **`aggregated-tr-only.txt`** - 12,376 IPs from TR
- **`aggregated-tw-only.txt`** - 13,021 IPs from TW
- **`aggregated-ua-only.txt`** - 8,085 IPs from UA
- **`aggregated-us-only.txt`** - 203,355 IPs from US
- **`aggregated-ve-only.txt`** - 6,493 IPs from VE
- **`aggregated-vn-only.txt`** - 35,541 IPs from VN
- **`aggregated-za-only.txt`** - 6,894 IPs from ZA
- **`aggregated-multi-50countries-combined.txt`** - 940,505 unique IPs (deduplicated across all countries)
