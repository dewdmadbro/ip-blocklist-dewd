...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-1071594-2D56A8)
...
**Last Updated:** 2026-06-02 11:02:29 UTC
...
- **Total Input IPs:** 1,071,594
- **Countries Processed:** 50
- **Combined Unique IPs:** 946,454
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 165,171 | 163,351 | 209,048 | 19.51% | `aggregated-us-only.txt` |
| China | CN | 7,502 | 7,501 | 134,017 | 12.51% | `aggregated-cn-only.txt` |
| India | IN | 12,894 | 12,865 | 66,966 | 6.25% | `aggregated-in-only.txt` |
| Germany | DE | 28,948 | 28,868 | 41,701 | 3.89% | `aggregated-de-only.txt` |
| Russia | RU | 13,123 | 12,894 | 25,060 | 2.34% | `aggregated-ru-only.txt` |
| United Kingdom | GB | 34,022 | 33,847 | 30,411 | 2.84% | `aggregated-gb-only.txt` |
| Thailand | TH | 1,927 | 1,926 | 13,672 | 1.28% | `aggregated-th-only.txt` |
| Vietnam | VN | 2,159 | 2,159 | 34,626 | 3.23% | `aggregated-vn-only.txt` |
| South Korea | KR | 3,938 | 3,928 | 13,938 | 1.30% | `aggregated-kr-only.txt` |
| Brazil | BR | 13,593 | 13,559 | 43,990 | 4.11% | `aggregated-br-only.txt` |
| Taiwan | TW | 2,399 | 2,399 | 13,064 | 1.22% | `aggregated-tw-only.txt` |
| Canada | CA | 17,038 | 16,909 | 23,594 | 2.20% | `aggregated-ca-only.txt` |
| Singapore | SG | 9,341 | 9,331 | 32,737 | 3.05% | `aggregated-sg-only.txt` |
| Italy | IT | 9,565 | 9,541 | 14,069 | 1.31% | `aggregated-it-only.txt` |
| Netherlands | NL | 18,603 | 18,479 | 51,081 | 4.77% | `aggregated-nl-only.txt` |
| Indonesia | ID | 6,408 | 6,389 | 25,447 | 2.37% | `aggregated-id-only.txt` |
| France | FR | 32,238 | 32,212 | 19,664 | 1.84% | `aggregated-fr-only.txt` |
| Venezuela | VE | 931 | 931 | 6,608 | 0.62% | `aggregated-ve-only.txt` |
| Australia | AU | 12,034 | 11,967 | 16,101 | 1.50% | `aggregated-au-only.txt` |
...
| Poland | PL | 8,039 | 8,008 | 7,445 | 0.69% | `aggregated-pl-only.txt` |
| Mexico | MX | 4,395 | 4,391 | 10,728 | 1.00% | `aggregated-mx-only.txt` |
| Spain | ES | 11,295 | 11,270 | 7,790 | 0.73% | `aggregated-es-only.txt` |
| Argentina | AR | 3,494 | 3,492 | 9,000 | 0.84% | `aggregated-ar-only.txt` |
| Egypt | EG | 718 | 718 | 2,780 | 0.26% | `aggregated-eg-only.txt` |
| Pakistan | PK | 1,338 | 1,336 | 13,682 | 1.28% | `aggregated-pk-only.txt` |
...
| Colombia | CO | 2,210 | 2,210 | 4,283 | 0.40% | `aggregated-co-only.txt` |
| United Arab Emirates | AE | 3,284 | 3,284 | 3,383 | 0.32% | `aggregated-ae-only.txt` |
| Romania | RO | 3,946 | 3,937 | 2,089 | 0.19% | `aggregated-ro-only.txt` |
...
| South Africa | ZA | 3,967 | 3,953 | 6,370 | 0.59% | `aggregated-za-only.txt` |
...
| Kenya | KE | 857 | 857 | 2,097 | 0.20% | `aggregated-ke-only.txt` |
| Algeria | DZ | 218 | 218 | 1,618 | 0.15% | `aggregated-dz-only.txt` |
| Serbia | RS | 949 | 947 | 1,023 | 0.10% | `aggregated-rs-only.txt` |
...
- **`aggregated.txt`** - 1,071,594 total aggregated IPs from all sources
- **`aggregated-ae-only.txt`** - 3,383 IPs from AE
- **`aggregated-ar-only.txt`** - 9,000 IPs from AR
...
- **`aggregated-br-only.txt`** - 43,990 IPs from BR
- **`aggregated-by-only.txt`** - 646 IPs from BY
- **`aggregated-ca-only.txt`** - 23,594 IPs from CA
- **`aggregated-cl-only.txt`** - 2,172 IPs from CL
- **`aggregated-cn-only.txt`** - 134,017 IPs from CN
- **`aggregated-co-only.txt`** - 4,283 IPs from CO
- **`aggregated-cz-only.txt`** - 1,715 IPs from CZ
- **`aggregated-de-only.txt`** - 41,701 IPs from DE
- **`aggregated-dz-only.txt`** - 1,618 IPs from DZ
- **`aggregated-eg-only.txt`** - 2,780 IPs from EG
- **`aggregated-es-only.txt`** - 7,790 IPs from ES
- **`aggregated-et-only.txt`** - 877 IPs from ET
- **`aggregated-fr-only.txt`** - 19,664 IPs from FR
- **`aggregated-gb-only.txt`** - 30,411 IPs from GB
- **`aggregated-gh-only.txt`** - 490 IPs from GH
- **`aggregated-id-only.txt`** - 25,447 IPs from ID
- **`aggregated-in-only.txt`** - 66,966 IPs from IN
- **`aggregated-iq-only.txt`** - 1,755 IPs from IQ
- **`aggregated-ir-only.txt`** - 3,972 IPs from IR
- **`aggregated-it-only.txt`** - 14,069 IPs from IT
- **`aggregated-ke-only.txt`** - 2,097 IPs from KE
- **`aggregated-kr-only.txt`** - 13,938 IPs from KR
- **`aggregated-kz-only.txt`** - 2,402 IPs from KZ
- **`aggregated-lk-only.txt`** - 639 IPs from LK
- **`aggregated-ma-only.txt`** - 3,465 IPs from MA
- **`aggregated-mx-only.txt`** - 10,728 IPs from MX
...
- **`aggregated-pk-only.txt`** - 13,682 IPs from PK
- **`aggregated-pl-only.txt`** - 7,445 IPs from PL
- **`aggregated-ro-only.txt`** - 2,089 IPs from RO
- **`aggregated-rs-only.txt`** - 1,023 IPs from RS
- **`aggregated-ru-only.txt`** - 25,060 IPs from RU
- **`aggregated-sa-only.txt`** - 3,751 IPs from SA
- **`aggregated-sg-only.txt`** - 32,737 IPs from SG
- **`aggregated-th-only.txt`** - 13,672 IPs from TH
- **`aggregated-tr-only.txt`** - 12,641 IPs from TR
- **`aggregated-tw-only.txt`** - 13,064 IPs from TW
- **`aggregated-ua-only.txt`** - 8,074 IPs from UA
- **`aggregated-us-only.txt`** - 209,048 IPs from US
- **`aggregated-ve-only.txt`** - 6,608 IPs from VE
- **`aggregated-vn-only.txt`** - 34,626 IPs from VN
- **`aggregated-za-only.txt`** - 6,370 IPs from ZA
- **`aggregated-multi-50countries-combined.txt`** - 946,454 unique IPs (deduplicated across all countries)
