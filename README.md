...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-902045-2D56A8)
...
**Last Updated:** 2026-05-04 10:28:14 UTC
...
- **Total Input IPs:** 902,045
- **Countries Processed:** 50
- **Combined Unique IPs:** 799,439
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 169,198 | 167,680 | 146,560 | 16.25% | `aggregated-us-only.txt` |
| China | CN | 7,598 | 7,597 | 126,132 | 13.98% | `aggregated-cn-only.txt` |
| India | IN | 12,838 | 12,810 | 53,116 | 5.89% | `aggregated-in-only.txt` |
| Germany | DE | 28,972 | 28,867 | 34,731 | 3.85% | `aggregated-de-only.txt` |
| Russia | RU | 13,120 | 12,898 | 19,743 | 2.19% | `aggregated-ru-only.txt` |
| United Kingdom | GB | 33,411 | 33,252 | 26,331 | 2.92% | `aggregated-gb-only.txt` |
| Thailand | TH | 1,947 | 1,945 | 12,391 | 1.37% | `aggregated-th-only.txt` |
| Vietnam | VN | 2,128 | 2,128 | 26,651 | 2.95% | `aggregated-vn-only.txt` |
| South Korea | KR | 4,006 | 3,996 | 12,835 | 1.42% | `aggregated-kr-only.txt` |
| Brazil | BR | 12,782 | 12,630 | 41,401 | 4.59% | `aggregated-br-only.txt` |
| Taiwan | TW | 2,413 | 2,413 | 10,909 | 1.21% | `aggregated-tw-only.txt` |
| Canada | CA | 16,890 | 16,768 | 20,531 | 2.28% | `aggregated-ca-only.txt` |
| Singapore | SG | 9,268 | 9,258 | 27,572 | 3.06% | `aggregated-sg-only.txt` |
| Italy | IT | 9,580 | 9,556 | 13,299 | 1.47% | `aggregated-it-only.txt` |
| Netherlands | NL | 18,273 | 18,151 | 47,664 | 5.28% | `aggregated-nl-only.txt` |
| Indonesia | ID | 6,409 | 6,390 | 22,094 | 2.45% | `aggregated-id-only.txt` |
| France | FR | 32,393 | 32,367 | 17,709 | 1.96% | `aggregated-fr-only.txt` |
| Venezuela | VE | 900 | 900 | 4,289 | 0.48% | `aggregated-ve-only.txt` |
| Australia | AU | 11,396 | 11,317 | 14,989 | 1.66% | `aggregated-au-only.txt` |
| Turkey | TR | 3,399 | 3,371 | 12,851 | 1.42% | `aggregated-tr-only.txt` |
| Ukraine | UA | 5,540 | 5,481 | 7,619 | 0.84% | `aggregated-ua-only.txt` |
| Iran | IR | 2,012 | 2,011 | 3,264 | 0.36% | `aggregated-ir-only.txt` |
| Poland | PL | 8,011 | 7,976 | 5,199 | 0.58% | `aggregated-pl-only.txt` |
| Mexico | MX | 4,307 | 4,303 | 9,879 | 1.10% | `aggregated-mx-only.txt` |
| Spain | ES | 11,140 | 11,107 | 6,264 | 0.69% | `aggregated-es-only.txt` |
...
| Morocco | MA | 478 | 478 | 3,562 | 0.39% | `aggregated-ma-only.txt` |
| Saudi Arabia | SA | 1,617 | 1,617 | 4,162 | 0.46% | `aggregated-sa-only.txt` |
| South Africa | ZA | 3,955 | 3,942 | 5,097 | 0.57% | `aggregated-za-only.txt` |
| Bangladesh | BD | 2,608 | 2,603 | 4,521 | 0.50% | `aggregated-bd-only.txt` |
| Chile | CL | 1,870 | 1,870 | 2,965 | 0.33% | `aggregated-cl-only.txt` |
| Nigeria | NG | 1,071 | 1,071 | 1,158 | 0.13% | `aggregated-ng-only.txt` |
| Kenya | KE | 851 | 851 | 2,416 | 0.27% | `aggregated-ke-only.txt` |
| Algeria | DZ | 217 | 217 | 1,527 | 0.17% | `aggregated-dz-only.txt` |
...
- **`aggregated.txt`** - 902,045 total aggregated IPs from all sources
- **`aggregated-ae-only.txt`** - 2,976 IPs from AE
- **`aggregated-ar-only.txt`** - 8,631 IPs from AR
- **`aggregated-au-only.txt`** - 14,989 IPs from AU
- **`aggregated-bd-only.txt`** - 4,521 IPs from BD
- **`aggregated-bg-only.txt`** - 2,328 IPs from BG
- **`aggregated-br-only.txt`** - 41,401 IPs from BR
- **`aggregated-by-only.txt`** - 644 IPs from BY
- **`aggregated-ca-only.txt`** - 20,531 IPs from CA
- **`aggregated-cl-only.txt`** - 2,965 IPs from CL
- **`aggregated-cn-only.txt`** - 126,132 IPs from CN
- **`aggregated-co-only.txt`** - 4,151 IPs from CO
- **`aggregated-cz-only.txt`** - 1,395 IPs from CZ
- **`aggregated-de-only.txt`** - 34,731 IPs from DE
- **`aggregated-dz-only.txt`** - 1,527 IPs from DZ
- **`aggregated-eg-only.txt`** - 2,815 IPs from EG
- **`aggregated-es-only.txt`** - 6,264 IPs from ES
- **`aggregated-et-only.txt`** - 960 IPs from ET
- **`aggregated-fr-only.txt`** - 17,709 IPs from FR
- **`aggregated-gb-only.txt`** - 26,331 IPs from GB
- **`aggregated-gh-only.txt`** - 483 IPs from GH
- **`aggregated-id-only.txt`** - 22,094 IPs from ID
- **`aggregated-in-only.txt`** - 53,116 IPs from IN
- **`aggregated-iq-only.txt`** - 1,567 IPs from IQ
- **`aggregated-ir-only.txt`** - 3,264 IPs from IR
- **`aggregated-it-only.txt`** - 13,299 IPs from IT
- **`aggregated-ke-only.txt`** - 2,416 IPs from KE
- **`aggregated-kr-only.txt`** - 12,835 IPs from KR
- **`aggregated-kz-only.txt`** - 2,114 IPs from KZ
- **`aggregated-lk-only.txt`** - 582 IPs from LK
- **`aggregated-ma-only.txt`** - 3,562 IPs from MA
- **`aggregated-mx-only.txt`** - 9,879 IPs from MX
- **`aggregated-my-only.txt`** - 5,229 IPs from MY
- **`aggregated-ng-only.txt`** - 1,158 IPs from NG
- **`aggregated-nl-only.txt`** - 47,664 IPs from NL
- **`aggregated-pe-only.txt`** - 1,298 IPs from PE
- **`aggregated-pk-only.txt`** - 12,253 IPs from PK
- **`aggregated-pl-only.txt`** - 5,199 IPs from PL
- **`aggregated-ro-only.txt`** - 1,621 IPs from RO
- **`aggregated-rs-only.txt`** - 961 IPs from RS
- **`aggregated-ru-only.txt`** - 19,743 IPs from RU
- **`aggregated-sa-only.txt`** - 4,162 IPs from SA
- **`aggregated-sg-only.txt`** - 27,572 IPs from SG
- **`aggregated-th-only.txt`** - 12,391 IPs from TH
- **`aggregated-tr-only.txt`** - 12,851 IPs from TR
- **`aggregated-tw-only.txt`** - 10,909 IPs from TW
- **`aggregated-ua-only.txt`** - 7,619 IPs from UA
- **`aggregated-us-only.txt`** - 146,560 IPs from US
- **`aggregated-ve-only.txt`** - 4,289 IPs from VE
- **`aggregated-vn-only.txt`** - 26,651 IPs from VN
- **`aggregated-za-only.txt`** - 5,097 IPs from ZA
- **`aggregated-multi-50countries-combined.txt`** - 799,439 unique IPs (deduplicated across all countries)
