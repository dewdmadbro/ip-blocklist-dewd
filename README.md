...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-1271162-2D56A8)
...
**Last Updated:** 2026-07-26 04:05:48 UTC
...
- **Total Input IPs:** 1,271,162
- **Countries Processed:** 50
- **Combined Unique IPs:** 1,118,137
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 135,484 | 133,670 | 235,835 | 18.55% | `aggregated-us-only.txt` |
| China | CN | 7,801 | 7,800 | 172,215 | 13.55% | `aggregated-cn-only.txt` |
| India | IN | 13,176 | 13,145 | 76,827 | 6.04% | `aggregated-in-only.txt` |
| Germany | DE | 29,225 | 29,158 | 46,334 | 3.65% | `aggregated-de-only.txt` |
| Russia | RU | 13,278 | 13,041 | 27,514 | 2.16% | `aggregated-ru-only.txt` |
| United Kingdom | GB | 35,497 | 35,342 | 32,361 | 2.55% | `aggregated-gb-only.txt` |
| Thailand | TH | 1,984 | 1,984 | 15,354 | 1.21% | `aggregated-th-only.txt` |
| Vietnam | VN | 2,193 | 2,193 | 39,940 | 3.14% | `aggregated-vn-only.txt` |
| South Korea | KR | 3,949 | 3,939 | 15,944 | 1.25% | `aggregated-kr-only.txt` |
| Brazil | BR | 13,023 | 12,978 | 67,953 | 5.35% | `aggregated-br-only.txt` |
| Taiwan | TW | 2,388 | 2,388 | 13,964 | 1.10% | `aggregated-tw-only.txt` |
| Canada | CA | 16,948 | 16,824 | 26,330 | 2.07% | `aggregated-ca-only.txt` |
| Singapore | SG | 9,453 | 9,443 | 35,140 | 2.76% | `aggregated-sg-only.txt` |
| Italy | IT | 9,769 | 9,745 | 15,484 | 1.22% | `aggregated-it-only.txt` |
| Netherlands | NL | 18,880 | 18,759 | 51,366 | 4.04% | `aggregated-nl-only.txt` |
| Indonesia | ID | 6,505 | 6,481 | 28,613 | 2.25% | `aggregated-id-only.txt` |
| France | FR | 33,610 | 33,583 | 23,694 | 1.86% | `aggregated-fr-only.txt` |
| Venezuela | VE | 957 | 957 | 7,778 | 0.61% | `aggregated-ve-only.txt` |
| Australia | AU | 12,139 | 12,065 | 16,998 | 1.34% | `aggregated-au-only.txt` |
| Turkey | TR | 3,450 | 3,428 | 13,758 | 1.08% | `aggregated-tr-only.txt` |
| Ukraine | UA | 5,551 | 5,495 | 10,013 | 0.79% | `aggregated-ua-only.txt` |
| Iran | IR | 2,048 | 2,047 | 5,345 | 0.42% | `aggregated-ir-only.txt` |
| Poland | PL | 8,204 | 8,171 | 8,332 | 0.66% | `aggregated-pl-only.txt` |
| Mexico | MX | 4,471 | 4,467 | 15,716 | 1.24% | `aggregated-mx-only.txt` |
| Spain | ES | 11,172 | 11,153 | 9,404 | 0.74% | `aggregated-es-only.txt` |
| Argentina | AR | 3,474 | 3,472 | 11,982 | 0.94% | `aggregated-ar-only.txt` |
| Egypt | EG | 728 | 728 | 3,683 | 0.29% | `aggregated-eg-only.txt` |
| Pakistan | PK | 1,355 | 1,353 | 17,626 | 1.39% | `aggregated-pk-only.txt` |
| Malaysia | MY | 2,570 | 2,570 | 5,844 | 0.46% | `aggregated-my-only.txt` |
| Bulgaria | BG | 2,376 | 2,365 | 3,071 | 0.24% | `aggregated-bg-only.txt` |
| Czechia | CZ | 3,621 | 3,620 | 1,941 | 0.15% | `aggregated-cz-only.txt` |
| Colombia | CO | 2,215 | 2,215 | 6,707 | 0.53% | `aggregated-co-only.txt` |
| United Arab Emirates | AE | 3,842 | 3,842 | 4,374 | 0.34% | `aggregated-ae-only.txt` |
| Romania | RO | 3,995 | 3,986 | 2,557 | 0.20% | `aggregated-ro-only.txt` |
| Kazakhstan | KZ | 1,312 | 1,311 | 2,694 | 0.21% | `aggregated-kz-only.txt` |
| Morocco | MA | 494 | 494 | 4,219 | 0.33% | `aggregated-ma-only.txt` |
| Saudi Arabia | SA | 1,682 | 1,682 | 4,342 | 0.34% | `aggregated-sa-only.txt` |
| South Africa | ZA | 4,021 | 4,007 | 8,608 | 0.68% | `aggregated-za-only.txt` |
| Bangladesh | BD | 2,627 | 2,625 | 7,988 | 0.63% | `aggregated-bd-only.txt` |
| Chile | CL | 1,975 | 1,973 | 3,677 | 0.29% | `aggregated-cl-only.txt` |
| Nigeria | NG | 1,091 | 1,091 | 1,728 | 0.14% | `aggregated-ng-only.txt` |
| Kenya | KE | 873 | 873 | 2,965 | 0.23% | `aggregated-ke-only.txt` |
| Algeria | DZ | 219 | 219 | 2,177 | 0.17% | `aggregated-dz-only.txt` |
| Serbia | RS | 992 | 990 | 1,302 | 0.10% | `aggregated-rs-only.txt` |
| Peru | PE | 1,120 | 1,119 | 2,080 | 0.16% | `aggregated-pe-only.txt` |
| Sri Lanka | LK | 248 | 248 | 954 | 0.08% | `aggregated-lk-only.txt` |
| Iraq | IQ | 683 | 683 | 2,883 | 0.23% | `aggregated-iq-only.txt` |
| Ethiopia | ET | 97 | 97 | 1,188 | 0.09% | `aggregated-et-only.txt` |
| Ghana | GH | 342 | 342 | 586 | 0.05% | `aggregated-gh-only.txt` |
| Belarus | BY | 417 | 417 | 749 | 0.06% | `aggregated-by-only.txt` |
...
- **`aggregated.txt`** - 1,271,162 total aggregated IPs from all sources
- **`aggregated-ae-only.txt`** - 4,374 IPs from AE
- **`aggregated-ar-only.txt`** - 11,982 IPs from AR
- **`aggregated-au-only.txt`** - 16,998 IPs from AU
- **`aggregated-bd-only.txt`** - 7,988 IPs from BD
- **`aggregated-bg-only.txt`** - 3,071 IPs from BG
- **`aggregated-br-only.txt`** - 67,953 IPs from BR
- **`aggregated-by-only.txt`** - 749 IPs from BY
- **`aggregated-ca-only.txt`** - 26,330 IPs from CA
- **`aggregated-cl-only.txt`** - 3,677 IPs from CL
- **`aggregated-cn-only.txt`** - 172,215 IPs from CN
- **`aggregated-co-only.txt`** - 6,707 IPs from CO
- **`aggregated-cz-only.txt`** - 1,941 IPs from CZ
- **`aggregated-de-only.txt`** - 46,334 IPs from DE
- **`aggregated-dz-only.txt`** - 2,177 IPs from DZ
- **`aggregated-eg-only.txt`** - 3,683 IPs from EG
- **`aggregated-es-only.txt`** - 9,404 IPs from ES
- **`aggregated-et-only.txt`** - 1,188 IPs from ET
- **`aggregated-fr-only.txt`** - 23,694 IPs from FR
- **`aggregated-gb-only.txt`** - 32,361 IPs from GB
- **`aggregated-gh-only.txt`** - 586 IPs from GH
- **`aggregated-id-only.txt`** - 28,613 IPs from ID
- **`aggregated-in-only.txt`** - 76,827 IPs from IN
- **`aggregated-iq-only.txt`** - 2,883 IPs from IQ
- **`aggregated-ir-only.txt`** - 5,345 IPs from IR
- **`aggregated-it-only.txt`** - 15,484 IPs from IT
- **`aggregated-ke-only.txt`** - 2,965 IPs from KE
- **`aggregated-kr-only.txt`** - 15,944 IPs from KR
- **`aggregated-kz-only.txt`** - 2,694 IPs from KZ
- **`aggregated-lk-only.txt`** - 954 IPs from LK
- **`aggregated-ma-only.txt`** - 4,219 IPs from MA
- **`aggregated-mx-only.txt`** - 15,716 IPs from MX
- **`aggregated-my-only.txt`** - 5,844 IPs from MY
- **`aggregated-ng-only.txt`** - 1,728 IPs from NG
- **`aggregated-nl-only.txt`** - 51,366 IPs from NL
- **`aggregated-pe-only.txt`** - 2,080 IPs from PE
- **`aggregated-pk-only.txt`** - 17,626 IPs from PK
- **`aggregated-pl-only.txt`** - 8,332 IPs from PL
- **`aggregated-ro-only.txt`** - 2,557 IPs from RO
- **`aggregated-rs-only.txt`** - 1,302 IPs from RS
- **`aggregated-ru-only.txt`** - 27,514 IPs from RU
- **`aggregated-sa-only.txt`** - 4,342 IPs from SA
- **`aggregated-sg-only.txt`** - 35,140 IPs from SG
- **`aggregated-th-only.txt`** - 15,354 IPs from TH
- **`aggregated-tr-only.txt`** - 13,758 IPs from TR
- **`aggregated-tw-only.txt`** - 13,964 IPs from TW
- **`aggregated-ua-only.txt`** - 10,013 IPs from UA
- **`aggregated-us-only.txt`** - 235,835 IPs from US
- **`aggregated-ve-only.txt`** - 7,778 IPs from VE
- **`aggregated-vn-only.txt`** - 39,940 IPs from VN
- **`aggregated-za-only.txt`** - 8,608 IPs from ZA
- **`aggregated-multi-50countries-combined.txt`** - 1,118,137 unique IPs (deduplicated across all countries)
