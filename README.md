...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-1442561-2D56A8)
...
**Last Updated:** 2026-09-05 04:43:53 UTC
...
- **Total Input IPs:** 1,442,561
- **Countries Processed:** 50
- **Combined Unique IPs:** 1,272,109
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 130,784 | 128,927 | 273,373 | 18.95% | `aggregated-us-only.txt` |
| China | CN | 7,835 | 7,834 | 219,403 | 15.21% | `aggregated-cn-only.txt` |
| India | IN | 13,252 | 13,223 | 81,113 | 5.62% | `aggregated-in-only.txt` |
| Germany | DE | 29,886 | 29,769 | 44,991 | 3.12% | `aggregated-de-only.txt` |
| Russia | RU | 13,260 | 13,027 | 31,053 | 2.15% | `aggregated-ru-only.txt` |
| United Kingdom | GB | 35,780 | 35,619 | 34,366 | 2.38% | `aggregated-gb-only.txt` |
| Thailand | TH | 2,063 | 2,063 | 15,742 | 1.09% | `aggregated-th-only.txt` |
| Vietnam | VN | 2,223 | 2,223 | 38,478 | 2.67% | `aggregated-vn-only.txt` |
| South Korea | KR | 3,921 | 3,910 | 17,077 | 1.18% | `aggregated-kr-only.txt` |
| Brazil | BR | 12,583 | 12,539 | 85,719 | 5.94% | `aggregated-br-only.txt` |
| Taiwan | TW | 2,411 | 2,411 | 16,068 | 1.11% | `aggregated-tw-only.txt` |
| Canada | CA | 17,155 | 17,039 | 27,072 | 1.88% | `aggregated-ca-only.txt` |
| Singapore | SG | 9,542 | 9,532 | 38,541 | 2.67% | `aggregated-sg-only.txt` |
| Italy | IT | 9,778 | 9,756 | 16,554 | 1.15% | `aggregated-it-only.txt` |
| Netherlands | NL | 19,132 | 19,018 | 52,292 | 3.62% | `aggregated-nl-only.txt` |
| Indonesia | ID | 6,606 | 6,585 | 31,227 | 2.16% | `aggregated-id-only.txt` |
| France | FR | 33,396 | 33,368 | 26,770 | 1.86% | `aggregated-fr-only.txt` |
| Venezuela | VE | 977 | 977 | 7,793 | 0.54% | `aggregated-ve-only.txt` |
| Australia | AU | 12,241 | 12,174 | 17,739 | 1.23% | `aggregated-au-only.txt` |
| Turkey | TR | 3,509 | 3,492 | 15,623 | 1.08% | `aggregated-tr-only.txt` |
| Ukraine | UA | 5,559 | 5,515 | 16,714 | 1.16% | `aggregated-ua-only.txt` |
| Iran | IR | 2,061 | 2,060 | 5,513 | 0.38% | `aggregated-ir-only.txt` |
| Poland | PL | 8,233 | 8,204 | 8,650 | 0.60% | `aggregated-pl-only.txt` |
| Mexico | MX | 4,305 | 4,301 | 18,273 | 1.27% | `aggregated-mx-only.txt` |
| Spain | ES | 11,372 | 11,346 | 11,245 | 0.78% | `aggregated-es-only.txt` |
| Argentina | AR | 3,481 | 3,479 | 17,056 | 1.18% | `aggregated-ar-only.txt` |
| Egypt | EG | 742 | 742 | 3,818 | 0.26% | `aggregated-eg-only.txt` |
| Pakistan | PK | 1,380 | 1,379 | 19,581 | 1.36% | `aggregated-pk-only.txt` |
| Malaysia | MY | 2,628 | 2,628 | 6,633 | 0.46% | `aggregated-my-only.txt` |
| Bulgaria | BG | 2,359 | 2,345 | 3,281 | 0.23% | `aggregated-bg-only.txt` |
| Czechia | CZ | 3,687 | 3,686 | 2,068 | 0.14% | `aggregated-cz-only.txt` |
| Colombia | CO | 2,244 | 2,244 | 7,588 | 0.53% | `aggregated-co-only.txt` |
| United Arab Emirates | AE | 3,729 | 3,729 | 5,118 | 0.35% | `aggregated-ae-only.txt` |
| Romania | RO | 4,045 | 4,036 | 2,831 | 0.20% | `aggregated-ro-only.txt` |
| Kazakhstan | KZ | 1,295 | 1,294 | 2,995 | 0.21% | `aggregated-kz-only.txt` |
| Morocco | MA | 495 | 495 | 4,981 | 0.35% | `aggregated-ma-only.txt` |
| Saudi Arabia | SA | 1,720 | 1,720 | 5,386 | 0.37% | `aggregated-sa-only.txt` |
| South Africa | ZA | 4,054 | 4,040 | 9,385 | 0.65% | `aggregated-za-only.txt` |
| Bangladesh | BD | 2,703 | 2,701 | 7,708 | 0.53% | `aggregated-bd-only.txt` |
| Chile | CL | 2,004 | 2,002 | 4,963 | 0.34% | `aggregated-cl-only.txt` |
| Nigeria | NG | 1,123 | 1,123 | 1,602 | 0.11% | `aggregated-ng-only.txt` |
| Kenya | KE | 886 | 886 | 3,213 | 0.22% | `aggregated-ke-only.txt` |
| Algeria | DZ | 220 | 220 | 2,204 | 0.15% | `aggregated-dz-only.txt` |
| Serbia | RS | 1,003 | 1,003 | 1,405 | 0.10% | `aggregated-rs-only.txt` |
| Peru | PE | 1,127 | 1,126 | 2,244 | 0.16% | `aggregated-pe-only.txt` |
| Sri Lanka | LK | 252 | 252 | 988 | 0.07% | `aggregated-lk-only.txt` |
| Iraq | IQ | 676 | 676 | 2,902 | 0.20% | `aggregated-iq-only.txt` |
| Ethiopia | ET | 99 | 99 | 1,214 | 0.08% | `aggregated-et-only.txt` |
| Ghana | GH | 352 | 352 | 673 | 0.05% | `aggregated-gh-only.txt` |
| Belarus | BY | 427 | 427 | 883 | 0.06% | `aggregated-by-only.txt` |
...
- **`aggregated.txt`** - 1,442,561 total aggregated IPs from all sources
- **`aggregated-ae-only.txt`** - 5,118 IPs from AE
- **`aggregated-ar-only.txt`** - 17,056 IPs from AR
- **`aggregated-au-only.txt`** - 17,739 IPs from AU
- **`aggregated-bd-only.txt`** - 7,708 IPs from BD
- **`aggregated-bg-only.txt`** - 3,281 IPs from BG
- **`aggregated-br-only.txt`** - 85,719 IPs from BR
- **`aggregated-by-only.txt`** - 883 IPs from BY
- **`aggregated-ca-only.txt`** - 27,072 IPs from CA
- **`aggregated-cl-only.txt`** - 4,963 IPs from CL
- **`aggregated-cn-only.txt`** - 219,403 IPs from CN
- **`aggregated-co-only.txt`** - 7,588 IPs from CO
- **`aggregated-cz-only.txt`** - 2,068 IPs from CZ
- **`aggregated-de-only.txt`** - 44,991 IPs from DE
- **`aggregated-dz-only.txt`** - 2,204 IPs from DZ
- **`aggregated-eg-only.txt`** - 3,818 IPs from EG
- **`aggregated-es-only.txt`** - 11,245 IPs from ES
- **`aggregated-et-only.txt`** - 1,214 IPs from ET
- **`aggregated-fr-only.txt`** - 26,770 IPs from FR
- **`aggregated-gb-only.txt`** - 34,366 IPs from GB
- **`aggregated-gh-only.txt`** - 673 IPs from GH
- **`aggregated-id-only.txt`** - 31,227 IPs from ID
- **`aggregated-in-only.txt`** - 81,113 IPs from IN
- **`aggregated-iq-only.txt`** - 2,902 IPs from IQ
- **`aggregated-ir-only.txt`** - 5,513 IPs from IR
- **`aggregated-it-only.txt`** - 16,554 IPs from IT
- **`aggregated-ke-only.txt`** - 3,213 IPs from KE
- **`aggregated-kr-only.txt`** - 17,077 IPs from KR
- **`aggregated-kz-only.txt`** - 2,995 IPs from KZ
- **`aggregated-lk-only.txt`** - 988 IPs from LK
- **`aggregated-ma-only.txt`** - 4,981 IPs from MA
- **`aggregated-mx-only.txt`** - 18,273 IPs from MX
- **`aggregated-my-only.txt`** - 6,633 IPs from MY
- **`aggregated-ng-only.txt`** - 1,602 IPs from NG
- **`aggregated-nl-only.txt`** - 52,292 IPs from NL
- **`aggregated-pe-only.txt`** - 2,244 IPs from PE
- **`aggregated-pk-only.txt`** - 19,581 IPs from PK
- **`aggregated-pl-only.txt`** - 8,650 IPs from PL
- **`aggregated-ro-only.txt`** - 2,831 IPs from RO
- **`aggregated-rs-only.txt`** - 1,405 IPs from RS
- **`aggregated-ru-only.txt`** - 31,053 IPs from RU
- **`aggregated-sa-only.txt`** - 5,386 IPs from SA
- **`aggregated-sg-only.txt`** - 38,541 IPs from SG
- **`aggregated-th-only.txt`** - 15,742 IPs from TH
- **`aggregated-tr-only.txt`** - 15,623 IPs from TR
- **`aggregated-tw-only.txt`** - 16,068 IPs from TW
- **`aggregated-ua-only.txt`** - 16,714 IPs from UA
- **`aggregated-us-only.txt`** - 273,373 IPs from US
- **`aggregated-ve-only.txt`** - 7,793 IPs from VE
- **`aggregated-vn-only.txt`** - 38,478 IPs from VN
- **`aggregated-za-only.txt`** - 9,385 IPs from ZA
- **`aggregated-multi-50countries-combined.txt`** - 1,272,109 unique IPs (deduplicated across all countries)
