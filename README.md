...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-1336191-2D56A8)
...
**Last Updated:** 2026-08-12 19:35:48 UTC
...
- **Total Input IPs:** 1,336,191
- **Countries Processed:** 50
- **Combined Unique IPs:** 1,177,380
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 133,752 | 131,895 | 248,389 | 18.59% | `aggregated-us-only.txt` |
| China | CN | 7,864 | 7,863 | 190,096 | 14.23% | `aggregated-cn-only.txt` |
| India | IN | 13,195 | 13,165 | 79,594 | 5.96% | `aggregated-in-only.txt` |
| Germany | DE | 29,554 | 29,487 | 45,188 | 3.38% | `aggregated-de-only.txt` |
| Russia | RU | 13,366 | 13,132 | 29,763 | 2.23% | `aggregated-ru-only.txt` |
| United Kingdom | GB | 35,611 | 35,465 | 33,281 | 2.49% | `aggregated-gb-only.txt` |
| Thailand | TH | 1,995 | 1,995 | 15,233 | 1.14% | `aggregated-th-only.txt` |
| Vietnam | VN | 2,205 | 2,205 | 39,329 | 2.94% | `aggregated-vn-only.txt` |
| South Korea | KR | 3,940 | 3,930 | 16,498 | 1.23% | `aggregated-kr-only.txt` |
| Brazil | BR | 12,623 | 12,580 | 77,526 | 5.80% | `aggregated-br-only.txt` |
| Taiwan | TW | 2,393 | 2,393 | 14,864 | 1.11% | `aggregated-tw-only.txt` |
| Canada | CA | 17,090 | 16,967 | 25,736 | 1.93% | `aggregated-ca-only.txt` |
| Singapore | SG | 9,459 | 9,449 | 36,348 | 2.72% | `aggregated-sg-only.txt` |
| Italy | IT | 9,746 | 9,714 | 15,791 | 1.18% | `aggregated-it-only.txt` |
| Netherlands | NL | 18,940 | 18,817 | 51,535 | 3.86% | `aggregated-nl-only.txt` |
| Indonesia | ID | 6,564 | 6,535 | 29,195 | 2.18% | `aggregated-id-only.txt` |
| France | FR | 33,593 | 33,564 | 24,664 | 1.85% | `aggregated-fr-only.txt` |
| Venezuela | VE | 967 | 967 | 7,543 | 0.56% | `aggregated-ve-only.txt` |
| Australia | AU | 12,166 | 12,097 | 17,289 | 1.29% | `aggregated-au-only.txt` |
| Turkey | TR | 3,463 | 3,447 | 14,024 | 1.05% | `aggregated-tr-only.txt` |
| Ukraine | UA | 5,565 | 5,510 | 15,192 | 1.14% | `aggregated-ua-only.txt` |
| Iran | IR | 2,058 | 2,057 | 5,557 | 0.42% | `aggregated-ir-only.txt` |
| Poland | PL | 8,181 | 8,148 | 8,514 | 0.64% | `aggregated-pl-only.txt` |
| Mexico | MX | 4,348 | 4,344 | 16,539 | 1.24% | `aggregated-mx-only.txt` |
| Spain | ES | 11,222 | 11,204 | 10,023 | 0.75% | `aggregated-es-only.txt` |
| Argentina | AR | 3,476 | 3,474 | 13,159 | 0.98% | `aggregated-ar-only.txt` |
| Egypt | EG | 730 | 730 | 3,797 | 0.28% | `aggregated-eg-only.txt` |
| Pakistan | PK | 1,367 | 1,365 | 18,490 | 1.38% | `aggregated-pk-only.txt` |
| Malaysia | MY | 2,585 | 2,585 | 6,170 | 0.46% | `aggregated-my-only.txt` |
| Bulgaria | BG | 2,365 | 2,354 | 3,143 | 0.24% | `aggregated-bg-only.txt` |
| Czechia | CZ | 3,617 | 3,616 | 1,935 | 0.14% | `aggregated-cz-only.txt` |
| Colombia | CO | 2,234 | 2,234 | 6,848 | 0.51% | `aggregated-co-only.txt` |
| United Arab Emirates | AE | 3,831 | 3,831 | 4,626 | 0.35% | `aggregated-ae-only.txt` |
| Romania | RO | 4,009 | 4,000 | 2,611 | 0.20% | `aggregated-ro-only.txt` |
| Kazakhstan | KZ | 1,319 | 1,318 | 2,819 | 0.21% | `aggregated-kz-only.txt` |
| Morocco | MA | 494 | 494 | 4,669 | 0.35% | `aggregated-ma-only.txt` |
| Saudi Arabia | SA | 1,690 | 1,690 | 4,556 | 0.34% | `aggregated-sa-only.txt` |
| South Africa | ZA | 4,017 | 4,003 | 8,865 | 0.66% | `aggregated-za-only.txt` |
| Bangladesh | BD | 2,653 | 2,651 | 7,353 | 0.55% | `aggregated-bd-only.txt` |
| Chile | CL | 2,002 | 2,000 | 4,144 | 0.31% | `aggregated-cl-only.txt` |
| Nigeria | NG | 1,097 | 1,097 | 1,690 | 0.13% | `aggregated-ng-only.txt` |
| Kenya | KE | 875 | 875 | 3,000 | 0.22% | `aggregated-ke-only.txt` |
...
| Sri Lanka | LK | 248 | 248 | 996 | 0.07% | `aggregated-lk-only.txt` |
| Iraq | IQ | 687 | 687 | 2,612 | 0.20% | `aggregated-iq-only.txt` |
| Ethiopia | ET | 97 | 97 | 1,113 | 0.08% | `aggregated-et-only.txt` |
| Ghana | GH | 347 | 347 | 630 | 0.05% | `aggregated-gh-only.txt` |
| Belarus | BY | 422 | 422 | 788 | 0.06% | `aggregated-by-only.txt` |
...
- **`aggregated.txt`** - 1,336,191 total aggregated IPs from all sources
- **`aggregated-ae-only.txt`** - 4,626 IPs from AE
- **`aggregated-ar-only.txt`** - 13,159 IPs from AR
- **`aggregated-au-only.txt`** - 17,289 IPs from AU
- **`aggregated-bd-only.txt`** - 7,353 IPs from BD
- **`aggregated-bg-only.txt`** - 3,143 IPs from BG
- **`aggregated-br-only.txt`** - 77,526 IPs from BR
- **`aggregated-by-only.txt`** - 788 IPs from BY
- **`aggregated-ca-only.txt`** - 25,736 IPs from CA
- **`aggregated-cl-only.txt`** - 4,144 IPs from CL
- **`aggregated-cn-only.txt`** - 190,096 IPs from CN
- **`aggregated-co-only.txt`** - 6,848 IPs from CO
- **`aggregated-cz-only.txt`** - 1,935 IPs from CZ
- **`aggregated-de-only.txt`** - 45,188 IPs from DE
- **`aggregated-dz-only.txt`** - 2,158 IPs from DZ
- **`aggregated-eg-only.txt`** - 3,797 IPs from EG
- **`aggregated-es-only.txt`** - 10,023 IPs from ES
- **`aggregated-et-only.txt`** - 1,113 IPs from ET
- **`aggregated-fr-only.txt`** - 24,664 IPs from FR
- **`aggregated-gb-only.txt`** - 33,281 IPs from GB
- **`aggregated-gh-only.txt`** - 630 IPs from GH
- **`aggregated-id-only.txt`** - 29,195 IPs from ID
- **`aggregated-in-only.txt`** - 79,594 IPs from IN
- **`aggregated-iq-only.txt`** - 2,612 IPs from IQ
- **`aggregated-ir-only.txt`** - 5,557 IPs from IR
- **`aggregated-it-only.txt`** - 15,791 IPs from IT
- **`aggregated-ke-only.txt`** - 3,000 IPs from KE
- **`aggregated-kr-only.txt`** - 16,498 IPs from KR
- **`aggregated-kz-only.txt`** - 2,819 IPs from KZ
- **`aggregated-lk-only.txt`** - 996 IPs from LK
- **`aggregated-ma-only.txt`** - 4,669 IPs from MA
- **`aggregated-mx-only.txt`** - 16,539 IPs from MX
- **`aggregated-my-only.txt`** - 6,170 IPs from MY
- **`aggregated-ng-only.txt`** - 1,690 IPs from NG
- **`aggregated-nl-only.txt`** - 51,535 IPs from NL
- **`aggregated-pe-only.txt`** - 2,159 IPs from PE
- **`aggregated-pk-only.txt`** - 18,490 IPs from PK
- **`aggregated-pl-only.txt`** - 8,514 IPs from PL
- **`aggregated-ro-only.txt`** - 2,611 IPs from RO
- **`aggregated-rs-only.txt`** - 1,338 IPs from RS
- **`aggregated-ru-only.txt`** - 29,763 IPs from RU
- **`aggregated-sa-only.txt`** - 4,556 IPs from SA
- **`aggregated-sg-only.txt`** - 36,348 IPs from SG
- **`aggregated-th-only.txt`** - 15,233 IPs from TH
- **`aggregated-tr-only.txt`** - 14,024 IPs from TR
- **`aggregated-tw-only.txt`** - 14,864 IPs from TW
- **`aggregated-ua-only.txt`** - 15,192 IPs from UA
- **`aggregated-us-only.txt`** - 248,389 IPs from US
- **`aggregated-ve-only.txt`** - 7,543 IPs from VE
- **`aggregated-vn-only.txt`** - 39,329 IPs from VN
- **`aggregated-za-only.txt`** - 8,865 IPs from ZA
- **`aggregated-multi-50countries-combined.txt`** - 1,177,380 unique IPs (deduplicated across all countries)
