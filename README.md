...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-904585-2D56A8)
...
**Last Updated:** 2026-05-05 17:52:58 UTC
...
- **Total Input IPs:** 904,585
- **Countries Processed:** 50
- **Combined Unique IPs:** 801,778
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 169,198 | 167,680 | 147,231 | 16.28% | `aggregated-us-only.txt` |
| China | CN | 7,598 | 7,597 | 126,503 | 13.98% | `aggregated-cn-only.txt` |
| India | IN | 12,838 | 12,810 | 53,293 | 5.89% | `aggregated-in-only.txt` |
| Germany | DE | 28,972 | 28,867 | 34,972 | 3.87% | `aggregated-de-only.txt` |
| Russia | RU | 13,120 | 12,898 | 19,798 | 2.19% | `aggregated-ru-only.txt` |
| United Kingdom | GB | 33,411 | 33,252 | 26,395 | 2.92% | `aggregated-gb-only.txt` |
| Thailand | TH | 1,947 | 1,945 | 12,409 | 1.37% | `aggregated-th-only.txt` |
| Vietnam | VN | 2,128 | 2,128 | 26,743 | 2.96% | `aggregated-vn-only.txt` |
| South Korea | KR | 4,006 | 3,996 | 12,826 | 1.42% | `aggregated-kr-only.txt` |
| Brazil | BR | 12,782 | 12,630 | 41,546 | 4.59% | `aggregated-br-only.txt` |
| Taiwan | TW | 2,413 | 2,413 | 10,987 | 1.21% | `aggregated-tw-only.txt` |
| Canada | CA | 16,890 | 16,768 | 20,360 | 2.25% | `aggregated-ca-only.txt` |
| Singapore | SG | 9,268 | 9,258 | 27,575 | 3.05% | `aggregated-sg-only.txt` |
| Italy | IT | 9,580 | 9,556 | 13,351 | 1.48% | `aggregated-it-only.txt` |
| Netherlands | NL | 18,273 | 18,151 | 47,888 | 5.29% | `aggregated-nl-only.txt` |
| Indonesia | ID | 6,409 | 6,390 | 22,139 | 2.45% | `aggregated-id-only.txt` |
| France | FR | 32,393 | 32,367 | 17,868 | 1.98% | `aggregated-fr-only.txt` |
| Venezuela | VE | 900 | 900 | 4,292 | 0.47% | `aggregated-ve-only.txt` |
| Australia | AU | 11,396 | 11,317 | 15,032 | 1.66% | `aggregated-au-only.txt` |
| Turkey | TR | 3,399 | 3,371 | 12,906 | 1.43% | `aggregated-tr-only.txt` |
| Ukraine | UA | 5,540 | 5,481 | 7,538 | 0.83% | `aggregated-ua-only.txt` |
| Iran | IR | 2,012 | 2,011 | 3,269 | 0.36% | `aggregated-ir-only.txt` |
| Poland | PL | 8,011 | 7,976 | 5,211 | 0.58% | `aggregated-pl-only.txt` |
| Mexico | MX | 4,307 | 4,303 | 9,941 | 1.10% | `aggregated-mx-only.txt` |
| Spain | ES | 11,140 | 11,107 | 6,289 | 0.70% | `aggregated-es-only.txt` |
| Argentina | AR | 3,445 | 3,443 | 8,655 | 0.96% | `aggregated-ar-only.txt` |
| Egypt | EG | 716 | 716 | 2,825 | 0.31% | `aggregated-eg-only.txt` |
| Pakistan | PK | 1,320 | 1,320 | 12,324 | 1.36% | `aggregated-pk-only.txt` |
| Malaysia | MY | 2,498 | 2,498 | 5,219 | 0.58% | `aggregated-my-only.txt` |
| Bulgaria | BG | 2,290 | 2,280 | 2,330 | 0.26% | `aggregated-bg-only.txt` |
| Czechia | CZ | 3,593 | 3,592 | 1,405 | 0.16% | `aggregated-cz-only.txt` |
| Colombia | CO | 2,210 | 2,210 | 4,166 | 0.46% | `aggregated-co-only.txt` |
| United Arab Emirates | AE | 3,206 | 3,206 | 2,901 | 0.32% | `aggregated-ae-only.txt` |
| Romania | RO | 3,916 | 3,907 | 1,634 | 0.18% | `aggregated-ro-only.txt` |
| Kazakhstan | KZ | 1,349 | 1,348 | 2,113 | 0.23% | `aggregated-kz-only.txt` |
| Morocco | MA | 478 | 478 | 3,549 | 0.39% | `aggregated-ma-only.txt` |
| Saudi Arabia | SA | 1,617 | 1,617 | 4,125 | 0.46% | `aggregated-sa-only.txt` |
| South Africa | ZA | 3,955 | 3,942 | 5,104 | 0.56% | `aggregated-za-only.txt` |
| Bangladesh | BD | 2,608 | 2,603 | 4,517 | 0.50% | `aggregated-bd-only.txt` |
| Chile | CL | 1,870 | 1,870 | 2,938 | 0.32% | `aggregated-cl-only.txt` |
| Nigeria | NG | 1,071 | 1,071 | 1,157 | 0.13% | `aggregated-ng-only.txt` |
| Kenya | KE | 851 | 851 | 2,417 | 0.27% | `aggregated-ke-only.txt` |
| Algeria | DZ | 217 | 217 | 1,541 | 0.17% | `aggregated-dz-only.txt` |
...
| Iraq | IQ | 681 | 681 | 1,559 | 0.17% | `aggregated-iq-only.txt` |
| Ethiopia | ET | 99 | 99 | 952 | 0.11% | `aggregated-et-only.txt` |
...
- **`aggregated.txt`** - 904,585 total aggregated IPs from all sources
- **`aggregated-ae-only.txt`** - 2,901 IPs from AE
- **`aggregated-ar-only.txt`** - 8,655 IPs from AR
- **`aggregated-au-only.txt`** - 15,032 IPs from AU
- **`aggregated-bd-only.txt`** - 4,517 IPs from BD
- **`aggregated-bg-only.txt`** - 2,330 IPs from BG
- **`aggregated-br-only.txt`** - 41,546 IPs from BR
- **`aggregated-by-only.txt`** - 635 IPs from BY
- **`aggregated-ca-only.txt`** - 20,360 IPs from CA
- **`aggregated-cl-only.txt`** - 2,938 IPs from CL
- **`aggregated-cn-only.txt`** - 126,503 IPs from CN
- **`aggregated-co-only.txt`** - 4,166 IPs from CO
- **`aggregated-cz-only.txt`** - 1,405 IPs from CZ
- **`aggregated-de-only.txt`** - 34,972 IPs from DE
- **`aggregated-dz-only.txt`** - 1,541 IPs from DZ
- **`aggregated-eg-only.txt`** - 2,825 IPs from EG
- **`aggregated-es-only.txt`** - 6,289 IPs from ES
- **`aggregated-et-only.txt`** - 952 IPs from ET
- **`aggregated-fr-only.txt`** - 17,868 IPs from FR
- **`aggregated-gb-only.txt`** - 26,395 IPs from GB
- **`aggregated-gh-only.txt`** - 484 IPs from GH
- **`aggregated-id-only.txt`** - 22,139 IPs from ID
- **`aggregated-in-only.txt`** - 53,293 IPs from IN
- **`aggregated-iq-only.txt`** - 1,559 IPs from IQ
...
- **`aggregated-kr-only.txt`** - 12,826 IPs from KR
- **`aggregated-kz-only.txt`** - 2,113 IPs from KZ
- **`aggregated-lk-only.txt`** - 598 IPs from LK
- **`aggregated-ma-only.txt`** - 3,549 IPs from MA
- **`aggregated-mx-only.txt`** - 9,941 IPs from MX
- **`aggregated-my-only.txt`** - 5,219 IPs from MY
- **`aggregated-ng-only.txt`** - 1,157 IPs from NG
- **`aggregated-nl-only.txt`** - 47,888 IPs from NL
- **`aggregated-pe-only.txt`** - 1,306 IPs from PE
- **`aggregated-pk-only.txt`** - 12,324 IPs from PK
- **`aggregated-pl-only.txt`** - 5,211 IPs from PL
- **`aggregated-ro-only.txt`** - 1,634 IPs from RO
- **`aggregated-rs-only.txt`** - 962 IPs from RS
- **`aggregated-ru-only.txt`** - 19,798 IPs from RU
- **`aggregated-sa-only.txt`** - 4,125 IPs from SA
- **`aggregated-sg-only.txt`** - 27,575 IPs from SG
- **`aggregated-th-only.txt`** - 12,409 IPs from TH
- **`aggregated-tr-only.txt`** - 12,906 IPs from TR
- **`aggregated-tw-only.txt`** - 10,987 IPs from TW
- **`aggregated-ua-only.txt`** - 7,538 IPs from UA
- **`aggregated-us-only.txt`** - 147,231 IPs from US
- **`aggregated-ve-only.txt`** - 4,292 IPs from VE
- **`aggregated-vn-only.txt`** - 26,743 IPs from VN
- **`aggregated-za-only.txt`** - 5,104 IPs from ZA
- **`aggregated-multi-50countries-combined.txt`** - 801,778 unique IPs (deduplicated across all countries)
