...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-599776-2D56A8)
...
**Last Updated:** 2026-05-03 04:11:16 UTC
...
- **`aggregated.txt`** - 599,776 total aggregated IPs from all sources
- **`aggregated-au-only.txt`** - 12,311 IPs from AU
- **`aggregated-ca-only.txt`** - 14,379 IPs from CA
- **`aggregated-de-only.txt`** - 28,147 IPs from DE
- **`aggregated-gb-only.txt`** - 19,551 IPs from GB
- **`aggregated-kr-only.txt`** - 8,541 IPs from KR
- **`aggregated-us-only.txt`** - 112,389 IPs from US
- **`aggregated-multi-6countries-combined.txt`** - 195,318 unique IPs (deduplicated across all countries)
