...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-1276567-2D56A8)
...
**Last Updated:** 2026-07-27 10:16:50 UTC
...
- **Total Input IPs:** 1,276,567
- **Countries Processed:** 50
- **Combined Unique IPs:** 1,123,066
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 135,484 | 133,670 | 237,257 | 18.59% | `aggregated-us-only.txt` |
| China | CN | 7,801 | 7,800 | 173,317 | 13.58% | `aggregated-cn-only.txt` |
| India | IN | 13,176 | 13,145 | 76,872 | 6.02% | `aggregated-in-only.txt` |
| Germany | DE | 29,225 | 29,158 | 46,491 | 3.64% | `aggregated-de-only.txt` |
| Russia | RU | 13,278 | 13,041 | 27,672 | 2.17% | `aggregated-ru-only.txt` |
| United Kingdom | GB | 35,497 | 35,342 | 32,046 | 2.51% | `aggregated-gb-only.txt` |
| Thailand | TH | 1,984 | 1,984 | 15,403 | 1.21% | `aggregated-th-only.txt` |
| Vietnam | VN | 2,193 | 2,193 | 40,001 | 3.13% | `aggregated-vn-only.txt` |
| South Korea | KR | 3,949 | 3,939 | 15,967 | 1.25% | `aggregated-kr-only.txt` |
| Brazil | BR | 13,023 | 12,978 | 68,975 | 5.40% | `aggregated-br-only.txt` |
| Taiwan | TW | 2,388 | 2,388 | 13,998 | 1.10% | `aggregated-tw-only.txt` |
| Canada | CA | 16,948 | 16,824 | 26,317 | 2.06% | `aggregated-ca-only.txt` |
| Singapore | SG | 9,453 | 9,443 | 35,194 | 2.76% | `aggregated-sg-only.txt` |
| Italy | IT | 9,769 | 9,745 | 15,515 | 1.22% | `aggregated-it-only.txt` |
| Netherlands | NL | 18,880 | 18,759 | 51,402 | 4.03% | `aggregated-nl-only.txt` |
| Indonesia | ID | 6,505 | 6,481 | 28,714 | 2.25% | `aggregated-id-only.txt` |
| France | FR | 33,610 | 33,583 | 23,647 | 1.85% | `aggregated-fr-only.txt` |
| Venezuela | VE | 957 | 957 | 7,780 | 0.61% | `aggregated-ve-only.txt` |
| Australia | AU | 12,139 | 12,065 | 17,040 | 1.33% | `aggregated-au-only.txt` |
| Turkey | TR | 3,450 | 3,428 | 13,756 | 1.08% | `aggregated-tr-only.txt` |
| Ukraine | UA | 5,551 | 5,495 | 10,257 | 0.80% | `aggregated-ua-only.txt` |
| Iran | IR | 2,048 | 2,047 | 5,387 | 0.42% | `aggregated-ir-only.txt` |
| Poland | PL | 8,204 | 8,171 | 8,340 | 0.65% | `aggregated-pl-only.txt` |
| Mexico | MX | 4,471 | 4,467 | 15,877 | 1.24% | `aggregated-mx-only.txt` |
| Spain | ES | 11,172 | 11,153 | 9,423 | 0.74% | `aggregated-es-only.txt` |
| Argentina | AR | 3,474 | 3,472 | 12,045 | 0.94% | `aggregated-ar-only.txt` |
| Egypt | EG | 728 | 728 | 3,734 | 0.29% | `aggregated-eg-only.txt` |
| Pakistan | PK | 1,355 | 1,353 | 17,702 | 1.39% | `aggregated-pk-only.txt` |
| Malaysia | MY | 2,570 | 2,570 | 5,852 | 0.46% | `aggregated-my-only.txt` |
...
| United Arab Emirates | AE | 3,842 | 3,842 | 4,383 | 0.34% | `aggregated-ae-only.txt` |
...
| Saudi Arabia | SA | 1,682 | 1,682 | 4,352 | 0.34% | `aggregated-sa-only.txt` |
| South Africa | ZA | 4,021 | 4,007 | 8,703 | 0.68% | `aggregated-za-only.txt` |
| Bangladesh | BD | 2,627 | 2,625 | 8,009 | 0.63% | `aggregated-bd-only.txt` |
| Chile | CL | 1,975 | 1,973 | 3,704 | 0.29% | `aggregated-cl-only.txt` |
| Nigeria | NG | 1,091 | 1,091 | 1,758 | 0.14% | `aggregated-ng-only.txt` |
| Kenya | KE | 873 | 873 | 2,983 | 0.23% | `aggregated-ke-only.txt` |
| Algeria | DZ | 219 | 219 | 2,199 | 0.17% | `aggregated-dz-only.txt` |
...
| Iraq | IQ | 683 | 683 | 2,854 | 0.22% | `aggregated-iq-only.txt` |
| Ethiopia | ET | 97 | 97 | 1,182 | 0.09% | `aggregated-et-only.txt` |
| Ghana | GH | 342 | 342 | 587 | 0.05% | `aggregated-gh-only.txt` |
...
- **`aggregated.txt`** - 1,276,567 total aggregated IPs from all sources
- **`aggregated-ae-only.txt`** - 4,383 IPs from AE
- **`aggregated-ar-only.txt`** - 12,045 IPs from AR
- **`aggregated-au-only.txt`** - 17,040 IPs from AU
- **`aggregated-bd-only.txt`** - 8,009 IPs from BD
- **`aggregated-bg-only.txt`** - 3,068 IPs from BG
- **`aggregated-br-only.txt`** - 68,975 IPs from BR
- **`aggregated-by-only.txt`** - 755 IPs from BY
- **`aggregated-ca-only.txt`** - 26,317 IPs from CA
- **`aggregated-cl-only.txt`** - 3,704 IPs from CL
- **`aggregated-cn-only.txt`** - 173,317 IPs from CN
- **`aggregated-co-only.txt`** - 6,751 IPs from CO
- **`aggregated-cz-only.txt`** - 1,941 IPs from CZ
- **`aggregated-de-only.txt`** - 46,491 IPs from DE
- **`aggregated-dz-only.txt`** - 2,199 IPs from DZ
- **`aggregated-eg-only.txt`** - 3,734 IPs from EG
- **`aggregated-es-only.txt`** - 9,423 IPs from ES
- **`aggregated-et-only.txt`** - 1,182 IPs from ET
- **`aggregated-fr-only.txt`** - 23,647 IPs from FR
- **`aggregated-gb-only.txt`** - 32,046 IPs from GB
- **`aggregated-gh-only.txt`** - 587 IPs from GH
- **`aggregated-id-only.txt`** - 28,714 IPs from ID
- **`aggregated-in-only.txt`** - 76,872 IPs from IN
- **`aggregated-iq-only.txt`** - 2,854 IPs from IQ
- **`aggregated-ir-only.txt`** - 5,387 IPs from IR
- **`aggregated-it-only.txt`** - 15,515 IPs from IT
- **`aggregated-ke-only.txt`** - 2,983 IPs from KE
- **`aggregated-kr-only.txt`** - 15,967 IPs from KR
- **`aggregated-kz-only.txt`** - 2,722 IPs from KZ
- **`aggregated-lk-only.txt`** - 961 IPs from LK
- **`aggregated-ma-only.txt`** - 4,224 IPs from MA
- **`aggregated-mx-only.txt`** - 15,877 IPs from MX
- **`aggregated-my-only.txt`** - 5,852 IPs from MY
- **`aggregated-ng-only.txt`** - 1,758 IPs from NG
- **`aggregated-nl-only.txt`** - 51,402 IPs from NL
- **`aggregated-pe-only.txt`** - 2,087 IPs from PE
- **`aggregated-pk-only.txt`** - 17,702 IPs from PK
- **`aggregated-pl-only.txt`** - 8,340 IPs from PL
- **`aggregated-ro-only.txt`** - 2,560 IPs from RO
- **`aggregated-rs-only.txt`** - 1,302 IPs from RS
- **`aggregated-ru-only.txt`** - 27,672 IPs from RU
- **`aggregated-sa-only.txt`** - 4,352 IPs from SA
- **`aggregated-sg-only.txt`** - 35,194 IPs from SG
- **`aggregated-th-only.txt`** - 15,403 IPs from TH
- **`aggregated-tr-only.txt`** - 13,756 IPs from TR
- **`aggregated-tw-only.txt`** - 13,998 IPs from TW
- **`aggregated-ua-only.txt`** - 10,257 IPs from UA
- **`aggregated-us-only.txt`** - 237,257 IPs from US
- **`aggregated-ve-only.txt`** - 7,780 IPs from VE
- **`aggregated-vn-only.txt`** - 40,001 IPs from VN
- **`aggregated-za-only.txt`** - 8,703 IPs from ZA
- **`aggregated-multi-50countries-combined.txt`** - 1,123,066 unique IPs (deduplicated across all countries)
