...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-1072233-2D56A8)
...
- **`aggregated.txt`** - 1,072,233 total aggregated IPs from all sources
- **`aggregated-ae-only.txt`** - 3,384 IPs from AE
- **`aggregated-ar-only.txt`** - 9,010 IPs from AR
- **`aggregated-au-only.txt`** - 16,103 IPs from AU
- **`aggregated-bd-only.txt`** - 5,126 IPs from BD
- **`aggregated-bg-only.txt`** - 2,778 IPs from BG
- **`aggregated-br-only.txt`** - 44,031 IPs from BR
- **`aggregated-by-only.txt`** - 644 IPs from BY
- **`aggregated-ca-only.txt`** - 23,595 IPs from CA
- **`aggregated-cl-only.txt`** - 2,174 IPs from CL
- **`aggregated-cn-only.txt`** - 134,099 IPs from CN
- **`aggregated-co-only.txt`** - 4,286 IPs from CO
- **`aggregated-cz-only.txt`** - 1,717 IPs from CZ
- **`aggregated-de-only.txt`** - 41,673 IPs from DE
- **`aggregated-dz-only.txt`** - 1,616 IPs from DZ
- **`aggregated-eg-only.txt`** - 2,776 IPs from EG
- **`aggregated-es-only.txt`** - 7,796 IPs from ES
- **`aggregated-et-only.txt`** - 877 IPs from ET
- **`aggregated-fr-only.txt`** - 19,672 IPs from FR
- **`aggregated-gb-only.txt`** - 30,376 IPs from GB
- **`aggregated-gh-only.txt`** - 493 IPs from GH
- **`aggregated-id-only.txt`** - 25,472 IPs from ID
- **`aggregated-in-only.txt`** - 66,984 IPs from IN
- **`aggregated-iq-only.txt`** - 1,758 IPs from IQ
- **`aggregated-ir-only.txt`** - 3,974 IPs from IR
- **`aggregated-it-only.txt`** - 14,073 IPs from IT
- **`aggregated-ke-only.txt`** - 2,098 IPs from KE
- **`aggregated-kr-only.txt`** - 13,940 IPs from KR
- **`aggregated-kz-only.txt`** - 2,402 IPs from KZ
- **`aggregated-lk-only.txt`** - 646 IPs from LK
- **`aggregated-ma-only.txt`** - 3,470 IPs from MA
- **`aggregated-mx-only.txt`** - 10,731 IPs from MX
- **`aggregated-my-only.txt`** - 5,241 IPs from MY
- **`aggregated-ng-only.txt`** - 1,141 IPs from NG
- **`aggregated-nl-only.txt`** - 51,093 IPs from NL
- **`aggregated-pe-only.txt`** - 1,497 IPs from PE
- **`aggregated-pk-only.txt`** - 13,703 IPs from PK
- **`aggregated-pl-only.txt`** - 7,455 IPs from PL
- **`aggregated-ro-only.txt`** - 2,087 IPs from RO
- **`aggregated-rs-only.txt`** - 1,024 IPs from RS
- **`aggregated-ru-only.txt`** - 25,067 IPs from RU
- **`aggregated-sa-only.txt`** - 3,753 IPs from SA
- **`aggregated-sg-only.txt`** - 32,753 IPs from SG
- **`aggregated-th-only.txt`** - 13,671 IPs from TH
- **`aggregated-tr-only.txt`** - 12,646 IPs from TR
- **`aggregated-tw-only.txt`** - 13,070 IPs from TW
- **`aggregated-ua-only.txt`** - 8,083 IPs from UA
- **`aggregated-us-only.txt`** - 209,378 IPs from US
- **`aggregated-ve-only.txt`** - 6,608 IPs from VE
- **`aggregated-vn-only.txt`** - 34,649 IPs from VN
- **`aggregated-za-only.txt`** - 6,385 IPs from ZA
- **`aggregated-multi-50countries-combined.txt`** - 947,078 unique IPs (deduplicated across all countries)
