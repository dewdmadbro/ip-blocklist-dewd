...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-1047033-2D56A8)
...
**Last Updated:** 2026-05-13 18:20:02 UTC
...
- **Total Input IPs:** 1,047,033
- **Countries Processed:** 50
- **Combined Unique IPs:** 927,240
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 167,975 | 166,467 | 199,367 | 19.04% | `aggregated-us-only.txt` |
| China | CN | 7,573 | 7,572 | 135,134 | 12.91% | `aggregated-cn-only.txt` |
| India | IN | 12,849 | 12,821 | 65,257 | 6.23% | `aggregated-in-only.txt` |
| Germany | DE | 28,807 | 28,725 | 38,756 | 3.70% | `aggregated-de-only.txt` |
| Russia | RU | 13,075 | 12,845 | 24,965 | 2.38% | `aggregated-ru-only.txt` |
| United Kingdom | GB | 34,028 | 33,858 | 29,464 | 2.81% | `aggregated-gb-only.txt` |
| Thailand | TH | 1,943 | 1,942 | 13,533 | 1.29% | `aggregated-th-only.txt` |
| Vietnam | VN | 2,134 | 2,134 | 35,176 | 3.36% | `aggregated-vn-only.txt` |
| South Korea | KR | 3,984 | 3,974 | 14,190 | 1.36% | `aggregated-kr-only.txt` |
| Brazil | BR | 12,903 | 12,767 | 42,970 | 4.10% | `aggregated-br-only.txt` |
| Taiwan | TW | 2,418 | 2,418 | 12,991 | 1.24% | `aggregated-tw-only.txt` |
| Canada | CA | 17,039 | 16,905 | 22,393 | 2.14% | `aggregated-ca-only.txt` |
| Singapore | SG | 9,243 | 9,233 | 31,498 | 3.01% | `aggregated-sg-only.txt` |
| Italy | IT | 9,559 | 9,535 | 13,994 | 1.34% | `aggregated-it-only.txt` |
| Netherlands | NL | 18,372 | 18,250 | 50,595 | 4.83% | `aggregated-nl-only.txt` |
| Indonesia | ID | 6,412 | 6,393 | 25,290 | 2.42% | `aggregated-id-only.txt` |
| France | FR | 32,099 | 32,073 | 19,758 | 1.89% | `aggregated-fr-only.txt` |
| Venezuela | VE | 928 | 928 | 6,496 | 0.62% | `aggregated-ve-only.txt` |
| Australia | AU | 12,110 | 12,041 | 15,610 | 1.49% | `aggregated-au-only.txt` |
| Turkey | TR | 3,410 | 3,386 | 12,279 | 1.17% | `aggregated-tr-only.txt` |
| Ukraine | UA | 5,547 | 5,492 | 7,947 | 0.76% | `aggregated-ua-only.txt` |
| Iran | IR | 2,013 | 2,012 | 3,935 | 0.38% | `aggregated-ir-only.txt` |
| Poland | PL | 8,019 | 7,988 | 7,414 | 0.71% | `aggregated-pl-only.txt` |
| Mexico | MX | 4,378 | 4,374 | 10,388 | 0.99% | `aggregated-mx-only.txt` |
| Spain | ES | 10,946 | 10,915 | 7,421 | 0.71% | `aggregated-es-only.txt` |
| Argentina | AR | 3,471 | 3,469 | 8,883 | 0.85% | `aggregated-ar-only.txt` |
| Egypt | EG | 730 | 730 | 2,737 | 0.26% | `aggregated-eg-only.txt` |
| Pakistan | PK | 1,320 | 1,320 | 13,353 | 1.28% | `aggregated-pk-only.txt` |
| Malaysia | MY | 2,480 | 2,480 | 5,209 | 0.50% | `aggregated-my-only.txt` |
| Bulgaria | BG | 2,287 | 2,277 | 2,780 | 0.27% | `aggregated-bg-only.txt` |
| Czechia | CZ | 3,600 | 3,600 | 1,664 | 0.16% | `aggregated-cz-only.txt` |
| Colombia | CO | 2,222 | 2,222 | 4,442 | 0.42% | `aggregated-co-only.txt` |
| United Arab Emirates | AE | 3,232 | 3,232 | 3,388 | 0.32% | `aggregated-ae-only.txt` |
| Romania | RO | 3,917 | 3,908 | 2,069 | 0.20% | `aggregated-ro-only.txt` |
| Kazakhstan | KZ | 1,255 | 1,254 | 2,295 | 0.22% | `aggregated-kz-only.txt` |
| Morocco | MA | 478 | 478 | 3,390 | 0.32% | `aggregated-ma-only.txt` |
| Saudi Arabia | SA | 1,630 | 1,630 | 3,803 | 0.36% | `aggregated-sa-only.txt` |
| South Africa | ZA | 3,962 | 3,949 | 6,650 | 0.64% | `aggregated-za-only.txt` |
| Bangladesh | BD | 2,615 | 2,612 | 5,232 | 0.50% | `aggregated-bd-only.txt` |
| Chile | CL | 1,885 | 1,885 | 2,362 | 0.23% | `aggregated-cl-only.txt` |
| Nigeria | NG | 1,071 | 1,071 | 1,127 | 0.11% | `aggregated-ng-only.txt` |
| Kenya | KE | 853 | 853 | 2,387 | 0.23% | `aggregated-ke-only.txt` |
...
| Ethiopia | ET | 98 | 98 | 901 | 0.09% | `aggregated-et-only.txt` |
...
- **`aggregated.txt`** - 1,047,033 total aggregated IPs from all sources
- **`aggregated-ae-only.txt`** - 3,388 IPs from AE
- **`aggregated-ar-only.txt`** - 8,883 IPs from AR
- **`aggregated-au-only.txt`** - 15,610 IPs from AU
- **`aggregated-bd-only.txt`** - 5,232 IPs from BD
- **`aggregated-bg-only.txt`** - 2,780 IPs from BG
- **`aggregated-br-only.txt`** - 42,970 IPs from BR
- **`aggregated-by-only.txt`** - 678 IPs from BY
- **`aggregated-ca-only.txt`** - 22,393 IPs from CA
- **`aggregated-cl-only.txt`** - 2,362 IPs from CL
- **`aggregated-cn-only.txt`** - 135,134 IPs from CN
- **`aggregated-co-only.txt`** - 4,442 IPs from CO
- **`aggregated-cz-only.txt`** - 1,664 IPs from CZ
- **`aggregated-de-only.txt`** - 38,756 IPs from DE
...
- **`aggregated-gb-only.txt`** - 29,464 IPs from GB
- **`aggregated-gh-only.txt`** - 505 IPs from GH
- **`aggregated-id-only.txt`** - 25,290 IPs from ID
...
- **`aggregated-it-only.txt`** - 13,994 IPs from IT
- **`aggregated-ke-only.txt`** - 2,387 IPs from KE
- **`aggregated-kr-only.txt`** - 14,190 IPs from KR
- **`aggregated-kz-only.txt`** - 2,295 IPs from KZ
- **`aggregated-lk-only.txt`** - 625 IPs from LK
- **`aggregated-ma-only.txt`** - 3,390 IPs from MA
- **`aggregated-mx-only.txt`** - 10,388 IPs from MX
- **`aggregated-my-only.txt`** - 5,209 IPs from MY
- **`aggregated-ng-only.txt`** - 1,127 IPs from NG
- **`aggregated-nl-only.txt`** - 50,595 IPs from NL
- **`aggregated-pe-only.txt`** - 1,489 IPs from PE
- **`aggregated-pk-only.txt`** - 13,353 IPs from PK
- **`aggregated-pl-only.txt`** - 7,414 IPs from PL
- **`aggregated-ro-only.txt`** - 2,069 IPs from RO
- **`aggregated-rs-only.txt`** - 1,005 IPs from RS
- **`aggregated-ru-only.txt`** - 24,965 IPs from RU
- **`aggregated-sa-only.txt`** - 3,803 IPs from SA
- **`aggregated-sg-only.txt`** - 31,498 IPs from SG
- **`aggregated-th-only.txt`** - 13,533 IPs from TH
- **`aggregated-tr-only.txt`** - 12,279 IPs from TR
- **`aggregated-tw-only.txt`** - 12,991 IPs from TW
- **`aggregated-ua-only.txt`** - 7,947 IPs from UA
- **`aggregated-us-only.txt`** - 199,367 IPs from US
- **`aggregated-ve-only.txt`** - 6,496 IPs from VE
- **`aggregated-vn-only.txt`** - 35,176 IPs from VN
- **`aggregated-za-only.txt`** - 6,650 IPs from ZA
- **`aggregated-multi-50countries-combined.txt`** - 927,240 unique IPs (deduplicated across all countries)
