...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-1120463-2D56A8)
...
**Last Updated:** 2026-06-16 21:26:45 UTC
...
- **Total Input IPs:** 1,120,463
- **Countries Processed:** 50
- **Combined Unique IPs:** 989,852
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 162,102 | 160,287 | 217,334 | 19.40% | `aggregated-us-only.txt` |
| China | CN | 7,798 | 7,797 | 138,314 | 12.34% | `aggregated-cn-only.txt` |
| India | IN | 12,962 | 12,931 | 71,227 | 6.36% | `aggregated-in-only.txt` |
| Germany | DE | 28,808 | 28,728 | 43,958 | 3.92% | `aggregated-de-only.txt` |
| Russia | RU | 13,175 | 12,935 | 25,752 | 2.30% | `aggregated-ru-only.txt` |
| United Kingdom | GB | 35,600 | 35,425 | 31,926 | 2.85% | `aggregated-gb-only.txt` |
| Thailand | TH | 1,945 | 1,945 | 13,867 | 1.24% | `aggregated-th-only.txt` |
| Vietnam | VN | 2,161 | 2,161 | 35,296 | 3.15% | `aggregated-vn-only.txt` |
| South Korea | KR | 3,954 | 3,944 | 14,560 | 1.30% | `aggregated-kr-only.txt` |
| Brazil | BR | 13,481 | 13,446 | 48,014 | 4.29% | `aggregated-br-only.txt` |
| Taiwan | TW | 2,421 | 2,421 | 13,472 | 1.20% | `aggregated-tw-only.txt` |
| Canada | CA | 16,986 | 16,858 | 25,787 | 2.30% | `aggregated-ca-only.txt` |
| Singapore | SG | 9,327 | 9,317 | 35,035 | 3.13% | `aggregated-sg-only.txt` |
| Italy | IT | 9,615 | 9,591 | 14,639 | 1.31% | `aggregated-it-only.txt` |
| Netherlands | NL | 18,797 | 18,662 | 51,110 | 4.56% | `aggregated-nl-only.txt` |
| Indonesia | ID | 6,427 | 6,406 | 26,403 | 2.36% | `aggregated-id-only.txt` |
| France | FR | 32,688 | 32,662 | 20,855 | 1.86% | `aggregated-fr-only.txt` |
| Venezuela | VE | 940 | 940 | 6,711 | 0.60% | `aggregated-ve-only.txt` |
| Australia | AU | 12,043 | 11,960 | 16,693 | 1.49% | `aggregated-au-only.txt` |
| Turkey | TR | 3,433 | 3,409 | 13,039 | 1.16% | `aggregated-tr-only.txt` |
| Ukraine | UA | 5,549 | 5,494 | 8,173 | 0.73% | `aggregated-ua-only.txt` |
| Iran | IR | 2,032 | 2,031 | 4,466 | 0.40% | `aggregated-ir-only.txt` |
| Poland | PL | 8,080 | 8,050 | 7,569 | 0.68% | `aggregated-pl-only.txt` |
| Mexico | MX | 4,387 | 4,383 | 11,573 | 1.03% | `aggregated-mx-only.txt` |
| Spain | ES | 11,015 | 10,993 | 8,145 | 0.73% | `aggregated-es-only.txt` |
| Argentina | AR | 3,454 | 3,452 | 9,408 | 0.84% | `aggregated-ar-only.txt` |
| Egypt | EG | 731 | 731 | 3,040 | 0.27% | `aggregated-eg-only.txt` |
| Pakistan | PK | 1,343 | 1,341 | 14,701 | 1.31% | `aggregated-pk-only.txt` |
| Malaysia | MY | 2,523 | 2,523 | 5,448 | 0.49% | `aggregated-my-only.txt` |
| Bulgaria | BG | 2,326 | 2,315 | 2,837 | 0.25% | `aggregated-bg-only.txt` |
| Czechia | CZ | 3,655 | 3,654 | 1,737 | 0.16% | `aggregated-cz-only.txt` |
| Colombia | CO | 2,207 | 2,207 | 4,681 | 0.42% | `aggregated-co-only.txt` |
| United Arab Emirates | AE | 3,300 | 3,300 | 3,671 | 0.33% | `aggregated-ae-only.txt` |
| Romania | RO | 4,009 | 3,999 | 2,192 | 0.20% | `aggregated-ro-only.txt` |
| Kazakhstan | KZ | 1,308 | 1,307 | 2,461 | 0.22% | `aggregated-kz-only.txt` |
| Morocco | MA | 476 | 476 | 3,635 | 0.32% | `aggregated-ma-only.txt` |
| Saudi Arabia | SA | 1,632 | 1,632 | 4,024 | 0.36% | `aggregated-sa-only.txt` |
| South Africa | ZA | 3,966 | 3,952 | 6,662 | 0.59% | `aggregated-za-only.txt` |
| Bangladesh | BD | 2,628 | 2,626 | 5,517 | 0.49% | `aggregated-bd-only.txt` |
| Chile | CL | 1,910 | 1,909 | 2,653 | 0.24% | `aggregated-cl-only.txt` |
| Nigeria | NG | 1,077 | 1,077 | 1,236 | 0.11% | `aggregated-ng-only.txt` |
| Kenya | KE | 867 | 867 | 2,630 | 0.23% | `aggregated-ke-only.txt` |
| Algeria | DZ | 219 | 219 | 1,757 | 0.16% | `aggregated-dz-only.txt` |
| Serbia | RS | 959 | 957 | 1,074 | 0.10% | `aggregated-rs-only.txt` |
| Peru | PE | 1,103 | 1,102 | 1,615 | 0.14% | `aggregated-pe-only.txt` |
| Sri Lanka | LK | 249 | 249 | 777 | 0.07% | `aggregated-lk-only.txt` |
| Iraq | IQ | 683 | 683 | 2,047 | 0.18% | `aggregated-iq-only.txt` |
| Ethiopia | ET | 99 | 99 | 950 | 0.08% | `aggregated-et-only.txt` |
...
- **`aggregated.txt`** - 1,120,463 total aggregated IPs from all sources
- **`aggregated-ae-only.txt`** - 3,671 IPs from AE
- **`aggregated-ar-only.txt`** - 9,408 IPs from AR
- **`aggregated-au-only.txt`** - 16,693 IPs from AU
- **`aggregated-bd-only.txt`** - 5,517 IPs from BD
- **`aggregated-bg-only.txt`** - 2,837 IPs from BG
- **`aggregated-br-only.txt`** - 48,014 IPs from BR
- **`aggregated-by-only.txt`** - 664 IPs from BY
- **`aggregated-ca-only.txt`** - 25,787 IPs from CA
- **`aggregated-cl-only.txt`** - 2,653 IPs from CL
- **`aggregated-cn-only.txt`** - 138,314 IPs from CN
- **`aggregated-co-only.txt`** - 4,681 IPs from CO
- **`aggregated-cz-only.txt`** - 1,737 IPs from CZ
- **`aggregated-de-only.txt`** - 43,958 IPs from DE
- **`aggregated-dz-only.txt`** - 1,757 IPs from DZ
- **`aggregated-eg-only.txt`** - 3,040 IPs from EG
- **`aggregated-es-only.txt`** - 8,145 IPs from ES
- **`aggregated-et-only.txt`** - 950 IPs from ET
- **`aggregated-fr-only.txt`** - 20,855 IPs from FR
- **`aggregated-gb-only.txt`** - 31,926 IPs from GB
- **`aggregated-gh-only.txt`** - 517 IPs from GH
- **`aggregated-id-only.txt`** - 26,403 IPs from ID
- **`aggregated-in-only.txt`** - 71,227 IPs from IN
- **`aggregated-iq-only.txt`** - 2,047 IPs from IQ
- **`aggregated-ir-only.txt`** - 4,466 IPs from IR
- **`aggregated-it-only.txt`** - 14,639 IPs from IT
- **`aggregated-ke-only.txt`** - 2,630 IPs from KE
- **`aggregated-kr-only.txt`** - 14,560 IPs from KR
- **`aggregated-kz-only.txt`** - 2,461 IPs from KZ
- **`aggregated-lk-only.txt`** - 777 IPs from LK
- **`aggregated-ma-only.txt`** - 3,635 IPs from MA
- **`aggregated-mx-only.txt`** - 11,573 IPs from MX
- **`aggregated-my-only.txt`** - 5,448 IPs from MY
- **`aggregated-ng-only.txt`** - 1,236 IPs from NG
- **`aggregated-nl-only.txt`** - 51,110 IPs from NL
- **`aggregated-pe-only.txt`** - 1,615 IPs from PE
- **`aggregated-pk-only.txt`** - 14,701 IPs from PK
- **`aggregated-pl-only.txt`** - 7,569 IPs from PL
- **`aggregated-ro-only.txt`** - 2,192 IPs from RO
- **`aggregated-rs-only.txt`** - 1,074 IPs from RS
- **`aggregated-ru-only.txt`** - 25,752 IPs from RU
- **`aggregated-sa-only.txt`** - 4,024 IPs from SA
- **`aggregated-sg-only.txt`** - 35,035 IPs from SG
- **`aggregated-th-only.txt`** - 13,867 IPs from TH
- **`aggregated-tr-only.txt`** - 13,039 IPs from TR
- **`aggregated-tw-only.txt`** - 13,472 IPs from TW
- **`aggregated-ua-only.txt`** - 8,173 IPs from UA
- **`aggregated-us-only.txt`** - 217,334 IPs from US
- **`aggregated-ve-only.txt`** - 6,711 IPs from VE
- **`aggregated-vn-only.txt`** - 35,296 IPs from VN
- **`aggregated-za-only.txt`** - 6,662 IPs from ZA
- **`aggregated-multi-50countries-combined.txt`** - 989,852 unique IPs (deduplicated across all countries)
