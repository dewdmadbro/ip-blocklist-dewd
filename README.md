...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-901403-2D56A8)
...
**Last Updated:** 2026-05-07 07:21:33 UTC
...
- **Total Input IPs:** 901,403
- **Countries Processed:** 50
- **Combined Unique IPs:** 799,414
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 169,198 | 167,680 | 147,077 | 16.32% | `aggregated-us-only.txt` |
| China | CN | 7,598 | 7,597 | 126,556 | 14.04% | `aggregated-cn-only.txt` |
| India | IN | 12,838 | 12,810 | 52,960 | 5.88% | `aggregated-in-only.txt` |
| Germany | DE | 28,972 | 28,867 | 35,073 | 3.89% | `aggregated-de-only.txt` |
| Russia | RU | 13,120 | 12,898 | 19,774 | 2.19% | `aggregated-ru-only.txt` |
| United Kingdom | GB | 33,411 | 33,252 | 26,582 | 2.95% | `aggregated-gb-only.txt` |
| Thailand | TH | 1,947 | 1,945 | 12,354 | 1.37% | `aggregated-th-only.txt` |
| Vietnam | VN | 2,128 | 2,128 | 26,654 | 2.96% | `aggregated-vn-only.txt` |
| South Korea | KR | 4,006 | 3,996 | 12,875 | 1.43% | `aggregated-kr-only.txt` |
| Brazil | BR | 12,782 | 12,630 | 40,696 | 4.51% | `aggregated-br-only.txt` |
| Taiwan | TW | 2,413 | 2,413 | 10,987 | 1.22% | `aggregated-tw-only.txt` |
| Canada | CA | 16,890 | 16,768 | 20,974 | 2.33% | `aggregated-ca-only.txt` |
| Singapore | SG | 9,268 | 9,258 | 27,639 | 3.07% | `aggregated-sg-only.txt` |
| Italy | IT | 9,580 | 9,556 | 13,351 | 1.48% | `aggregated-it-only.txt` |
| Netherlands | NL | 18,273 | 18,151 | 48,041 | 5.33% | `aggregated-nl-only.txt` |
| Indonesia | ID | 6,409 | 6,390 | 21,997 | 2.44% | `aggregated-id-only.txt` |
| France | FR | 32,393 | 32,367 | 18,014 | 2.00% | `aggregated-fr-only.txt` |
| Venezuela | VE | 900 | 900 | 4,140 | 0.46% | `aggregated-ve-only.txt` |
| Australia | AU | 11,396 | 11,317 | 15,065 | 1.67% | `aggregated-au-only.txt` |
| Turkey | TR | 3,399 | 3,371 | 12,639 | 1.40% | `aggregated-tr-only.txt` |
| Ukraine | UA | 5,540 | 5,481 | 7,474 | 0.83% | `aggregated-ua-only.txt` |
| Iran | IR | 2,012 | 2,011 | 3,268 | 0.36% | `aggregated-ir-only.txt` |
| Poland | PL | 8,011 | 7,976 | 5,211 | 0.58% | `aggregated-pl-only.txt` |
| Mexico | MX | 4,307 | 4,303 | 9,817 | 1.09% | `aggregated-mx-only.txt` |
| Spain | ES | 11,140 | 11,107 | 6,269 | 0.70% | `aggregated-es-only.txt` |
| Argentina | AR | 3,445 | 3,443 | 8,566 | 0.95% | `aggregated-ar-only.txt` |
| Egypt | EG | 716 | 716 | 2,749 | 0.30% | `aggregated-eg-only.txt` |
| Pakistan | PK | 1,320 | 1,320 | 12,227 | 1.36% | `aggregated-pk-only.txt` |
| Malaysia | MY | 2,498 | 2,498 | 5,064 | 0.56% | `aggregated-my-only.txt` |
| Bulgaria | BG | 2,290 | 2,280 | 2,332 | 0.26% | `aggregated-bg-only.txt` |
| Czechia | CZ | 3,593 | 3,592 | 1,415 | 0.16% | `aggregated-cz-only.txt` |
| Colombia | CO | 2,210 | 2,210 | 4,122 | 0.46% | `aggregated-co-only.txt` |
| United Arab Emirates | AE | 3,206 | 3,206 | 2,832 | 0.31% | `aggregated-ae-only.txt` |
| Romania | RO | 3,916 | 3,907 | 1,631 | 0.18% | `aggregated-ro-only.txt` |
| Kazakhstan | KZ | 1,349 | 1,348 | 2,080 | 0.23% | `aggregated-kz-only.txt` |
| Morocco | MA | 478 | 478 | 3,415 | 0.38% | `aggregated-ma-only.txt` |
| Saudi Arabia | SA | 1,617 | 1,617 | 3,885 | 0.43% | `aggregated-sa-only.txt` |
| South Africa | ZA | 3,955 | 3,942 | 5,021 | 0.56% | `aggregated-za-only.txt` |
| Bangladesh | BD | 2,608 | 2,603 | 4,466 | 0.50% | `aggregated-bd-only.txt` |
| Chile | CL | 1,870 | 1,870 | 2,728 | 0.30% | `aggregated-cl-only.txt` |
| Nigeria | NG | 1,071 | 1,071 | 1,124 | 0.12% | `aggregated-ng-only.txt` |
| Kenya | KE | 851 | 851 | 2,378 | 0.26% | `aggregated-ke-only.txt` |
| Algeria | DZ | 217 | 217 | 1,492 | 0.17% | `aggregated-dz-only.txt` |
| Serbia | RS | 950 | 948 | 950 | 0.11% | `aggregated-rs-only.txt` |
| Peru | PE | 1,105 | 1,104 | 1,297 | 0.14% | `aggregated-pe-only.txt` |
| Sri Lanka | LK | 241 | 241 | 582 | 0.06% | `aggregated-lk-only.txt` |
| Iraq | IQ | 681 | 681 | 1,542 | 0.17% | `aggregated-iq-only.txt` |
| Ethiopia | ET | 99 | 99 | 928 | 0.10% | `aggregated-et-only.txt` |
| Ghana | GH | 344 | 344 | 480 | 0.05% | `aggregated-gh-only.txt` |
| Belarus | BY | 491 | 491 | 621 | 0.07% | `aggregated-by-only.txt` |
...
- **`aggregated.txt`** - 901,403 total aggregated IPs from all sources
- **`aggregated-ae-only.txt`** - 2,832 IPs from AE
- **`aggregated-ar-only.txt`** - 8,566 IPs from AR
- **`aggregated-au-only.txt`** - 15,065 IPs from AU
- **`aggregated-bd-only.txt`** - 4,466 IPs from BD
- **`aggregated-bg-only.txt`** - 2,332 IPs from BG
- **`aggregated-br-only.txt`** - 40,696 IPs from BR
- **`aggregated-by-only.txt`** - 621 IPs from BY
- **`aggregated-ca-only.txt`** - 20,974 IPs from CA
- **`aggregated-cl-only.txt`** - 2,728 IPs from CL
- **`aggregated-cn-only.txt`** - 126,556 IPs from CN
- **`aggregated-co-only.txt`** - 4,122 IPs from CO
- **`aggregated-cz-only.txt`** - 1,415 IPs from CZ
- **`aggregated-de-only.txt`** - 35,073 IPs from DE
- **`aggregated-dz-only.txt`** - 1,492 IPs from DZ
- **`aggregated-eg-only.txt`** - 2,749 IPs from EG
- **`aggregated-es-only.txt`** - 6,269 IPs from ES
- **`aggregated-et-only.txt`** - 928 IPs from ET
- **`aggregated-fr-only.txt`** - 18,014 IPs from FR
- **`aggregated-gb-only.txt`** - 26,582 IPs from GB
- **`aggregated-gh-only.txt`** - 480 IPs from GH
- **`aggregated-id-only.txt`** - 21,997 IPs from ID
- **`aggregated-in-only.txt`** - 52,960 IPs from IN
- **`aggregated-iq-only.txt`** - 1,542 IPs from IQ
- **`aggregated-ir-only.txt`** - 3,268 IPs from IR
- **`aggregated-it-only.txt`** - 13,351 IPs from IT
- **`aggregated-ke-only.txt`** - 2,378 IPs from KE
- **`aggregated-kr-only.txt`** - 12,875 IPs from KR
- **`aggregated-kz-only.txt`** - 2,080 IPs from KZ
- **`aggregated-lk-only.txt`** - 582 IPs from LK
- **`aggregated-ma-only.txt`** - 3,415 IPs from MA
- **`aggregated-mx-only.txt`** - 9,817 IPs from MX
- **`aggregated-my-only.txt`** - 5,064 IPs from MY
- **`aggregated-ng-only.txt`** - 1,124 IPs from NG
- **`aggregated-nl-only.txt`** - 48,041 IPs from NL
- **`aggregated-pe-only.txt`** - 1,297 IPs from PE
- **`aggregated-pk-only.txt`** - 12,227 IPs from PK
- **`aggregated-pl-only.txt`** - 5,211 IPs from PL
- **`aggregated-ro-only.txt`** - 1,631 IPs from RO
- **`aggregated-rs-only.txt`** - 950 IPs from RS
- **`aggregated-ru-only.txt`** - 19,774 IPs from RU
- **`aggregated-sa-only.txt`** - 3,885 IPs from SA
- **`aggregated-sg-only.txt`** - 27,639 IPs from SG
- **`aggregated-th-only.txt`** - 12,354 IPs from TH
- **`aggregated-tr-only.txt`** - 12,639 IPs from TR
- **`aggregated-tw-only.txt`** - 10,987 IPs from TW
- **`aggregated-ua-only.txt`** - 7,474 IPs from UA
- **`aggregated-us-only.txt`** - 147,077 IPs from US
- **`aggregated-ve-only.txt`** - 4,140 IPs from VE
- **`aggregated-vn-only.txt`** - 26,654 IPs from VN
- **`aggregated-za-only.txt`** - 5,021 IPs from ZA
- **`aggregated-multi-50countries-combined.txt`** - 799,414 unique IPs (deduplicated across all countries)
