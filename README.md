...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-1131101-2D56A8)
...
**Last Updated:** 2026-06-21 05:25:49 UTC
...
- **Total Input IPs:** 1,131,101
- **Countries Processed:** 50
- **Combined Unique IPs:** 998,646
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 157,756 | 155,950 | 219,180 | 19.38% | `aggregated-us-only.txt` |
| China | CN | 7,904 | 7,903 | 142,941 | 12.64% | `aggregated-cn-only.txt` |
| India | IN | 12,970 | 12,938 | 71,986 | 6.36% | `aggregated-in-only.txt` |
| Germany | DE | 28,842 | 28,762 | 43,799 | 3.87% | `aggregated-de-only.txt` |
| Russia | RU | 13,176 | 12,937 | 25,873 | 2.29% | `aggregated-ru-only.txt` |
| United Kingdom | GB | 35,639 | 35,460 | 31,667 | 2.80% | `aggregated-gb-only.txt` |
| Thailand | TH | 1,954 | 1,954 | 13,887 | 1.23% | `aggregated-th-only.txt` |
| Vietnam | VN | 2,164 | 2,164 | 35,548 | 3.14% | `aggregated-vn-only.txt` |
| South Korea | KR | 3,964 | 3,954 | 14,837 | 1.31% | `aggregated-kr-only.txt` |
| Brazil | BR | 13,475 | 13,440 | 48,333 | 4.27% | `aggregated-br-only.txt` |
| Taiwan | TW | 2,417 | 2,417 | 13,548 | 1.20% | `aggregated-tw-only.txt` |
| Canada | CA | 17,019 | 16,891 | 24,178 | 2.14% | `aggregated-ca-only.txt` |
| Singapore | SG | 9,303 | 9,293 | 35,315 | 3.12% | `aggregated-sg-only.txt` |
| Italy | IT | 9,635 | 9,611 | 14,686 | 1.30% | `aggregated-it-only.txt` |
| Netherlands | NL | 18,841 | 18,711 | 51,064 | 4.51% | `aggregated-nl-only.txt` |
| Indonesia | ID | 6,422 | 6,401 | 26,710 | 2.36% | `aggregated-id-only.txt` |
| France | FR | 32,646 | 32,619 | 21,005 | 1.86% | `aggregated-fr-only.txt` |
| Venezuela | VE | 941 | 941 | 6,759 | 0.60% | `aggregated-ve-only.txt` |
| Australia | AU | 12,040 | 11,957 | 16,747 | 1.48% | `aggregated-au-only.txt` |
| Turkey | TR | 3,403 | 3,379 | 13,051 | 1.15% | `aggregated-tr-only.txt` |
| Ukraine | UA | 5,552 | 5,497 | 8,269 | 0.73% | `aggregated-ua-only.txt` |
| Iran | IR | 2,046 | 2,045 | 4,544 | 0.40% | `aggregated-ir-only.txt` |
| Poland | PL | 8,097 | 8,063 | 7,613 | 0.67% | `aggregated-pl-only.txt` |
| Mexico | MX | 4,379 | 4,375 | 11,796 | 1.04% | `aggregated-mx-only.txt` |
| Spain | ES | 11,030 | 11,008 | 8,213 | 0.73% | `aggregated-es-only.txt` |
| Argentina | AR | 3,459 | 3,457 | 9,519 | 0.84% | `aggregated-ar-only.txt` |
| Egypt | EG | 737 | 737 | 3,079 | 0.27% | `aggregated-eg-only.txt` |
| Pakistan | PK | 1,364 | 1,362 | 14,882 | 1.32% | `aggregated-pk-only.txt` |
| Malaysia | MY | 2,530 | 2,530 | 5,477 | 0.48% | `aggregated-my-only.txt` |
| Bulgaria | BG | 2,335 | 2,324 | 2,886 | 0.26% | `aggregated-bg-only.txt` |
| Czechia | CZ | 3,623 | 3,622 | 1,741 | 0.15% | `aggregated-cz-only.txt` |
| Colombia | CO | 2,199 | 2,199 | 4,822 | 0.43% | `aggregated-co-only.txt` |
| United Arab Emirates | AE | 3,314 | 3,314 | 3,719 | 0.33% | `aggregated-ae-only.txt` |
| Romania | RO | 4,016 | 4,006 | 2,204 | 0.19% | `aggregated-ro-only.txt` |
| Kazakhstan | KZ | 1,307 | 1,306 | 2,462 | 0.22% | `aggregated-kz-only.txt` |
| Morocco | MA | 478 | 478 | 3,672 | 0.32% | `aggregated-ma-only.txt` |
| Saudi Arabia | SA | 1,634 | 1,634 | 4,061 | 0.36% | `aggregated-sa-only.txt` |
| South Africa | ZA | 3,972 | 3,958 | 6,803 | 0.60% | `aggregated-za-only.txt` |
| Bangladesh | BD | 2,623 | 2,621 | 5,646 | 0.50% | `aggregated-bd-only.txt` |
| Chile | CL | 1,898 | 1,897 | 2,663 | 0.24% | `aggregated-cl-only.txt` |
| Nigeria | NG | 1,080 | 1,080 | 1,250 | 0.11% | `aggregated-ng-only.txt` |
| Kenya | KE | 866 | 866 | 2,660 | 0.24% | `aggregated-ke-only.txt` |
| Algeria | DZ | 220 | 220 | 1,769 | 0.16% | `aggregated-dz-only.txt` |
| Serbia | RS | 960 | 958 | 1,099 | 0.10% | `aggregated-rs-only.txt` |
| Peru | PE | 1,105 | 1,104 | 1,640 | 0.14% | `aggregated-pe-only.txt` |
| Sri Lanka | LK | 250 | 250 | 803 | 0.07% | `aggregated-lk-only.txt` |
| Iraq | IQ | 683 | 683 | 2,100 | 0.19% | `aggregated-iq-only.txt` |
| Ethiopia | ET | 99 | 99 | 952 | 0.08% | `aggregated-et-only.txt` |
| Ghana | GH | 340 | 340 | 522 | 0.05% | `aggregated-gh-only.txt` |
| Belarus | BY | 421 | 421 | 666 | 0.06% | `aggregated-by-only.txt` |
...
- **`aggregated.txt`** - 1,131,101 total aggregated IPs from all sources
- **`aggregated-ae-only.txt`** - 3,719 IPs from AE
- **`aggregated-ar-only.txt`** - 9,519 IPs from AR
- **`aggregated-au-only.txt`** - 16,747 IPs from AU
- **`aggregated-bd-only.txt`** - 5,646 IPs from BD
- **`aggregated-bg-only.txt`** - 2,886 IPs from BG
- **`aggregated-br-only.txt`** - 48,333 IPs from BR
- **`aggregated-by-only.txt`** - 666 IPs from BY
- **`aggregated-ca-only.txt`** - 24,178 IPs from CA
- **`aggregated-cl-only.txt`** - 2,663 IPs from CL
- **`aggregated-cn-only.txt`** - 142,941 IPs from CN
- **`aggregated-co-only.txt`** - 4,822 IPs from CO
- **`aggregated-cz-only.txt`** - 1,741 IPs from CZ
- **`aggregated-de-only.txt`** - 43,799 IPs from DE
- **`aggregated-dz-only.txt`** - 1,769 IPs from DZ
- **`aggregated-eg-only.txt`** - 3,079 IPs from EG
- **`aggregated-es-only.txt`** - 8,213 IPs from ES
- **`aggregated-et-only.txt`** - 952 IPs from ET
- **`aggregated-fr-only.txt`** - 21,005 IPs from FR
- **`aggregated-gb-only.txt`** - 31,667 IPs from GB
- **`aggregated-gh-only.txt`** - 522 IPs from GH
- **`aggregated-id-only.txt`** - 26,710 IPs from ID
- **`aggregated-in-only.txt`** - 71,986 IPs from IN
- **`aggregated-iq-only.txt`** - 2,100 IPs from IQ
- **`aggregated-ir-only.txt`** - 4,544 IPs from IR
- **`aggregated-it-only.txt`** - 14,686 IPs from IT
- **`aggregated-ke-only.txt`** - 2,660 IPs from KE
- **`aggregated-kr-only.txt`** - 14,837 IPs from KR
- **`aggregated-kz-only.txt`** - 2,462 IPs from KZ
- **`aggregated-lk-only.txt`** - 803 IPs from LK
- **`aggregated-ma-only.txt`** - 3,672 IPs from MA
- **`aggregated-mx-only.txt`** - 11,796 IPs from MX
- **`aggregated-my-only.txt`** - 5,477 IPs from MY
- **`aggregated-ng-only.txt`** - 1,250 IPs from NG
- **`aggregated-nl-only.txt`** - 51,064 IPs from NL
- **`aggregated-pe-only.txt`** - 1,640 IPs from PE
- **`aggregated-pk-only.txt`** - 14,882 IPs from PK
- **`aggregated-pl-only.txt`** - 7,613 IPs from PL
- **`aggregated-ro-only.txt`** - 2,204 IPs from RO
- **`aggregated-rs-only.txt`** - 1,099 IPs from RS
- **`aggregated-ru-only.txt`** - 25,873 IPs from RU
- **`aggregated-sa-only.txt`** - 4,061 IPs from SA
- **`aggregated-sg-only.txt`** - 35,315 IPs from SG
- **`aggregated-th-only.txt`** - 13,887 IPs from TH
- **`aggregated-tr-only.txt`** - 13,051 IPs from TR
- **`aggregated-tw-only.txt`** - 13,548 IPs from TW
- **`aggregated-ua-only.txt`** - 8,269 IPs from UA
- **`aggregated-us-only.txt`** - 219,180 IPs from US
- **`aggregated-ve-only.txt`** - 6,759 IPs from VE
- **`aggregated-vn-only.txt`** - 35,548 IPs from VN
- **`aggregated-za-only.txt`** - 6,803 IPs from ZA
- **`aggregated-multi-50countries-combined.txt`** - 998,646 unique IPs (deduplicated across all countries)
