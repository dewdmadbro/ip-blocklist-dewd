...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-1263064-2D56A8)
...
**Last Updated:** 2026-07-24 03:53:35 UTC
...
- **Total Input IPs:** 1,263,064
- **Countries Processed:** 50
- **Combined Unique IPs:** 1,111,194
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 137,787 | 135,973 | 234,972 | 18.60% | `aggregated-us-only.txt` |
| China | CN | 7,716 | 7,715 | 171,279 | 13.56% | `aggregated-cn-only.txt` |
| India | IN | 13,160 | 13,130 | 76,477 | 6.05% | `aggregated-in-only.txt` |
| Germany | DE | 29,153 | 29,083 | 46,301 | 3.67% | `aggregated-de-only.txt` |
| Russia | RU | 13,272 | 13,034 | 27,424 | 2.17% | `aggregated-ru-only.txt` |
| United Kingdom | GB | 35,446 | 35,279 | 32,323 | 2.56% | `aggregated-gb-only.txt` |
| Thailand | TH | 1,979 | 1,979 | 15,298 | 1.21% | `aggregated-th-only.txt` |
| Vietnam | VN | 2,188 | 2,188 | 39,919 | 3.16% | `aggregated-vn-only.txt` |
| South Korea | KR | 3,909 | 3,899 | 15,944 | 1.26% | `aggregated-kr-only.txt` |
| Brazil | BR | 12,907 | 12,848 | 65,532 | 5.19% | `aggregated-br-only.txt` |
| Taiwan | TW | 2,387 | 2,387 | 13,930 | 1.10% | `aggregated-tw-only.txt` |
| Canada | CA | 16,857 | 16,741 | 26,305 | 2.08% | `aggregated-ca-only.txt` |
| Singapore | SG | 9,463 | 9,453 | 35,075 | 2.78% | `aggregated-sg-only.txt` |
| Italy | IT | 9,737 | 9,694 | 15,434 | 1.22% | `aggregated-it-only.txt` |
| Netherlands | NL | 18,776 | 18,667 | 51,350 | 4.07% | `aggregated-nl-only.txt` |
| Indonesia | ID | 6,499 | 6,473 | 28,528 | 2.26% | `aggregated-id-only.txt` |
| France | FR | 33,011 | 32,984 | 23,500 | 1.86% | `aggregated-fr-only.txt` |
| Venezuela | VE | 956 | 956 | 7,738 | 0.61% | `aggregated-ve-only.txt` |
| Australia | AU | 12,109 | 12,038 | 16,950 | 1.34% | `aggregated-au-only.txt` |
| Turkey | TR | 3,444 | 3,421 | 13,821 | 1.09% | `aggregated-tr-only.txt` |
| Ukraine | UA | 5,541 | 5,485 | 9,790 | 0.78% | `aggregated-ua-only.txt` |
| Iran | IR | 2,057 | 2,056 | 5,357 | 0.42% | `aggregated-ir-only.txt` |
| Poland | PL | 8,180 | 8,150 | 8,365 | 0.66% | `aggregated-pl-only.txt` |
| Mexico | MX | 4,452 | 4,448 | 15,415 | 1.22% | `aggregated-mx-only.txt` |
| Spain | ES | 11,055 | 11,035 | 9,281 | 0.73% | `aggregated-es-only.txt` |
| Argentina | AR | 3,452 | 3,450 | 11,870 | 0.94% | `aggregated-ar-only.txt` |
| Egypt | EG | 728 | 728 | 3,684 | 0.29% | `aggregated-eg-only.txt` |
| Pakistan | PK | 1,351 | 1,349 | 17,506 | 1.39% | `aggregated-pk-only.txt` |
| Malaysia | MY | 2,550 | 2,550 | 5,812 | 0.46% | `aggregated-my-only.txt` |
| Bulgaria | BG | 2,378 | 2,367 | 3,056 | 0.24% | `aggregated-bg-only.txt` |
| Czechia | CZ | 3,623 | 3,622 | 1,947 | 0.15% | `aggregated-cz-only.txt` |
| Colombia | CO | 2,217 | 2,217 | 6,597 | 0.52% | `aggregated-co-only.txt` |
| United Arab Emirates | AE | 3,826 | 3,826 | 4,338 | 0.34% | `aggregated-ae-only.txt` |
| Romania | RO | 3,987 | 3,979 | 2,534 | 0.20% | `aggregated-ro-only.txt` |
| Kazakhstan | KZ | 1,309 | 1,308 | 2,684 | 0.21% | `aggregated-kz-only.txt` |
| Morocco | MA | 493 | 493 | 4,192 | 0.33% | `aggregated-ma-only.txt` |
| Saudi Arabia | SA | 1,675 | 1,675 | 4,316 | 0.34% | `aggregated-sa-only.txt` |
| South Africa | ZA | 3,992 | 3,978 | 8,465 | 0.67% | `aggregated-za-only.txt` |
| Bangladesh | BD | 2,628 | 2,626 | 7,529 | 0.60% | `aggregated-bd-only.txt` |
| Chile | CL | 1,931 | 1,929 | 3,614 | 0.29% | `aggregated-cl-only.txt` |
| Nigeria | NG | 1,080 | 1,080 | 1,704 | 0.13% | `aggregated-ng-only.txt` |
| Kenya | KE | 873 | 873 | 3,120 | 0.25% | `aggregated-ke-only.txt` |
| Algeria | DZ | 219 | 219 | 2,166 | 0.17% | `aggregated-dz-only.txt` |
| Serbia | RS | 994 | 992 | 1,308 | 0.10% | `aggregated-rs-only.txt` |
| Peru | PE | 1,180 | 1,179 | 2,100 | 0.17% | `aggregated-pe-only.txt` |
...
| Ghana | GH | 343 | 343 | 586 | 0.05% | `aggregated-gh-only.txt` |
...
- **`aggregated.txt`** - 1,263,064 total aggregated IPs from all sources
- **`aggregated-ae-only.txt`** - 4,338 IPs from AE
- **`aggregated-ar-only.txt`** - 11,870 IPs from AR
- **`aggregated-au-only.txt`** - 16,950 IPs from AU
- **`aggregated-bd-only.txt`** - 7,529 IPs from BD
- **`aggregated-bg-only.txt`** - 3,056 IPs from BG
- **`aggregated-br-only.txt`** - 65,532 IPs from BR
- **`aggregated-by-only.txt`** - 747 IPs from BY
- **`aggregated-ca-only.txt`** - 26,305 IPs from CA
- **`aggregated-cl-only.txt`** - 3,614 IPs from CL
- **`aggregated-cn-only.txt`** - 171,279 IPs from CN
- **`aggregated-co-only.txt`** - 6,597 IPs from CO
...
- **`aggregated-eg-only.txt`** - 3,684 IPs from EG
- **`aggregated-es-only.txt`** - 9,281 IPs from ES
- **`aggregated-et-only.txt`** - 1,189 IPs from ET
- **`aggregated-fr-only.txt`** - 23,500 IPs from FR
- **`aggregated-gb-only.txt`** - 32,323 IPs from GB
- **`aggregated-gh-only.txt`** - 586 IPs from GH
- **`aggregated-id-only.txt`** - 28,528 IPs from ID
- **`aggregated-in-only.txt`** - 76,477 IPs from IN
- **`aggregated-iq-only.txt`** - 2,872 IPs from IQ
- **`aggregated-ir-only.txt`** - 5,357 IPs from IR
- **`aggregated-it-only.txt`** - 15,434 IPs from IT
- **`aggregated-ke-only.txt`** - 3,120 IPs from KE
- **`aggregated-kr-only.txt`** - 15,944 IPs from KR
- **`aggregated-kz-only.txt`** - 2,684 IPs from KZ
- **`aggregated-lk-only.txt`** - 950 IPs from LK
- **`aggregated-ma-only.txt`** - 4,192 IPs from MA
- **`aggregated-mx-only.txt`** - 15,415 IPs from MX
- **`aggregated-my-only.txt`** - 5,812 IPs from MY
- **`aggregated-ng-only.txt`** - 1,704 IPs from NG
- **`aggregated-nl-only.txt`** - 51,350 IPs from NL
- **`aggregated-pe-only.txt`** - 2,100 IPs from PE
- **`aggregated-pk-only.txt`** - 17,506 IPs from PK
- **`aggregated-pl-only.txt`** - 8,365 IPs from PL
- **`aggregated-ro-only.txt`** - 2,534 IPs from RO
- **`aggregated-rs-only.txt`** - 1,308 IPs from RS
- **`aggregated-ru-only.txt`** - 27,424 IPs from RU
- **`aggregated-sa-only.txt`** - 4,316 IPs from SA
- **`aggregated-sg-only.txt`** - 35,075 IPs from SG
- **`aggregated-th-only.txt`** - 15,298 IPs from TH
- **`aggregated-tr-only.txt`** - 13,821 IPs from TR
- **`aggregated-tw-only.txt`** - 13,930 IPs from TW
- **`aggregated-ua-only.txt`** - 9,790 IPs from UA
- **`aggregated-us-only.txt`** - 234,972 IPs from US
- **`aggregated-ve-only.txt`** - 7,738 IPs from VE
- **`aggregated-vn-only.txt`** - 39,919 IPs from VN
- **`aggregated-za-only.txt`** - 8,465 IPs from ZA
- **`aggregated-multi-50countries-combined.txt`** - 1,111,194 unique IPs (deduplicated across all countries)
