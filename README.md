...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-1253866-2D56A8)
...
**Last Updated:** 2026-07-22 08:51:27 UTC
...
- **Total Input IPs:** 1,253,866
- **Countries Processed:** 50
- **Combined Unique IPs:** 1,102,837
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 137,787 | 135,973 | 234,377 | 18.69% | `aggregated-us-only.txt` |
| China | CN | 7,716 | 7,715 | 170,406 | 13.59% | `aggregated-cn-only.txt` |
| India | IN | 13,160 | 13,130 | 75,808 | 6.05% | `aggregated-in-only.txt` |
| Germany | DE | 29,153 | 29,083 | 46,266 | 3.69% | `aggregated-de-only.txt` |
| Russia | RU | 13,272 | 13,034 | 27,330 | 2.18% | `aggregated-ru-only.txt` |
| United Kingdom | GB | 35,446 | 35,279 | 31,943 | 2.55% | `aggregated-gb-only.txt` |
| Thailand | TH | 1,979 | 1,979 | 14,783 | 1.18% | `aggregated-th-only.txt` |
| Vietnam | VN | 2,188 | 2,188 | 39,822 | 3.18% | `aggregated-vn-only.txt` |
| South Korea | KR | 3,909 | 3,899 | 15,918 | 1.27% | `aggregated-kr-only.txt` |
| Brazil | BR | 12,907 | 12,848 | 63,872 | 5.09% | `aggregated-br-only.txt` |
| Taiwan | TW | 2,387 | 2,387 | 13,890 | 1.11% | `aggregated-tw-only.txt` |
| Canada | CA | 16,857 | 16,741 | 25,115 | 2.00% | `aggregated-ca-only.txt` |
| Singapore | SG | 9,463 | 9,453 | 35,019 | 2.79% | `aggregated-sg-only.txt` |
| Italy | IT | 9,737 | 9,694 | 15,374 | 1.23% | `aggregated-it-only.txt` |
| Netherlands | NL | 18,776 | 18,667 | 51,373 | 4.10% | `aggregated-nl-only.txt` |
| Indonesia | ID | 6,499 | 6,473 | 28,316 | 2.26% | `aggregated-id-only.txt` |
| France | FR | 33,011 | 32,984 | 23,283 | 1.86% | `aggregated-fr-only.txt` |
| Venezuela | VE | 956 | 956 | 7,707 | 0.61% | `aggregated-ve-only.txt` |
| Australia | AU | 12,109 | 12,038 | 17,014 | 1.36% | `aggregated-au-only.txt` |
| Turkey | TR | 3,444 | 3,421 | 13,692 | 1.09% | `aggregated-tr-only.txt` |
| Ukraine | UA | 5,541 | 5,485 | 9,383 | 0.75% | `aggregated-ua-only.txt` |
| Iran | IR | 2,057 | 2,056 | 5,275 | 0.42% | `aggregated-ir-only.txt` |
| Poland | PL | 8,180 | 8,150 | 8,337 | 0.66% | `aggregated-pl-only.txt` |
| Mexico | MX | 4,452 | 4,448 | 15,219 | 1.21% | `aggregated-mx-only.txt` |
| Spain | ES | 11,055 | 11,035 | 9,233 | 0.74% | `aggregated-es-only.txt` |
| Argentina | AR | 3,452 | 3,450 | 11,793 | 0.94% | `aggregated-ar-only.txt` |
| Egypt | EG | 728 | 728 | 3,627 | 0.29% | `aggregated-eg-only.txt` |
| Pakistan | PK | 1,351 | 1,349 | 17,347 | 1.38% | `aggregated-pk-only.txt` |
| Malaysia | MY | 2,550 | 2,550 | 5,795 | 0.46% | `aggregated-my-only.txt` |
| Bulgaria | BG | 2,378 | 2,367 | 3,049 | 0.24% | `aggregated-bg-only.txt` |
| Czechia | CZ | 3,623 | 3,622 | 1,942 | 0.15% | `aggregated-cz-only.txt` |
| Colombia | CO | 2,217 | 2,217 | 6,517 | 0.52% | `aggregated-co-only.txt` |
| United Arab Emirates | AE | 3,826 | 3,826 | 4,314 | 0.34% | `aggregated-ae-only.txt` |
| Romania | RO | 3,987 | 3,979 | 2,523 | 0.20% | `aggregated-ro-only.txt` |
| Kazakhstan | KZ | 1,309 | 1,308 | 2,671 | 0.21% | `aggregated-kz-only.txt` |
| Morocco | MA | 493 | 493 | 4,174 | 0.33% | `aggregated-ma-only.txt` |
| Saudi Arabia | SA | 1,675 | 1,675 | 4,298 | 0.34% | `aggregated-sa-only.txt` |
| South Africa | ZA | 3,992 | 3,978 | 8,417 | 0.67% | `aggregated-za-only.txt` |
| Bangladesh | BD | 2,628 | 2,626 | 7,479 | 0.60% | `aggregated-bd-only.txt` |
| Chile | CL | 1,931 | 1,929 | 3,580 | 0.29% | `aggregated-cl-only.txt` |
| Nigeria | NG | 1,080 | 1,080 | 1,654 | 0.13% | `aggregated-ng-only.txt` |
| Kenya | KE | 873 | 873 | 3,103 | 0.25% | `aggregated-ke-only.txt` |
| Algeria | DZ | 219 | 219 | 2,127 | 0.17% | `aggregated-dz-only.txt` |
| Serbia | RS | 994 | 992 | 1,295 | 0.10% | `aggregated-rs-only.txt` |
| Peru | PE | 1,180 | 1,179 | 2,067 | 0.16% | `aggregated-pe-only.txt` |
| Sri Lanka | LK | 248 | 248 | 934 | 0.07% | `aggregated-lk-only.txt` |
| Iraq | IQ | 684 | 684 | 2,873 | 0.23% | `aggregated-iq-only.txt` |
| Ethiopia | ET | 97 | 97 | 1,184 | 0.09% | `aggregated-et-only.txt` |
| Ghana | GH | 343 | 343 | 578 | 0.05% | `aggregated-gh-only.txt` |
...
- **`aggregated.txt`** - 1,253,866 total aggregated IPs from all sources
- **`aggregated-ae-only.txt`** - 4,314 IPs from AE
- **`aggregated-ar-only.txt`** - 11,793 IPs from AR
- **`aggregated-au-only.txt`** - 17,014 IPs from AU
- **`aggregated-bd-only.txt`** - 7,479 IPs from BD
- **`aggregated-bg-only.txt`** - 3,049 IPs from BG
- **`aggregated-br-only.txt`** - 63,872 IPs from BR
- **`aggregated-by-only.txt`** - 741 IPs from BY
- **`aggregated-ca-only.txt`** - 25,115 IPs from CA
- **`aggregated-cl-only.txt`** - 3,580 IPs from CL
- **`aggregated-cn-only.txt`** - 170,406 IPs from CN
- **`aggregated-co-only.txt`** - 6,517 IPs from CO
- **`aggregated-cz-only.txt`** - 1,942 IPs from CZ
- **`aggregated-de-only.txt`** - 46,266 IPs from DE
- **`aggregated-dz-only.txt`** - 2,127 IPs from DZ
- **`aggregated-eg-only.txt`** - 3,627 IPs from EG
- **`aggregated-es-only.txt`** - 9,233 IPs from ES
- **`aggregated-et-only.txt`** - 1,184 IPs from ET
- **`aggregated-fr-only.txt`** - 23,283 IPs from FR
- **`aggregated-gb-only.txt`** - 31,943 IPs from GB
- **`aggregated-gh-only.txt`** - 578 IPs from GH
- **`aggregated-id-only.txt`** - 28,316 IPs from ID
- **`aggregated-in-only.txt`** - 75,808 IPs from IN
- **`aggregated-iq-only.txt`** - 2,873 IPs from IQ
- **`aggregated-ir-only.txt`** - 5,275 IPs from IR
- **`aggregated-it-only.txt`** - 15,374 IPs from IT
- **`aggregated-ke-only.txt`** - 3,103 IPs from KE
- **`aggregated-kr-only.txt`** - 15,918 IPs from KR
- **`aggregated-kz-only.txt`** - 2,671 IPs from KZ
- **`aggregated-lk-only.txt`** - 934 IPs from LK
- **`aggregated-ma-only.txt`** - 4,174 IPs from MA
- **`aggregated-mx-only.txt`** - 15,219 IPs from MX
- **`aggregated-my-only.txt`** - 5,795 IPs from MY
- **`aggregated-ng-only.txt`** - 1,654 IPs from NG
- **`aggregated-nl-only.txt`** - 51,373 IPs from NL
- **`aggregated-pe-only.txt`** - 2,067 IPs from PE
- **`aggregated-pk-only.txt`** - 17,347 IPs from PK
- **`aggregated-pl-only.txt`** - 8,337 IPs from PL
- **`aggregated-ro-only.txt`** - 2,523 IPs from RO
- **`aggregated-rs-only.txt`** - 1,295 IPs from RS
- **`aggregated-ru-only.txt`** - 27,330 IPs from RU
- **`aggregated-sa-only.txt`** - 4,298 IPs from SA
- **`aggregated-sg-only.txt`** - 35,019 IPs from SG
- **`aggregated-th-only.txt`** - 14,783 IPs from TH
- **`aggregated-tr-only.txt`** - 13,692 IPs from TR
- **`aggregated-tw-only.txt`** - 13,890 IPs from TW
- **`aggregated-ua-only.txt`** - 9,383 IPs from UA
- **`aggregated-us-only.txt`** - 234,377 IPs from US
- **`aggregated-ve-only.txt`** - 7,707 IPs from VE
- **`aggregated-vn-only.txt`** - 39,822 IPs from VN
- **`aggregated-za-only.txt`** - 8,417 IPs from ZA
- **`aggregated-multi-50countries-combined.txt`** - 1,102,837 unique IPs (deduplicated across all countries)
