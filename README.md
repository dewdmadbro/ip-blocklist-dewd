...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-896473-2D56A8)
...
**Last Updated:** 2026-05-12 10:46:11 UTC
...
- **Total Input IPs:** 896,473
- **Countries Processed:** 50
- **Combined Unique IPs:** 785,228
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 167,975 | 166,467 | 211,952 | 23.64% | `aggregated-us-only.txt` |
| China | CN | 7,573 | 7,572 | 121,602 | 13.56% | `aggregated-cn-only.txt` |
| India | IN | 12,849 | 12,821 | 28,376 | 3.17% | `aggregated-in-only.txt` |
| Germany | DE | 28,807 | 28,725 | 39,838 | 4.44% | `aggregated-de-only.txt` |
| Russia | RU | 13,075 | 12,845 | 20,809 | 2.32% | `aggregated-ru-only.txt` |
| United Kingdom | GB | 34,028 | 33,858 | 34,009 | 3.79% | `aggregated-gb-only.txt` |
| Thailand | TH | 1,943 | 1,942 | 11,910 | 1.33% | `aggregated-th-only.txt` |
| Vietnam | VN | 2,134 | 2,134 | 23,750 | 2.65% | `aggregated-vn-only.txt` |
| South Korea | KR | 3,984 | 3,974 | 17,377 | 1.94% | `aggregated-kr-only.txt` |
| Brazil | BR | 12,903 | 12,767 | 29,510 | 3.29% | `aggregated-br-only.txt` |
| Taiwan | TW | 2,418 | 2,418 | 11,755 | 1.31% | `aggregated-tw-only.txt` |
| Canada | CA | 17,039 | 16,905 | 22,079 | 2.46% | `aggregated-ca-only.txt` |
| Singapore | SG | 9,243 | 9,233 | 15,401 | 1.72% | `aggregated-sg-only.txt` |
| Italy | IT | 9,559 | 9,535 | 16,644 | 1.86% | `aggregated-it-only.txt` |
| Netherlands | NL | 18,372 | 18,250 | 36,808 | 4.11% | `aggregated-nl-only.txt` |
| Indonesia | ID | 6,412 | 6,393 | 14,308 | 1.60% | `aggregated-id-only.txt` |
| France | FR | 32,099 | 32,073 | 15,723 | 1.75% | `aggregated-fr-only.txt` |
| Venezuela | VE | 928 | 928 | 2,918 | 0.33% | `aggregated-ve-only.txt` |
| Australia | AU | 12,110 | 12,041 | 12,497 | 1.39% | `aggregated-au-only.txt` |
| Turkey | TR | 3,410 | 3,386 | 9,655 | 1.08% | `aggregated-tr-only.txt` |
| Ukraine | UA | 5,547 | 5,492 | 6,895 | 0.77% | `aggregated-ua-only.txt` |
| Iran | IR | 2,013 | 2,012 | 2,595 | 0.29% | `aggregated-ir-only.txt` |
| Poland | PL | 8,019 | 7,988 | 5,971 | 0.67% | `aggregated-pl-only.txt` |
| Mexico | MX | 4,378 | 4,374 | 8,902 | 0.99% | `aggregated-mx-only.txt` |
| Spain | ES | 10,946 | 10,915 | 6,752 | 0.75% | `aggregated-es-only.txt` |
| Argentina | AR | 3,471 | 3,469 | 7,127 | 0.80% | `aggregated-ar-only.txt` |
| Egypt | EG | 730 | 730 | 2,362 | 0.26% | `aggregated-eg-only.txt` |
| Pakistan | PK | 1,320 | 1,320 | 7,867 | 0.88% | `aggregated-pk-only.txt` |
| Malaysia | MY | 2,480 | 2,480 | 3,861 | 0.43% | `aggregated-my-only.txt` |
| Bulgaria | BG | 2,287 | 2,277 | 2,067 | 0.23% | `aggregated-bg-only.txt` |
...
| Morocco | MA | 478 | 478 | 3,025 | 0.34% | `aggregated-ma-only.txt` |
| Saudi Arabia | SA | 1,630 | 1,630 | 3,437 | 0.38% | `aggregated-sa-only.txt` |
| South Africa | ZA | 3,962 | 3,949 | 2,326 | 0.26% | `aggregated-za-only.txt` |
| Bangladesh | BD | 2,615 | 2,612 | 1,563 | 0.17% | `aggregated-bd-only.txt` |
| Chile | CL | 1,885 | 1,885 | 1,945 | 0.22% | `aggregated-cl-only.txt` |
...
| Serbia | RS | 951 | 949 | 993 | 0.11% | `aggregated-rs-only.txt` |
...
- **`aggregated.txt`** - 896,473 total aggregated IPs from all sources
- **`aggregated-ae-only.txt`** - 2,964 IPs from AE
- **`aggregated-ar-only.txt`** - 7,127 IPs from AR
- **`aggregated-au-only.txt`** - 12,497 IPs from AU
- **`aggregated-bd-only.txt`** - 1,563 IPs from BD
- **`aggregated-bg-only.txt`** - 2,067 IPs from BG
- **`aggregated-br-only.txt`** - 29,510 IPs from BR
- **`aggregated-by-only.txt`** - 361 IPs from BY
- **`aggregated-ca-only.txt`** - 22,079 IPs from CA
- **`aggregated-cl-only.txt`** - 1,945 IPs from CL
- **`aggregated-cn-only.txt`** - 121,602 IPs from CN
- **`aggregated-co-only.txt`** - 3,361 IPs from CO
- **`aggregated-cz-only.txt`** - 2,365 IPs from CZ
- **`aggregated-de-only.txt`** - 39,838 IPs from DE
- **`aggregated-dz-only.txt`** - 1,378 IPs from DZ
- **`aggregated-eg-only.txt`** - 2,362 IPs from EG
- **`aggregated-es-only.txt`** - 6,752 IPs from ES
- **`aggregated-et-only.txt`** - 838 IPs from ET
- **`aggregated-fr-only.txt`** - 15,723 IPs from FR
- **`aggregated-gb-only.txt`** - 34,009 IPs from GB
- **`aggregated-gh-only.txt`** - 429 IPs from GH
- **`aggregated-id-only.txt`** - 14,308 IPs from ID
- **`aggregated-in-only.txt`** - 28,376 IPs from IN
- **`aggregated-iq-only.txt`** - 805 IPs from IQ
- **`aggregated-ir-only.txt`** - 2,595 IPs from IR
- **`aggregated-it-only.txt`** - 16,644 IPs from IT
- **`aggregated-ke-only.txt`** - 1,570 IPs from KE
- **`aggregated-kr-only.txt`** - 17,377 IPs from KR
- **`aggregated-kz-only.txt`** - 2,318 IPs from KZ
- **`aggregated-lk-only.txt`** - 758 IPs from LK
- **`aggregated-ma-only.txt`** - 3,025 IPs from MA
- **`aggregated-mx-only.txt`** - 8,902 IPs from MX
- **`aggregated-my-only.txt`** - 3,861 IPs from MY
- **`aggregated-ng-only.txt`** - 547 IPs from NG
- **`aggregated-nl-only.txt`** - 36,808 IPs from NL
- **`aggregated-pe-only.txt`** - 1,083 IPs from PE
- **`aggregated-pk-only.txt`** - 7,867 IPs from PK
- **`aggregated-pl-only.txt`** - 5,971 IPs from PL
- **`aggregated-ro-only.txt`** - 1,842 IPs from RO
- **`aggregated-rs-only.txt`** - 993 IPs from RS
- **`aggregated-ru-only.txt`** - 20,809 IPs from RU
- **`aggregated-sa-only.txt`** - 3,437 IPs from SA
- **`aggregated-sg-only.txt`** - 15,401 IPs from SG
- **`aggregated-th-only.txt`** - 11,910 IPs from TH
- **`aggregated-tr-only.txt`** - 9,655 IPs from TR
- **`aggregated-tw-only.txt`** - 11,755 IPs from TW
- **`aggregated-ua-only.txt`** - 6,895 IPs from UA
- **`aggregated-us-only.txt`** - 211,952 IPs from US
- **`aggregated-ve-only.txt`** - 2,918 IPs from VE
- **`aggregated-vn-only.txt`** - 23,750 IPs from VN
- **`aggregated-za-only.txt`** - 2,326 IPs from ZA
- **`aggregated-multi-50countries-combined.txt`** - 785,228 unique IPs (deduplicated across all countries)
