...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-1061815-2D56A8)
...
- **`aggregated.txt`** - 1,061,815 total aggregated IPs from all sources
- **`aggregated-ae-only.txt`** - 3,398 IPs from AE
- **`aggregated-ar-only.txt`** - 8,985 IPs from AR
- **`aggregated-au-only.txt`** - 15,859 IPs from AU
- **`aggregated-bd-only.txt`** - 5,230 IPs from BD
- **`aggregated-bg-only.txt`** - 2,748 IPs from BG
- **`aggregated-br-only.txt`** - 44,119 IPs from BR
- **`aggregated-by-only.txt`** - 683 IPs from BY
- **`aggregated-ca-only.txt`** - 22,814 IPs from CA
...
- **`aggregated-de-only.txt`** - 39,884 IPs from DE
- **`aggregated-dz-only.txt`** - 1,573 IPs from DZ
- **`aggregated-eg-only.txt`** - 2,732 IPs from EG
- **`aggregated-es-only.txt`** - 7,616 IPs from ES
- **`aggregated-et-only.txt`** - 898 IPs from ET
- **`aggregated-fr-only.txt`** - 20,116 IPs from FR
- **`aggregated-gb-only.txt`** - 30,228 IPs from GB
- **`aggregated-gh-only.txt`** - 499 IPs from GH
- **`aggregated-id-only.txt`** - 25,316 IPs from ID
- **`aggregated-in-only.txt`** - 65,889 IPs from IN
...
- **`aggregated-kr-only.txt`** - 14,324 IPs from KR
- **`aggregated-kz-only.txt`** - 2,322 IPs from KZ
- **`aggregated-lk-only.txt`** - 627 IPs from LK
- **`aggregated-ma-only.txt`** - 3,436 IPs from MA
- **`aggregated-mx-only.txt`** - 10,579 IPs from MX
- **`aggregated-my-only.txt`** - 5,228 IPs from MY
- **`aggregated-ng-only.txt`** - 1,125 IPs from NG
- **`aggregated-nl-only.txt`** - 50,953 IPs from NL
- **`aggregated-pe-only.txt`** - 1,507 IPs from PE
- **`aggregated-pk-only.txt`** - 13,405 IPs from PK
- **`aggregated-pl-only.txt`** - 7,463 IPs from PL
- **`aggregated-ro-only.txt`** - 2,093 IPs from RO
- **`aggregated-rs-only.txt`** - 1,008 IPs from RS
- **`aggregated-ru-only.txt`** - 25,112 IPs from RU
- **`aggregated-sa-only.txt`** - 3,765 IPs from SA
- **`aggregated-sg-only.txt`** - 32,315 IPs from SG
- **`aggregated-th-only.txt`** - 13,609 IPs from TH
- **`aggregated-tr-only.txt`** - 12,376 IPs from TR
- **`aggregated-tw-only.txt`** - 13,019 IPs from TW
- **`aggregated-ua-only.txt`** - 8,082 IPs from UA
- **`aggregated-us-only.txt`** - 203,322 IPs from US
- **`aggregated-ve-only.txt`** - 6,492 IPs from VE
- **`aggregated-vn-only.txt`** - 35,533 IPs from VN
- **`aggregated-za-only.txt`** - 6,888 IPs from ZA
- **`aggregated-multi-50countries-combined.txt`** - 940,238 unique IPs (deduplicated across all countries)
