...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-1070640-2D56A8)
...
**Last Updated:** 2026-05-31 04:59:50 UTC
...
- **Total Input IPs:** 1,070,640
- **Countries Processed:** 50
- **Combined Unique IPs:** 945,936
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 165,171 | 163,351 | 208,023 | 19.43% | `aggregated-us-only.txt` |
| China | CN | 7,502 | 7,501 | 133,702 | 12.49% | `aggregated-cn-only.txt` |
| India | IN | 12,894 | 12,865 | 66,643 | 6.22% | `aggregated-in-only.txt` |
| Germany | DE | 28,948 | 28,868 | 41,753 | 3.90% | `aggregated-de-only.txt` |
| Russia | RU | 13,123 | 12,894 | 25,004 | 2.34% | `aggregated-ru-only.txt` |
| United Kingdom | GB | 34,022 | 33,847 | 30,583 | 2.86% | `aggregated-gb-only.txt` |
| Thailand | TH | 1,927 | 1,926 | 13,644 | 1.27% | `aggregated-th-only.txt` |
| Vietnam | VN | 2,159 | 2,159 | 35,292 | 3.30% | `aggregated-vn-only.txt` |
| South Korea | KR | 3,938 | 3,928 | 13,912 | 1.30% | `aggregated-kr-only.txt` |
| Brazil | BR | 13,593 | 13,559 | 44,176 | 4.13% | `aggregated-br-only.txt` |
| Taiwan | TW | 2,399 | 2,399 | 13,020 | 1.22% | `aggregated-tw-only.txt` |
| Canada | CA | 17,038 | 16,909 | 23,981 | 2.24% | `aggregated-ca-only.txt` |
| Singapore | SG | 9,341 | 9,331 | 32,603 | 3.05% | `aggregated-sg-only.txt` |
| Italy | IT | 9,565 | 9,541 | 14,011 | 1.31% | `aggregated-it-only.txt` |
| Netherlands | NL | 18,603 | 18,479 | 51,116 | 4.77% | `aggregated-nl-only.txt` |
| Indonesia | ID | 6,408 | 6,389 | 25,399 | 2.37% | `aggregated-id-only.txt` |
| France | FR | 32,238 | 32,212 | 19,596 | 1.83% | `aggregated-fr-only.txt` |
| Venezuela | VE | 931 | 931 | 6,653 | 0.62% | `aggregated-ve-only.txt` |
| Australia | AU | 12,034 | 11,967 | 16,083 | 1.50% | `aggregated-au-only.txt` |
| Turkey | TR | 3,399 | 3,374 | 12,650 | 1.18% | `aggregated-tr-only.txt` |
| Ukraine | UA | 5,573 | 5,519 | 8,072 | 0.75% | `aggregated-ua-only.txt` |
| Iran | IR | 2,018 | 2,017 | 3,933 | 0.37% | `aggregated-ir-only.txt` |
| Poland | PL | 8,039 | 8,008 | 7,413 | 0.69% | `aggregated-pl-only.txt` |
| Mexico | MX | 4,395 | 4,391 | 10,796 | 1.01% | `aggregated-mx-only.txt` |
| Spain | ES | 11,295 | 11,270 | 7,772 | 0.73% | `aggregated-es-only.txt` |
| Argentina | AR | 3,494 | 3,492 | 9,053 | 0.85% | `aggregated-ar-only.txt` |
| Egypt | EG | 718 | 718 | 2,755 | 0.26% | `aggregated-eg-only.txt` |
| Pakistan | PK | 1,338 | 1,336 | 13,589 | 1.27% | `aggregated-pk-only.txt` |
...
| United Arab Emirates | AE | 3,284 | 3,284 | 3,361 | 0.31% | `aggregated-ae-only.txt` |
| Romania | RO | 3,946 | 3,937 | 2,084 | 0.19% | `aggregated-ro-only.txt` |
| Kazakhstan | KZ | 1,263 | 1,262 | 2,403 | 0.22% | `aggregated-kz-only.txt` |
| Morocco | MA | 475 | 475 | 3,484 | 0.33% | `aggregated-ma-only.txt` |
| Saudi Arabia | SA | 1,629 | 1,629 | 3,748 | 0.35% | `aggregated-sa-only.txt` |
| South Africa | ZA | 3,967 | 3,953 | 6,426 | 0.60% | `aggregated-za-only.txt` |
| Bangladesh | BD | 2,621 | 2,616 | 5,166 | 0.48% | `aggregated-bd-only.txt` |
| Chile | CL | 1,901 | 1,901 | 2,219 | 0.21% | `aggregated-cl-only.txt` |
| Nigeria | NG | 1,077 | 1,077 | 1,136 | 0.11% | `aggregated-ng-only.txt` |
| Kenya | KE | 857 | 857 | 2,088 | 0.20% | `aggregated-ke-only.txt` |
| Algeria | DZ | 218 | 218 | 1,606 | 0.15% | `aggregated-dz-only.txt` |
...
| Iraq | IQ | 684 | 684 | 1,805 | 0.17% | `aggregated-iq-only.txt` |
| Ethiopia | ET | 99 | 99 | 887 | 0.08% | `aggregated-et-only.txt` |
| Ghana | GH | 341 | 341 | 490 | 0.05% | `aggregated-gh-only.txt` |
...
- **`aggregated.txt`** - 1,070,640 total aggregated IPs from all sources
- **`aggregated-ae-only.txt`** - 3,361 IPs from AE
- **`aggregated-ar-only.txt`** - 9,053 IPs from AR
- **`aggregated-au-only.txt`** - 16,083 IPs from AU
- **`aggregated-bd-only.txt`** - 5,166 IPs from BD
- **`aggregated-bg-only.txt`** - 2,749 IPs from BG
- **`aggregated-br-only.txt`** - 44,176 IPs from BR
- **`aggregated-by-only.txt`** - 650 IPs from BY
- **`aggregated-ca-only.txt`** - 23,981 IPs from CA
- **`aggregated-cl-only.txt`** - 2,219 IPs from CL
...
- **`aggregated-dz-only.txt`** - 1,606 IPs from DZ
- **`aggregated-eg-only.txt`** - 2,755 IPs from EG
- **`aggregated-es-only.txt`** - 7,772 IPs from ES
- **`aggregated-et-only.txt`** - 887 IPs from ET
- **`aggregated-fr-only.txt`** - 19,596 IPs from FR
- **`aggregated-gb-only.txt`** - 30,583 IPs from GB
- **`aggregated-gh-only.txt`** - 490 IPs from GH
- **`aggregated-id-only.txt`** - 25,399 IPs from ID
- **`aggregated-in-only.txt`** - 66,643 IPs from IN
- **`aggregated-iq-only.txt`** - 1,805 IPs from IQ
- **`aggregated-ir-only.txt`** - 3,933 IPs from IR
- **`aggregated-it-only.txt`** - 14,011 IPs from IT
- **`aggregated-ke-only.txt`** - 2,088 IPs from KE
- **`aggregated-kr-only.txt`** - 13,912 IPs from KR
- **`aggregated-kz-only.txt`** - 2,403 IPs from KZ
- **`aggregated-lk-only.txt`** - 625 IPs from LK
- **`aggregated-ma-only.txt`** - 3,484 IPs from MA
- **`aggregated-mx-only.txt`** - 10,796 IPs from MX
- **`aggregated-my-only.txt`** - 5,219 IPs from MY
- **`aggregated-ng-only.txt`** - 1,136 IPs from NG
- **`aggregated-nl-only.txt`** - 51,116 IPs from NL
- **`aggregated-pe-only.txt`** - 1,493 IPs from PE
- **`aggregated-pk-only.txt`** - 13,589 IPs from PK
- **`aggregated-pl-only.txt`** - 7,413 IPs from PL
- **`aggregated-ro-only.txt`** - 2,084 IPs from RO
- **`aggregated-rs-only.txt`** - 1,024 IPs from RS
- **`aggregated-ru-only.txt`** - 25,004 IPs from RU
- **`aggregated-sa-only.txt`** - 3,748 IPs from SA
- **`aggregated-sg-only.txt`** - 32,603 IPs from SG
- **`aggregated-th-only.txt`** - 13,644 IPs from TH
- **`aggregated-tr-only.txt`** - 12,650 IPs from TR
- **`aggregated-tw-only.txt`** - 13,020 IPs from TW
- **`aggregated-ua-only.txt`** - 8,072 IPs from UA
- **`aggregated-us-only.txt`** - 208,023 IPs from US
- **`aggregated-ve-only.txt`** - 6,653 IPs from VE
- **`aggregated-vn-only.txt`** - 35,292 IPs from VN
- **`aggregated-za-only.txt`** - 6,426 IPs from ZA
- **`aggregated-multi-50countries-combined.txt`** - 945,936 unique IPs (deduplicated across all countries)
