...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-1272409-2D56A8)
...
**Last Updated:** 2026-07-26 08:46:53 UTC
...
- **Total Input IPs:** 1,272,409
- **Countries Processed:** 50
- **Combined Unique IPs:** 1,119,285
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 135,484 | 133,670 | 236,019 | 18.55% | `aggregated-us-only.txt` |
| China | CN | 7,801 | 7,800 | 172,579 | 13.56% | `aggregated-cn-only.txt` |
| India | IN | 13,176 | 13,145 | 76,861 | 6.04% | `aggregated-in-only.txt` |
| Germany | DE | 29,225 | 29,158 | 46,376 | 3.64% | `aggregated-de-only.txt` |
| Russia | RU | 13,278 | 13,041 | 27,524 | 2.16% | `aggregated-ru-only.txt` |
| United Kingdom | GB | 35,497 | 35,342 | 32,396 | 2.55% | `aggregated-gb-only.txt` |
| Thailand | TH | 1,984 | 1,984 | 15,358 | 1.21% | `aggregated-th-only.txt` |
| Vietnam | VN | 2,193 | 2,193 | 39,952 | 3.14% | `aggregated-vn-only.txt` |
| South Korea | KR | 3,949 | 3,939 | 15,950 | 1.25% | `aggregated-kr-only.txt` |
| Brazil | BR | 13,023 | 12,978 | 68,113 | 5.35% | `aggregated-br-only.txt` |
| Taiwan | TW | 2,388 | 2,388 | 13,967 | 1.10% | `aggregated-tw-only.txt` |
| Canada | CA | 16,948 | 16,824 | 26,396 | 2.07% | `aggregated-ca-only.txt` |
| Singapore | SG | 9,453 | 9,443 | 35,158 | 2.76% | `aggregated-sg-only.txt` |
| Italy | IT | 9,769 | 9,745 | 15,487 | 1.22% | `aggregated-it-only.txt` |
| Netherlands | NL | 18,880 | 18,759 | 51,372 | 4.04% | `aggregated-nl-only.txt` |
| Indonesia | ID | 6,505 | 6,481 | 28,619 | 2.25% | `aggregated-id-only.txt` |
| France | FR | 33,610 | 33,583 | 23,704 | 1.86% | `aggregated-fr-only.txt` |
| Venezuela | VE | 957 | 957 | 7,781 | 0.61% | `aggregated-ve-only.txt` |
| Australia | AU | 12,139 | 12,065 | 17,004 | 1.34% | `aggregated-au-only.txt` |
| Turkey | TR | 3,450 | 3,428 | 13,777 | 1.08% | `aggregated-tr-only.txt` |
| Ukraine | UA | 5,551 | 5,495 | 10,024 | 0.79% | `aggregated-ua-only.txt` |
| Iran | IR | 2,048 | 2,047 | 5,351 | 0.42% | `aggregated-ir-only.txt` |
| Poland | PL | 8,204 | 8,171 | 8,331 | 0.65% | `aggregated-pl-only.txt` |
| Mexico | MX | 4,471 | 4,467 | 15,759 | 1.24% | `aggregated-mx-only.txt` |
| Spain | ES | 11,172 | 11,153 | 9,413 | 0.74% | `aggregated-es-only.txt` |
| Argentina | AR | 3,474 | 3,472 | 11,997 | 0.94% | `aggregated-ar-only.txt` |
| Egypt | EG | 728 | 728 | 3,680 | 0.29% | `aggregated-eg-only.txt` |
| Pakistan | PK | 1,355 | 1,353 | 17,630 | 1.39% | `aggregated-pk-only.txt` |
| Malaysia | MY | 2,570 | 2,570 | 5,850 | 0.46% | `aggregated-my-only.txt` |
| Bulgaria | BG | 2,376 | 2,365 | 3,070 | 0.24% | `aggregated-bg-only.txt` |
| Czechia | CZ | 3,621 | 3,620 | 1,942 | 0.15% | `aggregated-cz-only.txt` |
| Colombia | CO | 2,215 | 2,215 | 6,717 | 0.53% | `aggregated-co-only.txt` |
| United Arab Emirates | AE | 3,842 | 3,842 | 4,379 | 0.34% | `aggregated-ae-only.txt` |
| Romania | RO | 3,995 | 3,986 | 2,558 | 0.20% | `aggregated-ro-only.txt` |
| Kazakhstan | KZ | 1,312 | 1,311 | 2,699 | 0.21% | `aggregated-kz-only.txt` |
| Morocco | MA | 494 | 494 | 4,219 | 0.33% | `aggregated-ma-only.txt` |
| Saudi Arabia | SA | 1,682 | 1,682 | 4,343 | 0.34% | `aggregated-sa-only.txt` |
| South Africa | ZA | 4,021 | 4,007 | 8,627 | 0.68% | `aggregated-za-only.txt` |
| Bangladesh | BD | 2,627 | 2,625 | 7,995 | 0.63% | `aggregated-bd-only.txt` |
| Chile | CL | 1,975 | 1,973 | 3,683 | 0.29% | `aggregated-cl-only.txt` |
| Nigeria | NG | 1,091 | 1,091 | 1,729 | 0.14% | `aggregated-ng-only.txt` |
| Kenya | KE | 873 | 873 | 2,968 | 0.23% | `aggregated-ke-only.txt` |
...
- **`aggregated.txt`** - 1,272,409 total aggregated IPs from all sources
- **`aggregated-ae-only.txt`** - 4,379 IPs from AE
- **`aggregated-ar-only.txt`** - 11,997 IPs from AR
- **`aggregated-au-only.txt`** - 17,004 IPs from AU
- **`aggregated-bd-only.txt`** - 7,995 IPs from BD
- **`aggregated-bg-only.txt`** - 3,070 IPs from BG
- **`aggregated-br-only.txt`** - 68,113 IPs from BR
- **`aggregated-by-only.txt`** - 751 IPs from BY
- **`aggregated-ca-only.txt`** - 26,396 IPs from CA
- **`aggregated-cl-only.txt`** - 3,683 IPs from CL
- **`aggregated-cn-only.txt`** - 172,579 IPs from CN
- **`aggregated-co-only.txt`** - 6,717 IPs from CO
- **`aggregated-cz-only.txt`** - 1,942 IPs from CZ
- **`aggregated-de-only.txt`** - 46,376 IPs from DE
- **`aggregated-dz-only.txt`** - 2,179 IPs from DZ
- **`aggregated-eg-only.txt`** - 3,680 IPs from EG
- **`aggregated-es-only.txt`** - 9,413 IPs from ES
- **`aggregated-et-only.txt`** - 1,188 IPs from ET
- **`aggregated-fr-only.txt`** - 23,704 IPs from FR
- **`aggregated-gb-only.txt`** - 32,396 IPs from GB
- **`aggregated-gh-only.txt`** - 589 IPs from GH
- **`aggregated-id-only.txt`** - 28,619 IPs from ID
- **`aggregated-in-only.txt`** - 76,861 IPs from IN
- **`aggregated-iq-only.txt`** - 2,883 IPs from IQ
- **`aggregated-ir-only.txt`** - 5,351 IPs from IR
- **`aggregated-it-only.txt`** - 15,487 IPs from IT
- **`aggregated-ke-only.txt`** - 2,968 IPs from KE
- **`aggregated-kr-only.txt`** - 15,950 IPs from KR
- **`aggregated-kz-only.txt`** - 2,699 IPs from KZ
- **`aggregated-lk-only.txt`** - 954 IPs from LK
- **`aggregated-ma-only.txt`** - 4,219 IPs from MA
- **`aggregated-mx-only.txt`** - 15,759 IPs from MX
- **`aggregated-my-only.txt`** - 5,850 IPs from MY
...
- **`aggregated-pk-only.txt`** - 17,630 IPs from PK
- **`aggregated-pl-only.txt`** - 8,331 IPs from PL
- **`aggregated-ro-only.txt`** - 2,558 IPs from RO
- **`aggregated-rs-only.txt`** - 1,302 IPs from RS
- **`aggregated-ru-only.txt`** - 27,524 IPs from RU
- **`aggregated-sa-only.txt`** - 4,343 IPs from SA
- **`aggregated-sg-only.txt`** - 35,158 IPs from SG
- **`aggregated-th-only.txt`** - 15,358 IPs from TH
- **`aggregated-tr-only.txt`** - 13,777 IPs from TR
- **`aggregated-tw-only.txt`** - 13,967 IPs from TW
- **`aggregated-ua-only.txt`** - 10,024 IPs from UA
- **`aggregated-us-only.txt`** - 236,019 IPs from US
- **`aggregated-ve-only.txt`** - 7,781 IPs from VE
- **`aggregated-vn-only.txt`** - 39,952 IPs from VN
- **`aggregated-za-only.txt`** - 8,627 IPs from ZA
- **`aggregated-multi-50countries-combined.txt`** - 1,119,285 unique IPs (deduplicated across all countries)
