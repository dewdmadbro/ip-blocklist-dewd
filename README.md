...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-1078498-2D56A8)
...
**Last Updated:** 2026-05-23 04:15:51 UTC
...
- **Total Input IPs:** 1,078,498
- **Countries Processed:** 50
- **Combined Unique IPs:** 955,011
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 167,217 | 165,713 | 207,317 | 19.22% | `aggregated-us-only.txt` |
| China | CN | 7,572 | 7,571 | 138,150 | 12.81% | `aggregated-cn-only.txt` |
| India | IN | 12,832 | 12,801 | 66,629 | 6.18% | `aggregated-in-only.txt` |
| Germany | DE | 28,842 | 28,762 | 40,775 | 3.78% | `aggregated-de-only.txt` |
| Russia | RU | 13,087 | 12,857 | 25,405 | 2.36% | `aggregated-ru-only.txt` |
| United Kingdom | GB | 33,930 | 33,764 | 31,023 | 2.88% | `aggregated-gb-only.txt` |
| Thailand | TH | 1,936 | 1,935 | 13,678 | 1.27% | `aggregated-th-only.txt` |
| Vietnam | VN | 2,142 | 2,142 | 36,000 | 3.34% | `aggregated-vn-only.txt` |
| South Korea | KR | 3,976 | 3,966 | 14,524 | 1.35% | `aggregated-kr-only.txt` |
| Brazil | BR | 13,022 | 12,952 | 44,721 | 4.15% | `aggregated-br-only.txt` |
| Taiwan | TW | 2,417 | 2,417 | 13,193 | 1.22% | `aggregated-tw-only.txt` |
| Canada | CA | 17,079 | 16,951 | 24,444 | 2.27% | `aggregated-ca-only.txt` |
| Singapore | SG | 9,249 | 9,239 | 32,710 | 3.03% | `aggregated-sg-only.txt` |
| Italy | IT | 9,537 | 9,513 | 14,114 | 1.31% | `aggregated-it-only.txt` |
| Netherlands | NL | 18,516 | 18,392 | 51,318 | 4.76% | `aggregated-nl-only.txt` |
| Indonesia | ID | 6,418 | 6,397 | 25,530 | 2.37% | `aggregated-id-only.txt` |
| France | FR | 32,086 | 32,060 | 20,625 | 1.91% | `aggregated-fr-only.txt` |
| Venezuela | VE | 924 | 924 | 6,556 | 0.61% | `aggregated-ve-only.txt` |
| Australia | AU | 12,099 | 12,029 | 16,101 | 1.49% | `aggregated-au-only.txt` |
| Turkey | TR | 3,406 | 3,380 | 12,429 | 1.15% | `aggregated-tr-only.txt` |
| Ukraine | UA | 5,551 | 5,496 | 8,146 | 0.76% | `aggregated-ua-only.txt` |
| Iran | IR | 2,016 | 2,015 | 3,923 | 0.36% | `aggregated-ir-only.txt` |
| Poland | PL | 8,036 | 8,005 | 7,515 | 0.70% | `aggregated-pl-only.txt` |
| Mexico | MX | 4,410 | 4,406 | 10,710 | 0.99% | `aggregated-mx-only.txt` |
| Spain | ES | 11,163 | 11,132 | 7,777 | 0.72% | `aggregated-es-only.txt` |
| Argentina | AR | 3,467 | 3,465 | 8,998 | 0.83% | `aggregated-ar-only.txt` |
| Egypt | EG | 716 | 716 | 2,787 | 0.26% | `aggregated-eg-only.txt` |
| Pakistan | PK | 1,319 | 1,319 | 13,511 | 1.25% | `aggregated-pk-only.txt` |
| Malaysia | MY | 2,492 | 2,492 | 5,234 | 0.49% | `aggregated-my-only.txt` |
| Bulgaria | BG | 2,275 | 2,265 | 2,802 | 0.26% | `aggregated-bg-only.txt` |
| Czechia | CZ | 3,605 | 3,604 | 1,736 | 0.16% | `aggregated-cz-only.txt` |
| Colombia | CO | 2,207 | 2,207 | 4,490 | 0.42% | `aggregated-co-only.txt` |
| United Arab Emirates | AE | 3,233 | 3,233 | 3,453 | 0.32% | `aggregated-ae-only.txt` |
| Romania | RO | 3,924 | 3,915 | 2,097 | 0.19% | `aggregated-ro-only.txt` |
| Kazakhstan | KZ | 1,259 | 1,258 | 2,391 | 0.22% | `aggregated-kz-only.txt` |
| Morocco | MA | 475 | 475 | 3,464 | 0.32% | `aggregated-ma-only.txt` |
| Saudi Arabia | SA | 1,623 | 1,623 | 3,769 | 0.35% | `aggregated-sa-only.txt` |
| South Africa | ZA | 3,965 | 3,952 | 7,020 | 0.65% | `aggregated-za-only.txt` |
| Bangladesh | BD | 2,614 | 2,609 | 5,224 | 0.48% | `aggregated-bd-only.txt` |
| Chile | CL | 1,886 | 1,886 | 2,410 | 0.22% | `aggregated-cl-only.txt` |
| Nigeria | NG | 1,072 | 1,072 | 1,145 | 0.11% | `aggregated-ng-only.txt` |
| Kenya | KE | 855 | 855 | 2,431 | 0.23% | `aggregated-ke-only.txt` |
| Algeria | DZ | 217 | 217 | 1,604 | 0.15% | `aggregated-dz-only.txt` |
| Serbia | RS | 945 | 943 | 1,013 | 0.09% | `aggregated-rs-only.txt` |
| Peru | PE | 1,093 | 1,092 | 1,519 | 0.14% | `aggregated-pe-only.txt` |
| Sri Lanka | LK | 247 | 247 | 646 | 0.06% | `aggregated-lk-only.txt` |
| Iraq | IQ | 682 | 682 | 1,874 | 0.17% | `aggregated-iq-only.txt` |
...
- **`aggregated.txt`** - 1,078,498 total aggregated IPs from all sources
- **`aggregated-ae-only.txt`** - 3,453 IPs from AE
- **`aggregated-ar-only.txt`** - 8,998 IPs from AR
- **`aggregated-au-only.txt`** - 16,101 IPs from AU
- **`aggregated-bd-only.txt`** - 5,224 IPs from BD
- **`aggregated-bg-only.txt`** - 2,802 IPs from BG
- **`aggregated-br-only.txt`** - 44,721 IPs from BR
- **`aggregated-by-only.txt`** - 681 IPs from BY
- **`aggregated-ca-only.txt`** - 24,444 IPs from CA
- **`aggregated-cl-only.txt`** - 2,410 IPs from CL
- **`aggregated-cn-only.txt`** - 138,150 IPs from CN
- **`aggregated-co-only.txt`** - 4,490 IPs from CO
- **`aggregated-cz-only.txt`** - 1,736 IPs from CZ
- **`aggregated-de-only.txt`** - 40,775 IPs from DE
- **`aggregated-dz-only.txt`** - 1,604 IPs from DZ
- **`aggregated-eg-only.txt`** - 2,787 IPs from EG
- **`aggregated-es-only.txt`** - 7,777 IPs from ES
- **`aggregated-et-only.txt`** - 895 IPs from ET
- **`aggregated-fr-only.txt`** - 20,625 IPs from FR
- **`aggregated-gb-only.txt`** - 31,023 IPs from GB
- **`aggregated-gh-only.txt`** - 504 IPs from GH
- **`aggregated-id-only.txt`** - 25,530 IPs from ID
- **`aggregated-in-only.txt`** - 66,629 IPs from IN
- **`aggregated-iq-only.txt`** - 1,874 IPs from IQ
- **`aggregated-ir-only.txt`** - 3,923 IPs from IR
- **`aggregated-it-only.txt`** - 14,114 IPs from IT
- **`aggregated-ke-only.txt`** - 2,431 IPs from KE
- **`aggregated-kr-only.txt`** - 14,524 IPs from KR
- **`aggregated-kz-only.txt`** - 2,391 IPs from KZ
- **`aggregated-lk-only.txt`** - 646 IPs from LK
- **`aggregated-ma-only.txt`** - 3,464 IPs from MA
- **`aggregated-mx-only.txt`** - 10,710 IPs from MX
...
- **`aggregated-pk-only.txt`** - 13,511 IPs from PK
- **`aggregated-pl-only.txt`** - 7,515 IPs from PL
- **`aggregated-ro-only.txt`** - 2,097 IPs from RO
- **`aggregated-rs-only.txt`** - 1,013 IPs from RS
- **`aggregated-ru-only.txt`** - 25,405 IPs from RU
- **`aggregated-sa-only.txt`** - 3,769 IPs from SA
- **`aggregated-sg-only.txt`** - 32,710 IPs from SG
- **`aggregated-th-only.txt`** - 13,678 IPs from TH
- **`aggregated-tr-only.txt`** - 12,429 IPs from TR
- **`aggregated-tw-only.txt`** - 13,193 IPs from TW
- **`aggregated-ua-only.txt`** - 8,146 IPs from UA
- **`aggregated-us-only.txt`** - 207,317 IPs from US
- **`aggregated-ve-only.txt`** - 6,556 IPs from VE
- **`aggregated-vn-only.txt`** - 36,000 IPs from VN
- **`aggregated-za-only.txt`** - 7,020 IPs from ZA
- **`aggregated-multi-50countries-combined.txt`** - 955,011 unique IPs (deduplicated across all countries)
