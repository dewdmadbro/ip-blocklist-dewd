...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-1057146-2D56A8)
...
**Last Updated:** 2026-05-17 04:25:53 UTC
...
- **Total Input IPs:** 1,057,146
- **Countries Processed:** 50
- **Combined Unique IPs:** 936,014
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 167,217 | 165,713 | 201,999 | 19.11% | `aggregated-us-only.txt` |
| China | CN | 7,572 | 7,571 | 136,012 | 12.87% | `aggregated-cn-only.txt` |
| India | IN | 12,832 | 12,801 | 65,797 | 6.22% | `aggregated-in-only.txt` |
| Germany | DE | 28,842 | 28,762 | 39,387 | 3.73% | `aggregated-de-only.txt` |
| Russia | RU | 13,087 | 12,857 | 25,071 | 2.37% | `aggregated-ru-only.txt` |
| United Kingdom | GB | 33,930 | 33,764 | 29,685 | 2.81% | `aggregated-gb-only.txt` |
| Thailand | TH | 1,936 | 1,935 | 13,582 | 1.28% | `aggregated-th-only.txt` |
| Vietnam | VN | 2,142 | 2,142 | 35,447 | 3.35% | `aggregated-vn-only.txt` |
| South Korea | KR | 3,976 | 3,966 | 14,306 | 1.35% | `aggregated-kr-only.txt` |
| Brazil | BR | 13,022 | 12,952 | 43,815 | 4.14% | `aggregated-br-only.txt` |
| Taiwan | TW | 2,417 | 2,417 | 13,005 | 1.23% | `aggregated-tw-only.txt` |
| Canada | CA | 17,079 | 16,951 | 22,532 | 2.13% | `aggregated-ca-only.txt` |
| Singapore | SG | 9,249 | 9,239 | 32,259 | 3.05% | `aggregated-sg-only.txt` |
| Italy | IT | 9,537 | 9,513 | 13,962 | 1.32% | `aggregated-it-only.txt` |
| Netherlands | NL | 18,516 | 18,392 | 50,748 | 4.80% | `aggregated-nl-only.txt` |
| Indonesia | ID | 6,418 | 6,397 | 25,308 | 2.39% | `aggregated-id-only.txt` |
| France | FR | 32,086 | 32,060 | 20,039 | 1.90% | `aggregated-fr-only.txt` |
| Venezuela | VE | 924 | 924 | 6,481 | 0.61% | `aggregated-ve-only.txt` |
| Australia | AU | 12,099 | 12,029 | 15,822 | 1.50% | `aggregated-au-only.txt` |
| Turkey | TR | 3,406 | 3,380 | 12,351 | 1.17% | `aggregated-tr-only.txt` |
| Ukraine | UA | 5,551 | 5,496 | 8,072 | 0.76% | `aggregated-ua-only.txt` |
| Iran | IR | 2,016 | 2,015 | 3,941 | 0.37% | `aggregated-ir-only.txt` |
| Poland | PL | 8,036 | 8,005 | 7,445 | 0.70% | `aggregated-pl-only.txt` |
| Mexico | MX | 4,410 | 4,406 | 10,522 | 1.00% | `aggregated-mx-only.txt` |
| Spain | ES | 11,163 | 11,132 | 7,590 | 0.72% | `aggregated-es-only.txt` |
| Argentina | AR | 3,467 | 3,465 | 8,949 | 0.85% | `aggregated-ar-only.txt` |
| Egypt | EG | 716 | 716 | 2,722 | 0.26% | `aggregated-eg-only.txt` |
| Pakistan | PK | 1,319 | 1,319 | 13,398 | 1.27% | `aggregated-pk-only.txt` |
| Malaysia | MY | 2,492 | 2,492 | 5,223 | 0.49% | `aggregated-my-only.txt` |
| Bulgaria | BG | 2,275 | 2,265 | 2,749 | 0.26% | `aggregated-bg-only.txt` |
| Czechia | CZ | 3,605 | 3,604 | 1,678 | 0.16% | `aggregated-cz-only.txt` |
| Colombia | CO | 2,207 | 2,207 | 4,498 | 0.43% | `aggregated-co-only.txt` |
| United Arab Emirates | AE | 3,233 | 3,233 | 3,394 | 0.32% | `aggregated-ae-only.txt` |
| Romania | RO | 3,924 | 3,915 | 2,085 | 0.20% | `aggregated-ro-only.txt` |
| Kazakhstan | KZ | 1,259 | 1,258 | 2,314 | 0.22% | `aggregated-kz-only.txt` |
| Morocco | MA | 475 | 475 | 3,423 | 0.32% | `aggregated-ma-only.txt` |
| Saudi Arabia | SA | 1,623 | 1,623 | 3,757 | 0.36% | `aggregated-sa-only.txt` |
| South Africa | ZA | 3,965 | 3,952 | 6,804 | 0.64% | `aggregated-za-only.txt` |
| Bangladesh | BD | 2,614 | 2,609 | 5,236 | 0.50% | `aggregated-bd-only.txt` |
| Chile | CL | 1,886 | 1,886 | 2,385 | 0.23% | `aggregated-cl-only.txt` |
| Nigeria | NG | 1,072 | 1,072 | 1,126 | 0.11% | `aggregated-ng-only.txt` |
| Kenya | KE | 855 | 855 | 2,412 | 0.23% | `aggregated-ke-only.txt` |
| Algeria | DZ | 217 | 217 | 1,575 | 0.15% | `aggregated-dz-only.txt` |
| Serbia | RS | 945 | 943 | 1,010 | 0.10% | `aggregated-rs-only.txt` |
| Peru | PE | 1,093 | 1,092 | 1,500 | 0.14% | `aggregated-pe-only.txt` |
...
- **`aggregated.txt`** - 1,057,146 total aggregated IPs from all sources
- **`aggregated-ae-only.txt`** - 3,394 IPs from AE
- **`aggregated-ar-only.txt`** - 8,949 IPs from AR
- **`aggregated-au-only.txt`** - 15,822 IPs from AU
- **`aggregated-bd-only.txt`** - 5,236 IPs from BD
- **`aggregated-bg-only.txt`** - 2,749 IPs from BG
- **`aggregated-br-only.txt`** - 43,815 IPs from BR
- **`aggregated-by-only.txt`** - 683 IPs from BY
- **`aggregated-ca-only.txt`** - 22,532 IPs from CA
- **`aggregated-cl-only.txt`** - 2,385 IPs from CL
- **`aggregated-cn-only.txt`** - 136,012 IPs from CN
- **`aggregated-co-only.txt`** - 4,498 IPs from CO
- **`aggregated-cz-only.txt`** - 1,678 IPs from CZ
- **`aggregated-de-only.txt`** - 39,387 IPs from DE
- **`aggregated-dz-only.txt`** - 1,575 IPs from DZ
- **`aggregated-eg-only.txt`** - 2,722 IPs from EG
- **`aggregated-es-only.txt`** - 7,590 IPs from ES
- **`aggregated-et-only.txt`** - 895 IPs from ET
- **`aggregated-fr-only.txt`** - 20,039 IPs from FR
- **`aggregated-gb-only.txt`** - 29,685 IPs from GB
- **`aggregated-gh-only.txt`** - 498 IPs from GH
- **`aggregated-id-only.txt`** - 25,308 IPs from ID
- **`aggregated-in-only.txt`** - 65,797 IPs from IN
...
- **`aggregated-ke-only.txt`** - 2,412 IPs from KE
- **`aggregated-kr-only.txt`** - 14,306 IPs from KR
- **`aggregated-kz-only.txt`** - 2,314 IPs from KZ
- **`aggregated-lk-only.txt`** - 631 IPs from LK
- **`aggregated-ma-only.txt`** - 3,423 IPs from MA
- **`aggregated-mx-only.txt`** - 10,522 IPs from MX
- **`aggregated-my-only.txt`** - 5,223 IPs from MY
- **`aggregated-ng-only.txt`** - 1,126 IPs from NG
- **`aggregated-nl-only.txt`** - 50,748 IPs from NL
- **`aggregated-pe-only.txt`** - 1,500 IPs from PE
...
- **`aggregated-ru-only.txt`** - 25,071 IPs from RU
- **`aggregated-sa-only.txt`** - 3,757 IPs from SA
- **`aggregated-sg-only.txt`** - 32,259 IPs from SG
- **`aggregated-th-only.txt`** - 13,582 IPs from TH
- **`aggregated-tr-only.txt`** - 12,351 IPs from TR
- **`aggregated-tw-only.txt`** - 13,005 IPs from TW
- **`aggregated-ua-only.txt`** - 8,072 IPs from UA
- **`aggregated-us-only.txt`** - 201,999 IPs from US
- **`aggregated-ve-only.txt`** - 6,481 IPs from VE
- **`aggregated-vn-only.txt`** - 35,447 IPs from VN
- **`aggregated-za-only.txt`** - 6,804 IPs from ZA
- **`aggregated-multi-50countries-combined.txt`** - 936,014 unique IPs (deduplicated across all countries)
