...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-1443219-2D56A8)
...
**Last Updated:** 2026-09-04 20:55:25 UTC
...
- **Total Input IPs:** 1,443,219
- **Countries Processed:** 50
- **Combined Unique IPs:** 1,272,792
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 130,784 | 128,927 | 273,641 | 18.96% | `aggregated-us-only.txt` |
| China | CN | 7,835 | 7,834 | 219,166 | 15.19% | `aggregated-cn-only.txt` |
| India | IN | 13,252 | 13,223 | 81,338 | 5.64% | `aggregated-in-only.txt` |
| Germany | DE | 29,886 | 29,769 | 45,024 | 3.12% | `aggregated-de-only.txt` |
| Russia | RU | 13,260 | 13,027 | 31,035 | 2.15% | `aggregated-ru-only.txt` |
| United Kingdom | GB | 35,780 | 35,619 | 34,410 | 2.38% | `aggregated-gb-only.txt` |
| Thailand | TH | 2,063 | 2,063 | 15,752 | 1.09% | `aggregated-th-only.txt` |
| Vietnam | VN | 2,223 | 2,223 | 38,464 | 2.67% | `aggregated-vn-only.txt` |
| South Korea | KR | 3,921 | 3,910 | 17,063 | 1.18% | `aggregated-kr-only.txt` |
| Brazil | BR | 12,583 | 12,539 | 85,959 | 5.96% | `aggregated-br-only.txt` |
| Taiwan | TW | 2,411 | 2,411 | 16,054 | 1.11% | `aggregated-tw-only.txt` |
| Canada | CA | 17,155 | 17,039 | 27,080 | 1.88% | `aggregated-ca-only.txt` |
| Singapore | SG | 9,542 | 9,532 | 38,524 | 2.67% | `aggregated-sg-only.txt` |
| Italy | IT | 9,778 | 9,756 | 16,550 | 1.15% | `aggregated-it-only.txt` |
| Netherlands | NL | 19,132 | 19,018 | 52,325 | 3.63% | `aggregated-nl-only.txt` |
| Indonesia | ID | 6,606 | 6,585 | 31,229 | 2.16% | `aggregated-id-only.txt` |
| France | FR | 33,396 | 33,368 | 26,753 | 1.85% | `aggregated-fr-only.txt` |
| Venezuela | VE | 977 | 977 | 7,792 | 0.54% | `aggregated-ve-only.txt` |
| Australia | AU | 12,241 | 12,174 | 17,737 | 1.23% | `aggregated-au-only.txt` |
| Turkey | TR | 3,509 | 3,492 | 15,637 | 1.08% | `aggregated-tr-only.txt` |
| Ukraine | UA | 5,559 | 5,515 | 16,739 | 1.16% | `aggregated-ua-only.txt` |
| Iran | IR | 2,061 | 2,060 | 5,511 | 0.38% | `aggregated-ir-only.txt` |
| Poland | PL | 8,233 | 8,204 | 8,653 | 0.60% | `aggregated-pl-only.txt` |
| Mexico | MX | 4,305 | 4,301 | 18,308 | 1.27% | `aggregated-mx-only.txt` |
| Spain | ES | 11,372 | 11,346 | 11,253 | 0.78% | `aggregated-es-only.txt` |
| Argentina | AR | 3,481 | 3,479 | 17,058 | 1.18% | `aggregated-ar-only.txt` |
| Egypt | EG | 742 | 742 | 3,826 | 0.27% | `aggregated-eg-only.txt` |
| Pakistan | PK | 1,380 | 1,379 | 19,605 | 1.36% | `aggregated-pk-only.txt` |
| Malaysia | MY | 2,628 | 2,628 | 6,640 | 0.46% | `aggregated-my-only.txt` |
| Bulgaria | BG | 2,359 | 2,345 | 3,279 | 0.23% | `aggregated-bg-only.txt` |
| Czechia | CZ | 3,687 | 3,686 | 2,064 | 0.14% | `aggregated-cz-only.txt` |
| Colombia | CO | 2,244 | 2,244 | 7,583 | 0.53% | `aggregated-co-only.txt` |
...
| Morocco | MA | 495 | 495 | 4,985 | 0.35% | `aggregated-ma-only.txt` |
| Saudi Arabia | SA | 1,720 | 1,720 | 5,394 | 0.37% | `aggregated-sa-only.txt` |
| South Africa | ZA | 4,054 | 4,040 | 9,408 | 0.65% | `aggregated-za-only.txt` |
| Bangladesh | BD | 2,703 | 2,701 | 7,709 | 0.53% | `aggregated-bd-only.txt` |
| Chile | CL | 2,004 | 2,002 | 4,961 | 0.34% | `aggregated-cl-only.txt` |
...
| Ethiopia | ET | 99 | 99 | 1,216 | 0.08% | `aggregated-et-only.txt` |
...
- **`aggregated.txt`** - 1,443,219 total aggregated IPs from all sources
- **`aggregated-ae-only.txt`** - 5,116 IPs from AE
- **`aggregated-ar-only.txt`** - 17,058 IPs from AR
- **`aggregated-au-only.txt`** - 17,737 IPs from AU
- **`aggregated-bd-only.txt`** - 7,709 IPs from BD
- **`aggregated-bg-only.txt`** - 3,279 IPs from BG
- **`aggregated-br-only.txt`** - 85,959 IPs from BR
- **`aggregated-by-only.txt`** - 881 IPs from BY
- **`aggregated-ca-only.txt`** - 27,080 IPs from CA
- **`aggregated-cl-only.txt`** - 4,961 IPs from CL
- **`aggregated-cn-only.txt`** - 219,166 IPs from CN
- **`aggregated-co-only.txt`** - 7,583 IPs from CO
- **`aggregated-cz-only.txt`** - 2,064 IPs from CZ
- **`aggregated-de-only.txt`** - 45,024 IPs from DE
- **`aggregated-dz-only.txt`** - 2,206 IPs from DZ
- **`aggregated-eg-only.txt`** - 3,826 IPs from EG
- **`aggregated-es-only.txt`** - 11,253 IPs from ES
- **`aggregated-et-only.txt`** - 1,216 IPs from ET
- **`aggregated-fr-only.txt`** - 26,753 IPs from FR
- **`aggregated-gb-only.txt`** - 34,410 IPs from GB
- **`aggregated-gh-only.txt`** - 670 IPs from GH
- **`aggregated-id-only.txt`** - 31,229 IPs from ID
- **`aggregated-in-only.txt`** - 81,338 IPs from IN
- **`aggregated-iq-only.txt`** - 2,898 IPs from IQ
- **`aggregated-ir-only.txt`** - 5,511 IPs from IR
- **`aggregated-it-only.txt`** - 16,550 IPs from IT
- **`aggregated-ke-only.txt`** - 3,213 IPs from KE
- **`aggregated-kr-only.txt`** - 17,063 IPs from KR
- **`aggregated-kz-only.txt`** - 3,000 IPs from KZ
- **`aggregated-lk-only.txt`** - 987 IPs from LK
- **`aggregated-ma-only.txt`** - 4,985 IPs from MA
- **`aggregated-mx-only.txt`** - 18,308 IPs from MX
- **`aggregated-my-only.txt`** - 6,640 IPs from MY
- **`aggregated-ng-only.txt`** - 1,609 IPs from NG
- **`aggregated-nl-only.txt`** - 52,325 IPs from NL
- **`aggregated-pe-only.txt`** - 2,245 IPs from PE
- **`aggregated-pk-only.txt`** - 19,605 IPs from PK
- **`aggregated-pl-only.txt`** - 8,653 IPs from PL
- **`aggregated-ro-only.txt`** - 2,835 IPs from RO
- **`aggregated-rs-only.txt`** - 1,407 IPs from RS
- **`aggregated-ru-only.txt`** - 31,035 IPs from RU
- **`aggregated-sa-only.txt`** - 5,394 IPs from SA
- **`aggregated-sg-only.txt`** - 38,524 IPs from SG
- **`aggregated-th-only.txt`** - 15,752 IPs from TH
- **`aggregated-tr-only.txt`** - 15,637 IPs from TR
- **`aggregated-tw-only.txt`** - 16,054 IPs from TW
- **`aggregated-ua-only.txt`** - 16,739 IPs from UA
- **`aggregated-us-only.txt`** - 273,641 IPs from US
- **`aggregated-ve-only.txt`** - 7,792 IPs from VE
- **`aggregated-vn-only.txt`** - 38,464 IPs from VN
- **`aggregated-za-only.txt`** - 9,408 IPs from ZA
- **`aggregated-multi-50countries-combined.txt`** - 1,272,792 unique IPs (deduplicated across all countries)
