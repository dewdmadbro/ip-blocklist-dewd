...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-904419-2D56A8)
...
**Last Updated:** 2026-05-05 14:27:50 UTC
...
- **Total Input IPs:** 904,419
- **Countries Processed:** 50
- **Combined Unique IPs:** 801,622
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 169,198 | 167,680 | 147,105 | 16.27% | `aggregated-us-only.txt` |
| China | CN | 7,598 | 7,597 | 126,461 | 13.98% | `aggregated-cn-only.txt` |
| India | IN | 12,838 | 12,810 | 53,284 | 5.89% | `aggregated-in-only.txt` |
| Germany | DE | 28,972 | 28,867 | 34,949 | 3.86% | `aggregated-de-only.txt` |
| Russia | RU | 13,120 | 12,898 | 19,800 | 2.19% | `aggregated-ru-only.txt` |
| United Kingdom | GB | 33,411 | 33,252 | 26,404 | 2.92% | `aggregated-gb-only.txt` |
| Thailand | TH | 1,947 | 1,945 | 12,408 | 1.37% | `aggregated-th-only.txt` |
| Vietnam | VN | 2,128 | 2,128 | 26,735 | 2.96% | `aggregated-vn-only.txt` |
| South Korea | KR | 4,006 | 3,996 | 12,882 | 1.42% | `aggregated-kr-only.txt` |
| Brazil | BR | 12,782 | 12,630 | 41,529 | 4.59% | `aggregated-br-only.txt` |
| Taiwan | TW | 2,413 | 2,413 | 10,976 | 1.21% | `aggregated-tw-only.txt` |
| Canada | CA | 16,890 | 16,768 | 20,381 | 2.25% | `aggregated-ca-only.txt` |
| Singapore | SG | 9,268 | 9,258 | 27,625 | 3.05% | `aggregated-sg-only.txt` |
| Italy | IT | 9,580 | 9,556 | 13,355 | 1.48% | `aggregated-it-only.txt` |
| Netherlands | NL | 18,273 | 18,151 | 47,873 | 5.29% | `aggregated-nl-only.txt` |
| Indonesia | ID | 6,409 | 6,390 | 22,131 | 2.45% | `aggregated-id-only.txt` |
| France | FR | 32,393 | 32,367 | 17,861 | 1.97% | `aggregated-fr-only.txt` |
| Venezuela | VE | 900 | 900 | 4,292 | 0.47% | `aggregated-ve-only.txt` |
| Australia | AU | 11,396 | 11,317 | 15,024 | 1.66% | `aggregated-au-only.txt` |
| Turkey | TR | 3,399 | 3,371 | 12,904 | 1.43% | `aggregated-tr-only.txt` |
| Ukraine | UA | 5,540 | 5,481 | 7,536 | 0.83% | `aggregated-ua-only.txt` |
| Iran | IR | 2,012 | 2,011 | 3,270 | 0.36% | `aggregated-ir-only.txt` |
| Poland | PL | 8,011 | 7,976 | 5,210 | 0.58% | `aggregated-pl-only.txt` |
| Mexico | MX | 4,307 | 4,303 | 9,932 | 1.10% | `aggregated-mx-only.txt` |
| Spain | ES | 11,140 | 11,107 | 6,291 | 0.70% | `aggregated-es-only.txt` |
| Argentina | AR | 3,445 | 3,443 | 8,649 | 0.96% | `aggregated-ar-only.txt` |
| Egypt | EG | 716 | 716 | 2,825 | 0.31% | `aggregated-eg-only.txt` |
| Pakistan | PK | 1,320 | 1,320 | 12,321 | 1.36% | `aggregated-pk-only.txt` |
| Malaysia | MY | 2,498 | 2,498 | 5,219 | 0.58% | `aggregated-my-only.txt` |
| Bulgaria | BG | 2,290 | 2,280 | 2,328 | 0.26% | `aggregated-bg-only.txt` |
| Czechia | CZ | 3,593 | 3,592 | 1,407 | 0.16% | `aggregated-cz-only.txt` |
| Colombia | CO | 2,210 | 2,210 | 4,166 | 0.46% | `aggregated-co-only.txt` |
| United Arab Emirates | AE | 3,206 | 3,206 | 2,898 | 0.32% | `aggregated-ae-only.txt` |
| Romania | RO | 3,916 | 3,907 | 1,633 | 0.18% | `aggregated-ro-only.txt` |
| Kazakhstan | KZ | 1,349 | 1,348 | 2,114 | 0.23% | `aggregated-kz-only.txt` |
| Morocco | MA | 478 | 478 | 3,547 | 0.39% | `aggregated-ma-only.txt` |
| Saudi Arabia | SA | 1,617 | 1,617 | 4,120 | 0.46% | `aggregated-sa-only.txt` |
| South Africa | ZA | 3,955 | 3,942 | 5,107 | 0.56% | `aggregated-za-only.txt` |
| Bangladesh | BD | 2,608 | 2,603 | 4,520 | 0.50% | `aggregated-bd-only.txt` |
| Chile | CL | 1,870 | 1,870 | 2,937 | 0.32% | `aggregated-cl-only.txt` |
| Nigeria | NG | 1,071 | 1,071 | 1,158 | 0.13% | `aggregated-ng-only.txt` |
| Kenya | KE | 851 | 851 | 2,415 | 0.27% | `aggregated-ke-only.txt` |
| Algeria | DZ | 217 | 217 | 1,543 | 0.17% | `aggregated-dz-only.txt` |
| Serbia | RS | 950 | 948 | 965 | 0.11% | `aggregated-rs-only.txt` |
...
| Ethiopia | ET | 99 | 99 | 951 | 0.11% | `aggregated-et-only.txt` |
...
- **`aggregated.txt`** - 904,419 total aggregated IPs from all sources
- **`aggregated-ae-only.txt`** - 2,898 IPs from AE
- **`aggregated-ar-only.txt`** - 8,649 IPs from AR
- **`aggregated-au-only.txt`** - 15,024 IPs from AU
- **`aggregated-bd-only.txt`** - 4,520 IPs from BD
- **`aggregated-bg-only.txt`** - 2,328 IPs from BG
- **`aggregated-br-only.txt`** - 41,529 IPs from BR
- **`aggregated-by-only.txt`** - 636 IPs from BY
- **`aggregated-ca-only.txt`** - 20,381 IPs from CA
- **`aggregated-cl-only.txt`** - 2,937 IPs from CL
- **`aggregated-cn-only.txt`** - 126,461 IPs from CN
- **`aggregated-co-only.txt`** - 4,166 IPs from CO
- **`aggregated-cz-only.txt`** - 1,407 IPs from CZ
- **`aggregated-de-only.txt`** - 34,949 IPs from DE
- **`aggregated-dz-only.txt`** - 1,543 IPs from DZ
- **`aggregated-eg-only.txt`** - 2,825 IPs from EG
- **`aggregated-es-only.txt`** - 6,291 IPs from ES
- **`aggregated-et-only.txt`** - 951 IPs from ET
- **`aggregated-fr-only.txt`** - 17,861 IPs from FR
- **`aggregated-gb-only.txt`** - 26,404 IPs from GB
- **`aggregated-gh-only.txt`** - 483 IPs from GH
- **`aggregated-id-only.txt`** - 22,131 IPs from ID
- **`aggregated-in-only.txt`** - 53,284 IPs from IN
- **`aggregated-iq-only.txt`** - 1,556 IPs from IQ
- **`aggregated-ir-only.txt`** - 3,270 IPs from IR
- **`aggregated-it-only.txt`** - 13,355 IPs from IT
- **`aggregated-ke-only.txt`** - 2,415 IPs from KE
- **`aggregated-kr-only.txt`** - 12,882 IPs from KR
- **`aggregated-kz-only.txt`** - 2,114 IPs from KZ
- **`aggregated-lk-only.txt`** - 600 IPs from LK
- **`aggregated-ma-only.txt`** - 3,547 IPs from MA
- **`aggregated-mx-only.txt`** - 9,932 IPs from MX
- **`aggregated-my-only.txt`** - 5,219 IPs from MY
- **`aggregated-ng-only.txt`** - 1,158 IPs from NG
- **`aggregated-nl-only.txt`** - 47,873 IPs from NL
- **`aggregated-pe-only.txt`** - 1,306 IPs from PE
- **`aggregated-pk-only.txt`** - 12,321 IPs from PK
- **`aggregated-pl-only.txt`** - 5,210 IPs from PL
- **`aggregated-ro-only.txt`** - 1,633 IPs from RO
- **`aggregated-rs-only.txt`** - 965 IPs from RS
- **`aggregated-ru-only.txt`** - 19,800 IPs from RU
- **`aggregated-sa-only.txt`** - 4,120 IPs from SA
- **`aggregated-sg-only.txt`** - 27,625 IPs from SG
- **`aggregated-th-only.txt`** - 12,408 IPs from TH
- **`aggregated-tr-only.txt`** - 12,904 IPs from TR
- **`aggregated-tw-only.txt`** - 10,976 IPs from TW
- **`aggregated-ua-only.txt`** - 7,536 IPs from UA
- **`aggregated-us-only.txt`** - 147,105 IPs from US
- **`aggregated-ve-only.txt`** - 4,292 IPs from VE
- **`aggregated-vn-only.txt`** - 26,735 IPs from VN
- **`aggregated-za-only.txt`** - 5,107 IPs from ZA
- **`aggregated-multi-50countries-combined.txt`** - 801,622 unique IPs (deduplicated across all countries)
