...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-1213741-2D56A8)
...
**Last Updated:** 2026-07-08 14:48:45 UTC
...
- **Total Input IPs:** 1,213,741
- **Countries Processed:** 50
- **Combined Unique IPs:** 1,069,572
- **Combined Output File:** `aggregated-multi-50countries-combined.txt`
- **Overall Filter Rate:** 88.12%

## Per-Country Results

| Country | Code | Networks Found | Networks Optimized | IPs Matched | Filter Rate | Output File |
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 146,470 | 144,657 | 230,259 | 18.97% | `aggregated-us-only.txt` |
| China | CN | 7,922 | 7,919 | 162,778 | 13.41% | `aggregated-cn-only.txt` |
| India | IN | 13,039 | 13,009 | 73,683 | 6.07% | `aggregated-in-only.txt` |
| Germany | DE | 29,016 | 28,930 | 45,523 | 3.75% | `aggregated-de-only.txt` |
| Russia | RU | 13,226 | 12,987 | 26,407 | 2.18% | `aggregated-ru-only.txt` |
| United Kingdom | GB | 35,133 | 34,962 | 32,840 | 2.71% | `aggregated-gb-only.txt` |
| Thailand | TH | 1,967 | 1,967 | 14,175 | 1.17% | `aggregated-th-only.txt` |
| Vietnam | VN | 2,174 | 2,174 | 37,844 | 3.12% | `aggregated-vn-only.txt` |
| South Korea | KR | 3,913 | 3,903 | 15,410 | 1.27% | `aggregated-kr-only.txt` |
| Brazil | BR | 13,073 | 13,013 | 58,942 | 4.86% | `aggregated-br-only.txt` |
| Taiwan | TW | 2,373 | 2,373 | 13,636 | 1.12% | `aggregated-tw-only.txt` |
| Canada | CA | 16,851 | 16,729 | 25,683 | 2.12% | `aggregated-ca-only.txt` |
| Singapore | SG | 9,368 | 9,358 | 36,022 | 2.97% | `aggregated-sg-only.txt` |
| Italy | IT | 9,679 | 9,655 | 15,194 | 1.25% | `aggregated-it-only.txt` |
| Netherlands | NL | 18,798 | 18,684 | 51,577 | 4.25% | `aggregated-nl-only.txt` |
| Indonesia | ID | 6,473 | 6,452 | 27,076 | 2.23% | `aggregated-id-only.txt` |
| France | FR | 32,809 | 32,782 | 22,605 | 1.86% | `aggregated-fr-only.txt` |
| Venezuela | VE | 954 | 954 | 7,419 | 0.61% | `aggregated-ve-only.txt` |
| Australia | AU | 12,084 | 12,012 | 17,269 | 1.42% | `aggregated-au-only.txt` |
| Turkey | TR | 3,428 | 3,408 | 13,353 | 1.10% | `aggregated-tr-only.txt` |
| Ukraine | UA | 5,410 | 5,355 | 8,816 | 0.73% | `aggregated-ua-only.txt` |
| Iran | IR | 2,050 | 2,049 | 4,706 | 0.39% | `aggregated-ir-only.txt` |
| Poland | PL | 8,117 | 8,083 | 8,022 | 0.66% | `aggregated-pl-only.txt` |
| Mexico | MX | 4,334 | 4,330 | 14,044 | 1.16% | `aggregated-mx-only.txt` |
| Spain | ES | 11,350 | 11,330 | 8,999 | 0.74% | `aggregated-es-only.txt` |
| Argentina | AR | 3,487 | 3,485 | 10,872 | 0.90% | `aggregated-ar-only.txt` |
| Egypt | EG | 787 | 787 | 3,254 | 0.27% | `aggregated-eg-only.txt` |
| Pakistan | PK | 1,343 | 1,341 | 16,060 | 1.32% | `aggregated-pk-only.txt` |
| Malaysia | MY | 2,535 | 2,535 | 5,720 | 0.47% | `aggregated-my-only.txt` |
| Bulgaria | BG | 2,358 | 2,347 | 2,987 | 0.25% | `aggregated-bg-only.txt` |
| Czechia | CZ | 3,597 | 3,596 | 1,892 | 0.16% | `aggregated-cz-only.txt` |
| Colombia | CO | 2,199 | 2,198 | 5,949 | 0.49% | `aggregated-co-only.txt` |
| United Arab Emirates | AE | 3,726 | 3,726 | 4,086 | 0.34% | `aggregated-ae-only.txt` |
| Romania | RO | 4,039 | 4,031 | 2,472 | 0.20% | `aggregated-ro-only.txt` |
| Kazakhstan | KZ | 1,296 | 1,295 | 2,552 | 0.21% | `aggregated-kz-only.txt` |
| Morocco | MA | 477 | 477 | 4,095 | 0.34% | `aggregated-ma-only.txt` |
| Saudi Arabia | SA | 1,647 | 1,647 | 4,321 | 0.36% | `aggregated-sa-only.txt` |
| South Africa | ZA | 3,990 | 3,976 | 7,984 | 0.66% | `aggregated-za-only.txt` |
| Bangladesh | BD | 2,621 | 2,618 | 6,579 | 0.54% | `aggregated-bd-only.txt` |
| Chile | CL | 1,911 | 1,909 | 3,278 | 0.27% | `aggregated-cl-only.txt` |
| Nigeria | NG | 1,083 | 1,083 | 1,420 | 0.12% | `aggregated-ng-only.txt` |
| Kenya | KE | 873 | 873 | 2,854 | 0.24% | `aggregated-ke-only.txt` |
| Algeria | DZ | 219 | 219 | 1,964 | 0.16% | `aggregated-dz-only.txt` |
| Serbia | RS | 973 | 971 | 1,233 | 0.10% | `aggregated-rs-only.txt` |
| Peru | PE | 1,105 | 1,104 | 1,881 | 0.15% | `aggregated-pe-only.txt` |
| Sri Lanka | LK | 248 | 248 | 868 | 0.07% | `aggregated-lk-only.txt` |
| Iraq | IQ | 682 | 682 | 2,629 | 0.22% | `aggregated-iq-only.txt` |
| Ethiopia | ET | 97 | 97 | 1,097 | 0.09% | `aggregated-et-only.txt` |
| Ghana | GH | 342 | 342 | 540 | 0.04% | `aggregated-gh-only.txt` |
| Belarus | BY | 418 | 418 | 703 | 0.06% | `aggregated-by-only.txt` |
...
- **`aggregated.txt`** - 1,213,741 total aggregated IPs from all sources
- **`aggregated-ae-only.txt`** - 4,086 IPs from AE
- **`aggregated-ar-only.txt`** - 10,872 IPs from AR
- **`aggregated-au-only.txt`** - 17,269 IPs from AU
- **`aggregated-bd-only.txt`** - 6,579 IPs from BD
- **`aggregated-bg-only.txt`** - 2,987 IPs from BG
- **`aggregated-br-only.txt`** - 58,942 IPs from BR
- **`aggregated-by-only.txt`** - 703 IPs from BY
- **`aggregated-ca-only.txt`** - 25,683 IPs from CA
- **`aggregated-cl-only.txt`** - 3,278 IPs from CL
- **`aggregated-cn-only.txt`** - 162,778 IPs from CN
- **`aggregated-co-only.txt`** - 5,949 IPs from CO
- **`aggregated-cz-only.txt`** - 1,892 IPs from CZ
- **`aggregated-de-only.txt`** - 45,523 IPs from DE
- **`aggregated-dz-only.txt`** - 1,964 IPs from DZ
- **`aggregated-eg-only.txt`** - 3,254 IPs from EG
- **`aggregated-es-only.txt`** - 8,999 IPs from ES
- **`aggregated-et-only.txt`** - 1,097 IPs from ET
- **`aggregated-fr-only.txt`** - 22,605 IPs from FR
- **`aggregated-gb-only.txt`** - 32,840 IPs from GB
- **`aggregated-gh-only.txt`** - 540 IPs from GH
- **`aggregated-id-only.txt`** - 27,076 IPs from ID
- **`aggregated-in-only.txt`** - 73,683 IPs from IN
- **`aggregated-iq-only.txt`** - 2,629 IPs from IQ
- **`aggregated-ir-only.txt`** - 4,706 IPs from IR
- **`aggregated-it-only.txt`** - 15,194 IPs from IT
- **`aggregated-ke-only.txt`** - 2,854 IPs from KE
- **`aggregated-kr-only.txt`** - 15,410 IPs from KR
- **`aggregated-kz-only.txt`** - 2,552 IPs from KZ
- **`aggregated-lk-only.txt`** - 868 IPs from LK
- **`aggregated-ma-only.txt`** - 4,095 IPs from MA
- **`aggregated-mx-only.txt`** - 14,044 IPs from MX
- **`aggregated-my-only.txt`** - 5,720 IPs from MY
- **`aggregated-ng-only.txt`** - 1,420 IPs from NG
- **`aggregated-nl-only.txt`** - 51,577 IPs from NL
- **`aggregated-pe-only.txt`** - 1,881 IPs from PE
- **`aggregated-pk-only.txt`** - 16,060 IPs from PK
- **`aggregated-pl-only.txt`** - 8,022 IPs from PL
- **`aggregated-ro-only.txt`** - 2,472 IPs from RO
- **`aggregated-rs-only.txt`** - 1,233 IPs from RS
- **`aggregated-ru-only.txt`** - 26,407 IPs from RU
- **`aggregated-sa-only.txt`** - 4,321 IPs from SA
- **`aggregated-sg-only.txt`** - 36,022 IPs from SG
- **`aggregated-th-only.txt`** - 14,175 IPs from TH
- **`aggregated-tr-only.txt`** - 13,353 IPs from TR
- **`aggregated-tw-only.txt`** - 13,636 IPs from TW
- **`aggregated-ua-only.txt`** - 8,816 IPs from UA
- **`aggregated-us-only.txt`** - 230,259 IPs from US
- **`aggregated-ve-only.txt`** - 7,419 IPs from VE
- **`aggregated-vn-only.txt`** - 37,844 IPs from VN
- **`aggregated-za-only.txt`** - 7,984 IPs from ZA
- **`aggregated-multi-50countries-combined.txt`** - 1,069,572 unique IPs (deduplicated across all countries)
