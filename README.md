...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-1703907-2D56A8)
...
**Last Updated:** 2026-09-12 11:00:59 UTC
...
- **Total Input IPs:** 1,703,907
- **Countries Processed:** 50
- **Combined Unique IPs:** 1,494,228
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 130,282 | 128,440 | 327,912 | 19.24% | `aggregated-us-only.txt` |
| China | CN | 7,830 | 7,829 | 239,294 | 14.04% | `aggregated-cn-only.txt` |
| India | IN | 13,289 | 13,260 | 90,248 | 5.30% | `aggregated-in-only.txt` |
| Germany | DE | 29,980 | 29,865 | 49,862 | 2.93% | `aggregated-de-only.txt` |
| Russia | RU | 13,215 | 12,981 | 38,231 | 2.24% | `aggregated-ru-only.txt` |
| United Kingdom | GB | 35,923 | 35,760 | 39,993 | 2.35% | `aggregated-gb-only.txt` |
| Thailand | TH | 2,062 | 2,062 | 17,480 | 1.03% | `aggregated-th-only.txt` |
| Vietnam | VN | 2,222 | 2,222 | 43,017 | 2.52% | `aggregated-vn-only.txt` |
| South Korea | KR | 3,943 | 3,932 | 19,033 | 1.12% | `aggregated-kr-only.txt` |
| Brazil | BR | 12,586 | 12,544 | 105,001 | 6.16% | `aggregated-br-only.txt` |
| Taiwan | TW | 2,411 | 2,411 | 18,409 | 1.08% | `aggregated-tw-only.txt` |
| Canada | CA | 17,185 | 17,069 | 30,423 | 1.79% | `aggregated-ca-only.txt` |
| Singapore | SG | 9,598 | 9,588 | 43,766 | 2.57% | `aggregated-sg-only.txt` |
| Italy | IT | 9,808 | 9,786 | 19,550 | 1.15% | `aggregated-it-only.txt` |
| Netherlands | NL | 19,163 | 19,049 | 54,877 | 3.22% | `aggregated-nl-only.txt` |
| Indonesia | ID | 6,616 | 6,595 | 36,086 | 2.12% | `aggregated-id-only.txt` |
| France | FR | 33,424 | 33,396 | 31,161 | 1.83% | `aggregated-fr-only.txt` |
| Venezuela | VE | 979 | 979 | 10,366 | 0.61% | `aggregated-ve-only.txt` |
| Australia | AU | 12,309 | 12,242 | 18,663 | 1.10% | `aggregated-au-only.txt` |
| Turkey | TR | 3,540 | 3,520 | 20,995 | 1.23% | `aggregated-tr-only.txt` |
| Ukraine | UA | 5,554 | 5,509 | 21,083 | 1.24% | `aggregated-ua-only.txt` |
| Iran | IR | 2,069 | 2,068 | 6,338 | 0.37% | `aggregated-ir-only.txt` |
| Poland | PL | 8,247 | 8,218 | 10,554 | 0.62% | `aggregated-pl-only.txt` |
| Mexico | MX | 4,317 | 4,313 | 23,378 | 1.37% | `aggregated-mx-only.txt` |
| Spain | ES | 11,404 | 11,370 | 14,356 | 0.84% | `aggregated-es-only.txt` |
| Argentina | AR | 3,498 | 3,496 | 25,540 | 1.50% | `aggregated-ar-only.txt` |
| Egypt | EG | 740 | 740 | 5,338 | 0.31% | `aggregated-eg-only.txt` |
| Pakistan | PK | 1,378 | 1,377 | 23,816 | 1.40% | `aggregated-pk-only.txt` |
| Malaysia | MY | 2,615 | 2,615 | 7,793 | 0.46% | `aggregated-my-only.txt` |
| Bulgaria | BG | 2,365 | 2,351 | 3,754 | 0.22% | `aggregated-bg-only.txt` |
| Czechia | CZ | 3,696 | 3,695 | 2,543 | 0.15% | `aggregated-cz-only.txt` |
| Colombia | CO | 2,250 | 2,250 | 10,929 | 0.64% | `aggregated-co-only.txt` |
| United Arab Emirates | AE | 3,788 | 3,788 | 6,358 | 0.37% | `aggregated-ae-only.txt` |
| Romania | RO | 4,057 | 4,048 | 3,192 | 0.19% | `aggregated-ro-only.txt` |
| Kazakhstan | KZ | 1,288 | 1,287 | 3,943 | 0.23% | `aggregated-kz-only.txt` |
| Morocco | MA | 489 | 489 | 7,305 | 0.43% | `aggregated-ma-only.txt` |
| Saudi Arabia | SA | 1,723 | 1,723 | 7,601 | 0.45% | `aggregated-sa-only.txt` |
| South Africa | ZA | 4,070 | 4,056 | 12,136 | 0.71% | `aggregated-za-only.txt` |
| Bangladesh | BD | 2,713 | 2,711 | 11,327 | 0.66% | `aggregated-bd-only.txt` |
| Chile | CL | 2,001 | 1,999 | 8,340 | 0.49% | `aggregated-cl-only.txt` |
| Nigeria | NG | 1,126 | 1,126 | 2,328 | 0.14% | `aggregated-ng-only.txt` |
| Kenya | KE | 883 | 883 | 4,199 | 0.25% | `aggregated-ke-only.txt` |
| Algeria | DZ | 220 | 220 | 3,328 | 0.20% | `aggregated-dz-only.txt` |
| Serbia | RS | 1,004 | 1,004 | 1,767 | 0.10% | `aggregated-rs-only.txt` |
| Peru | PE | 1,123 | 1,122 | 2,933 | 0.17% | `aggregated-pe-only.txt` |
| Sri Lanka | LK | 252 | 252 | 1,151 | 0.07% | `aggregated-lk-only.txt` |
| Iraq | IQ | 675 | 675 | 4,462 | 0.26% | `aggregated-iq-only.txt` |
| Ethiopia | ET | 100 | 100 | 1,812 | 0.11% | `aggregated-et-only.txt` |
...
- **`aggregated.txt`** - 1,703,907 total aggregated IPs from all sources
- **`aggregated-ae-only.txt`** - 6,358 IPs from AE
- **`aggregated-ar-only.txt`** - 25,540 IPs from AR
- **`aggregated-au-only.txt`** - 18,663 IPs from AU
- **`aggregated-bd-only.txt`** - 11,327 IPs from BD
- **`aggregated-bg-only.txt`** - 3,754 IPs from BG
- **`aggregated-br-only.txt`** - 105,001 IPs from BR
- **`aggregated-by-only.txt`** - 1,439 IPs from BY
- **`aggregated-ca-only.txt`** - 30,423 IPs from CA
- **`aggregated-cl-only.txt`** - 8,340 IPs from CL
- **`aggregated-cn-only.txt`** - 239,294 IPs from CN
- **`aggregated-co-only.txt`** - 10,929 IPs from CO
- **`aggregated-cz-only.txt`** - 2,543 IPs from CZ
- **`aggregated-de-only.txt`** - 49,862 IPs from DE
- **`aggregated-dz-only.txt`** - 3,328 IPs from DZ
- **`aggregated-eg-only.txt`** - 5,338 IPs from EG
- **`aggregated-es-only.txt`** - 14,356 IPs from ES
- **`aggregated-et-only.txt`** - 1,812 IPs from ET
- **`aggregated-fr-only.txt`** - 31,161 IPs from FR
- **`aggregated-gb-only.txt`** - 39,993 IPs from GB
- **`aggregated-gh-only.txt`** - 818 IPs from GH
- **`aggregated-id-only.txt`** - 36,086 IPs from ID
- **`aggregated-in-only.txt`** - 90,248 IPs from IN
- **`aggregated-iq-only.txt`** - 4,462 IPs from IQ
- **`aggregated-ir-only.txt`** - 6,338 IPs from IR
- **`aggregated-it-only.txt`** - 19,550 IPs from IT
- **`aggregated-ke-only.txt`** - 4,199 IPs from KE
- **`aggregated-kr-only.txt`** - 19,033 IPs from KR
- **`aggregated-kz-only.txt`** - 3,943 IPs from KZ
- **`aggregated-lk-only.txt`** - 1,151 IPs from LK
- **`aggregated-ma-only.txt`** - 7,305 IPs from MA
- **`aggregated-mx-only.txt`** - 23,378 IPs from MX
- **`aggregated-my-only.txt`** - 7,793 IPs from MY
- **`aggregated-ng-only.txt`** - 2,328 IPs from NG
- **`aggregated-nl-only.txt`** - 54,877 IPs from NL
- **`aggregated-pe-only.txt`** - 2,933 IPs from PE
- **`aggregated-pk-only.txt`** - 23,816 IPs from PK
- **`aggregated-pl-only.txt`** - 10,554 IPs from PL
- **`aggregated-ro-only.txt`** - 3,192 IPs from RO
- **`aggregated-rs-only.txt`** - 1,767 IPs from RS
- **`aggregated-ru-only.txt`** - 38,231 IPs from RU
- **`aggregated-sa-only.txt`** - 7,601 IPs from SA
- **`aggregated-sg-only.txt`** - 43,766 IPs from SG
- **`aggregated-th-only.txt`** - 17,480 IPs from TH
- **`aggregated-tr-only.txt`** - 20,995 IPs from TR
- **`aggregated-tw-only.txt`** - 18,409 IPs from TW
- **`aggregated-ua-only.txt`** - 21,083 IPs from UA
- **`aggregated-us-only.txt`** - 327,912 IPs from US
- **`aggregated-ve-only.txt`** - 10,366 IPs from VE
- **`aggregated-vn-only.txt`** - 43,017 IPs from VN
- **`aggregated-za-only.txt`** - 12,136 IPs from ZA
- **`aggregated-multi-50countries-combined.txt`** - 1,494,228 unique IPs (deduplicated across all countries)
