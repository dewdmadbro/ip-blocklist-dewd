...
![Total IPs Blocked](https://img.shields.io/badge/Blocked_IPs-1052850-2D56A8)
...
**Last Updated:** 2026-05-15 14:39:04 UTC
...
- **Total Input IPs:** 1,052,850
- **Countries Processed:** 50
- **Combined Unique IPs:** 932,338
...
|---------|------|----------------|--------------------|-----------|-----------|-----------|
| United States | US | 167,975 | 166,467 | 201,637 | 19.15% | `aggregated-us-only.txt` |
| China | CN | 7,573 | 7,572 | 135,624 | 12.88% | `aggregated-cn-only.txt` |
| India | IN | 12,849 | 12,821 | 65,544 | 6.23% | `aggregated-in-only.txt` |
| Germany | DE | 28,807 | 28,725 | 39,154 | 3.72% | `aggregated-de-only.txt` |
| Russia | RU | 13,075 | 12,845 | 24,985 | 2.37% | `aggregated-ru-only.txt` |
| United Kingdom | GB | 34,028 | 33,858 | 29,581 | 2.81% | `aggregated-gb-only.txt` |
| Thailand | TH | 1,943 | 1,942 | 13,561 | 1.29% | `aggregated-th-only.txt` |
| Vietnam | VN | 2,134 | 2,134 | 35,274 | 3.35% | `aggregated-vn-only.txt` |
| South Korea | KR | 3,984 | 3,974 | 14,227 | 1.35% | `aggregated-kr-only.txt` |
| Brazil | BR | 12,903 | 12,767 | 43,301 | 4.11% | `aggregated-br-only.txt` |
| Taiwan | TW | 2,418 | 2,418 | 12,982 | 1.23% | `aggregated-tw-only.txt` |
| Canada | CA | 17,039 | 16,905 | 22,465 | 2.13% | `aggregated-ca-only.txt` |
| Singapore | SG | 9,243 | 9,233 | 31,724 | 3.01% | `aggregated-sg-only.txt` |
| Italy | IT | 9,559 | 9,535 | 14,051 | 1.33% | `aggregated-it-only.txt` |
| Netherlands | NL | 18,372 | 18,250 | 50,770 | 4.82% | `aggregated-nl-only.txt` |
| Indonesia | ID | 6,412 | 6,393 | 25,284 | 2.40% | `aggregated-id-only.txt` |
| France | FR | 32,099 | 32,073 | 19,898 | 1.89% | `aggregated-fr-only.txt` |
| Venezuela | VE | 928 | 928 | 6,489 | 0.62% | `aggregated-ve-only.txt` |
| Australia | AU | 12,110 | 12,041 | 15,703 | 1.49% | `aggregated-au-only.txt` |
| Turkey | TR | 3,410 | 3,386 | 12,309 | 1.17% | `aggregated-tr-only.txt` |
| Ukraine | UA | 5,547 | 5,492 | 8,014 | 0.76% | `aggregated-ua-only.txt` |
| Iran | IR | 2,013 | 2,012 | 3,937 | 0.37% | `aggregated-ir-only.txt` |
| Poland | PL | 8,019 | 7,988 | 7,438 | 0.71% | `aggregated-pl-only.txt` |
| Mexico | MX | 4,378 | 4,374 | 10,428 | 0.99% | `aggregated-mx-only.txt` |
| Spain | ES | 10,946 | 10,915 | 7,493 | 0.71% | `aggregated-es-only.txt` |
| Argentina | AR | 3,471 | 3,469 | 8,936 | 0.85% | `aggregated-ar-only.txt` |
| Egypt | EG | 730 | 730 | 2,725 | 0.26% | `aggregated-eg-only.txt` |
| Pakistan | PK | 1,320 | 1,320 | 13,366 | 1.27% | `aggregated-pk-only.txt` |
| Malaysia | MY | 2,480 | 2,480 | 5,205 | 0.49% | `aggregated-my-only.txt` |
| Bulgaria | BG | 2,287 | 2,277 | 2,744 | 0.26% | `aggregated-bg-only.txt` |
| Czechia | CZ | 3,600 | 3,600 | 1,666 | 0.16% | `aggregated-cz-only.txt` |
...
| Kazakhstan | KZ | 1,255 | 1,254 | 2,283 | 0.22% | `aggregated-kz-only.txt` |
| Morocco | MA | 478 | 478 | 3,410 | 0.32% | `aggregated-ma-only.txt` |
| Saudi Arabia | SA | 1,630 | 1,630 | 3,760 | 0.36% | `aggregated-sa-only.txt` |
| South Africa | ZA | 3,962 | 3,949 | 6,715 | 0.64% | `aggregated-za-only.txt` |
| Bangladesh | BD | 2,615 | 2,612 | 5,210 | 0.49% | `aggregated-bd-only.txt` |
| Chile | CL | 1,885 | 1,885 | 2,372 | 0.23% | `aggregated-cl-only.txt` |
...
- **`aggregated.txt`** - 1,052,850 total aggregated IPs from all sources
- **`aggregated-ae-only.txt`** - 3,379 IPs from AE
- **`aggregated-ar-only.txt`** - 8,936 IPs from AR
- **`aggregated-au-only.txt`** - 15,703 IPs from AU
- **`aggregated-bd-only.txt`** - 5,210 IPs from BD
- **`aggregated-bg-only.txt`** - 2,744 IPs from BG
- **`aggregated-br-only.txt`** - 43,301 IPs from BR
- **`aggregated-by-only.txt`** - 677 IPs from BY
- **`aggregated-ca-only.txt`** - 22,465 IPs from CA
- **`aggregated-cl-only.txt`** - 2,372 IPs from CL
- **`aggregated-cn-only.txt`** - 135,624 IPs from CN
- **`aggregated-co-only.txt`** - 4,444 IPs from CO
- **`aggregated-cz-only.txt`** - 1,666 IPs from CZ
- **`aggregated-de-only.txt`** - 39,154 IPs from DE
- **`aggregated-dz-only.txt`** - 1,565 IPs from DZ
- **`aggregated-eg-only.txt`** - 2,725 IPs from EG
- **`aggregated-es-only.txt`** - 7,493 IPs from ES
- **`aggregated-et-only.txt`** - 900 IPs from ET
- **`aggregated-fr-only.txt`** - 19,898 IPs from FR
- **`aggregated-gb-only.txt`** - 29,581 IPs from GB
- **`aggregated-gh-only.txt`** - 500 IPs from GH
- **`aggregated-id-only.txt`** - 25,284 IPs from ID
- **`aggregated-in-only.txt`** - 65,544 IPs from IN
- **`aggregated-iq-only.txt`** - 1,892 IPs from IQ
- **`aggregated-ir-only.txt`** - 3,937 IPs from IR
- **`aggregated-it-only.txt`** - 14,051 IPs from IT
- **`aggregated-ke-only.txt`** - 2,387 IPs from KE
- **`aggregated-kr-only.txt`** - 14,227 IPs from KR
- **`aggregated-kz-only.txt`** - 2,283 IPs from KZ
- **`aggregated-lk-only.txt`** - 624 IPs from LK
- **`aggregated-ma-only.txt`** - 3,410 IPs from MA
- **`aggregated-mx-only.txt`** - 10,428 IPs from MX
- **`aggregated-my-only.txt`** - 5,205 IPs from MY
- **`aggregated-ng-only.txt`** - 1,130 IPs from NG
- **`aggregated-nl-only.txt`** - 50,770 IPs from NL
- **`aggregated-pe-only.txt`** - 1,494 IPs from PE
- **`aggregated-pk-only.txt`** - 13,366 IPs from PK
- **`aggregated-pl-only.txt`** - 7,438 IPs from PL
- **`aggregated-ro-only.txt`** - 2,075 IPs from RO
- **`aggregated-rs-only.txt`** - 1,006 IPs from RS
- **`aggregated-ru-only.txt`** - 24,985 IPs from RU
- **`aggregated-sa-only.txt`** - 3,760 IPs from SA
- **`aggregated-sg-only.txt`** - 31,724 IPs from SG
- **`aggregated-th-only.txt`** - 13,561 IPs from TH
- **`aggregated-tr-only.txt`** - 12,309 IPs from TR
- **`aggregated-tw-only.txt`** - 12,982 IPs from TW
- **`aggregated-ua-only.txt`** - 8,014 IPs from UA
- **`aggregated-us-only.txt`** - 201,637 IPs from US
- **`aggregated-ve-only.txt`** - 6,489 IPs from VE
- **`aggregated-vn-only.txt`** - 35,274 IPs from VN
- **`aggregated-za-only.txt`** - 6,715 IPs from ZA
- **`aggregated-multi-50countries-combined.txt`** - 932,338 unique IPs (deduplicated across all countries)
